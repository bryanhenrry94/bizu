            ...
            try
            {
                ...
                var selectGuia = from q in OEnti.vwfa_Guia_Remision
                  ...
                  var CabeceraGuia = from cab in selectGuia
                                    ...
                                    { cab.IdEmpresa,
                                       ...
                                       cab.gi_TotalQuintales,
                                        ...
                                        cab.Direccion_Origen,
                                        cab.Direccion_Destino,
                                        cab.ruta,
                                        cab.placa
                                    }
                                          into grouping
                  ...
                  foreach (var item in CabeceraGuia)
                  {
                      ...
                      info.IdPeriodo = Convert.ToInt32(item.Key.IdPeriodo);
                      ...
                      info.Direccion_Origen = item.Key.Direccion_Origen;
                      info.Direccion_Destino = item.Key.Direccion_Destino;
                      info.ruta = item.Key.ruta;
                      info.placa = item.Key.placa;
