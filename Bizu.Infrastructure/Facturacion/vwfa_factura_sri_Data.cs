            ...
            try
            {
                ...
                var consulta = from h in OEFAC.vwfa_factura_sri
                                ...
                                select new 
                                {
                                    ...
                                    h.pe_cedulaRuc,
                                    h.pe_correo,
                                    h.pe_correo_secundario1,
                                    h.pe_correo_secundario2,
                                    h.vt_plazo,
                                    h.vt_fech_venc,
                                    h.vt_Observacion,
                                    h.IdTerminoPago,
                ...
                foreach (var item in consulta)
                {
                    ...
                    Info.pe_correo_secundario1 = item.pe_correo_secundario1;
                    Info.pe_correo_secundario2 = item.pe_correo_secundario2;
                    ...
                    Info.DireccionCliente = item.DireccionCliente;
