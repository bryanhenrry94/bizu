    ...
    public class fa_factura_det_x_fa_descuento_Data
    {
        ...
        public bool EliminarDB(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdCbteVta)
        {
            try
            {
                using (EntitiesFacturacion Context = new EntitiesFacturacion())
                {
                    string comando = "delete from fa_factura_det_x_fa_descuento where IdEmpresa_fa = " + IdEmpresa + " and IdSucursal = " + IdSucursal + " and IdBodega = " + IdBodega + " and IdCbteVta = " + IdCbteVta;
