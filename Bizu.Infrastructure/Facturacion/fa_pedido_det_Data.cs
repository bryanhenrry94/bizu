        ...
        public List<fa_pedido_det_Info> Get_List_pedido_det(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdPedido)
        {
            try
            {
                ...
                foreach (var item in select_pedido_det)
                {
                    ...
                    info.dp_estado = item.dp_estado;
                    info.idPunto_cargo = item.idPunto_cargo;
                    info.idPunto_cargo_grupo = item.idPunto_cargo_grupo;
                    info.dp_por_iva = item.dp_por_iva;
                    //Nuevo
                    info.IdCod_Impuesto_Iva = item.IdCod_Impuesto_Iva;
                    info.dp_estado = item.dp_estado;
                    info.idPunto_cargo = item.idPunto_cargo;
        ...
        public Boolean GrabarDB(fa_pedido_det_Info info, ref string msg)
        {
            try
            {
                    ...
                    using (EntitiesFacturacion context = new EntitiesFacturacion())
                    {
                        ...
                        //Nuevo
                        address.IdCod_Impuesto_Iva = info.IdCod_Impuesto_Iva;
                        address.dp_estado = info.dp_estado;
                        address.idPunto_cargo = info.idPunto_cargo;
                        address.idPunto_cargo_grupo = info.idPunto_cargo_grupo;
                        address.dp_por_iva = info.dp_por_iva;
                        address.idCod_Impuesto_Ice = info.idCod_Impuesto_Ice;
