...
[Keyless]
public partial class VwinProductoXTbBodegaLite
{
    ...
    [Column("pr_Pedidos_fact")]
    public double PrPedidosFact { get; set; }

    [Column("pr_Pedidos_inv")]
    public double PrPedidosInv { get; set; }
    ...
    [Column("nom_Tipo_Producto")]
    [StringLength(50)]
    [MySqlCollation("utf8mb4_unicode_ci")]
    public string NomTipoProducto { get; set; } = null!;
