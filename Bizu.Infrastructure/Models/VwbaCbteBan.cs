...
[Keyless]
public partial class VwbaCbteBan
{
    [Column("tc_TipoCbte")]
    [StringLength(50)]
    ...
    [StringLength(50)]
    [MySqlCollation("utf8mb4_unicode_ci")]
    public string IdEstadoCbteBanCat { get; set; } = null!;

    [Column("nom_Estado_Cbte_Ban")]
    [StringLength(250)]
    [MySqlCollation("utf8mb4_unicode_ci")]
    public string? NomEstadoCbteBan { get; set; }
    ...
    [StringLength(0)]
    public string EstadoConciliacion { get; set; } = null!;

    [Column("IdEstado_Preaviso_ch_cat")]
    [StringLength(50)]
    [MySqlCollation("utf8mb4_unicode_ci")]
    public string IdEstadoPreavisoChCat { get; set; } = null!;
