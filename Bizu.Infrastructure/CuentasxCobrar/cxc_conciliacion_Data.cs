        ...
        public Boolean Guardar_Conciliacion(cxc_conciliacion_Info Item, ref decimal Id, ref string mensaje)
        {
            try
            {
                using (EntitiesCuentas_x_Cobrar oEnti = new EntitiesCuentas_x_Cobrar())
                {
                    ...
                    //inserto detalle de la conciliacion
                    cxc_conciliacion_det_Data Data_cxc_conciliacion_det = new cxc_conciliacion_det_Data();
                    Data_cxc_conciliacion_det.GuardarDB(Item.Detalle, ref Id, ref mensaje);
                }
                return true;
            }
            catch (Exception ex)
