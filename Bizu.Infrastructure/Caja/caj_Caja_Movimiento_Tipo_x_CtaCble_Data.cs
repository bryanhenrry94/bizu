...
namespace Bizu.Infrastructure.Caja
{
    public class caj_Caja_Movimiento_Tipo_x_CtaCble_Data
    {
        ...
        private Boolean ExisteDB(caj_Caja_Movimiento_Tipo_x_CtaCble_Info Info_Caja_Movimiento_Tipo_x_CtaCble)
        {
            try
            {
                Boolean Existe = false;                

                if (Info_Caja_Movimiento_Tipo_x_CtaCble != null)
                {
                    EntitiesCaja Entities = new EntitiesCaja();

                    var query = from q in Entities.caj_Caja_Movimiento_Tipo_x_CtaCble
                                where q.IdEmpresa == Info_Caja_Movimiento_Tipo_x_CtaCble.IdEmpresa
                                && q.IdTipoMovi == Info_Caja_Movimiento_Tipo_x_CtaCble.IdTipoMovi
                                select q;
