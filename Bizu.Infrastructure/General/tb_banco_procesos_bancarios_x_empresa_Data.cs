    ...
    public class tb_banco_procesos_bancarios_x_empresa_Data
    {
            ...
            try
            {
                ...
                using (EntitiesGeneral Context = new EntitiesGeneral())
                {
                    ...
                    foreach (var item in lst)
                    {
                        ...
                        //info.cod_Proceso = item.IdProceso_bancario_tipo;
        ...
        public bool EliminarDB(int IdEmpresa, int IdBanco)
        {
            try
            {
                try
                {
                    string Comando = "DELETE FROM tb_banco_procesos_bancarios_x_empresa WHERE IdEmpresa = " + IdEmpresa + " and IdBanco = " + IdBanco;
                    using(EntitiesGeneral Context = new EntitiesGeneral())
                    {
