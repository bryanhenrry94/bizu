      ...
      public List<in_Ingreso_x_OrdenCompra_det_Info> Get_List_Ingreso_x_OrdenCompra_det_x_proveedor(int IdEmpresa, decimal IdProveedor)
      {
          try
          {
              ...
              foreach (var item in Consulta)
              {
                  ...
                  Obj.Tipo = item.Tipo;
                  Obj.oc_fecha = Convert.ToDateTime(item.oc_fecha);  //rth
                  ...
                  //Obj.IdBodegaProducto = item.IdBodegaProducto;
                  ...
                  Obj.oc_NumDocumento = item.oc_NumDocumento;
                  Obj.detalle_x_tiem  = item.detalle_x_tiem;                  
      ...
      public List<in_Ingreso_x_OrdenCompra_det_Info> Get_List_Ingreso_x_OrdenCompra_det_x_proveedor_x_OrdenCompra(int IdEmpresa, decimal IdProveedor, int ordenCompra)
      {
          try
          {
              ...
              foreach (var item in Consulta)
              {
                  ...
                  Obj.nom_proveedor = item.nom_proveedor;
                  Obj.Tipo = item.Tipo;
                  Obj.IdProductoTipo = item.IdProductoTipo;
