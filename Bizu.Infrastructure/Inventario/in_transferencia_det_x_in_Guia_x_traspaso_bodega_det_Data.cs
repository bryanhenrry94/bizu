    ...
    public class in_transferencia_det_x_in_Guia_x_traspaso_bodega_det_Data
    {
        ...
        public bool EliminarDB(in_transferencia_Info info)
        {
            try
            {
                try
                {
                    string comando = "DELETE FROM in_transferencia_det_x_in_Guia_x_traspaso_bodega_det WHERE IdEmpresa_trans = " + info.IdEmpresa + " and IdSucursalOrigen_trans = " + info.IdSucursalOrigen + " and IdBodegaOrigen_trans = " + info.IdBodegaOrigen + " and IdTransferencia_trans = " + info.IdTransferencia;
