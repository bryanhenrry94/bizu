...
namespace Bizu.Infrastructure.Inventario
{
    public class in_producto_x_tb_bodega_Costo_Historico_Data
    {
        ...
        public bool Proceso_recosteo_y_correccion_contable_inv(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdProducto, DateTime Fecha_ini, DateTime Fecha_fin, int Decimales)
        {
            try
            {
                List<in_producto_x_tb_bodega_Costo_Historico_Info> Lista = new List<in_producto_x_tb_bodega_Costo_Historico_Info>();
