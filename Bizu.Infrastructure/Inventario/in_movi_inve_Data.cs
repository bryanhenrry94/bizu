...
namespace Bizu.Infrastructure.Inventario
{
    public class in_movi_inve_Data
    {
        ...
        public List<in_movi_inve_Info> Get_list_Movi_inven(int idcompany, int idSucursalIni, int idSucursalFin, int IdBodegaIni, int IdBodegaFin, int TipoMoviIni, int TipoMoviFin, DateTime FechaIni, DateTime FechaFin, string Signo_Ing_Egre = "")
        {
            try
            {
            ...
            try
            {
                using (EntitiesInventario context = new EntitiesInventario())
                {
                    ...
                    if (Q.ToList().Count == 0)
                    {
                        ...
                        address.Estado = string.IsNullOrEmpty(prI.Estado) ? "A" : prI.Estado; // "A";
        ...
        public in_movi_inve_Info Get_list_Movi_inven_Reporte(int IdEmpresa, int IdSucursal, int IdBodega, int TipoMovi, decimal IdNumMovi)
        {
            try
            {
                byte[] logo;
