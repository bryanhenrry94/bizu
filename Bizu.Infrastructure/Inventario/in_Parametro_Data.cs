            ...
            try
            {
                using (EntitiesInventario context = new EntitiesInventario())
                {
                    ...
                    if (selectBaParam == 0)
                    {
                        ...
                        addressG.IdMovi_Inven_tipo_Ing_Obra = info.IdMovi_Inven_tipo_Ing_Obra;
                        addressG.IdMovi_Inven_tipo_Egr_Obra = info.IdMovi_Inven_tipo_Egr_Obra;
                        ...
                        addressG.pa_ruta_descarga_xml_guia_elct = info.pa_ruta_descarga_xml_guia_elct;
                        addressG.Genera_Mov_Inv_x_GuiaRemision = info.Genera_Mov_Inv_x_GuiaRemision;
                        addressG.IdMovi_Inven_tipo_x_GuiaRemision = info.IdMovi_Inven_tipo_x_GuiaRemision;
                        addressG.IdMotivo_Inv_x_GuiaRemision = info.IdMotivo_Inv_x_GuiaRemision;
                        addressG.IdMovi_Inven_tipo_x_Anulacion_GuiaRemision = info.IdMovi_Inven_tipo_x_Anulacion_GuiaRemision;
                        addressG.IdMotivo_Inv_x_Anulacion_GuiaRemision = info.IdMotivo_Inv_x_Anulacion_GuiaRemision;
                        addressG.P_Maneja_Lote = info.P_Maneja_Lote;
                    ...
                    else
                    {
                        ...
                        contact.IdMovi_Inven_tipo_Ing_Obra = info.IdMovi_Inven_tipo_Ing_Obra;
                        contact.IdMovi_Inven_tipo_Egr_Obra = info.IdMovi_Inven_tipo_Egr_Obra;
                        ...
                        contact.pa_ruta_descarga_xml_guia_elct = info.pa_ruta_descarga_xml_guia_elct;

                        contact.P_IdCtaCble_transitoria_transf_inven = (info.P_IdCtaCble_transitoria_transf_inven == null) ? null : Convert.ToString(info.P_IdCtaCble_transitoria_transf_inven);
                        contact.pa_ruta_descarga_xml_guia_elct = info.pa_ruta_descarga_xml_guia_elct;
                        contact.Genera_Mov_Inv_x_GuiaRemision = info.Genera_Mov_Inv_x_GuiaRemision;
                        contact.IdMovi_Inven_tipo_x_GuiaRemision = info.IdMovi_Inven_tipo_x_GuiaRemision;
                        contact.IdMotivo_Inv_x_GuiaRemision = info.IdMotivo_Inv_x_GuiaRemision;
                        contact.IdMovi_Inven_tipo_x_Anulacion_GuiaRemision = info.IdMovi_Inven_tipo_x_Anulacion_GuiaRemision;
                        contact.IdMotivo_Inv_x_Anulacion_GuiaRemision = info.IdMotivo_Inv_x_Anulacion_GuiaRemision;
                        contact.P_Maneja_Lote = info.P_Maneja_Lote;
        ...
        public in_Parametro_Info Get_Info_Parametro(int IdEmpresa)
        {
            try
            {
                ...
                foreach (var item in selectBaParam)
                {
                    ...
                    Cbt.IdMovi_Inven_tipo_Ing_Obra = item.IdMovi_Inven_tipo_Ing_Obra;
                    Cbt.IdMovi_Inven_tipo_Egr_Obra = item.IdMovi_Inven_tipo_Egr_Obra;
                    Cbt.IdSucursalSuministro = Convert.ToInt32(item.IdSucursal_Suministro);
                    ...
                    Cbt.pa_ruta_descarga_xml_guia_elct = item.pa_ruta_descarga_xml_guia_elct;
                    Cbt.Genera_Mov_Inv_x_GuiaRemision = item.Genera_Mov_Inv_x_GuiaRemision;
                    Cbt.IdMovi_Inven_tipo_x_GuiaRemision = item.IdMovi_Inven_tipo_x_GuiaRemision;
                    Cbt.IdMotivo_Inv_x_GuiaRemision = item.IdMotivo_Inv_x_GuiaRemision;
                    Cbt.IdMovi_Inven_tipo_x_Anulacion_GuiaRemision = item.IdMovi_Inven_tipo_x_Anulacion_GuiaRemision;
                    Cbt.IdMotivo_Inv_x_Anulacion_GuiaRemision = item.IdMotivo_Inv_x_Anulacion_GuiaRemision;
                    Cbt.P_Maneja_Lote = item.P_Maneja_Lote;
                }
                return (Cbt);
            }
            catch (Exception ex)
