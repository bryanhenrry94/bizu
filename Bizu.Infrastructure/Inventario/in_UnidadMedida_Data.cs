   ...
   public  class in_UnidadMedida_Data
    {
       ...
       public List<in_UnidadMedida_Info> Get_list_UnidadMedida()
       {
           try
           {
               ...
               var selectCbtecble = from C in OECbtecble_Info.in_UnidadMedida where C.Estado=="A"
                                    select C;
       ...
       public in_UnidadMedida_Info Get_Info_UnidadMedida(string IdUnidadMedida)
       {
           try
           {
               ...
               var selectCbtecble = from C in OECbtecble_Info.in_UnidadMedida where C.Estado=="A"
                                    && C.IdUnidadMedida == IdUnidadMedida
                                    select C;
               ...
               foreach (var item in selectCbtecble)
               {
                   ...
                   Info.Usado_en_Movimiento = item.Usado_en_Movimiento;
                   Info.Estado = item.Estado;
                   Info.Descripcion2 = "[" + item.IdUnidadMedida + "] " + item.Descripcion;                   
               }
