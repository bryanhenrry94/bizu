        ...
        public in_ProductoTipo_Info BuscarTipo(int idtipo, int idempresa)
        {
            try
            {
                ...
                if (tipo != null)
                {
                    ...
                    tipoProd.tp_EsCombo = tipo.tp_EsCombo;
                    tipoProd.tp_ManejaInven = tipo.tp_ManejaInven;
                    tipoProd.EsMateriaPrima = tipo.EsMateriaPrima;
                    tipoProd.EsProductoTerminado= tipo.EsProductoTerminado;
