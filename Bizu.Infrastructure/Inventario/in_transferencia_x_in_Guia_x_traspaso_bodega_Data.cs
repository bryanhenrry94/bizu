    ...
    public class in_transferencia_x_in_Guia_x_traspaso_bodega_Data
    {
        ...
        public Boolean EliminarDB(in_transferencia_Info InfoTrans ) 
        {
            try
            {
                using (EntitiesInventario Context = new EntitiesInventario())
                {
                    string comando = "DELETE FROM in_transferencia_x_in_Guia_x_traspaso_bodega where IdEmpresa = " + InfoTrans.IdEmpresa + " and IdSucursalOrgen = " + InfoTrans.IdSucursalOrigen + " and IdBodegaOrigen = " + InfoTrans.IdBodegaOrigen + " and IdTransferencia = " + InfoTrans.IdTransferencia;
