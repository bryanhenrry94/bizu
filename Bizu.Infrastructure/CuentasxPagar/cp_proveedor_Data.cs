    ...
    { 
        ...
        public List<cp_proveedor_Info> Get_List_proveedor(int IdEmpresa)
        {
            try
            {
                ...
                //                      select selec;
                var resultado = OEUser.vwcp_ProveedorRuc
                        .Where(vpr => vpr.IdEmpresa == IdEmpresa)
                        .ToList();
                ...
                foreach (var item in resultado)
                {
                    ...
                    datI.IdTerminoPago = item.IdTerminoPago;
                    ...
                    datI.pr_contribuyenteExentoDeIVA = item.pr_contribuyenteExentoDeIVA;
                    ...
                    datI.IdCtaCble_TarjetaPago = item.IdCtaCble_TarjetaPago;
                    ...
                    datI.IdTipoDocumento_acreditacion = item.IdTipoDocumento_acreditacion;
                    datI.cedulaRuc_acreditacion = item.cedulaRuc_acreditacion;
                    datI.beneficiario_acreditacion = item.beneficiario_acreditacion;
                    datI.correo_acreditacion = item.correo_acreditacion;
                    ...
                    datI.pr_GranContribuyente = item.pr_GranContribuyente;
                    datI.IdRegimen = item.IdRegimen;
                    datI.nomRegimen = item.nomRegimen;
                    datI.nomNaturaleza = item.nomNaturaleza;
                    datI.CorreoPrincipal = item.CorreoPrincipal;
                    datI.CorreoSecundario = item.CorreoSecundario;
                    datI.CorreoAlterno = item.CorreoAlterno;
        ...
        public cp_proveedor_Info Get_Info_Proveedor_Solo_CtasCbles(int IdEmpresa, decimal IdProveedor)
        {
            try
            {
                ...
                var selectProveedor = from selec in OEUser.vwcp_ProveedorRuc
                                      where selec.IdEmpresa == IdEmpresa && selec.IdProveedor == IdProveedor
                                      select new { selec.IdEmpresa, selec.IdProveedor, selec.IdCtaCble_Anticipo, selec.IdCtaCble_CXP, selec.IdCtaCble_Gasto, selec.IdCtaCble_TarjetaPago };
        ...
        public cp_proveedor_Info Get_Info_Proveedor_x_Persona(int IdEmpresa, decimal IdPersona, ref string msj)
        {
            try
            {
                ...
                var selectProveedor = from selec in OEUser.vwcp_ProveedorRuc
                                      ...
                                      && selec.pe_estado == "A" && selec.pr_estado == "A"
                                      select selec;
            ...
            try
            {
                try
                {
                    ...
                    using (EntitiesCuentasxPagar context = new EntitiesCuentasxPagar())
                    {
                        ...
                        address.pr_contribuyenteExentoDeIVA = info.pr_contribuyenteExentoDeIVA;
                        address.pr_plazo = info.pr_plazo;
                        address.representante_legal = ".";
                        address.pr_estado = info.pr_estado;
                        address.IdCiudad = info.IdCiudad;
                        ...
                        address.IdCtaCble_TarjetaPago = (info.IdCtaCble_TarjetaPago == null) ? null : info.IdCtaCble_TarjetaPago.Trim();
                        ...
                        address.pr_GranContribuyente = info.pr_GranContribuyente;
                        address.IdRegimen = info.IdRegimen;
                        address.CorreoPrincipal = info.CorreoPrincipal;
                        address.CorreoSecundario = info.CorreoSecundario;
                        address.CorreoAlterno = info.CorreoAlterno;
            ...
            try
            {
                ...
                using (EntitiesCuentasxPagar context = new EntitiesCuentasxPagar())
                {
                    ...
                    if (address != null)
                    {
                        ...
                        address.IdCtaCble_TarjetaPago = info.IdCtaCble_TarjetaPago;
                        address.IdCtaCble_CXP = info.IdCtaCble_CXP;
                        address.IdClaseProveedor = info.IdClaseProveedor;
                        address.IdTerminoPago = (info.IdTerminoPago == null) ? null : info.IdTerminoPago.Trim();
                        address.IdTipoCta_acreditacion_cat = (info.IdTipoCta_acreditacion_cat == "") ? null : info.IdTipoCta_acreditacion_cat;
                        address.num_cta_acreditacion = info.num_cta_acreditacion;
                        address.IdBanco_acreditacion = info.IdBanco_acreditacion;
                        address.IdTipoDocumento_acreditacion = info.IdTipoDocumento_acreditacion;
        ...
        {  
            try
            {
                ...
                OECp_Proveedor.Database.ExecuteSqlCommand("delete from cp_proveedor where IdEmpresa = " + idEmpresa );
        ...
        public bool ActualizarDatosBancarios(cp_proveedor_Info Info)
        {
            try
            {
                bool res = false;
                ...
                using (EntitiesCuentasxPagar context = new EntitiesCuentasxPagar())
                {
                    ...
                    if (address != null)
                    {
                        address.IdTipoCta_acreditacion_cat = Info.IdTipoCta_acreditacion_cat;
                        address.num_cta_acreditacion = Info.num_cta_acreditacion;
                        address.IdBanco_acreditacion = Info.IdBanco_acreditacion;
                        address.IdTipoDocumento_acreditacion = Info.IdTipoDocumento_acreditacion;
                        address.cedulaRuc_acreditacion = Info.cedulaRuc_acreditacion;
