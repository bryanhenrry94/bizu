...
namespace Bizu.Infrastructure.CuentasxPagar
{
    ...
    public class vwcp_orden_pago_con_cancelacion_Data
    {
        ...
        public List<vwcp_orden_pago_con_cancelacion_Info> Get_List_orden_pago_con_cancelacion_Con_Saldo(int IdEmpresa, string IdTipoPersona, decimal IdPersona, decimal IdEntidad, string IdEstado_Aprobacion)
        {
            try
            {
        ...
        public List<vwcp_orden_pago_con_cancelacion_Info> Get_List_orden_pago_con_cancelacion(int IdEmpresa, string IdTipoPersona, decimal IdPersona, decimal IdEntidad, string IdEstado_Aprobacion)
        {
            try
            {
        ...
        public List<vwcp_orden_pago_con_cancelacion_Info> Get_List_orden_pago_con_cancelacion(int IdEmpresa, string IdTipoPersona, decimal IdPersona, int IdTipoCbte_cxp, int IdCbteCble_cxp)
        {
            try
            {
                ...
                var select_ = (from T in db.vwcp_orden_pago_con_cancelacion
                               where T.IdEmpresa == IdEmpresa
                                        && T.IdTipoPersona.Contains(IdTipoPersona)
                                        && T.IdPersona >= IdPersonaIni && T.IdPersona <= IdPersonaFin
                                        && T.IdTipoCbte_cxp == IdTipoCbte_cxp
                                        && T.IdCbteCble_cxp == IdCbteCble_cxp
                               select T
                               );
        ...
        public List<vwcp_orden_pago_con_cancelacion_Info> Get_List_orden_pago_para_aprobacion(int IdEmpresa, string IdTipoPersona, decimal IdPersona, decimal IdEntidad, string IdEstado_Aprobacion)
        {
            try
            {
        ...
        public List<vwcp_orden_pago_con_cancelacion_Info> Get_List_orden_pago_con_cancelacion_Mayor_a_cero_Lite(int IdEmpresa, string IdTipo_op, decimal IdProveedor, string IdEstado_Aprobacion)
        {
            ...
            try
            {
                ...
                IQueryable<vwcp_orden_pago_con_cancelacion_lite> select_ = null;

                if (IdTipo_op == "")
                {
                    select_ = (from T in db.vwcp_orden_pago_con_cancelacion_lite
                               where T.IdEmpresa == IdEmpresa
                                        && T.IdEntidad == IdProveedor
                                        && T.IdEstadoAprobacion == IdEstado_Aprobacion
                                        && T.Saldo_x_Pagar_OP > 0
        ...
        public List<vwcp_orden_pago_con_cancelacion_Info> Get_List_orden_pago_con_cancelacion_Mayor_a_cero_(int IdEmpresa, string IdTipoPersona, decimal IdPersona, decimal IdEntidad, string IdEstado_Aprobacion)
        {
            try
            {
                decimal IdPersonaIni = 0;
        ...
        public List<vwcp_orden_pago_con_cancelacion_Info> Get_List_orden_pago_con_cancelacion_Mayor_a_cero_x_OrdenPago(int IdEmpresa, string IdTipoPersona, decimal IdPersona, decimal IdEntidad, string IdEstado_Aprobacion)
        {
            try
            {
                ...
                IQueryable<vwcp_orden_pago_con_cancelacion_lite> select_;
        ...
        public List<vwcp_orden_pago_con_cancelacion_Info> Get_List_orden_pago_con_cancelacion_Mayor_a_cero_x_OrdenPago_FormaPago(int IdEmpresa, string IdEstado_Aprobacion, string IdFormaPago)
        {
            try
            {
                List<vwcp_orden_pago_con_cancelacion_Info> lM = new List<vwcp_orden_pago_con_cancelacion_Info>();
        ...
        public List<vwcp_orden_pago_con_cancelacion_Info> Get_List_orden_pago_con_cancelacion_Mayor_a_cero_x_OrdenPago_FormaPago(int IdEmpresa, string IdTipoPersona, decimal IdPersona, decimal IdEntidad, string IdEstado_Aprobacion, string FormaPago)
        {
            try
            {
        ...
        public List<vwcp_orden_pago_con_cancelacion_Info> Get_List_orden_pago_con_cancelacion_todos_Mayor_a_cero_Lite(int IdEmpresa, string IdEstado_Aprobacion)
        {
            ...
            try
            {
                ...
                List<vwcp_orden_pago_con_cancelacion_lite> select_ = (from T in db.vwcp_orden_pago_con_cancelacion_lite
                                                                      where T.IdEmpresa == IdEmpresa
                                                                               && T.IdEstadoAprobacion == IdEstado_Aprobacion
                                                                               && T.Saldo_x_Pagar_OP > 0
                                                                               && T.IdTipo_op != "ANTI_PROVEE"
        ...
        public List<vwcp_orden_pago_con_cancelacion_Info> Get_List_orden_pago_con_transferencia(int IdEmpresa, decimal IdArchivo, DateTime fechaInicio, DateTime fechaFin, string IdUsuario)
        {
            ...
            try
            {
                ...
                // Aqui esta el problema, esta teniendo un problema al realizar la consulta del SP, vamos a revisar
                ...
                foreach (var item in select_)
                {
                    ...
                    dat.IdTipoDocumento_acreditacion = item.IdTipoDocumento_acreditacion;
                    dat.cedulaRuc_acreditacion = item.cedulaRuc_acreditacion;
                    dat.beneficiario_acreditacion = item.beneficiario_acreditacion;
                    dat.correo_acreditacion = item.correo_acreditacion;
        ...
        public List<vwcp_orden_pago_con_cancelacion_Info> Get_List_orden_pago_con_cancelacion_todos_Mayor_a_cero(int IdEmpresa, decimal IdOrdenPago, int Secuencia_OP)
        {
            try
            {
                ...
                List<vwcp_orden_pago_con_cancelacion_Info> lM = new List<vwcp_orden_pago_con_cancelacion_Info>();
                EntitiesCuentasxPagar db = new EntitiesCuentasxPagar();
                var select_ = (from T in db.vwcp_orden_pago_con_cancelacion_lite
                               where T.IdEmpresa == IdEmpresa
