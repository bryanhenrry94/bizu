    ...
    public class cp_orden_giro_pagos_sri_Data
    {
        ...
        public bool EliminarDB(int IdEmpresa, Decimal IdCbteCble_Ogiro, int IdTipoCbte_Ogiro)
        {
            try
            {
                ...
                {
                    enti.Database.ExecuteSqlCommand("delete from cp_orden_giro_pagos_sri where IdEmpresa=" + IdEmpresa + " and IdCbteCble_Ogiro =" + IdCbteCble_Ogiro + " and IdTipoCbte_Ogiro=" + IdTipoCbte_Ogiro);
                }
                return true;
            }
            catch (Exception ex)
