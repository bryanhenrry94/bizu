    ...
    public class vwcp_liquidacionCompra_sri_Data
    {
        public List<vwcp_liquidacionCompra_sri_Info> Get_list_LiquidacionCompra_Sri(int IdEmpresa, decimal IdLiquidacionCompra, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ValidarObjeto_XML_LiquidacionCompra", ex.Message), ex) { EntityType = typeof(vwcp_liquidacionCompra_sri_Info) };
            }
        }
    }
}
