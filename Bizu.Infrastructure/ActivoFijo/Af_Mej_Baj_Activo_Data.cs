...
namespace Bizu.Infrastructure.ActivoFijo
{
    public class Af_Mej_Baj_Activo_Data
    {
        ...
        public Boolean GuardarDB(Af_Mej_Baj_Activo_Info InfoAf, ref decimal Id_Mejora_Baja_Activo,  ref string msjError)
        {
            try
            {
                ...
                {                    
                    ...
                    Address.IdPeriodo_Inicio_Depr = InfoAf.IdPeriodo_Inicio_Depr;
                    Address.FechaPeriodo = InfoAf.FechaPeriodo;
                    Address.NumIniDep_IniMej = InfoAf.NumIniDep_IniMej;
            ...
            try
            {
                ...
                using (EntitiesActivoFijo listado = new EntitiesActivoFijo())
                {
                    ...
                    foreach (var item in select)
                    {
                        ...
                        infoAf.IdPeriodo_Inicio_Depr = item.IdPeriodo_Inicio_Depr;
                    }
                }
                return infoAf;
            }
        ...
        public List<Af_Mej_Baj_Activo_Info> Get_Info_Mej_Baj_Activo_Rango(int IdEmpresa, decimal Id_ActivoFijo, string IdTipo, DateTime FechaIni, DateTime FechaFin)
        {
            try
            {
                List<Af_Mej_Baj_Activo_Info> listAf = new List<Af_Mej_Baj_Activo_Info>();
