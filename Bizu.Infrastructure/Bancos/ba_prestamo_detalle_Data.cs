                ...
                try
                {
                    string q =
                        ...
                        "SELECT     det.IdEmpresa, det.IdPrestamo, det.NumCuota," +
                                    ...
                                    " FROM         ba_prestamo_detalle AS det LEFT OUTER JOIN " +
                                    " ba_prestamo_detalle_cancelacion AS canc ON " +
        ...
        public bool Eliminar(int idempresa, int idprestamo)
        {
            try
            {
                    ...
                    using (EntitiesBanco Entity = new EntitiesBanco())
                    {
                        ...
                        string SQL = "delete from ba_prestamo_detalle where idempresa='" + idempresa + "' and idprestamo='" + idprestamo + "'";
