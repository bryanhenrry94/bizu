...
namespace Bizu.Infrastructure.Bancos
{
    public class ba_Caja_Movimiento_x_Cbte_Ban_x_Deposito_Data
    {
        ...
        public List<ba_Caja_Movimiento_x_Cbte_Ban_x_Deposito_Info> Get_List_Caja_Movimiento_x_Cbte_Ban_x_Deposito(int mba_IdEmpresa, decimal mba_IdCbteCble, int mba_IdTipocbte)
        {
            ...
            try
            {
                var select_ = from T in db.ba_Caja_Movimiento_x_Cbte_Ban_x_Deposito
                              where T.mba_IdEmpresa == mba_IdEmpresa && T.mba_IdCbteCble == mba_IdCbteCble && T.mba_IdTipocbte == mba_IdTipocbte
                              select T;
        ...
        public List<ba_Caja_Movimiento_x_Cbte_Ban_x_Deposito_Info> Get_List_Cbte_Ban_x_Caja_Movimiento(int mcj_IdEmpresa, decimal mcj_IdCbteCble, int mcj_IdTipocbte)
        {
            ...
            {
                var select_ = from T in db.ba_Caja_Movimiento_x_Cbte_Ban_x_Deposito
                              where T.mcj_IdEmpresa == mcj_IdEmpresa && T.mcj_IdCbteCble == mcj_IdCbteCble && T.mcj_IdTipocbte == mcj_IdTipocbte
                              select T;
