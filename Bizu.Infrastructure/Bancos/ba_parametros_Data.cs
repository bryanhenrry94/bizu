                ...
                using (EntitiesBanco entity = new EntitiesBanco())
                {
                    ...
                    if (parametros != null)
                    {
                        return new ba_parametros_Info()
                        {
                            ...
                            pa_notificacion_cheque = parametros.pa_notificacion_cheque,
                            pa_notificacion_cheque_auto = parametros.pa_notificacion_cheque_auto
                        };
                    }
                    else
                        return new ba_parametros_Info();
        ...
        public List<ba_parametros_Info> Get_List_Banco_otros_Parametros(int IdEmpresa)
        {
            ...
            try
            {
                ...
                foreach (var item in selectBaParam)
                {
                    ...
                    Cbt.pa_notificacion_cheque = item.pa_notificacion_cheque;
                    Cbt.pa_notificacion_cheque_auto = item.pa_notificacion_cheque_auto;
            ...
            try
            {
                using (EntitiesBanco Contex = new EntitiesBanco())
                {
                    ...
                    if (selectBaParam == 0)
                    {
                        ...
                        address.pa_notificacion_cheque = info.pa_notificacion_cheque;
                        address.pa_notificacion_cheque_auto = info.pa_notificacion_cheque_auto;
                    ...
                    else
                    {
                        using (EntitiesBanco context = new EntitiesBanco())
                        {
                            ...
                            if (contact != null)
                            {
                                ...
                                contact.pa_notificacion_cheque = info.pa_notificacion_cheque;
                                contact.pa_notificacion_cheque_auto = info.pa_notificacion_cheque_auto;
            ...
            try
            {
                using (EntitiesBanco Contex = new EntitiesBanco())
                {
                    ...
                    if (selectBaParam == 0)
                    {
                        ...
                        address.CiudadDefaultParaCrearCheques = "01";
        ...
        public ba_parametros_Info Get_Info_Banco_Otros_Parametros(int IdEmpresa)
        {
            ...
            try
            {
                ...
                foreach (var item in selectBaParam)
                {
                    ...
                    lM.pa_notificacion_cheque = item.pa_notificacion_cheque;
                    lM.pa_notificacion_cheque_auto = item.pa_notificacion_cheque_auto;
                }
