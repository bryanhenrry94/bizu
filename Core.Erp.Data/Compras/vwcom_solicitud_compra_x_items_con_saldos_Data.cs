   ...
   public class vwcom_solicitud_compra_x_items_con_saldos_Data
    {
               ...
               foreach (var item in Query2)
                   {
                       ...
                       Obj.Referencia = "Sucursal : " + item.Sucursal + " con Solicitud #: " + item.IdSolicitudCompra + " , Fecha: " + item.fecha + " , Observación: " + item.observacion + "";
       ...
       public List<vwcom_solicitud_compra_x_items_con_saldos_Info> getLista_Saldos(int IdEmpresa, int IdSucursal, int IdSolicitud, ref string mensaje)
        {
            List<vwcom_solicitud_compra_x_items_con_saldos_Info> lista = new List<vwcom_solicitud_compra_x_items_con_saldos_Info>();
            try
            {
