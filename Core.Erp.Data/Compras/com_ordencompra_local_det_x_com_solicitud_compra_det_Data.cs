    ...
    public class com_ordencompra_local_det_x_com_solicitud_compra_det_Data
    {
        ...
        public List<com_ordencompra_local_det_x_com_solicitud_compra_det_Info> Get_List_ordencompra_local_det_x_com_solicitud_compra_det_x_OrdenCompra(int IdEmpresa, int IdSucursal, decimal IdOrdenCompra)
        {
            try
            {
                ...
                EntitiesCompras_GE oEntities = new EntitiesCompras_GE();
        ...
        public Boolean Eliminar_Detalle_OCDxSCD(int IdEmpresa, int IdSucursal, decimal IdOrdenCompra, ref string msg)
        {
            try
            {
                ...
                {
                    int numeroElimindo = Entity.Database.ExecuteSqlCommand("DELETE FROM com_ordencompra_local_det_x_com_solicitud_compra_det where ocd_IdEmpresa = " + IdEmpresa
        ...
        public Boolean ModificarDB(List<com_ordencompra_local_det_x_com_solicitud_compra_det_Info> ListDet_Info, int IdEmpresa, int IdSucursal, decimal IdOrdenCompra, ref string msg)
        {
            try
            {
                using (EntitiesCompras_GE context = new EntitiesCompras_GE())
                {
                    context.Database.ExecuteSqlCommand("DELETE FROM com_ordencompra_local_det_x_com_solicitud_compra_det_Info WHERE ocd_IdEmpresa = " + IdEmpresa + " ocd_IdSucursal = " + IdSucursal + " ocd_IdOrdenCompra = " + IdOrdenCompra);

                    GrabarDB(ListDet_Info, ref mensaje);
                }
