  ...
  public  class tb_Proceso_SRI_Data
    {
        ...
        public factura Deserializar_factura_SRI_xml(string xml, ref string numAutorizacion, ref DateTime fechAutoriza, ref string mensaje)
        {
            ...
            try
            {
                ...
                xmlComprobanteOrigen.LoadXml(xml);
        ...
        public vwcxc_cobros_x_vta_nota_x_Ret_Info Deserializar_factura_SRI_Poli(string path, ref string numAutorizacion, ref DateTime fechAutoriza, ref string mensaje)
        {
            ...
            try
            {
                vwcxc_cobros_x_vta_nota_x_Ret_Info info_factura = new vwcxc_cobros_x_vta_nota_x_Ret_Info();
                ...
                if (xmlNode_f != null)// es un xml q fue recibido y tiene soap
                {
                    ...
                    numAutorizacion = sNum_Autorizacion;
                    info_factura.dc_Autorizacion = numAutorizacion;
