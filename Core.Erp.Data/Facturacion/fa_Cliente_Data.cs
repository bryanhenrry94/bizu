    ...
    public class fa_Cliente_Data
    {
        ...
        public bool Eliminar_Clientes(int idEmpresa, ref string mensaje)
        {
            try
            {
                ...
                OEFa_Cliente.Database.ExecuteSqlCommand("delete from fa_cliente where IdEmpresa = " + idEmpresa );
        ...
        public List<fa_Cliente_Info> Get_List_Cliente(int IdEmpresa)
        {
            try
            {
                ...
                foreach (var item in select_tipo_nota)
                {
                    ...
                    info.Nombre_Cliente2 = item.pe_apellido.Trim() + " " + item.pe_nombre.Trim();
                    //rth 
                   // info.Persona_Info.pe_extTelOficina = (item.pe_extTelOficina != null) ? item.pe_extTelOficina.Trim() : " ";
                   // info.Persona_Info.pe_cargoLaboral = (item.pe_cargoLaboral != null) ? item.pe_cargoLaboral.Trim() : " ";
                   // info.Persona_Info.pe_codigoPostar = (item.pe_codigoPostar != null) ? item.pe_codigoPostar.Trim() : " ";
                    info.Persona_Info.pe_fechaCreacion = item.pe_fechaCreacion;
        ...
        public Boolean ConsultarClienteVendedor(int IdEmpresa,ref fa_Cliente_Info InfoCliente,ref fa_Vendedor_Info InfoVendedor) {
            try
            {
                ...
                foreach (var item in select_tipo_nota)
                {
                  ...
                  //  InfoCliente.Persona_Info.pe_extTelOficina = (item.pe_extTelOficina != null) ? item.pe_extTelOficina.Trim() : "";
                  //  InfoCliente.Persona_Info.pe_cargoLaboral = (item.pe_cargoLaboral != null) ? item.pe_cargoLaboral.Trim() : "";
