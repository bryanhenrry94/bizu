...
namespace Core.Erp.Data.Facturacion
{
    public class fa_Factura_Data
    {
        ...
        {
            List<Core.Erp.Info.CuentasxPagar.xmlATS_V_1_1_4.ventaEst> list;
            ...
            try
            {
                using (EntitiesFacturacion facturacion = new EntitiesFacturacion())
                {
                    ...
                    list = facturacion.Database.SqlQuery<Core.Erp.Info.CuentasxPagar.xmlATS_V_1_1_4.ventaEst>(sql, new object[0]).ToList<Core.Erp.Info.CuentasxPagar.xmlATS_V_1_1_4.ventaEst>();
                }
            }
            catch (Exception ex)
            {
