   ...
   public class cp_reembolso_Data
   {
       ...
       public bool EliminarDB(int IdEmpresa,Decimal IdCbteCble_Ogiro,int IdTipoCbte_Ogiro)
       {
           try
           {
               using (EntitiesCuentasxPagar enti=new EntitiesCuentasxPagar())
               {
                   enti.Database.ExecuteSqlCommand("delete from cp_reembolso where IdEmpresa=" + IdEmpresa + " and IdCbteCble_Ogiro =" + IdCbteCble_Ogiro + " and IdTipoCbte_Ogiro="+IdTipoCbte_Ogiro);
               }
               return true;
           }
           catch (Exception ex)
