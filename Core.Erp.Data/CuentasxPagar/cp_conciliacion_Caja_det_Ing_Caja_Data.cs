...
namespace Core.Erp.Data.CuentasxPagar
{
    public class cp_conciliacion_Caja_det_Ing_Caja_Data
    {
        ...
        public Boolean GuardarDB(List<cp_conciliacion_Caja_det_Ing_Caja_Info> lst)
        {
            try
            {
                ...
                using (EntitiesCuentasxPagar Conexion = new EntitiesCuentasxPagar())
                {
                    ...
                    {
                        EliminarDB(item.IdEmpresa, item.IdConciliacion_Caja,item.IdTipocbte_movcaj,item.IdCbteCble_movcaj);
        ...
        public Boolean EliminarDB(int idEmpresa, decimal idConciliacion_caja, int IdTipocbte_movcaj, decimal IdCbteCble_movcaj)
        {
            try
            {
                using (EntitiesCuentasxPagar Conexion = new EntitiesCuentasxPagar())
                {
                    Conexion.Database.ExecuteSqlCommand("Delete from cp_conciliacion_Caja_det_Ing_Caja where idEmpresa = " + idEmpresa + " and IdConciliacion_Caja = "+idConciliacion_caja+" and IdTipocbte_movcaj = " + IdTipocbte_movcaj + " and IdCbteCble_movcaj = " + IdCbteCble_movcaj);
