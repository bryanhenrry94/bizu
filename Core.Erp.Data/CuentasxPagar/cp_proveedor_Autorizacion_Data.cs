...
namespace Core.Erp.Data.CuentasxPagar
{
    public class cp_proveedor_Autorizacion_Data
    {
        ...
        public List<cp_proveedor_Autorizacion_Info> Get_List_proveedor_Autorizacion(int IdEmpresa, decimal Iproveedor, string NumAutoriza, string Establecimiento, string Pto_Emision, decimal NumDoc_A_Buscar)
        {
            try
            {
                EntitiesCuentasxPagar Entity = new EntitiesCuentasxPagar();
                ...
                SSQL = SSQL + " and " + NumDoc_A_Buscar + " between CAST(factura_inicial as decimal) and cast(factura_final as decimal)";
                ...
                //{
                //    var select_ = from T in Entity.cp_proveedor_Autorizacion
                //                  where T.IdEmpresa == IdEmpresa
                //                  && T.IdProveedor == Iproveedor
                //                  && T.Serie1 == Establecimiento
                //                  && T.Serie2 == Pto_Emision
                //                  && T.nAutorizacion == NumAutoriza
                //                  && Convert.ToInt32(T.factura_inicial) >= NumDoc_A_Buscar && NumDoc_A_Buscar <= Convert.ToInt32(T.factura_final)
                //                  select T;

                //    foreach(var item in select_)
                //    {
                //        cp_proveedor_Autorizacion_Info Info = new cp_proveedor_Autorizacion_Info();
                //        Info.IdEmpresa = item.IdEmpresa;
                //        Info.IdProveedor = item.IdProveedor;
                //        Info.IdAutorizacion = item.IdAutorizacion;
                //        Info.Serie1 = item.Serie1;
                //        Info.Serie2 = item.Serie2;
                //        Info.nAutorizacion = item.nAutorizacion;
                //        Info.Valido_Hasta = item.Valido_Hasta;
                //        Info.factura_inicial = item.factura_final;
                //        Info.factura_final = item.factura_final;
                //        Info.NumAutorizacionImprenta = item.NumAutorizacionImprenta;
                //        listado.Add(Info);
                //    }
                //}
