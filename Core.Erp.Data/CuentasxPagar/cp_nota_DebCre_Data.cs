...
namespace Core.Erp.Data.CuentasxPagar
{
    public class cp_nota_DebCre_Data
    {
            ...
            try
            {
                ...
                foreach (var item in select_)
                {
                    ...
                    if (Info_cance != null)
                    {
                        ...
                        {
                            cp_nota_DebCre_Data ND_data = new cp_nota_DebCre_Data();
                            cp_nota_DebCre_Info Info_ND = new cp_nota_DebCre_Info();
                            Info_ND = ND_data.Get_Info_nota_DebCre(Convert.ToInt32(Info_cance.IdEmpresa_cxp), Convert.ToDecimal(Info_cance.IdCbteCble_cxp), Convert.ToInt32(Info_cance.IdTipoCbte_cxp));

                            if (Info_ND.IdEmpresa != 0)
                            {
                                dat.docModificado = "01";
                                dat.estabModificado = Info_ND.cn_serie1;
                                dat.ptoEmiModificado = Info_ND.cn_serie2;
                                dat.secModificado = Info_ND.cn_Nota;
                                dat.autModificado = Info_ND.cn_Autorizacion;
                                dat.cn_num_doc_modificado = Info_ND.cn_Nota;
                            }
                        }
                    ...
                    {
                        // SI NOTA DE CREDITO NO TIENE CANCELACION, SE DEBE LLENAR LA INFORMACION DEL DOCUMENTO MODIFICADO DE LA NOTA DE CREDITO
                        // REVISADO EL 08/08/2023 POR KARAUJO
        ...
        public List<cp_nota_DebCre_Info> Get_List_nota_DebCre(int IdEmpresa, string DebCre, string IdTipoNota)
        {
            try
            {
                List<cp_nota_DebCre_Info> lM = new List<cp_nota_DebCre_Info>();
            ...
            try
            {
                try
                {
                    ...
                    foreach (var item in select_)
                    {
                        ...
                        switch (item.IdTipoNota)
                        {
                            case "T_TIP_NOTA_SRI":
                                // asignar nombre SRI
                                dat.NombreTipoNota = "SRI";
                                break;

                            case "T_TIP_NOTA_INT":
                                // asignar nombre Interna
                                dat.NombreTipoNota = "Interna";
                                break;
                        }
        ...
        public cp_nota_DebCre_Info Get_Info_nota_DebCre(int IdEmpresa, decimal IdProveedor, string Serie1, string Serie2, string Secuencia)
        {
            try
            {
                ...
                var query = dbContext.cp_nota_DebCre.Where(q => q.IdEmpresa == IdEmpresa && q.IdProveedor == IdProveedor && q.cn_serie1 == Serie1 && q.cn_serie2 == Serie2 && q.cn_Nota == Secuencia).ToList();
                ...
                foreach (var item in query)
                {
                    ...
                    Info.cn_fecha = item.cn_fecha;
                    Info.Fecha_contable = item.Fecha_contable;
                    Info.cn_Fecha_vcto = item.cn_Fecha_vcto;
                    Info.cn_serie1 = item.cn_serie1;
                    Info.cn_serie2 = item.cn_serie2;
                    Info.cn_Nota = item.cn_Nota;
                    Info.cn_observacion = item.cn_observacion;
                    Info.cn_subtotal_iva = item.cn_subtotal_iva;
                    Info.cn_subtotal_siniva = item.cn_subtotal_siniva;
                    Info.cn_baseImponible = item.cn_baseImponible;
                    Info.cn_Por_iva = item.cn_Por_iva;
                    Info.cn_valoriva = item.cn_valoriva;
                    Info.cn_Ice_base = item.cn_Ice_base;
                    Info.cn_Ice_por = item.cn_Ice_por;
                    Info.cn_Ice_valor = item.cn_Ice_valor;
                    Info.cn_Serv_por = item.cn_Serv_por;
                    Info.cn_Serv_valor = item.cn_Serv_valor;
                    Info.cn_BaseSeguro = item.cn_BaseSeguro;
                    Info.cn_total = item.cn_total;
                    Info.cn_vaCoa = item.cn_vaCoa;
                    Info.cn_Autorizacion = item.cn_Autorizacion;
                    Info.cn_Autorizacion_Imprenta = item.cn_Autorizacion_Imprenta;
                    Info.cn_num_doc_modificado = item.cn_num_doc_modificado;
                    Info.IdCod_ICE = item.IdCod_ICE;
                    Info.IdTipoServicio = item.IdTipoServicio;
                    Info.IdIden_credito = item.IdIden_credito;
                    Info.IdCtaCble_Acre = item.IdCtaCble_Acre;
                    ...
                    Info.IdCbteCble_Anulacion = item.IdCbteCble_Anulacion;
                    Info.IdTipoCbte_Anulacion = item.IdTipoCbte_Anulacion;
                    Info.cn_tipoLocacion = item.cn_tipoLocacion;
