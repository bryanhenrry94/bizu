            ...
            try  
            {
                using (EntitiesCuentasxPagar context = new EntitiesCuentasxPagar())
                {
                    ...
                    if (selectBaParam == 0)
                    {
                        ...
                        addressG.pa_ctacble_x_Iva_Gastos_default = info.pa_ctacble_x_Iva_Gastos_default;
                        addressG.pa_notificacion_archivo_transferencia = info.pa_notificacion_archivo_transferencia;
                        addressG.pa_notificacion_archivo_transferencia_auto = info.pa_notificacion_archivo_transferencia_auto;
                    ...
                    else
                    {
                        ...
                        if (contact != null)
                        {
                            ...
                            contact.pa_ctacble_x_Iva_Gastos_default = info.pa_ctacble_x_Iva_Gastos_default;
                            contact.pa_notificacion_archivo_transferencia = info.pa_notificacion_archivo_transferencia;
                            contact.pa_notificacion_archivo_transferencia_auto = info.pa_notificacion_archivo_transferencia_auto;
        ...
        public cp_parametros_Info Get_Info_parametros(int IdEmpresa)
        {
            try
            {
                ...
                foreach (var item in selectBaParam)
                {
                    ...
                    Cbt.pa_X_Defecto_la_Retencion_es_cbte_elect = item.pa_X_Defecto_la_Retencion_es_cbte_elect;
                    Cbt.pa_ctacble_x_Iva_Gastos_default = item.pa_ctacble_x_Iva_Gastos_default;
                    Cbt.pa_valida_existe_retencion = item.pa_valida_existe_retencion;
                    Cbt.pa_notificacion_archivo_transferencia = item.pa_notificacion_archivo_transferencia;
                    Cbt.pa_notificacion_archivo_transferencia_auto = item.pa_notificacion_archivo_transferencia_auto;
