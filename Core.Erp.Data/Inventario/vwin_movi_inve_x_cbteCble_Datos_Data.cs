...
namespace Core.Erp.Data.Inventario
{
    public class vwin_movi_inve_x_cbteCble_Datos_Data
    {
        ...
        public List<vwin_movi_inve_x_cbteCble_Datos_Info> Get_List_vwin_movi_inve_x_cbteCble_Datos(int IdEmpresa, DateTime FechaIni, DateTime FechaFin, string Tipo_ing_egr, string Tipo_Contabilizado)
        {
            ...
            try
            {
                try
                {
                    ...
                    var Query = from q in oEnti.vwin_movi_inve_x_cbteCble_Datos
                                ...
                                && q.cm_fecha >= FechaIni.Date
                                && q.cm_fecha <= FechaFin.Date
                    ...
                    foreach (var item in Query)
                    {
                        ...
                        Obj.nom_categoria = item.nom_categoria;
                        Obj.nom_linea = item.nom_linea;
        ...
        public List<vwin_movi_inve_x_cbteCble_Datos_Info> Get_List_vwin_movi_inve_x_cbteCble_Datos_No_Contabilizados(int IdEmpresa, DateTime FechaIni, DateTime FechaFin, string Tipo_ing_egr)
        {
            List<vwin_movi_inve_x_cbteCble_Datos_Info> Lst = new List<vwin_movi_inve_x_cbteCble_Datos_Info>();
            try
            {
