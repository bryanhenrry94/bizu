    ...
    public class in_Ing_Egr_Inven_det_Data
    {
                ...
                try
                {
                    ...
                    foreach (var item in LstInfo)
                    {
                        using (EntitiesInventario Context = new EntitiesInventario())
                        {
                            ...
                            Address.IdEmpresa_gr = item.IdEmpresa_gr == 0 ? null : item.IdEmpresa_gr;
                            Address.IdSucursal_gr = item.IdSucursal_gr == 0 ? null : item.IdSucursal_gr;
                            Address.IdGuiaRemision = item.IdGuiaRemision == 0 ? null : item.IdGuiaRemision;
                            Address.Secuencia_gr = item.Secuencia_gr == 0 ? null : item.Secuencia_gr;
                            ...
                            Address.Lote = item.Lote;
                            Address.IdResponsable = item.IdResponsable;
                            Address.IdContratista = item.IdContratista;
        ...
        public Boolean EliminarDB(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdNumMovi, int IdMovi_inven_tipo, ref string msgs)
        {
            try
            {
                ...
                {
                    int numeroElimindo = Entity.Database.ExecuteSqlCommand("delete from in_Ing_Egr_Inven_det where IdEmpresa="
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_Inven_det(int IdEmpresa, int IdSucursal, int IdMovi_inven_tipo, decimal IdNumMovi)
        {
            try
            {
                EntitiesInventario inventario = new EntitiesInventario();
                List<in_Ing_Egr_Inven_det_Info> lM = new List<in_Ing_Egr_Inven_det_Info>();

                var select = from q in inventario.in_Ing_Egr_Inven_det
                             join p in inventario.in_Producto
                ...
                foreach (var item in select)
                {
                    ...
                    info.Lote = item.Lote;
                    info.IdResponsable = item.IdResponsable;
                    info.IdContratista = item.IdContratista;
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_Inven_det_Polig(int IdEmpresa, int IdSucursal, int IdMovi_inven_tipo, decimal IdNumMovi)
        {
            try
            {
                EntitiesInventario inventario = new EntitiesInventario();
                ...
                foreach (var item in select)
                {
                    ...
                    //info.idOrdenProd = Convert.ToDecimal(item.idOrdenProd);
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_Inven_det_x_transferencia(int IdEmpresa, int IdSucursalOrigen, int IdBodegaOrigen, decimal IdTransferencia)
        {
            try
            {
                ...
                var select = from q in inventario.vwin_Transferencia_Detalle
                             where q.IdEmpresa == IdEmpresa
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_Inven_det_agrupada(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdNumMovi)
        {
            try
            {
                ...
                var query = from q in inventario.vwin_Ing_Egr_Inven_det_x_Producto
                            where q.IdEmpresa == IdEmpresa
                            && q.IdSucursal == IdSucursal
                            && q.IdBodega == IdBodega
                            && q.IdNumMovi == IdNumMovi
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_Inven_det_x_OrdenCompra(int IdEmpresa, int IdSucursal, decimal IdOrdenCompra)
        {
            try
            {
                ...
                var Query = from q in inventario.vwin_Ing_Egr_Inven_det
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_det_x_OC_Agrupado(int IdEmpresa, int IdSucursal, decimal IdOrdenCompra)
        {
            try
            {
                ...
                var result = from q in inventario.in_Ing_Egr_Inven_det
                             where q.IdEmpresa == IdEmpresa
                           && q.IdSucursal_oc == IdSucursal
                           && q.IdOrdenCompra == IdOrdenCompra
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_det_x_GR_Agrupado(int IdEmpresa, int IdSucursal, decimal IdGuiaRemision)
        {
            try
            {
                ...
                var result = from q in inventario.in_Ing_Egr_Inven_det
                             where q.IdEmpresa_gr == IdEmpresa
                             && q.IdSucursal_gr == IdSucursal
                             && q.IdGuiaRemision == IdGuiaRemision
                             group q by new { q.IdEmpresa_gr, q.IdSucursal_gr, q.IdGuiaRemision } into g
                             select new
                             {
                                 IdEmpresa_gr = g.Key.IdEmpresa_gr,
                                 IdSucursal_gr = g.Key.IdSucursal_gr,
                                 IdGuiaRemision = g.Key.IdGuiaRemision,
                                 cant_tot = g.Sum(x => x.dm_cantidad_sinConversion)
                             };
                ...
                foreach (var item in result)
                {
                    ...
                    info.IdEmpresa_gr = Convert.ToInt32(item.IdEmpresa_gr);
                    info.IdSucursal_gr = Convert.ToInt32(item.IdSucursal_gr);
                    info.IdGuiaRemision = Convert.ToDecimal(item.IdGuiaRemision);
                    info.dm_cantidad = item.cant_tot;
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_det_x_OT_Agrupado(int IdEmpresa, int IdSucursal, decimal IdOrdenCompra)
        {
            try
            {
                EntitiesInventario inventario = new EntitiesInventario();
                ...
                var query = from q in inventario.vwin_Ing_Egr_Inven_det_x_prd_OrdenTrabajo_Det
                            where
                               q.IdEmpresa_ot == IdEmpresa
                               && q.IdSucursal_ot == IdSucursal
                               && q.IdOrdenTrabajo == IdOrdenCompra
                            group q by new { q.IdEmpresa_ot, q.IdSucursal_ot, q.IdOrdenTrabajo } into g
                            select new
                            {
                                IdEmpresa_ot = g.Key.IdEmpresa_ot,
                                IdSucursal_ot = g.Key.IdSucursal_ot,
                                IdOrdenTrabajo_ot = g.Key.IdOrdenTrabajo,
                                cant_tot = g.Sum(x => x.dm_cantidad_sinConversion)
                            };
                ...
                foreach (var item in query)
                {
                    ...
                    info.IdEmpresa_ot = Convert.ToInt32(item.IdEmpresa_ot);
                    info.IdSucursal_ot = Convert.ToInt32(item.IdSucursal_ot);
                    info.IdOrdenTrabajo = Convert.ToDecimal(item.IdOrdenTrabajo_ot);
                    info.dm_cantidad = item.cant_tot;
