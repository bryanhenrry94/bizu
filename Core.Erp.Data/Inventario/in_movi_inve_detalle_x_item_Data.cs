        ...
        public Boolean EliminarDB(List<in_movi_inve_detalle_Info> lista)
        {
            try
            {
                using (EntitiesInventario Context = new EntitiesInventario())
                {
                    ...
                    {
                        Context.Database.ExecuteSqlCommand("delete from in_movi_inve_detalle_x_item where IdEmpresa = " + item.IdEmpresa + " and IdSucursal = " + item.IdSucursal + " and IdBodega = " + item.IdBodega
