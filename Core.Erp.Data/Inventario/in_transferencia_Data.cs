    ...
    public class in_transferencia_Data
    {
            ...
            try
            {
                try
                {
                    using (EntitiesInventario contex = new EntitiesInventario())
                    {
                        ...
                        address.IdCentroCosto_Ing_Egr_Inven_Origen = info.IdCentroCosto_Ing_Egr_Inven_Origen;
                        address.IdCentroCosto_Ing_Egr_Inven_Destino = info.IdCentroCosto_Ing_Egr_Inven_Destino;
        ...
        public in_transferencia_Info Get_Info_transferencia(in_transferencia_Info info, int idEmpresa)
        {
            try
            {
                ...
                foreach (var item in select)
                {
                    ...
                    info.IdCentroCosto_Ing_Egr_Inven_Origen = item.IdCentroCosto_Ing_Egr_Inven_Origen;
                    info.IdCentroCosto_Ing_Egr_Inven_Destino = item.IdCentroCosto_Ing_Egr_Inven_Destino;
        ...
        public in_transferencia_Info Get_Info(int idEmpresa, int IdSucursal, int IdBodega, decimal IdTransferencia)
        {
            try
            {
                ...
                var select = from q in OEntInventario.in_transferencia
                             where q.IdEmpresa == idEmpresa
                ...
                foreach (var item in select)
                {
                    ...
                    info.IdMovi_inven_tipo_SucuOrig = item.IdMovi_inven_tipo_SucuOrig;
        ...
        public void EliminarDetalle(in_transferencia_Info info)
        {
            try
            {
                using (EntitiesInventario Contex = new EntitiesInventario())
                {
                    string comando = "DELETE FROM in_transferencia_det WHERE IdEmpresa = " + info.IdEmpresa + " and IdSucursalOrigen = " + info.IdSucursalOrigen + " and IdBodegaOrigen = " + info.IdBodegaOrigen + " and IdTransferencia = " + info.IdTransferencia;
        ...
        public List<in_transferencia_Info> Get_List_transferencia(int IdEmpresa, DateTime FechaIni, DateTime FechaFin, int IdSucursalIni, int idSucursalFin, int IdBodegaIni, int idBodegaFin)
        {
            try
            {
                ...
                foreach (var item in select)
                {
                    ...
                    info.IdCentroCosto_Ing_Egr_Inven_Origen = item.IdCentroCosto_Ing_Egr_Inven_Origen;
                    info.IdCentroCosto_Ing_Egr_Inven_Destino = item.IdCentroCosto_Ing_Egr_Inven_Destino;
                    //info.IdMotivo_Inv_SucuOrig = item.idmo
