            ...
            try
            {
                ...
                using (EntitiesCuentas_x_Cobrar cxc = new EntitiesCuentas_x_Cobrar())
                {
                    ...
                    foreach (var item in consultar)
                    {
                        ...
                        info.Centro_costo = (item.IdCentroCosto != null) ? "[" + item.IdCentroCosto + "] - " + item.Centro_costo : "";

                        info.IdCobro_cobro = Convert.ToDecimal(item.IdCobro_cobro);
                        info.Valor = item.Valor;
                        info.ValorAplicado = item.ValorAplicado;
        ...
        public List<cxc_cobro_x_Anticipo_Info> Get_List_cobro_x_Anticipo(int IdEmpresa, int IdAnticipo, ref string mensaje)
        {
            try
            {
                ...
                foreach (var item in select_)
                {
                    ...
                    dat.Centro_costo = item.Centro_costo;
