...
using Dazzsoft.ERP.Infrastructure.Model.CuentaPorPagar;

namespace Dazzsoft.ERP.Infrastructure.Persistence
{
    public class CuentaPorPagarContext : DbContext
    {
        public CuentaPorPagarContext() : base("name=DefaultConnection") { }
        ...
        public DbSet<cp_CXP_EDEHSA_Rpt001> cp_CXP_EDEHSA_Rpt001 { get; set; }
        public DbSet<cp_CXP_EDEHSA_Rpt001_Saldo_Inicial> cp_CXP_EDEHSA_Rpt001_Saldo_Inicial { get; set; }
        public DbSet<cp_CXP_Rpt001> cp_CXP_Rpt001 { get; set; }
        public DbSet<cp_CXP_Rpt001_Saldo_Inicial> cp_CXP_Rpt001_Saldo_Inicial { get; set; }
