...
using Dazzsoft.ERP.Infrastructure.Model.CuentaPorCobrar;

namespace Dazzsoft.ERP.Infrastructure.Persistence
{
    class CuentaPorCobrarContext : DbContext
    {
        public CuentaPorCobrarContext() : base("name=DefaultConnection") { }
        ...
        public DbSet<cxc_retencion_Multiple> cxc_retencion_Multiple { get; set; }
        public DbSet<cxc_retencion_Multiple_Documento> cxc_retencion_Multiple_Documento { get; set; }
        public DbSet<cxc_retencion_Multiple_Documentos_ValorAplicado> cxc_retencion_Multiple_Documentos_ValorAplicado { get; set; }
        public DbSet<vwcxc_retencion_Multiple> vwcxc_retencion_Multiple { get; set; }
        ...
        public DbSet<vwcxc_cobro_x_anticipo_pendientes_de_diario> vwcxc_cobro_x_anticipo_pendientes_de_diario { get; set; }
        public DbSet<vwcxc_cobros_Pendientes_de_deposito> vwcxc_cobros_Pendientes_de_deposito { get; set; }
        ...
        public DbSet<cxc_anticipo_facturado> cxc_anticipo_facturado { get; set; }
        public DbSet<vwcxc_anticipo_facturado> vwcxc_anticipo_facturado { get; set; }
        public DbSet<cxc_anticipo_facturado_det> cxc_anticipo_facturado_det { get; set; }
    }
}
