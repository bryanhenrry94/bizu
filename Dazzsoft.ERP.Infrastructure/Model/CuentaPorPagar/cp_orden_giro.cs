...
namespace Dazzsoft.ERP.Infrastructure.Model.CuentaPorPagar
{
    ...
    public partial class cp_orden_giro
    {
        public cp_orden_giro()
        {
            ...
            this.cp_liquidacion_compra = new HashSet<cp_liquidacion_compra>();
            this.cp_orden_giro_Impuesto = new HashSet<cp_orden_giro_Impuesto>();
        ...
        public virtual ICollection<cp_liquidacion_compra> cp_liquidacion_compra { get; set; }
        public virtual ICollection<cp_orden_giro_Impuesto> cp_orden_giro_Impuesto { get; set; }
