...
{
    public partial class FrmCom_CompradorMantenimiento : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
        ...
        void Guardar()
        {
            try
            {
                ...
                {                  
                    ...
                    string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El comprador ", Info.IdComprador);
        ...
        void Actualizar()
        {
            ...
            { 
                ...
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El comprador", Info.IdComprador);
                    MessageBox.Show(smensaje, param.Nombre_sistema);
                    //ucGe_Menu_Superior_Mant1.Visible_bntGuardar_y_Salir = DevExpress.XtraBars.BarItemVisibility.Never;
                    //ucGe_Menu_Superior_Mant1.Visible_btnGuardar = DevExpress.XtraBars.BarItemVisibility.Never;    
                    LimpiarDatos();
                ...
                if (Info.IdComprador != 0 )
                {
                    if (MessageBox.Show("¿Está seguro que desea anular eL Comprador #: " + Info.IdComprador + " ?", "Anulación de Comprador ", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        ...
                        if (Info.Estado == "A")
	                    {
                                ...
                                {
                                    string smensaje = string.Format("{0} # {1} se anuló con éxito.", "El comprador", Info.IdComprador);
                                    MessageBox.Show(smensaje, param.Nombre_sistema);
