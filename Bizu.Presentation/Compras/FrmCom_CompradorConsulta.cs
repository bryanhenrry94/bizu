...
{
    public partial class FrmCom_CompradorConsulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmCom_CompradorConsulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Compras.FrmCom_CompradorConsulta");
