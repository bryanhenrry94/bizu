...
{
    public partial class frmCom_OrdenCompra_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCom_OrdenCompraConsulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Compras.frmCom_OrdenCompra_Cons");
