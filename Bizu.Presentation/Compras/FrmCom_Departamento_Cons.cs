...
using Bizu.Presentation.Compras;
using Bizu.Application.SeguridadAcceso;
using Bizu.Domain.SeguridadAcceso;

namespace Bizu.Presentation.Compras
{
    public partial class FrmCom_Departamento_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmCom_Departamento_Cons_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Compras.FrmCom_Departamento_Cons");
