...
{
    public partial class FrmCom_OrdenCompra_Gene_x_Solicitud_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        void carga_grid()
        {
            ...
            {
                Log_Error_bus = new Bizu.Application.General.tb_sis_Log_Error_Vzen_Bus();
