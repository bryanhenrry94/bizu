...
{
    public partial class FrmCom_estado_cierre_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmCom_estado_cierre_Cons_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Compras.FrmCom_estado_cierre_Cons");
