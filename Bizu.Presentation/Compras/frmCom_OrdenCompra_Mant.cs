...
{
    public partial class frmCom_OrdenCompra_Mant : DevExpress.XtraEditors.XtraForm
    {
        #region variables
        ...
        private void gridViewOrdenCompra_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            try
            {
                ...
                if (e.Column.Name == colCodigo_Producto.Name)
                {
                    ...
                    if ((this.ucCp_Proveedor1.get_ProveedorInfo() != null) && (this.ucCp_Proveedor1.get_ProveedorInfo().pr_contribuyenteExentoDeIVA == "S"))
                    {
                        gridViewOrdenCompra.SetFocusedRowCellValue(colIdCod_Impuesto, "IVA0");
                    }
                    else
                    {
                ...
                else
                {
                        ...
                        || e.Column.Name == colDescuento.Name || e.Column.Name == colIdCod_Impuesto.Name)
                    {
                        ...
                        if ((this.ucCp_Proveedor1.get_ProveedorInfo() != null) && (this.ucCp_Proveedor1.get_ProveedorInfo().pr_contribuyenteExentoDeIVA == "N"))
                        {
                            ...
                            {
                                Iva = Math.Round((subtotal * InfoTipoImpuesto.porcentaje) / 100, 4);
