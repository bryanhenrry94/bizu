...
{
    public partial class FrmCom_Solicitante_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void LimpiarDatos()
        {
            try
            {
                ...
                ucGe_Menu_Superior_Mant1.Visible_btnGuardar = DevExpress.XtraBars.BarItemVisibility.Always;
                txtCedula.Focus();
        ...
        void Guardar()
        {
            try
            {
                ...
                if (Bus_comprador.GuardarDB(Info, ref MensajeError))
                {
                    ...
                    string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El Solicitante ", Info.IdSolicitante);
                    MessageBox.Show(smensaje, param.Nombre_sistema);
                    LimpiarDatos();
                }
                else
                {
                    string smensaje = string.Format("Error al Grabar:  {0}", MensajeError);
        ...
        void Actualizar()
        {
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El Solicitante", Info.IdSolicitante);
                    MessageBox.Show(smensaje, param.Nombre_sistema);
                    LimpiarDatos();
                }
                else
                ...
                if (Info.IdSolicitante != 0)
                {
                    if (MessageBox.Show("¿Está seguro que desea anular eL solicitante #: " + Info.IdSolicitante + " ?", "Anulación de solicitante ", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        ...
                        if (Info.estado == "A")
                        {
                            ...
                            {
                                string smensaje = string.Format("{0} # {1} se anuló con éxito.", "El Solicitante", Info.IdSolicitante);
                                MessageBox.Show(smensaje, param.Nombre_sistema);
            ...
            try
            {
                ...
                if (txtCedula.Text != string.Empty)
                {
                    if (BusPersona.VericarCedulaExiste(txtCedula.Text, ref  msg))
                    {
                        ...
                        txtNombre.Text = InfoPersona.pe_nombreCompleto;
            ...
            try
            {
                switch (_Accion)
                {
                    ...
                    case Cl_Enumeradores.eTipo_action.Anular:
                        ...
                        ucGe_Menu_Superior_Mant1.Visible_bntLimpiar = DevExpress.XtraBars.BarItemVisibility.Never;
                        ucGe_Menu_Superior_Mant1.Visible_bntImprimir = DevExpress.XtraBars.BarItemVisibility.Never;
                        ucGe_Menu_Superior_Mant1.Visible_bntAnular = DevExpress.XtraBars.BarItemVisibility.Always;
