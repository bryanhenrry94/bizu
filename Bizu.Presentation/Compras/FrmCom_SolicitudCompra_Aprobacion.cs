...
{
    public partial class FrmCom_SolicitudCompra_Aprobacion : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void cargar_grilla()
        {
            try
            {
                ...
                foreach (var item in listSolCom)
                {
                    item.Ico = imageList1.Images.Count > 0 ? (Bitmap)imageList1.Images[0] : null;
                }
        ...
        void Imprimir()
        {
            try
            {
                com_solicitud_compra_Info Row = gridView_solicitud_com.GetFocusedRow() as com_solicitud_compra_Info;
                ...
                if (Row != null)
                {
                    ...
                    //IdSucursal = ucGe_Sucursal_combo1.get_SucursalInfo().IdSucursal;
                    //IdSolicitudCompra = Row.IdSolicitudCompra;
