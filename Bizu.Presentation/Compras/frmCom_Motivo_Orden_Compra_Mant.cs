...
{
    public partial class frmCom_Motivo_Orden_Compra_Mant : DevExpress.XtraEditors.XtraForm
    {
                ...
                if (_Info.IdMotivo != 0)
                {
                    if (MessageBox.Show("¿Está seguro que desea anular el Motivo Compra #: " + _Info.IdMotivo + " ?", "Anulación de Motivo Compra ", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        ...
                        if (_Info.estado == "A")
                        {
                            ...
                            {
                                string smensaje = string.Format("{0} # {1} se anuló con éxito.", "El Motivo", _Info.IdMotivo);
            ...
            try
            {
                ...
                switch (Accion)
                {
                    case Cl_Enumeradores.eTipo_action.grabar:
                        ...
                        ucSeg_Menu.Visible_bntAnular = DevExpress.XtraBars.BarItemVisibility.Never;
                        ucSeg_Menu.Visible_bntImprimir = DevExpress.XtraBars.BarItemVisibility.Never;
                        ucSeg_Menu.Visible_bntLimpiar = DevExpress.XtraBars.BarItemVisibility.Never;
                        break;
                    ...
                    case Cl_Enumeradores.eTipo_action.Anular:
                        ...
                        ucSeg_Menu.Visible_bntAnular = DevExpress.XtraBars.BarItemVisibility.Always;
                        ucSeg_Menu.Visible_bntImprimir = DevExpress.XtraBars.BarItemVisibility.Never;
                        ucSeg_Menu.Visible_bntLimpiar = DevExpress.XtraBars.BarItemVisibility.Never;
                        ucSeg_Menu.Visible_bntGuardar_y_Salir = DevExpress.XtraBars.BarItemVisibility.Never;
                        ucSeg_Menu.Visible_btnGuardar = DevExpress.XtraBars.BarItemVisibility.Never;
                        break;
        ...
        private Boolean Guardar()
        {
            try
            {
                ...
                if (res)
                {
                    ...
                    string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El Motivo", _Info.IdMotivo);
                    MessageBox.Show(smensaje, param.Nombre_sistema);
                    //Accion = Cl_Enumeradores.eTipo_action.consultar;
                    //set_Accion(Accion);
                    LimpiarDatos();
        ...
        private Boolean Modificar()
        {
            try
            {
                ...
                if (res)
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El Motivo", _Info.IdMotivo);
                    MessageBox.Show(smensaje, param.Nombre_sistema);
                    Accion = Cl_Enumeradores.eTipo_action.grabar;
                    LimpiarDatos();
                }
