...
{
    public partial class FrmCa_CajaConsulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmCa_CajaConsulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Caja.FrmCa_CajaConsulta");
