...
{
    public partial class FrmCa_caj_Caja_Movimiento_Tipo : DevExpress.XtraEditors.XtraForm
    {
            ...
            try
            {
                ...
                switch (_Accion)
                {
                    ...
                    case Cl_Enumeradores.eTipo_action.actualizar:
                        //gBox_TipoMovimiento.Enabled = DevExpress.XtraBars.BarItemVisibility.Never;
                        ucGe_Menu.Visible_bntAnular = DevExpress.XtraBars.BarItemVisibility.Never;
                        break;
                ...
                if (validaColumna())
                {
                    ...
                    if (_Accion == Cl_Enumeradores.eTipo_action.grabar)
                    {
                        if (moviTipo_B.GrabarDB(moviTipo_I, ref idMoviTipo, ref  MensajeError))
                        {
                            ...
                            string smensaje = string.Format("{0} # {1} se guardó con éxito.", "Tipo Movimiento de caja ", txt_idTipoMovi.Text);
                    ...
                    if (_Accion == Cl_Enumeradores.eTipo_action.actualizar)
                    {
                        ...
                        {
                            string smensaje = string.Format("{0} # {1} se modificó con éxito.", "Tipo Movimiento de caja ", txt_idTipoMovi.Text);
                            MessageBox.Show(smensaje, param.Nombre_sistema);
                            //ucGe_Menu.Visible_bntGuardar_y_Salir = DevExpress.XtraBars.BarItemVisibility.Never;
                            //ucGe_Menu.Visible_btnGuardar = DevExpress.XtraBars.BarItemVisibility.Never;
                            LimpiarDatos();
                    ...
                    if (_Accion == Cl_Enumeradores.eTipo_action.Anular)
                    {
                        if (moviTipo_I.Estado != "I")
                        {
                            if (MessageBox.Show("¿Está seguro que desea anular el Tipo Movimiento de caja #: " + txt_idTipoMovi.Text + " ?", "Anulación de Tipo Movimiento de caja", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                            {
                                ...
                                {
                                    string smensaje = string.Format("{0} # {1} se anuló con éxito.", "Tipo Movimiento de caja ", txt_idTipoMovi.Text);
                                    MessageBox.Show(smensaje, param.Nombre_sistema);
