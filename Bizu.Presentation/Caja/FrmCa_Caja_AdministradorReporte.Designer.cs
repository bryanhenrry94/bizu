namespace Bizu.Presentation.Caja
{
    partial class FrmCa_Caja_AdministradorReporte
    {
        ...
        {
            this.ucGe_Administrador_Reporte1 = new Bizu.Presentation.Controles.UCGe_Administrador_Reporte();
            this.SuspendLayout();
            // 
            ...
            this.ucGe_Administrador_Reporte1.event_ucGe_Menu_event_btnSalir_ItemClick += new Bizu.Presentation.Controles.UCGe_Administrador_Reporte.delegate_ucGe_Menu_event_btnSalir_ItemClick(this.ucGe_Administrador_Reporte1_event_ucGe_Menu_event_btnSalir_ItemClick);
            // 
