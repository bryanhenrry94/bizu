...
{
    public partial class FrmCa_Caja_Talonario_Recibo_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmCa_Caja_Talonario_Recibo_Cons_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Caja.FrmCa_Caja_Talonario_Recibo_Cons");
