...
{
    public partial class frmFa_Vendedor_cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frm_Vendedor_General_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Facturacion.frmFa_Vendedor_cons");
