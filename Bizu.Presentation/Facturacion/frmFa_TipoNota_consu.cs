...
{
    public partial class frmFa_TipoNota_consu : DevExpress.XtraEditors.XtraForm
    {
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnAnular_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                if (info != null)
                {
                    ...
                    frm.set_Accion(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.Anular);
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnconsultar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                {
                    frmFa_TipoNota_Mant frm = new frmFa_TipoNota_Mant();
                    frm.set_Accion(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.consultar);
                    frm.set_TipoNota(info);
                    frm.ShowDialog();
                }
                load_TipoNota();
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnModificar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                {
                    frmFa_TipoNota_Mant frm = new frmFa_TipoNota_Mant();
                    frm.set_Accion(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.actualizar);
                    frm.set_TipoNota(info);
                    frm.ShowDialog();
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnNuevo_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                frmFa_TipoNota_Mant frm = new frmFa_TipoNota_Mant();
                frm.set_Accion(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.grabar);
                frm.ShowDialog();
                load_TipoNota();
            }
            catch (Exception ex)
        ...
        private void frmFA_TipoNota_General_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Facturacion.frmFa_TipoNota_consu");
