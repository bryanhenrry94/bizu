...
{
    public partial class frmFa_Nota_Cred_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        fa_factura_Bus bus_fact = new Bizu.Application.Facturacion.fa_factura_Bus();
        fa_factura_det_Bus bus_fact_det = new Bizu.Application.Facturacion.fa_factura_det_Bus();

        fa_notaCreDeb_Info info_notaDeb = new fa_notaCreDeb_Info();
        fa_notaCredDeb_Bus bus_notaDeb = new Bizu.Application.Facturacion.fa_notaCredDeb_Bus();
        fa_notaCreDeb_det_bus bus_notaDeb_det = new Bizu.Application.Facturacion.fa_notaCreDeb_det_bus();

        Bizu.Application.Facturacion.fa_factura_Bus bus_factura_graf = new Bizu.Application.Facturacion.fa_factura_Bus();
        Domain.Facturacion.fa_factura_Info info_factura_graf = new Domain.Facturacion.fa_factura_Info();
        ...
        fa_notaCreDeb_x_fa_factura_NotaDeb_Bus BusDocumentos_relacionados = new Bizu.Application.Facturacion.fa_notaCreDeb_x_fa_factura_NotaDeb_Bus();
        ...
        Bizu.Application.Facturacion.fa_notaCredDeb_Bus Bus_notaCredDeb = new Bizu.Application.Facturacion.fa_notaCredDeb_Bus();
        Bizu.Application.Facturacion.fa_notaCreDeb_det_bus Bus_notaCredDeb_det = new Bizu.Application.Facturacion.fa_notaCreDeb_det_bus();
        ...
        public frmFa_Nota_Cred_Mant()
        {
            ...
            ucSucursalBode.TipoCarga = Domain.General.Cl_Enumeradores.eTipoFiltro.Normal;
        ...
        private void frmFa_Nota_Cred_Mant_Load(object sender, EventArgs e)
        {
            try
            {
                colDescuento_total.Visible = false;
        ...
        public void cargarProductos()
        {
            try
            {
                ...
                listProducto = BusProducto.Get_list_Producto_modulo_x_Ventas(param.IdEmpresa, Convert.ToInt32(ucSucursalBode.cmb_sucursal.EditValue), Convert.ToInt32(ucSucursalBode.cmb_bodega.EditValue));
        ...
        private void GetInfoDocRelacionados()
        {
            try
            {
                ...
                foreach (var item in Info_NotaCre.lst_docs_relacionados)
                {
                    ...
                    item.Valor_Aplicado = Math.Round(Convert.ToDouble(valor),2);
                    item.vt_total = Math.Round(Convert.ToDouble(valor), 2);
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                switch (_Accion)
                {
                    case Cl_Enumeradores.eTipo_action.grabar:
                        ...
                        ucGe_Menu.Visible_btnAprobarGuardarSalir = DevExpress.XtraBars.BarItemVisibility.Never;
                    ...
                    case Cl_Enumeradores.eTipo_action.actualizar:
                        ...
                        ucGe_Menu.Visible_btnAprobarGuardarSalir = DevExpress.XtraBars.BarItemVisibility.Never;
                        ucGe_Menu.Visible_btnImprimirSoporte = DevExpress.XtraBars.BarItemVisibility.Always;
        ...
        private Boolean Validar()
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show(param.Get_Mensaje_sys(enum_Mensajes_sys.Por_Favor_) + " Ingrese una Observación", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void cmbCredito_EditValueChanged_1(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cmbCredito.EditValue != null)
                {
                    ...
                    {
                        fa_TipoNota_x_Empresa_x_Sucursal_Bus BusTipoNT = new Bizu.Application.Facturacion.fa_TipoNota_x_Empresa_x_Sucursal_Bus();
                        fa_TipoNota_x_Empresa_x_Sucursal_Info InfoTipo_NT_x_Sucu = new fa_TipoNota_x_Empresa_x_Sucursal_Info();
                        InfoTipo_NT_x_Sucu = BusTipoNT.Get_Info_TipoNota_x_Empresa_x_Sucursal_x_TipoNota(param.IdEmpresa, Convert.ToInt32(ucSucursalBode.cmb_sucursal.EditValue), InfoTipoNota.IdTipoNota);
        ...
        private void gridViewNotaCreDeb_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            try
            {
                ...
                cantidad = Convert.ToDouble(gridViewNotaCreDeb.GetFocusedRowCellValue(colCantidad));
                ...
                if (e.Column == colCantidad || e.Column == colPrecio)
                {
                    ...
                    gridViewNotaCreDeb.SetFocusedRowCellValue(colDescuento_total, descuento_total);
                    ...
                    if (InfoTipoImpuesto != null)
                    {
                        ...
                        {
                            Iva = ((SubtotalFinal * InfoTipoImpuesto.porcentaje) / 100);
                            Porc_Iva = InfoTipoImpuesto.porcentaje;
                        }
                ...
                if (e.Column == colPorDesc)
                {
                    ...
                    gridViewNotaCreDeb.SetFocusedRowCellValue(colDescuento_total, descuento_total);
                    double subt;
                    subt = subtotal - descuento_total;
                    gridViewNotaCreDeb.SetFocusedRowCellValue(colSubtotal, Convert.ToDecimal(Math.Round(subt, 2)));
        ...
        private void btn_cargar_diario_Click(object sender, EventArgs e)
        {
            try
            {
                fa_notaCreDeb_x_ct_cbtecble_Bus BusCbteCble = new Bizu.Application.Facturacion.fa_notaCreDeb_x_ct_cbtecble_Bus();
