...
{
    public partial class frmFa_Nota_Cred_Consulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        Bizu.Application.Facturacion.fa_notaCredDeb_Bus Bus_Nota = new Bizu.Application.Facturacion.fa_notaCredDeb_Bus();
        ...
        private void frmFa_Nota_Cred_Consulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Facturacion.frmFa_Nota_Cred_Consulta");
