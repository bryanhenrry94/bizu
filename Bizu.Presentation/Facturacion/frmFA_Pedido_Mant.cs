...
{
    public partial class frmFa_Pedido_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmFa_Pedido_Mant(int id_sucursal, int id_bodega)
            : this()
        {
            try
            {
        ...
        private void UCFAModuloFacturacion_Event_ultraGrid_ClickCell(object sender, DevExpress.XtraEditors.Controls.ChangingEventArgs e)
        {

        }
        private void UCFAModuloFacturacion_EditValueChanging(object sender, DevExpress.XtraEditors.Controls.ChangingEventArgs e)
        {
        ...
        private void frmFA_Pedido_Mant_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                UCFAModuloFacturacion.load_Producto(param.IdEmpresa, Convert.ToInt32(UC_Sucursal_Bodega.cmb_sucursal.EditValue), idbodega);
        ...
        public void CalcularTotales()
        {
            try
            {
                ...
                double iva = 0;
                lista_producto_detalle = new List<fa_pedido_det_Info>();
                //lista_producto_detalle = (List < fa_pedido_det_Info >) UCFAModuloFacturacion.lstPro_x_Bodega;
        ...
        private void gridControlOrdDesXpedi_Click(object sender, EventArgs e)
        {

        }

        private void UCFAModuloFacturacion_Load(object sender, EventArgs e)
        {

        }

        private void UCFAModuloFacturacion_event_gridView_KeyDown(KeyEventArgs e)
        {
