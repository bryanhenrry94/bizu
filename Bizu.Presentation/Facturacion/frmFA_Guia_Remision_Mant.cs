...
{
    public partial class frmFa_Guia_Remision_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void CargarControles()
        {
            ...
            try
            {
                ...
                ctrl_SucBod.TipoCarga = Bizu.Domain.General.Cl_Enumeradores.eTipoFiltro.Normal;
        ...
        public void Actualizar()
        {
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "La Guía de Remisión", _Info.IdGuiaRemision);
            ...
            try
            {
                ...
                if (MessageBox.Show("¿Está seguro que desea anular la Cotización ?", "Anulación de Cotización", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    if (ofrm.cerrado == "N")
                    {
                        ...
                        {
                            string smensaje = string.Format("{0} # {1} se anuló con éxito.", "La Guía de Remisión", _Info.IdGuiaRemision);
                            MessageBox.Show(smensaje, param.Nombre_sistema);
                            lblAnulado.Visible = true;
                        }
