...
{
    public partial class frmFa_Parametro : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void ParametrosFactura()
        {
            try
            {
                ...
                var tipoCbte = BusPlan.Get_list_Cbtecble_tipo(param.IdEmpresa,Bizu.Domain.General.Cl_Enumeradores.eTipoFiltro.todos, ref MensajeError);
