...
{
    public partial class frmFa_Cotizacion_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmFA_Cotizacion_Mant_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                infoBodega = UCfaBodega.get_bodega();
                infoSucursal = UCfaBodega.get_sucursal();
                UCfaBodega.TipoCarga = Bizu.Domain.General.Cl_Enumeradores.eTipoFiltro.Normal;
        ...
        void AnularCotizacion()
        {
            try
            {
                ...
                if (buscotizacion.AnularDB(infocotizacion, ref mensajeE) == true)
                {
                    ...
                    //  frm.motivoAnulacion);
                    string smensaje = string.Format("{0} # {1} se anuló con éxito.", "La Cotización", infocotizacion.IdCotizacion);
                ...
                if (Validar())
                {
                    ...
                    if (_Accion == Cl_Enumeradores.eTipo_action.grabar)
                    {
                        ...
                        if (buscotizacion.GrabarDB(infocotizacion, ref IdNumCotizacion, ref message))
                        {
                            ...
                            string smensaje = string.Format("{0} # {1} se guardó con éxito.", "La Cotización", infocotizacion.IdCotizacion);
                            MessageBox.Show(smensaje, param.Nombre_sistema);
                            ucGe_Menu.Visible_bntGuardar_y_Salir = DevExpress.XtraBars.BarItemVisibility.Never;
                            ucGe_Menu.Visible_btnGuardar = DevExpress.XtraBars.BarItemVisibility.Never;
                    ...
                    else if (_Accion == Cl_Enumeradores.eTipo_action.actualizar)
                    {
                        ...
                        if (buscotizacion.ModificarDB(infocotizacion, ref message))
                        {
                            ...
                            string smensaje = string.Format("{0} # {1} se modificó con éxito.", "La Cotización", infocotizacion.IdCotizacion);
                            MessageBox.Show(smensaje, param.Nombre_sistema);
                            ucGe_Menu.Visible_bntGuardar_y_Salir = DevExpress.XtraBars.BarItemVisibility.Never;
                            ucGe_Menu.Visible_btnGuardar = DevExpress.XtraBars.BarItemVisibility.Never;
                            //cambiarTabla();
