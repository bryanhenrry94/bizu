...
{
    public partial class frmFa_Catalogo_cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            //Control de Usuario
            Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Facturacion.frmFa_Catalogo_cons");
