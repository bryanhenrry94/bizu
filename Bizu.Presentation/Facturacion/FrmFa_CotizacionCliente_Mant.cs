...
{
    public partial class FrmFa_CotizacionCliente_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FrmFa_CotizacionCliente_Mant()
        {
            InitializeComponent();
        ...
        public FrmFa_CotizacionCliente_Mant(int id_sucursal, int id_bodega)
            : this()
        {
            try
            {
        ...
        public void FrmFa_CotizacionCliente_Mant_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Event_frmFA_Pedido_Mant_FormClosing += new delegate_frmFA_Pedido_Mant_FormClosing(FrmFa_CotizacionCliente_Mant_FormClosing);
                txt_plazo.Text = "3";
        ...
        void FrmFa_CotizacionCliente_Mant_FormClosing(object sender, EventArgs e) { }
        ...
        private void cmbProducto_EditValueChanging(object sender, DevExpress.XtraEditors.Controls.ChangingEventArgs e)
        {
            try
            {
                ...
                //gridView_Factura.SetFocusedRowCellValue(colIdPunto_cargo_grupo, InfoProd.IdGrupo);

                //gridView_Factura.SetFocusedRowCellValue(colIdPunto_cargo_grupo, InfoProd);
