...
{
    public partial class frmFa_Nota_Deb_Consulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmFa_Nota_Cred_Consulta_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Facturacion.frmFa_Nota_Deb_Consulta");
