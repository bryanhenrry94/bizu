...
{
    public partial class frmFa_Orden_Despacho_Mant : DevExpress.XtraEditors.XtraForm
    {
        #region variables
        ...
        public void Actualizar()
        {
            ...
            {                
                ...
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "La Orden de Despacho", txtIdOrdenDespacho.Text);
