...
using Bizu.Presentation.Facturacion;
...
{
    public partial class frmFa_Nota_Deb_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        fa_factura_Bus bus_factura_relacionada = new Bizu.Application.Facturacion.fa_factura_Bus();
        ...
        fa_notaCreDeb_x_ct_cbtecble_Bus bus_notaCreDeb_x_ct_cbtecble = new Bizu.Application.Facturacion.fa_notaCreDeb_x_ct_cbtecble_Bus();
        fa_notaCreDeb_x_ct_cbtecble_Info info_notaCreDeb_x_ct_cbtecble = new fa_notaCreDeb_x_ct_cbtecble_Info();
        Bizu.Application.Facturacion.fa_notaCredDeb_Bus Bus_notaCreDeb = new Bizu.Application.Facturacion.fa_notaCredDeb_Bus();
        Bizu.Application.Facturacion.fa_notaCreDeb_det_bus Bus_notaCreDeb_det = new Bizu.Application.Facturacion.fa_notaCreDeb_det_bus();
