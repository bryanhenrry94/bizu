...
{
    public partial class frmAF_DepreLineaRecta_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        void CalcularActivos_Depre()
        {
            try
            {
                Af_Activo_fijo_Bus BusActFijo = new Af_Activo_fijo_Bus();
                Af_Mej_Baj_Activo_Bus BusMejoraAct = new Af_Mej_Baj_Activo_Bus();
                Af_Depreciacion_Det_Bus busDepreDet = new Af_Depreciacion_Det_Bus();
