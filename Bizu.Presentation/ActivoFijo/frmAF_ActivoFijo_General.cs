...
{
    public partial class frmAF_ActivoFijo_General : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmAF_ActivoFijo_General_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "ActivoFijo.frmAF_ActivoFijo_General");
