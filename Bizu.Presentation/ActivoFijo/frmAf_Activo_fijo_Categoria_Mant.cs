...
{
    public partial class frmAf_Activo_fijo_Categoria_Mant : DevExpress.XtraEditors.XtraForm
    {
                ...
                if (InfoAf != null)
                {
                    ...
                    if (InfoAf.Estado == "A")
                    {
                        if (MessageBox.Show(param.Get_Mensaje_sys(enum_Mensajes_sys.Esta_seguro_Eliminar), param.Nombre_sistema, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
                            ...
                            {
                                string smensaje = "Registro anulado con exito";
                            ...
                            {
                                string smensaje = "Error al anular";
            ...
            try
            {
                switch (_Accion)
                {
                    case Cl_Enumeradores.eTipo_action.grabar:
                        ...
                        ucGe_Menu_Superior.Visible_bntAnular = DevExpress.XtraBars.BarItemVisibility.Never;
                        ucGe_Menu_Superior.Visible_bntGuardar_y_Salir = DevExpress.XtraBars.BarItemVisibility.Always;
                        ucGe_Menu_Superior.Visible_btnGuardar = DevExpress.XtraBars.BarItemVisibility.Always;
        ...
        Boolean Guardar()
        {
            try
            {
                ...
                if (respuesta)
                {
                    string smensaje = "Registro grabado con exito!";
                    MessageBox.Show(smensaje, param.Nombre_sistema);
                    txtId.Text = InfoAf.IdCategoriaAF.ToString();
                ...
                {
                    string smensaje = "Error al grabar";
                    MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
        ...
        Boolean Actualizar()
        {
            try
            {
                ...
                if (respuesta)
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "La Devolución", InfoAf.IdCategoriaAF);
                    MessageBox.Show(smensaje, param.Nombre_sistema);
                    LimpiarDatos();
                ...
                {
                    string smensaje = string.Format("Error al Modificar:   {0}", MensajeError);
                    MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
