...
using Bizu.Presentation.ActivoFijo;
...
{
    public partial class frmAF_Tipo_Depreciacion_Consul : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmAF_Tipo_Depreciacion_Consul_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "ActivoFijo.frmAF_Tipo_Depreciacion_Consul");
