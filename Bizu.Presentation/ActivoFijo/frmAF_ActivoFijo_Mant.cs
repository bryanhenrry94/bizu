    ...
    public partial class frmAF_ActivoFijo_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void ucGe_Menu_event_btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("Desea imprimir etiqueta?", param.Nombre_sistema, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
                {
                    XACTF_Rpt016_Rpt reporte = new XACTF_Rpt016_Rpt();
                    reporte.pIdEmpresa.Value = param.IdEmpresa;
                    reporte.pIdActivoFijo.Value = Convert.ToInt32(lbl_id_activo.Text);
                    Reporte.RequestParameters = false;
        ...
        private void cmbMarca_Load(object sender, EventArgs e)
        {
