...
namespace Bizu.Presentation.ActivoFijo
{
    ...
    //    DevExpress.XtraEditors.XtraForm FrmChildren;
    //    DevExpress.XtraEditors.XtraForm FrmParent;
    //    Cl_Enumeradores.eCliente_Vzen eCliente;
    //    frmAF_ActivoFijo_Mant frm;
    //    frmAF_ActivoFijo_Mant_FJ frm_FJ;
    //    public void Set_FrmChildren(DevExpress.XtraEditors.XtraForm _FrmChildren)
    //    {
    //        try
    //        {
    ...
    //    public void Set_FrmParent(DevExpress.XtraEditors.XtraForm _FrmParent)
    //    {
    //        try
    //        {
