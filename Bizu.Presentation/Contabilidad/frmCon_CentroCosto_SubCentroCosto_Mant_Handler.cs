    ...
    public class frmCon_CentroCosto_SubCentroCosto_Mant_Handler
    {
        ...
        public Boolean Guardar()
        {
            try
            {
                ...
                if (var == true)
                {
                    ...
                    {
                        string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El sub centro de costo ", Info_SubCentroCosto.IdCentroCosto_sub_centro_costo);
        ...
        public Boolean Actualizar()
        {
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El sub centro de costo ", Info_SubCentroCosto.IdCentroCosto_sub_centro_costo);
                    MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        public void Anular()
        {
            try
            {
                ...
                {
                    string smensaje = string.Format("Error al Anular:  {0}", "El registro ", Info_SubCentroCosto.IdCentroCosto_sub_centro_costo);
                    MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        public void cmbCentroCosto_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                if (enu == Bizu.Domain.General.Cl_Enumeradores.eTipo_action.grabar && Info_SubCentroCosto != null)
                {
