...
{
    public partial class frmCon_CbteCble_Consulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCon_CbteCble_Consulta_Load(object sender, EventArgs e)
        {
            try
            {
                ucGe_Menu_Mantenimiento_x_usuario.Validar_Permisos_Usuario(Cl_Enumeradores.eNombre_Carpeta.Contabilidad + "." + this.Name);
