...
{
    public partial class frmCon_CbteCble_Mant : DevExpress.XtraEditors.XtraForm
    {
        string MensajeError = "";
        ...
        void ucGe_Menu_event_btnAnular_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("¿Está seguro que desea anular dicho comprobante contable?", "Anulación de Cbte", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    ct_Cbtecble_tipo_Info tipoComp = List_Tipo_Comprobante.FirstOrDefault(q => q.IdTipoCbte == (Convert.ToInt32(cmb_tipocomprobante.EditValue)));
        ...
        public ct_Cbtecble_Info get_CbteCbleInfo()
        {
            ...
            try
            {
                ...
                if (InfoPeriodo != null && InfoPeriodo.pe_cerrado != "S")
                {
                    ...
                    InfoCbteCble.cb_FechaUltModi = DateTime.Now;
