...
{
    public partial class frmCon_Periodo_Mantenimiento : DevExpress.XtraEditors.XtraForm
    {
        ...
        private Boolean Grabar()
        {
            ...
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El Periodo ", Pi.IdPeriodo);
        ...
        private Boolean Modificar()
        {
            ...
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El Periodo ", Pi.IdPeriodo);
                    MessageBox.Show(smensaje, param.Nombre_sistema);
                    //ucGe_Menu.Visible_btnGuardar = DevExpress.XtraBars.BarItemVisibility.Never;
                    //ucGe_Menu.Visible_bntGuardar_y_Salir = DevExpress.XtraBars.BarItemVisibility.Never;
                    LimpiiarDatos();
                ...
                if (Pi.IdPeriodo != 0)
                {
                    ...
                    else
                    {
                        if (MessageBox.Show("¿Está seguro que desea anular el Periodo #: " + Pi.IdPeriodo + " ?", "ANULACIÓN", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
                            ...
                            {
                                string smensaje = string.Format("{0} # {1} se anuló con éxito.", "El Periodo ", Pi.IdPeriodo);
                                MessageBox.Show(smensaje, param.Nombre_sistema);
