...
{
    public partial class frmCon_GrupoEmpresarial_grupocble : DevExpress.XtraEditors.XtraForm
    {
            ...
            try
            {
                if (valida())
                {
                    ...
                    if (_Accion == Cl_Enumeradores.eTipo_action.grabar)
                    {
                        ...
                        {
                            string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El Grupo Contable ", this.txt_grupo.Text);
                            ...
                            MessageBox.Show("{0} # {1} se guardó con éxito.", param.Nombre_sistema);
                    }
                    if (_Accion == Cl_Enumeradores.eTipo_action.actualizar)
                    {
                        if (Gru_B.ModificarDB(Gru_I))
                        {
                            string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El Grupo Contable ", "");
                            MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
                            ...
                            MessageBox.Show("Error al Modificar:   {0}",param.Nombre_sistema);
                    }
