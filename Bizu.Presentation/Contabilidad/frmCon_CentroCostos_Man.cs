...
{
    public partial class frmCon_CentroCostos_Man : DevExpress.XtraEditors.XtraForm
    {
        #region "variables"
        ...
        public void cmb_centro_costo_padre_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_Accion == Bizu.Domain.General.Cl_Enumeradores.eTipo_action.grabar && Info_padre_centro_costo != null)
                {
