...
{
    public partial class frmCon_PlanCuenta_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void set_info()
        {
            ...
            try
            {
                ...
                cmbTipoCosto.EditValue = InfoPlanCta.IdTipo_Costo;
        ...
        public void get_info()
        {
            ...
            try
            {
                ...
                if (cmbTipoCosto.EditValue != null) InfoPlanCta.IdTipo_Costo = Convert.ToInt32(cmbTipoCosto.EditValue); else InfoPlanCta.IdTipo_Costo = null;
        ...
        private void cargar_combo()
        {
            try
            {
                ...
                {
                    List<tb_Catalogo_Info> listCat_Naturaleza = new List<Bizu.Domain.General.tb_Catalogo_Info>();
                    listCat_Naturaleza.Add(new Bizu.Domain.General.tb_Catalogo_Info(0, "D", "Deudora", "A", 0, 0));
                    listCat_Naturaleza.Add(new Bizu.Domain.General.tb_Catalogo_Info(0, "C", "Acreedora", "A", 0, 0));
                ...
                if (InfoPlanCta != null)
                {
                    ...
                    if (InfoPlanCta.pc_Estado == "A")
                    {
                        if (MessageBox.Show("¿Está seguro que desea anular la cuenta " + InfoPlanCta.pc_Cuenta2, "Anulación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
                            ...
                            {
                                string smensaje = string.Format("{0} # {1} se anuló con éxito.", "La cuenta", InfoPlanCta.pc_Cuenta2);
                                MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btn_Nuevo_Click(object sender, EventArgs e)
        {
            try
            {
                Llamar_formulario_tipo_gasto(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.grabar);
            }
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
