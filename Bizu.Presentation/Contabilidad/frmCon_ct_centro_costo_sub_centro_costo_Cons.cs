...
{
    public partial class frmCon_ct_centro_costo_sub_centro_costo_Cons : DevExpress.XtraEditors.XtraForm
    {        
        ...
        public void frmCon_ct_centro_costo_sub_centro_costo_Cons_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Contabilidad.frmCon_ct_centro_costo_sub_centro_costo_Cons");
