...
{
    public partial class frmCon_Periodo_Consulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCon_Periodo_Consulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(Parametros.IdEmpresa, Parametros.IdUsuario, "Contabilidad.frmCon_Periodo_Consulta");
