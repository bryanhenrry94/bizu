...
{
    public partial class frmCxc_EstadoCobro_Mantenimiento : DevExpress.XtraEditors.XtraForm
    {
        ...
        void Guardar()
        {
            try
            {
                if (validar())
                {
                    ...
                    {
                        string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El registro ", Info.IdEstadoCobro);
        ...
        void Actualizar()
        {
            try
            {
                if (validar())
                {
                    ...
                    {
                        string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El registro ", Info.IdEstadoCobro);
                        MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
                        //MessageBox.Show("El registro #" + Info.IdEstadoCobro + " se ha guardado correctamente", "Sistema", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        Bloquear_Datos();
                    }
