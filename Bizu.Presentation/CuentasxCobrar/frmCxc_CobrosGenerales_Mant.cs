...
using Bizu.Reports.CuentasxCobrar;
...
{
    public partial class frmCxc_CobrosGenerales_Mant : DevExpress.XtraEditors.XtraForm
    {
        string MensajeError = "";
        string cadena = "Canc./: ";
        string TieneDiarioContable = "NO";
        private Boolean cobroSinFactura = false;
        ...
        void ucGe_Menu_event_btnImprimirSoporte_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                print = new ReportPrintTool(reporte);
        ...
        void LimpiarDatos()
        {
            try
            {
                ucGe_Menu.Visible_btnGuardar = ucGe_Menu.Visible_bntGuardar_y_Salir = DevExpress.XtraBars.BarItemVisibility.Always;
            ...
            try
            {
                ...
                switch (_Accion)
                {
                    case Cl_Enumeradores.eTipo_action.grabar:
                        ...
                        {
                            string smensaje = string.Format("{0} # {1} se guardó con éxito.", "La Cuenta por Cobrar ", Info_Cobro.IdCobro);
                        ...
                        {
                            MessageBox.Show($"Ocurrio un error al grabar: {mensaErro}", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                            bolResult = false;
                        }
                    ...
                    case Cl_Enumeradores.eTipo_action.actualizar:
                        ...
                        {
                            string smensaje = string.Format("{0} # {1} se modificó con éxito.", "La Cuenta por Cobrar ", Info_Cobro.IdCobro);
                            MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
                            txtIdCuenta.Text = Info_Cobro.IdCobro.ToString();
                            if (Info_Cobro.cr_Codigo == "")
                            {
                        ...
                        {
                            MessageBox.Show("Ocurrio un error al actualizar", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
                            bolResult = false;
                        }
        ...
        void ucGe_Menu_event_btnAnular_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                fechaAnulac = frm.fechaAnul;
                Info_Cobro.Fecha_Anulac = fechaAnulac;

                // para anular un cobro que no tiene detalle de cobro, pero si tiene diario contable
                Info_Cobro.TieneDiarioCont_y_NoTieneDetalleCobro = TieneDiarioContable;
                if (Bus.AnularDB(Info_Cobro))
                {
                    MessageBox.Show("El registro ha sido anulado con éxito", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
        ...
        public void CargarCombo()
        {
            try
            {
                ...
                list_cobro_tipo_info = (from q in BustipoCxC.Get_List_Cobro_Tipo() orderby q.tc_Orden ascending select q).ToList();
                cmbTipoCobro.Properties.DataSource = list_cobro_tipo_info;
            ...
            try
            {
                ...
                switch (_Accion)
                {
                    ...
                    case Cl_Enumeradores.eTipo_action.consultar:
                        ...
                        ucGe_Menu.Enabled_bntLimpiar = ucGe_Menu.Enabled_bntAnular = false;
                ...
                if (Parm.TipoCobroDafaultFactu != null)
                {
                    cmbTipoCobro.EditValue = Parm.TipoCobroDafaultFactu;
                }
        ...
        public void Get()
        {
            try
            {
                ...
                Info_Cobro.IdCobro_tipo = (cmbTipoCobro.EditValue == null) ? "" : Convert.ToString(cmbTipoCobro.EditValue);
                ...
                if (cmbBancos.EditValue != null)
                {
                    ...
                    Info_Cobro.IdBanco = Convert.ToInt32(cmbBancos.EditValue);
                }
                else
                {
                    Info_Cobro.IdBanco = null;
                ...
                cxc_cobro_tipo_Info tipo = list_cobro_tipo_info.Find(q => q.IdCobro_tipo == Convert.ToString(cmbTipoCobro.EditValue));
                if (tipo == null) return;
        ...
        public void Set()
        {
            try
            {
                if (Info_Cobro.IdCobro_tipo != null)
                {
                    cmbTipoCobro.EditValue = Info_Cobro.IdCobro_tipo;
                }
        ...
        private void getNotaDC()
        {
            try
            {
                ...
                NDCInfo.CreDeb = (Convert.ToString(cmbTipoCobro.EditValue) == "NTCR") ? "C" : "D";
                ...
                NDCInfo.sc_observacion = Convert.ToString(cmbTipoCobro.EditValue) + "  " + "Cobro " + Info_Cobro.IdCobro.ToString() + " ==> " + txtObservacion.Text;
        ...
        public List<cxc_cobro_Det_Info> getDetalle2()
        {
            try
            {
                List<vwcxc_cartera_x_cobrar_Info> LISTA = new List<vwcxc_cartera_x_cobrar_Info>();
                ...
                var s = from q in bList where q.Check == false select q;
        ...
        public Boolean validar()
        {
            try
            {
                ...
                if (cmbTipoCobro.EditValue == null)
                {
                    MessageBox.Show("Seleccione un tipo de Cobro", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return true;
                }

                cxc_cobro_tipo_Info info_tipo_cobro = list_cobro_tipo_info.Find(q => q.IdCobro_tipo == Convert.ToString(cmbTipoCobro.EditValue));
                if (info_tipo_cobro == null)
                {
                    MessageBox.Show("Error al consultar el tipo de cobro", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return true;
                }

                if (info_tipo_cobro.IdCobro_tipo == "NTCR" || info_tipo_cobro.IdCobro_tipo == "NTDB")
                {
                    MessageBox.Show("Los cobros por notas de credito o debito deben ser realizados por la pantalla de Nota Credito y Debito ", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
        ...
        public void cargarGridContable()
        {
            try
            {
                ...
                if (InfoCxCxCt.cbr_IdEmpresa > 0)
                {
                    TieneDiarioContable = "SI";
                }
                else
                {
                    TieneDiarioContable = "NO";
                }
            }
            catch (Exception ex)
            {
        ...
        private void cmbTipoCobro_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                if (cmbTipoCobro.EditValue == null) return;
                cxc_cobro_tipo_Info tipo = list_cobro_tipo_info.Find(q => q.IdCobro_tipo == Convert.ToString(cmbTipoCobro.EditValue));
                if (tipo == null) return;
                ...
                this.gbDatosDeposito.Visible = false;
                this.dtpFechaCobro.Visible = true;
                this.dtpFechaIngreso.Visible = true;
                this.lb_documento.Text = "";
                this.lb_documento.Visible = false;
                ...
                switch (tipo.IdMotivo_tipo_cobro)
                {
                    case "EFEC":
                        ...
                        break;
                    case "CHEQ":
                        this.grbDatosBanco.Visible = true;
                        this.lb_documento.Text = "Cheque#:";
                        this.lb_documento.Visible = true;
                        this.txtNum_documento.Visible = true;
                        break;
                    case "DEPO":
                        this.gbDatosDeposito.Visible = true;
                        break;
                    case "NTCR":
                        this.pnlTipoNota.Visible = true;
                        break;
                    case "NTDB":
                        this.pnlTipoNota.Visible = true;
                        break;
                    case "RET":
                        this.lb_documento.Text = "Retencion#:";
                        this.lb_documento.Visible = true;
                        this.txtNum_documento.Visible = true;
                        break;
                    case "TARJ":
