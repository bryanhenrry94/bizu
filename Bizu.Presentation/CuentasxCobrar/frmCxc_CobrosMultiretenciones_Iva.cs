...
{
    public partial class frmCxc_CobrosMultiretenciones_Iva : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmCxc_CobrosMultiretenciones_Iva()
        {
            InitializeComponent();
            try
            {
        ...
        private void frmCxc_CobrosMultiretenciones_Iva_Load(object sender, EventArgs e)
        {
            try
            {
