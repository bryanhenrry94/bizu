...
{
    public partial class frmCxc_CobrosGenerales_Multiretenciones_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        List<caj_Caja_Info> ListCaja = new List<Domain.Caja.caj_Caja_Info>();
        ...
        public frmCxc_CobrosGenerales_Multiretenciones_Mant()
        {
            try
            {
                InitializeComponent();
                ...
                event_FrmClose += new Delegate_FrmClose(frmCxc_CobrosGenerales_Multiretenciones_Mant_event_FrmClose);
        ...
        void frmCxc_CobrosGenerales_Multiretenciones_Mant_event_FrmClose(object sender, FormClosingEventArgs e)
        {
            try
            {
        ...
        private void frmCxc_CobrosGenerales_Multiretenciones_Mant_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                frmCxc_CobrosGenerales_Multiretenciones_Mant_event_FrmClose(sender, e);
                ...
                if (row1 != null)
                {
                    ...
                    else if (e.HitInfo.Column.FieldName == "Ico")
                    {
                        ...
                        else
                        {
                            ...
                            if (cmbTipoCobro.SelectedValue != null)
                            {
                                if (cmbTipoCobro.SelectedValue.ToString() == "RTFTE1" || cmbTipoCobro.SelectedValue.ToString() == "RTFTE2")
                                {
                                    frmCxc_CobrosMultiretenciones_Fuente frmF = new frmCxc_CobrosMultiretenciones_Fuente();
                                    frmF.Accion = _Accion;
                                    if (red.TipoDoc == "FACT")
                                    {
                                        Infofac = busFac.Get_Info_factura(red.IdEmpresa, red.IdSucursal, red.IdBodega, red.IdCbteVta);
                                        frmF.setInfo(Infofac, null, Convert.ToString(ucFa_ClienteCmb1.get_ClienteInfo().IdCliente), Convert.ToInt32(cmbCaja.EditValue), red.TipoDoc);
                                    }
                                    else
                                    {
                                        InfoNd = busNd.Get_Info_notaCreDeb_x_ND(red.IdEmpresa, red.IdSucursal, red.IdBodega, red.IdCbteVta);
                                        frmF.setInfo(null, InfoNd, Convert.ToString(ucFa_ClienteCmb1.get_ClienteInfo().IdCliente), Convert.ToInt32(cmbCaja.EditValue), red.TipoDoc);
                                    }
                                    frmF.ShowDialog();
                                    CargarGrillaXCliente();
                                }
                                ...
                                {
                                    frmCxc_CobrosMultiretenciones_Iva frmI = new frmCxc_CobrosMultiretenciones_Iva();
                                    frmI.Accion = _Accion;
                                    if (red.TipoDoc == "FACT")
                                    {
                                        Infofac = busFac.Get_Info_factura(red.IdEmpresa, red.IdSucursal, red.IdBodega, red.IdCbteVta);
                                        frmI.setInfo(Infofac, null, Convert.ToString(ucFa_ClienteCmb1.get_ClienteInfo().IdCliente), Convert.ToInt32(cmbCaja.EditValue), red.TipoDoc);
                                    }
                                    else
                                    {
                                        InfoNd = busNd.Get_Info_notaCreDeb_x_ND(red.IdEmpresa, red.IdSucursal, red.IdBodega, red.IdCbteVta);
                                        frmI.setInfo(null, InfoNd, Convert.ToString(ucFa_ClienteCmb1.get_ClienteInfo().IdCliente), Convert.ToInt32(cmbCaja.EditValue), red.TipoDoc);
                                    }
                                    frmI.ShowDialog();
                                    CargarGrillaXCliente();
                                }
                ...
                if (Info_Cobro != null)
                {
                    ...
                    if (openFileDialog1.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        if ((myStream = openFileDialog1.OpenFile()) != null)
                        {
                            ...
                            Bizu.Domain.class_sri.FacturaV2.factura InfoFactura_SRI = new Bizu.Domain.class_sri.FacturaV2.factura();
                            ...
                            {
                                //llenado de campos  
                                txtAutorizacion.Text = numAutoriza;
                            }
                            else
                            {
