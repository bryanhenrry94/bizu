...
{
    public partial class frmCxc_Cobros_Doc_Cta : DevExpress.XtraEditors.XtraForm
    {
        ...
        /// <summary>
        /// Bizu.Application.SeguridadAcceso de datos
        /// </summary>
        #region Bizu.Application.SeguridadAcceso
        ...
        private void frmCxc_Cobros_Doc_Cta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxCobrar.frmCxc_Cobros_Doc_Cta");
