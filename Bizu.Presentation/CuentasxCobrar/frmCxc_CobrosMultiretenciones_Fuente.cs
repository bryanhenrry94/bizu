...
{
    public partial class frmCxc_CobrosMultiretenciones_Fuente : DevExpress.XtraEditors.XtraForm
    {
        ...
        cxc_cobro_Info Info_Cobro_General = new cxc_cobro_Info();
        ...
        public frmCxc_CobrosMultiretenciones_Fuente()
        {
            InitializeComponent();
            try
            {
            ...
            try
            {
                ...
                switch (Tipo_documento)
                {
                    case "FACT":
                        ...
                        txtObservaciones.Text = Info_Cobro_General.cr_observacion;
                        break;
                    case "NTDB":
                        InfoNota = Info_ND;
        ...
        private void frmCxc_CobrosMultiretenciones_Fuente_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnAnular_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (busCobro.Valida_cobro_x_deposito(Info_Cobro_General, ref  infobnaco))
                {
                ...
                if (MessageBox.Show("Se procederá a liberar los comprobantes aplicados a este cobro, ¿Está seguro que desea anular el cobro #" + Info_Cobro_General.IdCobro + "?", param.NombreEmpresa, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
                {
                    return;
                }
                ...
                Info_Cobro_General.MotiAnula = MensajeError;

                if (busCobro.AnularDB(Info_Cobro_General
                    ))
                {
