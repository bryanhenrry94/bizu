...
{
    public partial class frmCxc_Cobros_x_Ventas_cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmcxc_cobrosXventas_Load(object sender, EventArgs e)
        {
	        ...
	        {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxCobrar.frmCxc_Cobros_x_Ventas_cons");
