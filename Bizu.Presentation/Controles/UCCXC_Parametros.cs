    ...
    public partial class UCCxc_Parametros : UserControl
    {
        ...
        public void set_paramCXC()
        {
            try
            {
                ...
                cmbCtaCbleCli.set_PlanCtarInfo(param_I.IdCtaCble_x_anticipo);
        ...
        public void get_paramCXC()
        {
            try
            {
                ...
                param_I.pa_IdCaja_x_Default = (gridLookUpEdit_caja.EditValue != "") ? Convert.ToInt32(gridLookUpEdit_caja.EditValue) : 0;
                ...
                //J.A. actualizado 29-05-2018 
                param_I.IdCtaCble_x_anticipo = cmbCtaCbleCli.get_PlanCtaInfo().IdCtaCble;
