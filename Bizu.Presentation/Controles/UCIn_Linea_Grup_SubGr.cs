...
{
    public partial class ucIn_Linea_Grup_SubGr : UserControl
    {
        ...
        public ucIn_Linea_Grup_SubGr()
        {
            InitializeComponent();
            event_cmb_subgrupo_EditValueChanged += UCIn_Linea_Grup_SubGr_event_cmb_subgrupo_EditValueChanged;
            event_delegate_cmb_categoria_EditValueChanged += UCIn_Linea_Grup_SubGr_event_delegate_cmb_categoria_EditValueChanged;
        }
        ...
        private void UCIn_Linea_Grup_SubGr_Load(object sender, EventArgs e)
        {
            try
            {
                cargar_combos();
