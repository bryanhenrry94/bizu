       ...
       public event delegate_cmb_beneficiario_EditValueChanged event_cmb_beneficiario_EditValueChanged;
        ...
        private void Cargar_Combos()
        {
            try
            {
                ...
                list_Persona_Tipo.Add(new Bizu.Domain.General.tb_persona_tipo_Info("TODOS", "TODOS"));
        ...
        private void cmb_Persona_Tipo_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    IdTipo_Persona = Bizu.Domain.General.Cl_Enumeradores.eTipoPersona.TODOS;
                }
        ...
        private void Cargar_combo_beneficiario()
        {
            try
            {
                ...
                if (IdTipo_Persona == Bizu.Domain.General.Cl_Enumeradores.eTipoPersona.TODOS)
                {
                    List<Bizu.Domain.General.vwtb_persona_beneficiario_Info> LisBenefeciario= new List<Bizu.Domain.General.vwtb_persona_beneficiario_Info>();
                    Bizu.Domain.General.vwtb_persona_beneficiario_Info InfoBenefi= new Bizu.Domain.General.vwtb_persona_beneficiario_Info();
        ...
        private void llamar_Formulario(Cl_Enumeradores.eTipo_action Accion)
        {
            try
            {
                ...
                {                                        
                    if (Bizu.Domain.General.Cl_Enumeradores.eCliente_Vzen.EDEHSA == param.IdCliente_Ven_x_Default)
                    {
                        Bizu.Presentation.General_Edehsa.frmGe_MantPersona frmPersona = new Bizu.Presentation.General_Edehsa.frmGe_MantPersona();
