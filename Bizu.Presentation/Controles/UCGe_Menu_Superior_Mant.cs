...
namespace Bizu.Presentation.Controles
{
    public partial class UCGe_Menu_Superior_Mant : UserControl
    {
        ...
        public void Validar_Permisos_Usuario(string nombre_formulario)
        {
            try
            {
                Bizu.Application.SeguridadAcceso.seg_Menu_bus Busseg = new Bizu.Application.SeguridadAcceso.seg_Menu_bus();

                //Control de Usuario
                List<Bizu.Domain.SeguridadAcceso.seg_Menu_info> Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, nombre_formulario);
