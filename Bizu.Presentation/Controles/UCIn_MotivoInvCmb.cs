    ...
    public partial class UCIn_MotivoInvCmb : UserControl
    {
        ...
        public void cargar_MotivoInv()
        {
            try
            {
                ...
                info = listMotivoInv.FirstOrDefault(q => q.Genera_Movi_Inven == "S");
                ...
                if (info != null)
                {
                    switch (param.IdCliente_Ven_x_Default)
                    {
                        case Cl_Enumeradores.eCliente_Vzen.EDEHSA:
                            ...
                            break;
                        default:
                            cmbMotivoInv.EditValue = listMotivoInv.FirstOrDefault(q => q.Genera_Movi_Inven == "S").IdMotivo_Inv;
                            break;
                    }                    
                }                
            }
        ...
        public void cargar_MotivoInv(string sTipo_Ing_Egr)
        {
            try
            {
                listMotivoInv = new List<in_Motivo_Inven_Info>();
                listMotivoInv = BusMotivoInv.Get_List_Motivo_Inven(param.IdEmpresa, sTipo_Ing_Egr);
                cmbMotivoInv.Properties.DataSource = listMotivoInv;
