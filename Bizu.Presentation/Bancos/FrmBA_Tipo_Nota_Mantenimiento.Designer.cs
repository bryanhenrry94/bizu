namespace Bizu.Presentation.Bancos
{
    partial class FrmBA_Tipo_Nota_Mantenimiento
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cmbCuentaContable = new Bizu.Presentation.Controles.UCCon_PlanCtaCmb();
            this.cmbCuentaCosto = new Bizu.Presentation.Controles.UCCon_CentroCosto_ctas_Movi();
            ...
            // 
            this.baCbteBantipoInfoBindingSource.DataSource = typeof(Bizu.Domain.Bancos.ba_Cbte_Ban_tipo_Info);
            // 
