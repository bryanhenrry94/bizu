...
{
    public partial class FrmBA_DebitoCredito_MasivoConsulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmBA_DebitoCredito_MasivoConsulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Bancos.FrmBA_DebitoCredito_MasivoConsulta");
