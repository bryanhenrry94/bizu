...
{
    public partial class FrmBA_Archivo_Transferencia_Det : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void BuscarOP()
        {
            try
            {
                ...
                {
                    ba_Archivo_Transferencia_Det_Info Detalle_Info = new ba_Archivo_Transferencia_Det_Info();
