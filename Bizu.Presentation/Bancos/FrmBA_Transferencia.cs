...
{
    public partial class FrmBA_Transferencia : DevExpress.XtraEditors.XtraForm
    {
        ...
        public Boolean validaColumna()
        {
            try
            {
                ...
                if (ucBa_TipoFlujo_origen.get_TipoFlujoInfo() == null)
                {
                    //MessageBox.Show("Antes de continuar seleccione el tipo de flujo de origen", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    //return false;
                }

                if (ucBa_TipoFlujo_destino.get_TipoFlujoInfo() == null)
                {
                    //MessageBox.Show("Antes de continuar seleccione el tipo de flujo de origen", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    //return false;
                }
                ...
                if (validaColumna())
                {
                    ...
                    if (_Accion == Cl_Enumeradores.eTipo_action.grabar)
                    {
                        if (CbteCble_B.GrabarDB(CbteCble_I_ND, ref idCbteCble, ref msg))
                        {
                            ...
                            decimal IdFlujo=0;
                            decimal IdFlujoDestino=0;


                            IdFlujo = (ucBa_TipoFlujo_origen.get_TipoFlujoInfo() == null ? 0 : ucBa_TipoFlujo_origen.get_TipoFlujoInfo().IdTipoFlujo);
                            IdFlujoDestino = (ucBa_TipoFlujo_destino.get_TipoFlujoInfo() == null ? 0 : ucBa_TipoFlujo_destino.get_TipoFlujoInfo().IdTipoFlujo);

                          


                            get_CbteBan(_IdTipoCbte_ND, idCbteCble, ucBa_CuentaBanco_Origen.get_BaCuentaInfo().IdBanco, cod_CbteCble_ND, (int)ultraCmbE_empresaOrig.EditValue, IdFlujo, Convert.ToInt32(ucbA_Tipo_NDBA.get_TipoNotaInfo().IdTipoNota));
                            ...
                            if (CbteCble_B.GrabarDB(CbteCble_I_NC, ref idCbteCble, ref msg))
                            {
                                ...
                                get_CbteBan(_IdTipoCbte_NC, idCbteCble, ucBa_CuentaBanco_Destino.get_BaCuentaInfo().IdBanco, cod_CbteCble_NC, (int)ultraCmbE_empresaDest.EditValue, IdFlujoDestino, Convert.ToInt32(ucbA_Tipo_NCBA.get_TipoNotaInfo().IdTipoNota));
                                if (CbteBan_B.GrabarDB(Info_CbteBan_I, ref MensajeError) == false)
                    ...
                    res = false;
                    //MessageBox.Show("Error al Grabar:  {0}", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                if (transf_I != null)
                {
                    ...
                    if (transf_I.tr_estado == "A")
                    {
                            ...
                            " ?", "Anulación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
                            ...
                            {
                                string smensaje = string.Format("{0} # {1} se anuló con éxito.", "El registro", transf_I.IdTransferencia);
