...
{
    public partial class FrmBA_Tipo_Nota : DevExpress.XtraEditors.XtraForm
    {
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnconsultar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                TipoNotaMant._Accion = Bizu.Domain.General.Cl_Enumeradores.eTipo_action.consultar;
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnModificar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                cargarInfo();
                FrmBA_Tipo_Nota_Mantenimiento TipoNotaMant = new FrmBA_Tipo_Nota_Mantenimiento();
                TipoNotaMant._Accion = Bizu.Domain.General.Cl_Enumeradores.eTipo_action.actualizar;
                TipoNotaMant._Info(_Info);
                TipoNotaMant.Event_FrmBA_Catalogo_Mantenimiento_FormClosing += new FrmBA_Tipo_Nota_Mantenimiento.delegate_FrmBA_Tipo_Nota_Mantenimiento_FormClosing(TipoNotaMant_Event_FrmBA_Catalogo_Mantenimiento_FormClosing);
                TipoNotaMant.Show();
            }
        ...
        private void ucGe_Menu_Mantenimiento_x_usuario_event_btnAnular_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                cargarInfo();
                FrmBA_Tipo_Nota_Mantenimiento TipoNotaMant = new FrmBA_Tipo_Nota_Mantenimiento();
                TipoNotaMant._Accion = Bizu.Domain.General.Cl_Enumeradores.eTipo_action.Anular;
                TipoNotaMant._Info(_Info);
                TipoNotaMant.Event_FrmBA_Catalogo_Mantenimiento_FormClosing += new FrmBA_Tipo_Nota_Mantenimiento.delegate_FrmBA_Tipo_Nota_Mantenimiento_FormClosing(TipoNotaMant_Event_FrmBA_Catalogo_Mantenimiento_FormClosing);
                TipoNotaMant.Show();
            }
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnNuevo_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                FrmBA_Tipo_Nota_Mantenimiento TipoNotaMant = new FrmBA_Tipo_Nota_Mantenimiento();
                TipoNotaMant._Accion = Bizu.Domain.General.Cl_Enumeradores.eTipo_action.grabar;
                TipoNotaMant.Event_FrmBA_Catalogo_Mantenimiento_FormClosing += new FrmBA_Tipo_Nota_Mantenimiento.delegate_FrmBA_Tipo_Nota_Mantenimiento_FormClosing(TipoNotaMant_Event_FrmBA_Catalogo_Mantenimiento_FormClosing);
                TipoNotaMant.Show();
            }
            catch (Exception ex)
        ...
        private void FrmBA_Tipo_Nota_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Bancos.FrmBA_Tipo_Nota");
