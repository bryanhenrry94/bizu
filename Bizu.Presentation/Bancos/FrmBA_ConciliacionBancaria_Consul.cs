...
{
    public partial class FrmBA_ConciliacionBancaria_Consul : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmBa_ConciliacionBancariaConsulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Bancos.FrmBA_ConciliacionBancaria_Consul");
