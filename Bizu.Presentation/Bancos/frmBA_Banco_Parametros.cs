...
{
    public partial class FrmBA_Banco_Parametros : DevExpress.XtraEditors.XtraForm
    {
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;


        public FrmBA_Banco_Parametros()
        {
            try
            {
             InitializeComponent();
        ...
        private void frmBA_Banco_Parametros_Load(object sender, EventArgs e)
        {
            try
            {
                
                this.panel1.Controls.Add(baParametros);
            }
            catch (Exception ex)
            {
                string NameMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
        ...
        private Boolean guardar(object sender, EventArgs e)
        {
            try
            {
                if (baParametros.grabar())
                {
        ...
        private void btnAnular_Click(object sender, EventArgs e)
        {
            try
            {
               baParametros.btn_Refrescar_Click(sender, e);
            }
            catch (Exception ex)
            {
                string NameMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
        ...
        private void baParametros_Load(object sender, EventArgs e)
        {
