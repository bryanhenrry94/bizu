...
{
    public partial class FrmBA_DepositoBancario_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        {          
            try
            {
                ...
                List<cxc_cobro_Info> list_cobros_x_depositar_det = new List<cxc_cobro_Info>();
                ...
                foreach (var item in ListaSumatoria)
                {
                    ...
                    list_cobros_x_depositar_det = cxc_B.Get_List_Cobros_x_depositar_Agrupado_detallado(item.IdEmpresa , item.IdTipocbte_MoviCaja, item.IdCbteCble_MoviCaja );



                    foreach (var item2 in list_cobros_x_depositar_det)
                    {

                        ba_Caja_Movimiento_x_Cbte_Ban_x_Deposito_Info IngrEgrexDepo_I = new ba_Caja_Movimiento_x_Cbte_Ban_x_Deposito_Info();

                        IngrEgrexDepo_I.mcj_IdEmpresa = item2.IdEmpresa;
                        IngrEgrexDepo_I.mcj_IdCbteCble = item2.IdCbteCble_MoviCaja;
                        IngrEgrexDepo_I.mcj_IdTipocbte = item2.IdTipocbte_MoviCaja;

                        IngrEgrexDepo_I.mcj_Secuencia = item2.Secuencia_MoviCaja;
        ...
        private Boolean Actualizar()
        {
            ...
            try
            {
                ...
                if (respuesta)
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El Deposito correctamente con el Comprobante contable ", txt_Ncomprobante.Text);
        ...
        public void Imprimir_Deposito(ba_Cbte_Ban_Info CbteBan_I)
        {
            this.CbteBan_I = CbteBan_I;
