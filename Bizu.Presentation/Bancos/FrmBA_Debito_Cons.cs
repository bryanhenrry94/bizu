...
{
    public partial class FrmBA_Debito_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmBA_Debito_Cons_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Bancos.FrmBA_Debito_Cons");
