...
{
    public partial class FrmBA_DebitoCredito_Masivo : DevExpress.XtraEditors.XtraForm
    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (valida())
                    {
                        ...
                        {
                            string smensaje = string.Format("{0} # {1} se guardó con éxito.", "La Transacción de Notas Masivas ", IdTransaccion);
