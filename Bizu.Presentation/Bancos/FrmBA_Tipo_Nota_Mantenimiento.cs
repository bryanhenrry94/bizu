...
{
    public partial class FrmBA_Tipo_Nota_Mantenimiento : DevExpress.XtraEditors.XtraForm
    {
        ...
        public  bool Guardar()
        {
            try
            {
                if (validar())
                {
                    ...
                    {
                        //Bloquear_Datos();
                        string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El registro", Info.IdTipoNota);
        ...
        public bool Actualizar()
        {
            try
            {
                if (validar())
                {
                    ...
                    {
                        string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El registro ", Info.IdTipoNota);
                        MessageBox.Show(smensaje, param.Nombre_sistema);                        
