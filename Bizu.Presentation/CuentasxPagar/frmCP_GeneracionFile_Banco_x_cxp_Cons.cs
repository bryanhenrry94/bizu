...
{
    public partial class frmCP_GeneracionFile_Banco_x_cxp_Cons : DevExpress.XtraEditors.XtraForm
    {
       ...
       string mensaje = "";
        ...
        private void ucGe_Menu_event_btnNuevo_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                Preparar_Formulario(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.grabar);
            }
            catch (Exception ex)
            {
        ...
        private void ucGe_Menu_event_btnModificar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                if (Info_Archivo.IdEmpresa == 0)
                {
                    ...
                    Preparar_Formulario(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.actualizar);
        ...
        private void ucGe_Menu_event_btnAnular_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                if (Info_Archivo.IdEmpresa == 0)
                {
                    ...
                    Preparar_Formulario(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.Anular);
        ...
        private void ucGe_Menu_event_btnconsultar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                Preparar_Formulario(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.consultar);
        ...
        private void frmCP_GeneracionFile_Banco_x_cxp_Cons_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxPagar.frmCP_GeneracionFile_Banco_x_cxp_Cons");
        ...
        private void Preparar_Formulario(Cl_Enumeradores.eTipo_action iAccion)
        {
            try
            {
                ...
                if (Info_Archivo != null)
                {
                    ...
                    if (iAccion != Bizu.Domain.General.Cl_Enumeradores.eTipo_action.grabar)
                    {
