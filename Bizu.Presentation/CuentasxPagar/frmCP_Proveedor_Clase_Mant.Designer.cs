namespace Bizu.Presentation.CuentasxPagar
{
    partial class frmCP_Proveedor_Clase_Mant
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ucCon_CentroCosto_ctas_Movi1 = new Bizu.Presentation.Controles.UCCon_CentroCosto_ctas_Movi();
            this.cmb_ctacble_gastos = new Bizu.Presentation.Controles.UCCon_PlanCtaCmb();
            this.cmb_ctacble_anticipo = new Bizu.Presentation.Controles.UCCon_PlanCtaCmb();
            this.cmb_CtaCble_CXP = new Bizu.Presentation.Controles.UCCon_PlanCtaCmb();
