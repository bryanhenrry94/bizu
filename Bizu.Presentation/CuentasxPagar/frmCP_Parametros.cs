...
{//02/04/2013  11:21 AM
    public partial class frmCP_Parametros : DevExpress.XtraEditors.XtraForm
    {
        #region variables
            ...
            try
            {
                ...
                if (info != null)
                {
                    if (info.IdEmpresa != 0)
                    {
                        ...
                        ucCtacbleIvaGasto.set_PlanCtarInfo(info.pa_ctacble_x_Iva_Gastos_default);
                        chkNotificacionArchivoTransferencia.Checked = Convert.ToBoolean(info.pa_notificacion_archivo_transferencia);
                        chkNotificacionArchivoTransferenciaAuto.Checked = Convert.ToBoolean(info.pa_notificacion_archivo_transferencia_auto);
        ...
        public void Grabar()
        {
            try
            {
                ...
                info.pa_ctacble_x_Iva_Gastos_default = ucCtacbleIvaGasto.get_PlanCtaInfo().IdCtaCble;
                info.pa_notificacion_archivo_transferencia = chkNotificacionArchivoTransferencia.Checked;
                info.pa_notificacion_archivo_transferencia_auto = chkNotificacionArchivoTransferenciaAuto.Checked;
        ...
        private void chkNotificacionArchivoTransferencia_CheckedChanged(object sender, EventArgs e)
        {
            chkNotificacionArchivoTransferenciaAuto.Visible = chkNotificacionArchivoTransferencia.Checked;
        }
    }
}
