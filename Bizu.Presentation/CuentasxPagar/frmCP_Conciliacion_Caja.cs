...
using Bizu.Presentation.Caja;
using Bizu.Reports.Caja;
...
{
    public partial class frmCP_Conciliacion_Caja : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
        decimal IdProveedor;
        string CodTipoDoc = "";
        ...
        public Boolean Valida()
        {
            try
            {
                ...
                if (checkBox_OP.Checked == true)
                {
                    ...
                    {
                        if (this.cmbBeneficiario.Get_Persona_beneficiario_Info().IdBeneficiario == null)
                        {
        ...
        public void get_OrdenPago()
        {
            try
            {
                ...
                Info_Conciliacion.Info_Orden_Pago_x_Repocision_Caja.IdTipo_op = Info_Tipo_OP.IdTipo_op;
                Info_Conciliacion.Info_Orden_Pago_x_Repocision_Caja.IdEstadoAprobacion = Info_Tipo_OP.IdEstadoAprobacion;
                ...
                detalle.IdEstadoAprobacion = Info_Tipo_OP.IdEstadoAprobacion;
        ...
        private void Re_calcular()
        {
            try
            {
                if (Info_Conciliacion == null) return;
                if (Info_Conciliacion.IdEstadoCierre == null) return;
