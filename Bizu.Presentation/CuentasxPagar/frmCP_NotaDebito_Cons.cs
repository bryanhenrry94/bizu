...
{
    public partial class frmCP_NotaDebito_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCP_NotaDebito_Cons_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxPagar.frmCP_NotaDebito_Cons");
