...
{
    public partial class frmCP_TipoDocumento_Mant : DevExpress.XtraEditors.XtraForm
    {
       ...
       void Get_Documento()
        {
	        ...
	        {	        
                ...
                {
                    cp_codigo_SRI_Info info_Codigo_SRI = List_Codigo_SRI.Find(q => q.IdCodigo_SRI == item.IdCodigo_SRI);

                    if (info_Codigo_SRI != null)
                    {
                        if (info_Codigo_SRI.co_descripcion != null && info_Codigo_SRI.co_descripcion != "")
                            TipoSustento = TipoSustento + info_Codigo_SRI.codigoSRI + ",";
                    }                    
                }
