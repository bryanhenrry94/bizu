...
{
    public partial class frmCP_Proveedor_Clase_Consul : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCP_Proveedor_Clase_Consul_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxPagar.frmCP_Proveedor_Clase_Consul");
