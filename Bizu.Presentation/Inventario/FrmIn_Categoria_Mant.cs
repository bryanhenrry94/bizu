...
{
    public partial class FrmIn_Categoria_Mant : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
      ...
      //  UCIn_CtsContablesParaContabilizar ctrl_ctasContables;
        ...
        void Anular()
        {
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se anuló con éxito.", "La Categoria", infoCat.IdCategoria);
                ...
                else
                {
                    ...
                    switch (Accion)
                    {
                        case Cl_Enumeradores.eTipo_action.grabar:
                            ...
                            {
                                string smensaje = string.Format("{0} # {1} se guardó con éxito.", "La Categoria", infoCat.IdCategoria);
                                MessageBox.Show(smensaje, param.Nombre_sistema); 
                        ...
                        case Cl_Enumeradores.eTipo_action.actualizar:
                            ...
                            {
                                string smensaje = string.Format("{0} # {1} se modificó con éxito.", "La Categoria", infoCat.IdCategoria);
                                MessageBox.Show(smensaje, param.Nombre_sistema);
