...
{
    public partial class frmIn_ProductoTipo_Mant : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
        ...
        Boolean Anular()
        {
            try
            {
                ...
                {
                    Bizu.Presentation.General.FrmGe_MotivoAnulacion ofrmMot = new General.FrmGe_MotivoAnulacion();
                    ofrmMot.ShowDialog();
