...
{
    public partial class FrmIn_Categoria_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmIn_CategoriaConsulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Inventario.FrmIn_Categoria_Cons");
