namespace Bizu.Presentation.Inventario
{
    partial class FrmIn_Producto_Winzard_Import
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cmb_IdCtaCble_Inven = new Bizu.Presentation.Controles.UCCon_PlanCtaCmb();
            this.cmb_IdCtaCble_VenIva = new Bizu.Presentation.Controles.UCCon_PlanCtaCmb();
            this.cmb_IdCtaCble_Ven0 = new Bizu.Presentation.Controles.UCCon_PlanCtaCmb();
            this.cmb_IdCtaCble_DesIva = new Bizu.Presentation.Controles.UCCon_PlanCtaCmb();
            this.cmb_IdCtaCble_Des0 = new Bizu.Presentation.Controles.UCCon_PlanCtaCmb();
            this.labelControl1 = new DevExpress.XtraEditors.LabelControl();
            this.labelControl2 = new DevExpress.XtraEditors.LabelControl();
            this.labelControl3 = new DevExpress.XtraEditors.LabelControl();
            this.labelControl4 = new DevExpress.XtraEditors.LabelControl();
            this.labelControl5 = new DevExpress.XtraEditors.LabelControl();
            this.cmb_IdCtaCble_DevIva = new Bizu.Presentation.Controles.UCCon_PlanCtaCmb();
            this.cmb_IdCtaCble_Dev0 = new Bizu.Presentation.Controles.UCCon_PlanCtaCmb();
            this.cmb_IdCtaCble_Costo = new Bizu.Presentation.Controles.UCCon_PlanCtaCmb();
            this.cmb_IdCtaCble_Gasto_x_cxp = new Bizu.Presentation.Controles.UCCon_PlanCtaCmb();
            this.cmb_IdCtaCble_Vta = new Bizu.Presentation.Controles.UCCon_PlanCtaCmb();
