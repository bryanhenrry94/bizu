namespace Bizu.Presentation.Inventario
{
    partial class FrmIn_Aprobacion_Ing_Egr_x_transaccion
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cmb_Sucursal_Bodega = new Bizu.Presentation.Controles.UCIn_Sucursal_Bodega();
            ...
            this.ucGe_Menu_Superior_Mant1.event_btnAprobarGuardarSalir_Click += new Bizu.Presentation.Controles.UCGe_Menu_Superior_Mant.delegate_btnAprobarGuardarSalir_Click(this.ucGe_Menu_Superior_Mant1_event_btnAprobarGuardarSalir_Click);
            ...
            this.ucGe_Menu_Superior_Mant1.event_btnAprobar_Click += new Bizu.Presentation.Controles.UCGe_Menu_Superior_Mant.delegate_btnAprobar_Click(this.ucGe_Menu_Superior_Mant1_event_btnAprobar_Click);
            ...
            this.cmb_Sucursal_Bodega.TipoCarga = Bizu.Domain.General.Cl_Enumeradores.eTipoFiltro.todos;
            this.cmb_Sucursal_Bodega.Visible_cmb_bodega = true;
            this.cmb_Sucursal_Bodega.Event_cmb_bodega1_EditValueChanged += new Bizu.Presentation.Controles.UCIn_Sucursal_Bodega.delegate_cmb_bodega1_EditValueChanged(this.cmb_Sucursal_Bodega_Event_cmb_bodega1_EditValueChanged);
            // 
