...
{
    public partial class FrmIn_CreacionBodega : DevExpress.XtraEditors.XtraForm
    {

        #region Declaración de Variables
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        tb_Sucursal_Bus _Sucursal_B = new tb_Sucursal_Bus();
        tb_Bodega_Bus _Bodegas_b = new Bizu.Application.General.tb_Bodega_Bus();
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnNuevo_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                ofrm.set_Accion(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.grabar);
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnModificar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                frmFa_Bodega ofrm = new frmFa_Bodega();                
                ofrm.lbl_id_sucursal.Text = lbxSucursales.SelectedValue.ToString();
                ofrm.set_Accion(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.actualizar);
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnconsultar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                ofrm.Event_frmFA_Bodega_FormClosing += new frmFa_Bodega.delegate_frmFA_Bodega_FormClosing(ofrm_Event_frmFA_Bodega_FormClosing);
                ofrm.lbl_id_sucursal.Text = lbxSucursales.SelectedValue.ToString();
                ofrm.set_Accion(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.consultar);
                Bodega = gridViewBodega.GetFocusedRow() as tb_Bodega_Info;
                ofrm.set_Bodega(Bodega);
                ofrm.MdiParent = this.MdiParent;
                ofrm.Show();
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnAnular_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                ofrm.Event_frmFA_Bodega_FormClosing += new frmFa_Bodega.delegate_frmFA_Bodega_FormClosing(ofrm_Event_frmFA_Bodega_FormClosing);
                ofrm.lbl_id_sucursal.Text = lbxSucursales.SelectedValue.ToString();
                ofrm.set_Accion(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.Anular);
                Bodega = gridViewBodega.GetFocusedRow() as tb_Bodega_Info;
                ofrm.set_Bodega(Bodega);
                ofrm.MdiParent = this.MdiParent;
                ofrm.Show();
