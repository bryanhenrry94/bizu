...
{
    public partial class FrmIn_Devolucion_Inven_Mant : DevExpress.XtraEditors.XtraForm
    {
                ...
                if (infoDetDev != null)
                {
                    ...
                    if (infoDetDev.estado == "A" )
                    {
                        if (MessageBox.Show("¿Está seguro que desea anular la Devolucion  N#: " + infoDetDev.IdDev_Inven + " ?", "Anulación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
                            ...
                            {
                                string smensaje = string.Format("{0} # {1} se anuló con éxito.", "La Devolución", infoDetDev.IdDev_Inven);
            ...
            try
            {
                switch (_Accion)
                {
                    case Cl_Enumeradores.eTipo_action.grabar:
                        ...
                        LimpiarDatos();
                        ucGe_Menu_Superior.Visible_bntAnular = DevExpress.XtraBars.BarItemVisibility.Never;
                        ucGe_Menu_Superior.Visible_bntImprimir = DevExpress.XtraBars.BarItemVisibility.Never;
                        break;
                    case Cl_Enumeradores.eTipo_action.actualizar:

                        ucGe_Menu_Superior.Visible_bntAnular = DevExpress.XtraBars.BarItemVisibility.Never;
                        ucGe_Menu_Superior.Visible_bntLimpiar = DevExpress.XtraBars.BarItemVisibility.Never;
                        ...
                        ucGe_Menu_Superior.Visible_bntImprimir = DevExpress.XtraBars.BarItemVisibility.Always;
                        set_info_controls();
                    ...
                    case Cl_Enumeradores.eTipo_action.Anular:
                        ...
                        ucGe_Menu_Superior.Visible_bntLimpiar = DevExpress.XtraBars.BarItemVisibility.Never;
                        ucGe_Menu_Superior.Visible_btnGuardar = DevExpress.XtraBars.BarItemVisibility.Never;
                        ucGe_Menu_Superior.Visible_bntGuardar_y_Salir = DevExpress.XtraBars.BarItemVisibility.Never;
        ...
        private void cargar_combo()
        {
            try
            {
                int IdSucursal = 0;
                int IdBodega = 0;
                IdSucursal = Convert.ToInt32(ucIn_Sucursal_Bodega.cmb_sucursal.EditValue);
                IdBodega = Convert.ToInt32(ucIn_Sucursal_Bodega.cmb_bodega.EditValue);
        ...
        bool Guardar()
        {
            ...
            {   
                ...
                {
                    string smensaje = string.Format("{0} # {1} se guardó con éxito.", "La Devolución", infoDetDev.IdDev_Inven);
                    MessageBox.Show(smensaje, param.Nombre_sistema);                   
                    txtidDev.Text= infoDetDev.IdDev_Inven.ToString();
        ...
        bool Actualizar()
        {
            try
            {
               ...
               if (BusDevolucion.ModificarDB(infoDetDev, ref  mensaje))
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "La Devolución", infoDetDev.IdDev_Inven);
                    MessageBox.Show(smensaje, param.Nombre_sistema);
                    if (MessageBox.Show("¿Desea imprimir el soporte de la devolución?",param.Nombre_sistema,MessageBoxButtons.YesNo,MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
                    {
                        imprimir();
                ...
                {
                    string smensaje = string.Format("Error al Modificar:   {0}", mensaje);
                    MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);                 
                }
               return false;
            }
