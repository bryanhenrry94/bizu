...
{
    public partial class FrmIn_Catalogo_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        Boolean Guardar()
        {
           ...
           try
           {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El Catálogo", Info.IdCatalogo);
        ...
        Boolean Actualizar()
        {
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El Catálogo", Info.IdCatalogo);
                    MessageBox.Show(smensaje, param.Nombre_sistema);
                    LimpiarDatos();
                    return true;
                }
