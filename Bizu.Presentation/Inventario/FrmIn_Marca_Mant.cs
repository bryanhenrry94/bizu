...
{
    public partial class FrmIn_Marca_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        Boolean Grabar() 
        {
            try
            {
                ...
                if (_Accion == Cl_Enumeradores.eTipo_action.grabar)
                {
                    ...
                    {
                        string smensaje = string.Format("{0} # {1} se guardó con éxito.", "La Marca", marcaI.IdMarca);
                    ...
                    {
                        string smensaje = string.Format("Error al Grabar:  {0}", msg);
                ...
                if (_Accion == Cl_Enumeradores.eTipo_action.actualizar)
                {
                    ...
                    {
                        string smensaje = string.Format("{0} # {1} se modificó con éxito.", "La Marca", marcaI.IdMarca);
                        MessageBox.Show(smensaje, param.Nombre_sistema);
                        //ucGe_Menu.Enabled_bntGuardar_y_Salir = false;
                        //ucGe_Menu.Enabled_btnGuardar = false;
                        bolResult = true;
                    ...
                    {
                        string smensaje = string.Format("Error al Modificar:   {0}", msg);
                        MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);  
                    }
                ...
                if (_Accion == Cl_Enumeradores.eTipo_action.Anular)
                {
                    ...
                    {
                        string smensaje = string.Format("{0} # {1} se anuló con éxito.", "La Marca", marcaI.IdMarca);
                        MessageBox.Show(smensaje, param.Nombre_sistema); 
                    ...
                    {
                        string smensaje = string.Format("Error al Anular:  {0}", msg);
                        MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);  
                    }
                }
