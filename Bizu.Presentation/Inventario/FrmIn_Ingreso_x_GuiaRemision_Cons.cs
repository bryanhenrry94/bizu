...
{
    public partial class FrmIn_Ingreso_x_GuiaRemision_Cons : DevExpress.XtraEditors.XtraForm
    {
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus;   
        in_Ing_Egr_Inven_Bus bus_IngEgr ;      
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        in_Ing_Egr_Inven_Info info ;
        FrmIn_Ingreso_x_GuiaRemision_Mant frm;
        in_Parametro_Info info_param_inv = new in_Parametro_Info();
        ...
        public FrmIn_Ingreso_x_GuiaRemision_Cons()
        {
            InitializeComponent();
        ...
        private void cargagrid()
        {
            ...
            {         
                ...
                LstIngEge = bus_IngEgr.Get_List_Ing_Egr_Inven(param.IdEmpresa, IdSucursalIni, IdSucursalFin, IdBodegaIni, IdBodegaFin, fecha_desde, fecha_hasta, Convert.ToInt32(info_param_inv.IdMovi_Inven_tipo_x_Anulacion_GuiaRemision));
        ...
        private void FrmIn_Ingreso_x_GuiaRemision_Cons_Load(object sender, EventArgs e)
        {
            try
            {

                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Inventario.FrmIn_Ingreso_x_GuiaRemision_Cons");
        ...
        private void Preparar_Formulario(Cl_Enumeradores.eTipo_action Accion)
        {
            ...
            try
            {
                ...
                {
                    frm = new FrmIn_Ingreso_x_GuiaRemision_Mant();
                    frm.SETINFO_ = info;
                    frm.Text = frm.Text + " ***NUEVO REGISTRO***";
                    frm.set_Accion(Accion); frm.MdiParent = this.MdiParent;
                    frm.Show();
                    frm.event_FrmIn_Ingreso_x_GuiaRemision_Mant_FormClosing += frm_event_FrmIn_Ingreso_x_GuiaRemision_Mant_FormClosing;
                }
            }
            catch (Exception ex)
            {
        ...
        void frm_event_FrmIn_Ingreso_x_GuiaRemision_Mant_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                cargagrid();
