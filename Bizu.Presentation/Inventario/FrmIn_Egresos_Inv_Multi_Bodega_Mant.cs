...
{
    public partial class FrmIn_Egresos_Inv_Multi_Bodega_Mant : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
        //Bus        
                    ...
                    switch (Accion)
                    {
                        case Cl_Enumeradores.eTipo_action.grabar:
                            ...
                            if (bus_IngEgr.GuardarDB(info_IngEgr, ref   IdNumMovi, ref mensaje))
                            {
                                ...
                                string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El registro del Ingreso a Bodega ", IdNumMovi.ToString());
