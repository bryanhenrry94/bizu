...
{
    public partial class FrmIn_Tipo_Movi_Inven_Mantenimiento : DevExpress.XtraEditors.XtraForm
    {
            ...
            try
            {
                bool resultado = false;
                 ...
                 if (_Accion == Cl_Enumeradores.eTipo_action.grabar)
                 {
                     ...
                     {
                         resultado = true;
                         mensajeRecurso = "El registro ha sido guardado con éxito";
                     ...
                     {
                         return resultado;
                         mensajeRecurso = "Error al Grabar:  {0}";
                 ...
                 if (_Accion == Cl_Enumeradores.eTipo_action.actualizar)
                 {
                     ...
                     {
                         mensajeRecurso = "Error al Modificar:   {0}";
                         MessageBox.Show(mensajeRecurso + "\n" + msg, param.Nombre_sistema);
                         return resultado;
                     }
        ...
        public void anular()
        {
            if (_Accion == Cl_Enumeradores.eTipo_action.Anular)
            {
                ...
                try
                {
                    ...
                    {
                        Bizu.Presentation.General.FrmGe_MotivoAnulacion omot = new General.FrmGe_MotivoAnulacion();
                        omot.ShowDialog();
                        MoviInveI.MotiAnula = omot.motivoAnulacion;
                        if (moviB.AnularDB (MoviInveI))
                        {
                            ucGe_Menu.Enabled_bntAnular = false;
                            mensajeRecurso = "El registro ha sido anulado con éxito";
                            MessageBox.Show(mensajeRecurso, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                        else
                       {
