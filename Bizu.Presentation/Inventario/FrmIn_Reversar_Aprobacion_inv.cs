...
{
    public partial class FrmIn_Reversar_Aprobacion_inv : DevExpress.XtraEditors.XtraForm
    {
        #region
        ...
        private void FrmIn_Reversar_Aprobacion_inv_Load(object sender, EventArgs e)
        {
            try
            {
                ucGe_Menu_Superior_Mant1.btnAprobar.Caption = "Reversar";
                ucGe_Menu_Superior_Mant1.btnAprobarGuardarSalir.Caption = "Reversar y salir";
