...
{
    public partial class FrmIn_Egresos_x_Ajuste_Cons : DevExpress.XtraEditors.XtraForm
    {     
        List<in_Ing_Egr_Inven_Info> listEgresos;    
        in_Ing_Egr_Inven_Bus bus_IngEgr;   
        in_Ing_Egr_Inven_Info Info;
        FrmIn_Egresos_x_Ajuste_Mant frm;
       // Cl_Enumeradores.eTipo_action eAccion = new Cl_Enumeradores.eTipo_action();
        ...
        public FrmIn_Egresos_x_Ajuste_Cons()
        {
            InitializeComponent();
        ...
        private void FrmIn_Egresos_x_Ajuste_Cons_Load(object sender, EventArgs e)
        {
            try
            {

                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Inventario.FrmIn_Egresos_x_Ajuste_Cons");
                ...
                if (Info != null)
                {
                    ...
                    { MessageBox.Show("El registro ya se encuentra Anulado", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation); return; }
                        ...
                        else
                        {
                            ...
                            frm = new FrmIn_Egresos_x_Ajuste_Mant();
