...
{
    public partial class FrmIn_Ajuste_Inven_fisico_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        BindingList<in_Producto_Info> BindingList_Producto = new BindingList<Bizu.Domain.Inventario.in_Producto_Info>();
        ...
        private void set_Accion_In_Controls()
        {
            switch (_Accion)
            {
                ...
                case Cl_Enumeradores.eTipo_action.Anular:
                    ...
                    ucGe_Menu.Visible_bntAprobar = DevExpress.XtraBars.BarItemVisibility.Never;
                    break;
        ...
        public in_ajusteFisico_Info Get_info()
        {
            try
            {
                ...
                Info_AjusteFisico = new Bizu.Domain.Inventario.in_ajusteFisico_Info();
                ...
                foreach (var item in BindingList_Producto)
                {
                    foreach (var item1 in Productos_x_Ajust_Stock)
                    {
                        if (item.IdProducto == item1.IdProducto)
                        {
                            ...
                            //item.pr_stock = Convert.ToDouble(item1.StockSistema); 
                        }
                    }
                }
