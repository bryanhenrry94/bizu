...
{
    public partial class FrmIn_Catalogo_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            //Control de Usuario
            Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Inventario.FrmIn_Catalogo_Cons");
