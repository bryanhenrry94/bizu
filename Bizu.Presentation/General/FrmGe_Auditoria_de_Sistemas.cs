...
{
    public partial class FrmGe_Auditoria_de_Sistemas : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
        ...
        private void btn_Contabilizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (var item in lista_a_contabilizar)
                {
                    ...
                    MessageBox.Show(msg, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                }
        ...
        private void Cargar_ventas()
        {
            try
            {
                ...
                Fecha_ini = Convert.ToDateTime(dtp_desde.EditValue).Date;
                Fecha_Fin = Convert.ToDateTime(dtp_hasta.EditValue).Date;
        ...
        private void Cargar_inventario()
        {
            try
            {
                ...
                list_vwin_movi_inve_x_cbteCble_Datos = BusMovi_x_Cbte.Get_List_vwin_movi_inve_x_cbteCble_Datos(param.IdEmpresa, Convert.ToDateTime(dtp_desde.EditValue).Date, Convert.ToDateTime(dtp_hasta.EditValue).Date, tipo_ing_egr, Tipo_Conta);
                list_vwin_movi_inve_x_cbteCble_Datos_no_contabilizados = new BindingList<vwin_movi_inve_x_cbteCble_Datos_Info>(BusMovi_x_Cbte.Get_List_vwin_movi_inve_x_cbteCble_Datos_No_Contabilizados(param.IdEmpresa, Convert.ToDateTime(dtp_desde.EditValue).Date, Convert.ToDateTime(dtp_hasta.EditValue).Date, tipo_ing_egr_no_conta));
        ...
        private void cmb_Modificar_contabilidad_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                string mesn = "";
        ...
        private void cmbtipo_ing_egr_SelectedIndexChanged(object sender, EventArgs e)
        {
     
        }

        private void cmbtipo_ing_egr_no_conta_SelectedIndexChanged(object sender, EventArgs e)
        {
