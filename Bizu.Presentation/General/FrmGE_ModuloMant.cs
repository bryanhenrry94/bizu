...
{
    public partial class FrmGE_ModuloMant : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void Grabar()
        {
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El Módulo ", info_mod.CodModulo);
        ...
        private void Modificar()
        {
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El Módulo ", info_mod.CodModulo);
                    MessageBox.Show(smensaje, param.Nombre_sistema);
                    ucGe_Menu.Visible_bntGuardar_y_Salir = DevExpress.XtraBars.BarItemVisibility.Never;
                    ucGe_Menu.Visible_btnGuardar = DevExpress.XtraBars.BarItemVisibility.Never;
                }
