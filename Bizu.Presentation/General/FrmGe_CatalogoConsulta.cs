...
{
    public partial class FrmGe_CatalogoConsulta : DevExpress.XtraEditors.XtraForm
    {
       ...
       //nuevo
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnconsultar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                ofrm.setAccion(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.consultar);
       ...
       //nuevo
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnModificar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                ofrm = new FrmGe_CatalogoTipo_man(Convert.ToInt32(lstbox_TipoCatalogo.SelectedValue));
                ofrm.Event_frmGe_CatalogoTipo_man_FormClosing += ofrm_Event_frmGe_CatalogoTipo_man_FormClosing;
                ofrm.setAccion(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.actualizar);
                ofrm.SetInfo = gridViewCatalogo.GetFocusedRow() as tb_Catalogo_Info;
                ofrm.ShowDialog();
            }
            catch (Exception ex)
       ...
       //nuevo
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnNuevo_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ofrm = new FrmGe_CatalogoTipo_man(Convert.ToInt32(lstbox_TipoCatalogo.SelectedValue));
                ofrm.Event_frmGe_CatalogoTipo_man_FormClosing += ofrm_Event_frmGe_CatalogoTipo_man_FormClosing;
                ofrm.setAccion(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.grabar);
                ofrm.ShowDialog();
            }
            catch (Exception ex)
            {
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnAnular_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                    ofrm = new FrmGe_CatalogoTipo_man(Convert.ToInt32(lstbox_TipoCatalogo.SelectedValue));
                    ofrm.Event_frmGe_CatalogoTipo_man_FormClosing += ofrm_Event_frmGe_CatalogoTipo_man_FormClosing;
                    ofrm.setAccion(Bizu.Domain.General.Cl_Enumeradores.eTipo_action.Anular);
                    ofrm.SetInfo = gridViewCatalogo.GetFocusedRow() as tb_Catalogo_Info;
                    ofrm.ShowDialog();
            }
            catch (Exception ex)
