...
{
    public partial class FrmGe_sis_reporte : DevExpress.XtraEditors.XtraForm
    {
            ...
            try
            {
                switch (_Accion)
                {
                    ...
                    case Cl_Enumeradores.eTipo_action.consultar:
                        gridLookUpEdit_modulo.Enabled = false;
                        ucGe_Menu.Visible_bntDiseñoReporte = DevExpress.XtraBars.BarItemVisibility.Never;
                        txt_Id.ReadOnly = true;
                        ucGe_Menu.Visible_bntLimpiar = DevExpress.XtraBars.BarItemVisibility.Never;
