namespace Bizu.Presentation.SeguridadAcceso
{
    partial class FrmSeg_Usuario_Consul
    {
        ...
        {
            this.uC_Menu_Consultas1 = new Bizu.Presentation.Controles.UCGe_Menu_Mantenimiento_x_usuario();
            ...
            this.uC_Menu_Consultas1.fecha_desde = new System.DateTime(2023, 12, 13, 14, 18, 39, 565);
            this.uC_Menu_Consultas1.fecha_hasta = new System.DateTime(2024, 2, 13, 14, 18, 39, 565);
            ...
            this.uC_Menu_Consultas1.Size = new System.Drawing.Size(799, 131);
            ...
            this.uC_Menu_Consultas1.Visible_btnNotificar = DevExpress.XtraBars.BarItemVisibility.Never;
            this.uC_Menu_Consultas1.Visible_btnRevision = DevExpress.XtraBars.BarItemVisibility.Never;
            ...
            this.uC_Menu_Consultas1.Visible_Grupo_FormaPago = false;
            ...
            this.uC_Menu_Consultas1.event_btnNuevo_ItemClick += new Bizu.Presentation.Controles.UCGe_Menu_Mantenimiento_x_usuario.delegate_btnNuevo_ItemClick(this.uC_Menu_Consultas1_event_btnNuevo_ItemClick);
            this.uC_Menu_Consultas1.event_btnModificar_ItemClick += new Bizu.Presentation.Controles.UCGe_Menu_Mantenimiento_x_usuario.delegate_btnModificar_ItemClick(this.uC_Menu_Consultas1_event_btnModificar_ItemClick);
            this.uC_Menu_Consultas1.event_btnconsultar_ItemClick += new Bizu.Presentation.Controles.UCGe_Menu_Mantenimiento_x_usuario.delegate_btnconsultar_ItemClick(this.uC_Menu_Consultas1_event_btnconsultar_ItemClick);
            this.uC_Menu_Consultas1.event_btnAnular_ItemClick += new Bizu.Presentation.Controles.UCGe_Menu_Mantenimiento_x_usuario.delegate_btnAnular_ItemClick(this.uC_Menu_Consultas1_event_btnAnular_ItemClick);
            this.uC_Menu_Consultas1.event_btnImprimir_ItemClick += new Bizu.Presentation.Controles.UCGe_Menu_Mantenimiento_x_usuario.delegate_btnImprimir_ItemClick(this.uC_Menu_Consultas1_event_btnImprimir_ItemClick);
            this.uC_Menu_Consultas1.event_btnSalir_ItemClick += new Bizu.Presentation.Controles.UCGe_Menu_Mantenimiento_x_usuario.delegate_btnSalir_ItemClick(this.uC_Menu_Consultas1_event_btnSalir_ItemClick);
            this.uC_Menu_Consultas1.event_btnBuscar_Click += new Bizu.Presentation.Controles.UCGe_Menu_Mantenimiento_x_usuario.delegate_btnBuscar_Click(this.uC_Menu_Consultas1_event_btnBuscar_Click);
            // 
            // gridControlUsuario
            // 
            this.gridControlUsuario.Dock = System.Windows.Forms.DockStyle.Fill;
            this.gridControlUsuario.Location = new System.Drawing.Point(0, 131);
            this.gridControlUsuario.MainView = this.gridViewUsuario;
            this.gridControlUsuario.Name = "gridControlUsuario";
            this.gridControlUsuario.Size = new System.Drawing.Size(799, 319);
        ...
        private Bizu.Presentation.Controles.UCGe_Menu_Mantenimiento_x_usuario uC_Menu_Consultas1;
