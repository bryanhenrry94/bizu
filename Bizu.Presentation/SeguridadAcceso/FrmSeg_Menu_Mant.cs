            ...
            try
            {
                ...
                switch (accion)
                {
                    case Cl_Enumeradores.eTipo_action.grabar:
                        txtIdMenu.Text = new seg_Menu_bus().getIdMenu_Max(ref mensaje).ToString();                      
                        uC_Menu_Mantenimientos1.Visible_bntAnular = DevExpress.XtraBars.BarItemVisibility.Never;
                        break;
                    case Cl_Enumeradores.eTipo_action.actualizar:
                        Cargar();
                        uC_Menu_Mantenimientos1.Visible_bntAnular = DevExpress.XtraBars.BarItemVisibility.Never;
                        uC_Menu_Mantenimientos1.Visible_btnGuardar = DevExpress.XtraBars.BarItemVisibility.Never;
                        break;
                    case Cl_Enumeradores.eTipo_action.Anular:
                        Cargar();
                        uC_Menu_Mantenimientos1.Visible_bntGuardar_y_Salir = DevExpress.XtraBars.BarItemVisibility.Never;
                        uC_Menu_Mantenimientos1.Visible_btnGuardar = DevExpress.XtraBars.BarItemVisibility.Never;
                        break;
