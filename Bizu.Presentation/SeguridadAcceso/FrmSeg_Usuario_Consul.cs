...
{
    public partial class FrmSeg_Usuario_Consul : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void cargar_grid()
        {
            ...
            {
                string MensajeError = "";
                ListInfo_usuarios = bus.Get_List_Usuario_x_Empresa(param.IdEmpresa, ref MensajeError);
