...
namespace Bizu.Presentation.SeguridadAcceso
{
    public partial class FrmSeg_Login : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            Bizu.Application.General.cl_parametrosGenerales_Bus.Instance.IdUsuario = null;
            this.Close();
        }
                    ...
                    if (consulta)
                    {
                        if (BusUsuario.Validar_Credenciales(InfoUsuario, ref mensajeError))
                        {
                            ...
                            else
                            {
                                ...
                                Bizu.Application.General.cl_parametrosGenerales_Bus.Instance.IdUsuario = InfoUsuario.IdUsuario;
                                Bizu.Application.General.cl_parametrosGenerales_Bus.Instance.InfoUsuario = InfoUsuario;
                                LogonOk = true;
                                this.Close();
                            }
                        }
