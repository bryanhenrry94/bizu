...
{
    public partial class XINV_Rpt031_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();

        public int idMarca = 0;
        public List<Int32> IdMarca_List = new List<Int32>();

        public XINV_Rpt031_Rpt()
        {
            InitializeComponent();
        }
        ...
        private void XINV_FJ_Rpt006_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                XINV_Rpt031_Bus BUS = new XINV_Rpt031_Bus();

                List<XINV_Rpt031_Info> ListDataRpt = new List<XINV_Rpt031_Info>();
                ...
                ListDataRpt = BUS.Get_list(param.IdEmpresa, IdSucursalIni, IdBodegaIni, IdProductoIni, IdMarca_List, FechaIni, FechaFin);
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XINV_Rpt031_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XINV_Rpt031_Rpt) };
            }
        }
