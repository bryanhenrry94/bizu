    ...
    public partial class XINV_Rpt030_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void XINV_FJ_Rpt006_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                XINV_Rpt030_Bus BUS = new XINV_Rpt030_Bus();

                List<XINV_Rpt030_Info> ListDataRpt = new List<XINV_Rpt030_Info>();
                ...
                string IdCategoria = "";
                Int32 IdLinea = 0;
                Boolean Considerar_saldo_inicial = false;
                ...
                IdCategoria = (Parameters["IdCategoria"].Value).ToString();
                Considerar_saldo_inicial = Convert.ToBoolean(Parameters["Considerar_saldo_inicial"].Value);

                switch(param.IdCliente_Ven_x_Default)
                {
                    case Info.General.Cl_Enumeradores.eCliente_Vzen.EDEHSA:
                        ListDataRpt = BUS.Get_Kardes_Movimiento(param.IdEmpresa, IdSucursalIni, IdSucursalFin, IdBodegaIni, IdBodegaFin, IdProductoIni, IdProductoFin, IdCentroCosto, IdSubCentroCosto, IdMovi_inven_tipoIni, IdMovi_inven_tipoFin, TipoMov, FechaIni, FechaFin, IdCategoria, IdLinea_List, Considerar_saldo_inicial);
                        break;

                    default:
                        IdLinea = Convert.ToInt32(Parameters["IdLinea"].Value);                
                        ListDataRpt = BUS.Get_Kardes_Movimiento(param.IdEmpresa, IdSucursalIni, IdSucursalFin, IdBodegaIni, IdBodegaFin, IdProductoIni, IdProductoFin, IdCentroCosto, IdSubCentroCosto, IdMovi_inven_tipoIni, IdMovi_inven_tipoFin, TipoMov, FechaIni, FechaFin,IdCategoria,IdLinea);
                        break;
                }
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XINV_FJ_Rpt006_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XINV_Rpt030_Rpt) };
            }
        }
