    ...
    public class XINV_Rpt039_Data
    {
        public List<XINV_Rpt039_Info> Get_Data(int IdEmpresa, int IdSucursal, int IdBodega, int IdMov_inven_tipo, int IdNumMovi, decimal IdProducto)
        {
            try
            {
                ...
                List<XINV_Rpt039_Info> lista = new List<XINV_Rpt039_Info>();
                using (Entities_Inventario_General conexion = new Entities_Inventario_General())
                {
                    var querry = from q in conexion.vwINV_Rpt039
                    ...
                    foreach (var item in querry)
                    {
                        ...
                        XINV_Rpt039_Info itemInfo = new XINV_Rpt039_Info();
                        ...
                        itemInfo.Ubicacion1 = item.Ubicacion1;
                        itemInfo.Ubicacion2 = item.Ubicacion2;
