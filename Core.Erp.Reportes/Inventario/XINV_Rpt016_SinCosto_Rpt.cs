...
{
    public partial class XINV_Rpt016_SinCosto_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();

        public XINV_Rpt016_SinCosto_Rpt()
        {
            InitializeComponent();
        }

        
        private void XINV_Rpt016_SinCosto_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XINV_Rpt015_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XINV_Rpt016_SinCosto_Rpt) };
            }
