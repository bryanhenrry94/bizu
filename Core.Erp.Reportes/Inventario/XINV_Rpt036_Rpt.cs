...
{
    public partial class XINV_Rpt036_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        public List<int?> IdLinea_List = new List<int?>();

        public XINV_Rpt036_Rpt()
        {
            InitializeComponent();
        }
        ...
        private void XINV_FJ_Rpt006_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                XINV_Rpt036_Bus BUS = new XINV_Rpt036_Bus();

                List<XINV_Rpt036_Info> ListDataRpt = new List<XINV_Rpt036_Info>();
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XINV_FJ_Rpt006_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XINV_Rpt036_Rpt) };
            }
        }
