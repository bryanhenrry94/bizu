...
{
    public class XINV_Rpt035_Data
    {
        string MensajeError = "";

        public List<XINV_Rpt035_Info> Get_List(DateTime Fecha_desde, DateTime Fecha_hasta, int IdEmpresa, int IdSucursal, List<int> lst_bodega, decimal IdProducto, string idUsuario, bool No_mostrar_valores_en_0, bool Mostrar_detallado, string IdCategoria, List<int> List_IdLinea)
        {
            try
            {
                ...
                List<XINV_Rpt035_Info> List = new List<XINV_Rpt035_Info>();
                ...
                using (Entities_Inventario_General context = new Entities_Inventario_General())
                {
                    ...
                    foreach (var item_bodega in lst_bodega)
                    {
                        ...
                        foreach (var item in lst)
                        {
                            ...
                            XINV_Rpt035_Info info = new XINV_Rpt035_Info();
