...
{
    public partial class XINV_Rpt034_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        List<XINV_Rpt034_Info> List_Info = new List<XINV_Rpt034_Info>();
        XINV_Rpt034_Bus Bus_Rpt = new XINV_Rpt034_Bus();
        List<int> lst_bodega = new List<int>();
        public List<int> List_IdLinea;

        public XINV_Rpt034_rpt()
        {
            InitializeComponent();
        ...
        public void set_lst_bodega(List<int> lst_bodega_int)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XINV_Rpt034_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XINV_Rpt034_rpt) };
            }
        }

        private void XINV_Rpt034_rpt_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
