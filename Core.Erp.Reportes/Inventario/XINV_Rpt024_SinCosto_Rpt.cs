...
{
    public partial class XINV_Rpt024_SinCosto_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();

        string msg = "";
        public XINV_Rpt024_SinCosto_Rpt()
        {
            InitializeComponent();
        }

        private void XINV_Rpt024_SinCosto_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                xrLUsuario.Text = param.IdUsuario;
                lblFechaImpresion.Text = DateTime.Now.ToString("dddd, dd' de 'MMMM' de 'yyyy HH:mm:ss");
                xlbl_idReporte.Text = "XINV_Rpt024_SinCosto_Rpt";
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XINV_Rpt024_SinCosto_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XINV_Rpt024_SinCosto_Rpt) };
            }
        }
