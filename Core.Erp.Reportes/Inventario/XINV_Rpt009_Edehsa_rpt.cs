...
{
    public partial class XINV_Rpt009_Edehsa_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public XINV_Rpt009_Edehsa_rpt()
        {
            InitializeComponent();
            xlbl_idReporte.Text = "XINV_Rpt009_Edehsa_rpt";
        ...
        private void XINV_Rpt009_Edehsa_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XINV_Rpt009_Edehsa_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XINV_Rpt009_Edehsa_rpt) };
            }
        }
