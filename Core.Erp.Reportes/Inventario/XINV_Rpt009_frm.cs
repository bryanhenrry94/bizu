...
namespace Core.Erp.Reportes.Inventario
{
    public partial class XINV_Rpt009_frm : Form
    {
        ...
        void CargarGrid()
        {
            try
            {
                if (!Convert.ToBoolean(ucInv_Menu.beiCheck3.EditValue))
                {
                    XINV_Rpt009_Edehsa_rpt Reporte_Edehsa = new XINV_Rpt009_Edehsa_rpt();
                    ...
                    Reporte_Edehsa.Parameters["FechaIni"].Value = Convert.ToDateTime(ucInv_Menu.dtpDesde.EditValue).Date;
                    Reporte_Edehsa.Parameters["FechaFin"].Value = Convert.ToDateTime(ucInv_Menu.dtpHasta.EditValue).Date;
                ...
                {
                    XINV_Rpt009_Consolidado_rpt Reporte_Edehsa = new XINV_Rpt009_Consolidado_rpt();
        ...
        private void XINV_Rpt009_frm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ucInv_Menu.cmbSucursal.EditValue = param.IdSucursal;
            }
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
        ...
        private void ucInv_Menu_event_btnImprimir_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            DateTime Fecha_corte = param.Fecha_Transac.Date;
            ...
            Fecha_corte = Convert.ToDateTime(ucInv_Menu.dtpHasta.EditValue).Date;
