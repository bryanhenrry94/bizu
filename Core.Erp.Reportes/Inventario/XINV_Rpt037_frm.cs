...
{
    public partial class XINV_Rpt037_frm : Form
    {
        ...
        void ucInv_MenuReportes1_event_tnConsultar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                XINV_Rpt037_Rpt rpt = new XINV_Rpt037_Rpt();
        ...
        private void XINV_Rpt037_frm_Load(object sender, EventArgs e)
        {
