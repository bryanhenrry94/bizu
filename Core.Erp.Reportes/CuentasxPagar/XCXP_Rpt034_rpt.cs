...
{
    public partial class XCXP_Rpt034_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        
        
        public XCXP_Rpt034_rpt()
        {
            InitializeComponent();
            lblUsuario1.Text = param.IdUsuario;
        }

        private void XCXP_Rpt034_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                XCXP_Rpt034_Bus repbus = new XCXP_Rpt034_Bus();

                List<XCXP_Rpt034_Info> ListDataRpt = new List<XCXP_Rpt034_Info>();
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XCXP_Rpt034_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XCXP_Rpt034_rpt) };
            }
        }
