...
{
    public partial class XCXP_Rpt039_frm : Form
    {
        ...
        public XCXP_Rpt039_frm()
        {
            InitializeComponent();
        }

        private void XCXP_Rpt039_frm_Load(object sender, EventArgs e)
        {
            cargarCombo();
        ...
        private void btn_imprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                XCXP_Rpt039_Rpt Reporte = new XCXP_Rpt039_Rpt();
