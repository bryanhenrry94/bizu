...
{
    public partial class XCXP_Rpt040_frm : Form
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();

        public XCXP_Rpt040_frm()
        {
            InitializeComponent();
        ...
        void ucCxp_MenuReportes1_event_tnConsultar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                XCXP_Rpt040_Rpt rpt = new XCXP_Rpt040_Rpt();
                ...
                rpt.Parameters["IdProveedorIni"].Value = (ucCxp_MenuReportes1.cmbProveedor.EditValue == null || Convert.ToDecimal(ucCxp_MenuReportes1.cmbProveedor.EditValue) == 0) ? 0 : Convert.ToInt32(ucCxp_MenuReportes1.cmbProveedor.EditValue);
                rpt.Parameters["IdProveedorFin"].Value = (ucCxp_MenuReportes1.cmbProveedor.EditValue == null || Convert.ToDecimal(ucCxp_MenuReportes1.cmbProveedor.EditValue) == 0) ? 9999999 : Convert.ToInt32(ucCxp_MenuReportes1.cmbProveedor.EditValue);
        ...
        private void XCXP_Rpt040_frm_Load(object sender, EventArgs e)
        {
