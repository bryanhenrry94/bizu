    ...
    public partial class XCXP_Rpt030_Rpt_Sin_Agrupar : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void XCXP_Rpt030_Rpt_Sin_Agrupar_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XCXP_Rpt030_Rpt_Sin_Agrupar_BeforePrint", ex.Message), ex) { EntityType = typeof(XCXP_Rpt030_Rpt_Sin_Agrupar) };
            }
        }
        ...
        private void xrSubreport1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "set_parametros", ex.Message), ex) { EntityType = typeof(XCXP_Rpt030_Rpt_Sin_Agrupar) };
            }
        }
