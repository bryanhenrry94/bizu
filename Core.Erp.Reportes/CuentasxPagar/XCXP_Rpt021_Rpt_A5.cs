    ...
    public partial class XCXP_Rpt021_Rpt_A5 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void XCXP_Rpt021_Rpt_A5_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XCXP_Rpt021_Rpt_A5_BeforePrint", ex.Message), ex) { EntityType = typeof(XCXP_Rpt021_Rpt_A5) };
            }
        }
        ...
        private void xrSubreportNotaCredito_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "xrSubreportNotaCredito_BeforePrint", ex.Message), ex) { EntityType = typeof(XCXP_Rpt021_Rpt_A5) };
            }
        }
        ...
        private void xrSubreportRetenciones_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "xrSubreportRetenciones_BeforePrint", ex.Message), ex) { EntityType = typeof(XCXP_Rpt021_Rpt_A5) };
            }
        }
