...
{
    public partial class XFAC_Rpt015_frm : Form
    {

        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;        

        public XFAC_Rpt015_frm()
        {
            InitializeComponent();
        ...
        void ConsultarDatos()
        {
            try
            {
                XFAC_Rpt015_Rpt Reporte = new XFAC_Rpt015_Rpt();
                string tipoPago = "";
                ...
                Reporte.Parameters["IdClienteFin"].Value = (ucFa_Menu.cmbCliente.EditValue == null || 
                    Convert.ToDecimal(ucFa_Menu.cmbCliente.EditValue) == 0) ? 999999 : ucFa_Menu.cmbCliente.EditValue;                
                ...
                Reporte.Parameters["IdVendedorIni"].Value = (ucFa_Menu.cmbVendedor.EditValue == null) ? 0 : ucFa_Menu.cmbVendedor.EditValue;
                Reporte.Parameters["IdVendedorFin"].Value = (ucFa_Menu.cmbVendedor.EditValue == null || Convert.ToDecimal(ucFa_Menu.cmbVendedor.EditValue) == 0) ? 999999 : ucFa_Menu.cmbVendedor.EditValue;
