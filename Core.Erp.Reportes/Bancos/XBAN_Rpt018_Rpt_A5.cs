    ...
    public partial class XBAN_Rpt018_Rpt_A5 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void XBAN_Rpt018_Rpt_A5_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XBAN_Rpt018_Rpt_A5_BeforePrint", ex.Message), ex) { EntityType = typeof(XBAN_Rpt018_Rpt_A5) };
            }
        }
        ...
        private void ref_xban_rpt019_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "set_parametros", ex.Message), ex) { EntityType = typeof(XBAN_Rpt018_Rpt_A5) };
            }
        }
    }
}
