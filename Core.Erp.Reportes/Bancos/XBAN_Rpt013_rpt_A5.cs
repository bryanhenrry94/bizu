...
{
    public partial class XBAN_Rpt013_rpt_A5 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void XBAN_Rpt013_rpt_A5_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XBAN_Rpt013_rpt_A5_BeforePrint", ex.Message), ex) { EntityType = typeof(XBAN_Rpt013_rpt_A5) };   
            }
        }
    }
}