namespace Core.Erp.Reportes.Contabilidad
{
    partial class XCONTA_Rpt023_frm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.uCct_Menu_Reportes = new Core.Erp.Reportes.Controles.UCct_Menu_Reportes();
            ...
            this.uCct_Menu_Reportes.event_btnConsultar_ItemClick += new Core.Erp.Reportes.Controles.UCct_Menu_Reportes.delegate_btnConsultar_ItemClick(this.uCct_Menu_Reportes1_event_btnConsultar_ItemClick);
            this.uCct_Menu_Reportes.event_btnSalir_ItemClick += new Core.Erp.Reportes.Controles.UCct_Menu_Reportes.delegate_btnSalir_ItemClick(this.uCct_Menu_Reportes_event_btnSalir_ItemClick);
            this.uCct_Menu_Reportes.event_btnImprimir_ItemClick += new Core.Erp.Reportes.Controles.UCct_Menu_Reportes.delegate_btnImprimir_ItemClick(this.uCct_Menu_Reportes_event_btnImprimir_ItemClick);
