...
namespace Core.Erp.Reportes.Contabilidad
{
    public partial class XCONTA_Rpt006_frm : Form
    {
        ...
        public void Procesar()
        {
            try
            {
                ...
                if (rb_x_diferentes_cuentas.Checked)
                {
                    ...
                    var query = from ch in listCtas_Select
                                select ch.IdCtaCble;  

                    //MessageBox.Show("rth ..."+query);
        ...
        private void gridViewPlanCuenta_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
