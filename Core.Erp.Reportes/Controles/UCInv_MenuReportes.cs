...
namespace Core.Erp.Reportes.Controles
{
    public partial class UCInv_MenuReportes : UserControl
    {
        ...
        public string CaptionCheck3
        {
            get { return this.beiCheck3.Caption; }
        ...
        public DevExpress.XtraBars.BarItemVisibility VisiblecmbLineaMultiple
        {
            get { return this.cmbLinea_nultiple.Visibility; }
            set { this.cmbLinea_nultiple.Visibility = value; }
        }
        ...
        private void UCInv_MenuReportes_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                lstProductoInfo = busProducto.Get_list_Producto_cmb(param.IdEmpresa);
                ...
                cmb_Linea_multiple.DataSource = ListLinea;
        ...
        public List<int> Get_list_Linea_Cheked()
        {
            try
            {
                ...
                var listIdCC_Cheked = (from CheckedListBoxItem item in cmb_Linea_multiple.Items
