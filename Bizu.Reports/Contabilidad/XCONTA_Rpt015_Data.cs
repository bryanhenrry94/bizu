...
{
    public class XCONTA_Rpt015_Data
    {
        ...
        public List<XCONTA_Rpt015_Info> consultar_data(int IdEmpresa, List<ct_Periodo_Info> listPeriodo, string IdCentroCosto, int IdNivel_a_mostrar
            ...
            , bool MostrarCC, string IdUsuario, bool Considerar_Asiento_cierre_anual, ref String MensajeError)
                {
                    try
                    {
                        ...
                        {
                            list_data_Periodo_data = Get_data_Mayorizado_x_fecha(itemPeriodo.IdEmpresa, itemPeriodo.pe_FechaIni, itemPeriodo.pe_FechaFin, IdCentroCosto, IdNivel_a_mostrar, IdPunto_cargo_grupo, IdPunto_cargo, Mostrar_reg_Cero, MostrarCC, IdUsuario, Considerar_Asiento_cierre_anual, ref MensajeError);

                            nMes = listMeses.FirstOrDefault(v => v.idMes == itemPeriodo.pe_mes).nemonico;
                            Nom_Periodo = itemPeriodo.IdanioFiscal.ToString() + "-" + nMes;

                            foreach (var item in list_data_Periodo_data)
                            {
                       ...
                       , IdPunto_cargo_grupo, IdPunto_cargo, Mostrar_reg_Cero, MostrarCC, IdUsuario, Considerar_Asiento_cierre_anual, ref MensajeError);
                        ...
                        List<XCONTA_Rpt015_Info> listadedatos = new List<XCONTA_Rpt015_Info>();

                        foreach (var item_data in ListaCtasCbles_x_cbtes_con_movi)
                        {
                            XCONTA_Rpt015_Info Info = new XCONTA_Rpt015_Info();
        ...
        public List<XCONTA_Rpt015_Info> consultar_data_x_RangoFecha(int IdEmpresa, List<ct_Periodo_Info> listPeriodo, string IdCentroCosto, int IdNivel_a_mostrar
            , int IdPunto_cargo_grupo
            , int IdPunto_cargo
            , bool Mostrar_reg_Cero
            , bool MostrarCC, string IdUsuario, bool Considerar_Asiento_cierre_anual, ref String MensajeError)
                {
                    try
                    {
                        ct_Plancta_Data Plan_cta_data = new ct_Plancta_Data();
                        List<ct_Plancta_Info> list_plan_cta = new List<ct_Plancta_Info>();
                        List<string> List_IdCentroCosto = new List<string>();
                        ...
                        List_IdCentroCosto.Add(IdCentroCosto);
                        ...
                        foreach (var itemPeriodo in listPeriodo)
                        {
                            ...
                            list_data_Periodo_data = Get_data_Mayorizado_x_RangoFecha(itemPeriodo.IdEmpresa,
                                itemPeriodo.pe_FechaIni,
                                itemPeriodo.pe_FechaFin,
                                List_IdCentroCosto,
                                IdNivel_a_mostrar,
                                IdPunto_cargo_grupo,
                                IdPunto_cargo,
                                Mostrar_reg_Cero,
                                MostrarCC,
                                Considerar_Asiento_cierre_anual,
                                IdUsuario, ref MensajeError);
                        ...
                        list_data_Periodo_Actual = Get_data_Mayorizado_x_RangoFecha(
                            Periodo_Info_Actual.IdEmpresa,
                            Periodo_Info_Actual.pe_FechaIni,
                            Periodo_Info_Actual.pe_FechaFin,
                            List_IdCentroCosto,
                            IdNivel_a_mostrar,
                            IdPunto_cargo_grupo,
                            IdPunto_cargo,
        ...
        private List<XCONTA_Rpt002_Info> Get_data_Mayorizado_x_fecha(int IdEmpresa, DateTime FechaIni, DateTime FechaFin, string IdCentroCosto, int IdNivel_a_mostrar
            , int IdPunto_cargo_grupo
            , int IdPunto_cargo
        ...
        private List<XCONTA_Rpt002_Info> Get_data_Mayorizado_x_RangoFecha(int IdEmpresa, DateTime FechaIni, DateTime FechaFin, List<string> ListIdCentroCosto
            , int IdNivel_a_mostrar
            , int IdPunto_cargo_grupo
            , int IdPunto_cargo
            , bool Mostrar_reg_en_cero
