...
{
    public partial class XCONTA_Rpt012_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public XCONTA_Rpt012_Rpt()
        {
            InitializeComponent();
        }

        private void XCONTA_Rpt012_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                string msg = "";
                XCONTA_Rpt012_Bus Bus = new XCONTA_Rpt012_Bus();
                List<XCONTA_Rpt012_Info> lista = new List<XCONTA_Rpt012_Info>();
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XCONTA_Rpt001_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XCONTA_Rpt001_rpt) };
            }
        }
