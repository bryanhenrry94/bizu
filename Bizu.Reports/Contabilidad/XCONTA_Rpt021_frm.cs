...
{
    public partial class XCONTA_Rpt021_frm : Form
    {
        #region Variables
        ...
        XCONTA_Rpt021_Info Info_Fila = new XCONTA_Rpt021_Info();
        #endregion
       
        public XCONTA_Rpt021_frm()
        {
            InitializeComponent();
        }
        ...
        private void XCONTA_Rpt021_frm_Load(object sender, EventArgs e)
        {
            try
            {
                carga_combos();
        ...
        private void btnCargarReporte_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                lista = Bus.consultar_data(IdEmpresa, FechaIni,FechaFin, IdCentroCosto,
                    IdNivel_a_mostrar, IdPunto_cargo_grupo, IdPunto_cargo, chkMostrar_Reg_Cero.Checked,chkMostrar_CC.Checked,true,param.IdUsuario , ref msg);
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                XCONTA_Rpt021_rpt Reporte = new XCONTA_Rpt021_rpt();
                ...
                Reporte.PConsiderar_Asiento_cierre_anual.Value = chkConsiderar_Asiento_cierre_anual.Checked;
        ...
        private void treeListBG_FocusedNodeChanged(object sender, FocusedNodeChangedEventArgs e)
        {
            try
            {
                ...
                Info_Fila = new XCONTA_Rpt021_Info();
            }
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
        ...
        private void gw_balance_comp_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            try
            {
                Info_Fila = (XCONTA_Rpt021_Info)gw_balance_comp.GetFocusedRow();
