...
{
    public partial class XCONTA_Rpt020_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();


        public XCONTA_Rpt020_rpt()
        {
            InitializeComponent();
        }
        ...
        private void XCONTA_Rpt020_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XCONTA_Rpt020_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XCONTA_Rpt020_rpt) };   
            }
