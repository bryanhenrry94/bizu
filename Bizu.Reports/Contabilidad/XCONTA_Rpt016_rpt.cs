    ...
    public partial class XCONTA_Rpt016_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void set_periodo(List<ct_Periodo_Info> lista_periodo_a_buscar_)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XCONTA_Rpt016_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XCONTA_Rpt016_rpt) };
            }
        }
        ...
        private void GroupHeader2_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GroupHeader2_BeforePrint", ex.Message), ex) { EntityType = typeof(XCONTA_Rpt016_rpt) };
            }
        }
