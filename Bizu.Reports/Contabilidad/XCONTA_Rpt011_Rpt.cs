...
{
    public partial class XCONTA_Rpt011_Rpt : DevExpress.XtraReports.UI.XtraReport
    {

        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();

        public XCONTA_Rpt011_Rpt()
        {
            InitializeComponent();
        }

        private void XCONTA_Rpt011_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                string msg = "";
                XCONTA_Rpt011_Bus Bus = new XCONTA_Rpt011_Bus();
                ...
                lista = Bus.consultar_data(IdEmpresa, IdPeriodo, IdCentroCosto,
                    IdNivel_a_mostrar, IdPuntoCargo_Grupo, IdPuntoCargo, Mostrar_Reg_en_cero,Mostrar_CC,param.IdUsuario , ref msg);
