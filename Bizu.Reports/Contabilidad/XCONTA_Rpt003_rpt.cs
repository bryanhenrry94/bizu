    ...
    public partial class XCONTA_Rpt003_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void set_parametros(int IdEmpresa, int IdTipoCbte, decimal IdCbteCble)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "set_parametros", ex.Message), ex) { EntityType = typeof(XCONTA_Rpt003_rpt) };   
            }
        }
        ...
        private void XCONTA_Rpt003_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XCONTA_Rpt003_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XCONTA_Rpt003_rpt) };   
            }
