    ...
    public partial class XCONTA_Rpt018_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void XCONTA_Rpt018_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XCONTA_Rpt018_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XCONTA_Rpt018_rpt) };
            }
        }
        ...
        private void Remover_columnas()
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Remover_columnas", ex.Message), ex) { EntityType = typeof(XCONTA_Rpt018_rpt) };
            }
        }
    }
}
