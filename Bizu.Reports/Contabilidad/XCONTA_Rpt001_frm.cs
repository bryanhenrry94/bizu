...
{
    public partial class XCONTA_Rpt001_frm : Form
    {
        #region Variables
        ...
        private void XCONTA_Rpt001_frm_Load(object sender, EventArgs e)
        {
            try
            {
                carga_combos();
        ...
        private void btnCargarReporte_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //{
                //    if (item.GrupoCble.Trim() == "PASIVO" || item.GrupoCble.Trim() == "PATRIMONIO") 
                //    {
        ...
        private void btnImprimir_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                XCONTA_Rpt001_rpt Reporte = new XCONTA_Rpt001_rpt();
        ...
        private void btnImprimirExcel_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                lista = Bus.consultar_data(IdEmpresa, FechaIni, FechaFin,
                    IdCentroCosto, IdNivel_a_mostrar, IdPunto_cargo_grupo, IdPunto_cargo, Mostrar_Reg_en_cero, Mostrar_CC, true, param.IdUsuario, ref msg);

                gridControlCatalogo.DataSource = lista.ToArray();
        ...
        private void btn_imprimir_grilla_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
