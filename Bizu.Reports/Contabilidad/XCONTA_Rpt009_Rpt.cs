    ...
    public partial class XCONTA_Rpt009 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void Set_Parametros(int IdEmpresa, decimal IdConciliacion_caja)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Set_Parametros", ex.Message), ex) { EntityType = typeof(XCONTA_Rpt009) };
            }
        }
        ...
        private void XCONTA_Rpt009_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XCONTA_Rpt009_BeforePrint", ex.Message), ex) { EntityType = typeof(XCONTA_Rpt009) };
            }
        }
