...
{
    public partial class Inv_Reporte_CG : UserControl
    {
        #region Data
        ...
        public event UCInv_MenuReportes_2.delegate_btnConsultar_ItemClick event_tnConsultar_ItemClick;
        public delegate void delegate_btnImprimir_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e);
        public event UCInv_MenuReportes_2.delegate_btnImprimir_ItemClick event_btnImprimir_ItemClick;
        public delegate void delegate_btnSalir_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e);
        public event UCInv_MenuReportes_2.delegate_btnSalir_ItemClick event_btnSalir_ItemClick;
        #endregion
        ...
        private void Inv_Reporte_CG_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void beiLinea_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
