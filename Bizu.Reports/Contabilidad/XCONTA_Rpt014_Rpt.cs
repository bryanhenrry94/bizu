    ...
    public partial class XCONTA_Rpt014_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void Set_list_grupo_cble(List<string> List)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Set_list_grupo_cble", ex.Message), ex) { EntityType = typeof(XCONTA_Rpt014_Rpt) };
            }
        }
        private void XCONTA_Rpt014_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XCONTA_Rpt014_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XCONTA_Rpt014_Rpt) };
            }
        }
