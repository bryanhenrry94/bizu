...
{
   public class XCONTA_Rpt011_Data
    {
          ...
          ,bool Mostrar_cc,string IdUsuario, ref String MensajeError)
       {
           try
           {
               ...
               using (EntitiesContabilidadRptGeneral Estado_Resultado = new EntitiesContabilidadRptGeneral())
               {
                   ...
                   Estado_Resultado.spCON_Mayorizar_x_fecha_corte(IdEmpresa, FechaIni, FechaFin, IdCentroCosto, IdPunto_cargo_grupo, IdPunto_cargo, Mostrar_reg_en_cero, Mostrar_cc, true, IdUsuario).ToList();
