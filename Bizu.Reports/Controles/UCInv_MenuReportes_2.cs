...
public partial class UCInv_MenuReportes_2 : UserControl
    {
        ...
        List<in_Marca_Info> lst_Marca = new List<in_Marca_Info>();
        in_Marca_Info info_Marca = new in_Marca_Info();
        ...
        public Boolean VisibleMarca
        {
            get { return this.GrupoMarca.Visible; }
            set { this.GrupoMarca.Visible = value; }
        }
        ...
        public Boolean VisibleGrupoGuiaRemision
        {
            get { return this.GrupoGuiaRemision.Visible; }
            set { this.GrupoGuiaRemision.Visible = value; }
        }
        ...
        public DevExpress.XtraBars.BarItemVisibility VisibleCmbTipoMovInveMultiple
        {
            get { return this.cmbTipoMovInve_Multiple.Visibility; }
            set { this.cmbTipoMovInve_Multiple.Visibility = value; }
        }
        ...
        public DevExpress.XtraBars.BarItemVisibility VisibleCmb_Linea
        {
            get { return this.beiLinea.Visibility; }
            set { this.beiLinea.Visibility = value; }
        }
        public DevExpress.XtraBars.BarItemVisibility VisibleCmb_Linea_Multiple
        {
            get { return this.beiLineaMultiple.Visibility; }
            set { this.beiLineaMultiple.Visibility = value; }
        }

        public DevExpress.XtraBars.BarItemVisibility VisibleCheckedItem_1
        {
            get { return this.chk_checked_item_1.Visibility; }
            set { this.chk_checked_item_1.Visibility = value; }
        }

        public string Titulo_Checked_Item_1
        {
            get { return this.chk_checked_item_1.Caption; }
            set { this.chk_checked_item_1.Caption = value; }
        }
        ...
        private void UCInv_MenuReportes_2_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                CmbTipoMov_Grid_Multiple.DataSource = lstMoviTipiInfo.OrderBy(q => q.IdMovi_inven_tipo).ToList();
                ...
                cmb_Linea_Multiple.DataSource = lst_Linea;

                lst_Marca = bus_Marca.Get_list_Marca(param.IdEmpresa);
                cmb_Marca.DataSource = lst_Marca;
            }
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
        ...
        public in_Marca_Info Get_info_Marca()
        {
            try
            {
                info_Marca = new in_Marca_Info();

                if (beiMarca.EditValue != null )
                {
                    info_Marca = lst_Marca.FirstOrDefault(q => q.IdMarca == Convert.ToInt32(beiMarca.EditValue));
                }
                else
                    info_Marca = null;
        ...
        private void beiMarca_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                if (beiMarca.EditValue != null)
                {
                    int idMarca = Convert.ToInt32(beiMarca.EditValue);
                    List<in_Marca_Info> ListMarca_temp = new List<in_Marca_Info>();

                    lst_Marca = bus_Marca.Get_list_Marca(param.IdEmpresa);


                    ListMarca_temp = lst_Marca.Where(q => q.IdMarca == idMarca).ToList();

                    cmb_Marca.DataSource = null;
                    cmb_Marca.DataSource = ListMarca_temp;
                }
                else
                    cmb_Marca.DataSource = lst_Marca;
            }
        ...
        public List<int?> Get_list_Linea_Cheked()
        {
            try
            {
                ...
                var list_checked = (from CheckedListBoxItem item in cmb_Linea_Multiple.Items
        ...
        public List<int?> Get_list_TipoMoviInven_Cheked()
        {
            try
            {
                List<int?> lista = new List<int?>();

                var list_checked = (from CheckedListBoxItem item in CmbTipoMov_Grid_Multiple.Items
                                       where item.CheckState == CheckState.Checked
                                       select (int?)item.Value).ToArray();
