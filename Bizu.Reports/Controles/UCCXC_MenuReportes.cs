...
namespace Bizu.Reports.Controles
{
    public partial class UCCXC_MenuReportes : UserControl
    {
        ...
        public Boolean VisibleGrupoVendedorProvincia
        {
            get { return this.GrupoVendedorProvincia.Visible; }
            set { this.GrupoVendedorProvincia.Visible = value; }
        }

        public Boolean VisibleGrupoFitroFechaVenc
        {
            get { return this.GrupoFitroFechaVenc.Visible; }
            set { this.GrupoFitroFechaVenc.Visible = value; }
        }
        ...
        public DevExpress.XtraBars.BarItemVisibility VisibleCheked1
        {
            get { return this.barEditItemChk.Visibility; }
            set { this.barEditItemChk.Visibility = value; }
        }

        public DevExpress.XtraBars.BarItemVisibility VisibleCheked2
        {
            get { return this.barEditItem2.Visibility; }
            set { this.barEditItem2.Visibility = value; }
        }

        public DevExpress.XtraBars.BarItemVisibility VisibleCheked3
        {
            get { return this.barEditItem3.Visibility; }
            set { this.barEditItem3.Visibility = value; }
        }

        public DevExpress.XtraBars.BarItemVisibility VisibleCheked4
        {
            get { return this.badEditItem4.Visibility; }
            set { this.badEditItem4.Visibility = value; }
        }

        public DevExpress.XtraBars.BarItemVisibility VisibleCheked5
        {
            get { return this.barEditItem4.Visibility; }
            set { this.barEditItem4.Visibility = value; }
        }
        ...
        {
            get { return this.barEditItem2.Caption; }
            set { this.barEditItem2.Caption = value; }
        }

        public string TextCheck3
        {
            get { return this.barEditItem3.Caption; }
            set { this.barEditItem3.Caption = value; }
        }

        public string TextCheck4
        {
            get { return this.barEditItem4.Caption; }
            set { this.barEditItem4.Caption = value; }
        }

        public string TextCheck5
        {
            get { return this.barEditItem5.Caption; }
            set { this.barEditItem5.Caption = value; }
        }
        ...
        private void UCCXC_MenuReportes_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                badEditItem4.Caption = "Solo Facturas";
                barEditItem4.Caption = "Notas Débito";
