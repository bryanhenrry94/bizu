...
namespace Bizu.Reports.Controles
{
    public partial class UCACTF_Menu_Reportes : UserControl
    {
        ...
        public void LlenarCombo_EnumerdoresAlerta()
        {
            try
            {
                var query = (from int n in Enum.GetValues(typeof(Bizu.Reports.Compras.XCOMP_Rpt007_Info.eAlerta))
                             select new
                             {
                                 n,
                                 key = Enum.GetName(typeof(Bizu.Reports.Compras.XCOMP_Rpt007_Info.eAlerta), n)
                             });
