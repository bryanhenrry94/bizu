...
{
public partial class UCInv_MenuReportes_3 : UserControl
    {
        #region Data
        ...
        public DevExpress.XtraBars.BarItemVisibility VisibleCmb_Marca
        {
            get { return this.beiMarca.Visibility; }
            set { this.beiMarca.Visibility = value; }
        }

        public DevExpress.XtraBars.BarItemVisibility VisibleCmb_Marca_Multiple
        {
            get { return this.beiMarca_Multiple.Visibility; }
            set { this.beiMarca_Multiple.Visibility = value; }
        }

        //public DevExpress.XtraBars.BarItemVisibility VisibleCmbCategoria
        //{
        //    get { return this.cmb_Categoria.Visibility; }
        //    set { this.cmb_Categoria.Visibility = value; }
        //}

        //public DevExpress.XtraBars.BarItemVisibility VisibleCmbMarca
        //{
        //    get { return this.cmb_Marca.Visibility; }
        //    set { this.cmb_Marca.Visibility = value; }
        //}
        ...
        public UCInv_MenuReportes_3()
        {
            InitializeComponent();
            event_btnImprimir_ItemClick += UCInv_MenuReportes_3_event_btnImprimir_ItemClick;
            event_btnSalir_ItemClick += UCInv_MenuReportes_3_event_btnSalir_ItemClick;
            event_tnConsultar_ItemClick += UCInv_MenuReportes_3_event_tnConsultar_ItemClick;            
        }
    
        void UCInv_MenuReportes_3_event_tnConsultar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
        ...
        void UCInv_MenuReportes_3_event_btnSalir_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
        ...
        void UCInv_MenuReportes_3_event_btnImprimir_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
        ...
        private void UCInv_MenuReportes_3_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                cmb_Marca_Multiple.DataSource = lst_Marca;                
            }
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
