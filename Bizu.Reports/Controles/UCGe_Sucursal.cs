...
namespace Bizu.Reports.Controles
{
    public partial class UCGe_Sucursal : UserControl
    {
        ...
        public UCGe_Sucursal()
        {
            ...
            Event_cmb_sucursal_EditValueChanged += UCGe_Sucursal_Event_cmb_sucursal_EditValueChanged;
        }

        void UCGe_Sucursal_Event_cmb_sucursal_EditValueChanged(object sender, EventArgs e)
        {
