    ...
    public partial class XBAN_Rpt011_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void set_parametros(int IdEmpresa, int IdBanco, int IdConciliacion)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "set_parametros", ex.Message), ex) { EntityType = typeof(XBAN_Rpt011_rpt) };   
        ...
        private void XBAN_Rpt011_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XBAN_Rpt011_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XBAN_Rpt011_rpt) };   
