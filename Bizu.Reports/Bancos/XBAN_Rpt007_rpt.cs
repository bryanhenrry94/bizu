    ...
    public partial class XBAN_Rpt007_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void set_parametros(List<int> lst_tipo_flujo)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "set_parametros", ex.Message), ex) { EntityType = typeof(XBAN_Rpt007_rpt) };
            }
        }
        ...
        private void XBAN_Rpt007_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XBAN_Rpt007_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XBAN_Rpt007_rpt) };   
            }
        }
        ...
        private void SubReport_SaldoInicial_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "SubReport_SaldoInicial_BeforePrint", ex.Message), ex) { EntityType = typeof(XBAN_Rpt007_rpt) };
            }
        }
        ...
        private void SubReport_SaldoFinal_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "SubReport_SaldoFinal_BeforePrint", ex.Message), ex) { EntityType = typeof(XBAN_Rpt007_rpt) };
            }
        }
        ...
        private void GroupFooter_TipoFlujo_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GroupFooter_TipoFlujo_BeforePrint", ex.Message), ex) { EntityType = typeof(XBAN_Rpt007_rpt) };
            }
        }
