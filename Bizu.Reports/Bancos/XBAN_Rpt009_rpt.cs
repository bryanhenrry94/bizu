...
namespace Bizu.Reports.Bancos
{
    public partial class XBAN_Rpt009_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public Boolean ConsiderarAnulacionContable = false;
        ...
        private void XBAN_Rpt009_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                //if (ConsiderarAnulacionContable == true)
                //{
                //    lstInfo = rptBus.get_ReporteSaldoBancos_Considerar_IngEgr_X_AnulacionContable(IdEmpresa, fecha, FechaCorte);
                //}
                //else 
                //{
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XBAN_Rpt009_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XBAN_Rpt009_rpt) };   
            }
        }
