        ...
        XBAN_Rpt014_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void XBAN_Rpt014_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XBAN_Rpt013_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XBAN_Rpt014_rpt) };   
        ...
        private void xrSubreportDet_Depositado_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "xrSubreportDet_Depositado_BeforePrint", ex.Message), ex) { EntityType = typeof(XBAN_Rpt014_rpt) };   
