    ...
    public partial class XBAN_Rpt017_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void AsignarLista(List<ba_Cbte_Ban_Info> Lista)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AsignarLista", ex.Message), ex) { EntityType = typeof(XBAN_Rpt017_Rpt) };
            }
        }
        ...
        private void XBAN_Rpt017_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XBAN_Rpt017_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XBAN_Rpt017_Rpt) };
            }
        }
