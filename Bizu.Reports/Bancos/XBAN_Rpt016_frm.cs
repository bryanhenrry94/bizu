    ...
    public partial class XBAN_Rpt016_frm : Form
    {
        ...
        void ucBa_Menu_Reportes1_event_btnsalir_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ucBa_Menu_Reportes1_event_btnsalir_ItemClick", ex.Message), ex) { EntityType = typeof(XBAN_Rpt016_frm) };
        ...
        void ucBa_Menu_Reportes1_event_btnRefrescar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ucBa_Menu_Reportes1_event_btnRefrescar_ItemClick", ex.Message), ex) { EntityType = typeof(XBAN_Rpt016_frm) };
