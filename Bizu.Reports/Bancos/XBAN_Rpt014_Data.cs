  ...
  public  class XBAN_Rpt014_Data
    {
      ...
      public List<XBAN_Rpt014_Info> Get_Data_Reporte(int IdEmpresa, int IdTipocbte, decimal IdCbteCble, ref string MensajeError)
      {
          try
          {
              List<XBAN_Rpt014_Info> lstRpt = new List<XBAN_Rpt014_Info>();
              ...
              {
                  var select = from q in listado.vwBAN_Rpt014
                  ...
                  foreach (var item in select)
                  {
                      ...
                      XBAN_Rpt014_Info infoRpt = new XBAN_Rpt014_Info();
