...
namespace Bizu.Reports.Bancos
{
    public class XBAN_Rpt004_Data
    {
        ...
        public List<XBAN_Rpt004_Info> Cargar_data(int idempresa, DateTime FechaIni, DateTime FechaFin, int idBancoIni, int idBancoFin, string TipoCbte, /*string girado_A*/decimal IdPersona_Girado, string SchkImpreso, string Schkfacs)
        {
            ...
            try
            {
                ...
                using (EntitiesBancos_Reporte_Ge ListadoCbte = new EntitiesBancos_Reporte_Ge())
                {
                    ...
                    {
                        IQueryable<XBAN_Rpt004_Info> consulta = from h in ListadoCbte.vwBAN_Rpt004
                        ...
                        {
                            if (TipoCbte == "CHEQ" || TipoCbte == "NDBA")
                            {
