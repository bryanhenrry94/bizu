    ...
    public partial class XBAN_Rpt009_frm : Form
    {
        ...
        private void btn_Reporte_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.checkAnul.Checked == true)
                {
                    Reporte.ConsiderarAnulacionContable = true;
                }
                else
                {
                    Reporte.ConsiderarAnulacionContable =false;
                }

                Reporte.Parameters["IdEmpresa"].Value = param.IdEmpresa;
                Reporte.Parameters["fecha"].Value = Convert.ToDateTime(dte_fecha.EditValue).ToShortDateString();
                Reporte.Parameters["FechaCorte"].Value = Convert.ToDateTime(dte_FechaCorte.EditValue).ToShortDateString();
