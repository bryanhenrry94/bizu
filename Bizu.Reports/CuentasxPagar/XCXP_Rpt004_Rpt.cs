    ...
    public partial class XCXP_Rpt004_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void set_parametros(int IdEmpresa_, int IdTipoCbte_OG_, decimal IdCbteCble_Ogiro_)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "set_parametros", ex.Message), ex) { EntityType = typeof(XCXP_Rpt004_Rpt) };
        ...
        private void XCXP_Rpt004_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XCXP_Rpt004_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XCXP_Rpt004_Rpt) };
            }
