...
namespace Bizu.Reports.CuentasxPagar
{
    public partial class XCXP_Rpt002_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void XCXP_Rpt002_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XCXP_Rpt002_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XCXP_Rpt002_Rpt) };
            }
    ...
    {
        internal static readonly string IdUsuario;
    }
}
