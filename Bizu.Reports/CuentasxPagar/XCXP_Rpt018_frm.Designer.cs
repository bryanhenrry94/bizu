namespace Bizu.Reports.CuentasxPagar
{
    partial class XCXP_Rpt018_frm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ucCp_Menu_Reportes.Visible_Imprimir = DevExpress.XtraBars.BarItemVisibility.Always;
            this.ucCp_Menu_Reportes.event_btnRefrescar_ItemClick += new Bizu.Reports.Controles.UCCp_Menu_Reportes.delegate_btnRefrescar_ItemClick(this.ucCp_Menu_Reportes_event_btnRefrescar_ItemClick);
            this.ucCp_Menu_Reportes.event_btnsalir_ItemClick += new Bizu.Reports.Controles.UCCp_Menu_Reportes.delegate_btnsalir_ItemClick(this.ucCp_Menu_Reportes_event_btnsalir_ItemClick);
            this.ucCp_Menu_Reportes.event_btnimprimir_ItemClick += new Bizu.Reports.Controles.UCCp_Menu_Reportes.delegate_btnimprimir_ItemClick(this.ucCp_Menu_Reportes_event_btnimprimir_ItemClick);
            // 
            // XCXP_Rpt018_frm
            // 
