...
{
    public partial class XCXP_Rpt034_frm : Form
    {
        ...
        private void XCXP_Rpt034_frm_Load(object sender, EventArgs e)
        {
            try
            {
                cargarCombo();
        ...
        private void btn_Procesar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                XCXP_Rpt034_rpt Reporte = new XCXP_Rpt034_rpt();
