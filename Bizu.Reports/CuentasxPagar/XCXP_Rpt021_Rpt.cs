    ...
    public partial class XCXP_Rpt021_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void XCXP_Rpt021_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                this.DataSource = ListaRepor;
            }
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XCXP_Rpt021_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XCXP_Rpt021_Rpt) };
            }
        }
        ...
        private void xrSubreportNotaCredito_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "xrSubreportNotaCredito_BeforePrint", ex.Message), ex) { EntityType = typeof(XCXP_Rpt021_Rpt) };
            }
        }
        ...
        private void xrSubreportRetenciones_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "xrSubreportRetenciones_BeforePrint", ex.Message), ex) { EntityType = typeof(XCXP_Rpt021_Rpt) };
            }
        }
