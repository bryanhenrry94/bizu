    ...
    public class XFAC_Rpt008_Data
    {
        ...
        public List<XFAC_Rpt008_Info> get_ImpresionFactura(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdCbteVta)
        {
            try
            {
                ...
                {
                    var select = from q in ListadoDocu.vwFAC_Rpt008
                    ...
                    {
                        XFAC_Rpt008_Info infoRpt = new XFAC_Rpt008_Info();
                        ...
                        infoRpt.vt_detallexItems = item.vt_detallexItems;
                        infoRpt.IdFormaPago = item.IdFormaPago;
                        infoRpt.nom_FormaPago = item.nom_FormaPago;
