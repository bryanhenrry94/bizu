    ...
    public partial class XFAC_Rpt004_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void Set_lista_motivo(List<int> _lista)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Set_lista_motivo", ex.Message), ex) { EntityType = typeof(XFAC_Rpt004_rpt) };
            }
        }
        ...
        private void XFAC_Rpt004_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XFAC_Rpt004_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XFAC_Rpt004_rpt) };
            }
        }

       

        private void xrSubreportResumen_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "set_parametros", ex.Message), ex) { EntityType = typeof(XFAC_Rpt004_rpt) };
            }
        }
