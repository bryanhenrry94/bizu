    ...
    public partial class XFAC_Rpt002_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void XFAC_Rpt002_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                XFAC_Rpt002_Bus BusRes = new XFAC_Rpt002_Bus();
               //list_Info_resumen= BusRes.Get_List_Data_Reporte(IdEmpresa, IdSucursalIni, IdSucursalFin, IdClienteIni, IdClienteFin, FechaIni, FechaFin, TipoPago);
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XFAC_Rpt002_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XFAC_Rpt002_rpt) };
            }
        }

        private void xrSubreport_Resumen_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                //((XRSubreport)sender).ReportSource.DataSource = list_Info_resumen.ToArray();
