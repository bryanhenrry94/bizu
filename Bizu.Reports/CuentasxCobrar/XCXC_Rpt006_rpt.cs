    ...
    public partial class XCXC_Rpt006_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void XCXC_Rpt006_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                lstInfo = rptBus.get_RptCobros(IdEmpresa, IdSucursalIni, IdSucursalFin, IdClienteIni, IdClienteFin, FechaIni, FechaFin, listTipoCobro, TipoFecha, fech);
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XCXC_Rpt006_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XCXC_Rpt006_rpt) };
            }
        }
    }
}
