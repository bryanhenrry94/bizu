...
{
    public partial class XCXC_Rpt010_frm : Form
    {
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance; 

        public XCXC_Rpt010_frm()
        {
            InitializeComponent();
        ...
        void ConsultarDatos()
        {
            try
            {
                XCXC_Rpt010_rpt Reporte = new XCXC_Rpt010_rpt();
                ...
                Reporte.Parameters["IdSucursalFin"].Value = (uccxC_Menu.beiSucursal.EditValue == null || Convert.ToInt32(uccxC_Menu.beiSucursal.EditValue) == 0) ? 99999 : uccxC_Menu.beiSucursal.EditValue;
        ...
        private void XCXC_Rpt010_frm_Load(object sender, EventArgs e)
        {
            try
            {
