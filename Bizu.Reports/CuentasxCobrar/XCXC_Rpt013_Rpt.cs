...
namespace Bizu.Reports.CuentasxCobrar
{
    public partial class XCXC_Rpt013_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public Boolean RetenManual;
        public Boolean RetenElectronica;
        ...
        private void XCXC_Rpt013_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XCXC_Rpt006_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XCXC_Rpt013_Rpt) };
            }
        }
