...
{
    public partial class XINV_EDEHSA_Rpt001_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();

        public XINV_EDEHSA_Rpt001_Rpt()
        {
            InitializeComponent();
        }
        ...
        private void XINV_FJ_Rpt006_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                XINV_EDEHSA_Rpt001_Bus BUS = new XINV_EDEHSA_Rpt001_Bus();

                List<XINV_EDEHSA_Rpt001_Info> ListDataRpt = new List<XINV_EDEHSA_Rpt001_Info>();
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XINV_FJ_Rpt006_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XINV_EDEHSA_Rpt001_Rpt) };
            }
        }
