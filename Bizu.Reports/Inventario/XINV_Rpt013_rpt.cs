    ...
    public partial class XINV_Rpt013_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void Set_listas(List<int> _lst_bodega, List<string> _lst_subcentro)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Set_listas", ex.Message), ex) { EntityType = typeof(XINV_Rpt013_Rpt) };
            }
        }
        ...
        private void XINV_Rpt013_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XINV_Rpt013_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XINV_Rpt013_Rpt) };
            }
        }
