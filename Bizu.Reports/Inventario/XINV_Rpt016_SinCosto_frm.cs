...
{
    public partial class XINV_Rpt016_SinCosto_frm : Form
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();

        public XINV_Rpt016_SinCosto_frm()
        {
            InitializeComponent();
        }

        private void XINV_Rpt016_SinCosto_frm_Load(object sender, EventArgs e)
        {
            CargarCombos();
        }
        ...
        void CargarReporte()
        {
            try
            {
                XINV_Rpt016_SinCosto_Rpt Reporte = new XINV_Rpt016_SinCosto_Rpt();
