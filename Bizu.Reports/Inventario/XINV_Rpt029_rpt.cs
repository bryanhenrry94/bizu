    ...
    public partial class XINV_Rpt029_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void set_lista(List<int> _lst_bod)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "set_lista", ex.Message), ex) { EntityType = typeof(XINV_Rpt029_rpt) };
            }
        }
        ...
        private void XINV_Rpt029_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XINV_Rpt029_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XINV_Rpt029_rpt) };
            }
        }
