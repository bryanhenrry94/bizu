...
{
    public partial class XINV_Rpt035_frm : Form
    {
        #region variables
        ...
        private void ucInv_MenuReportes1_event_tnConsultar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                if (Mostrar_detallado )
                {
                    ...
                    XINV_Rpt035_rpt rpt = new XINV_Rpt035_rpt();
                    ...
                    rpt.P_IdCategoria.Value = ucInv_MenuReportes1.cmbCategoria.EditValue == null ? "0" : Convert.ToString(ucInv_MenuReportes1.cmbCategoria.EditValue);
                    rpt.List_IdLinea = ucInv_MenuReportes1.Get_list_Linea_Cheked();
                ...
                {
                    XINV_Rpt034_rpt rpt = new XINV_Rpt034_rpt();
        ...
        private void XINV_Rpt035_frm_Load(object sender, EventArgs e)
        {
