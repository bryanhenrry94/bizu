...
{
    public partial class XINV_Rpt034_frm : Form
    {        
        cl_parametrosGenerales_Bus param= cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        
        public XINV_Rpt034_frm()
        {
            InitializeComponent();
        ...
        void CargarGrid()
        {
            try 
            {	  
                XINV_Rpt034_rpt Reporte = new XINV_Rpt034_rpt();
                ...
                Reporte.Parameters["IdProductoFin"].Value = (ucInv_Menu.cmbProducto.EditValue == null || Convert.ToInt32(ucInv_Menu.cmbProducto.EditValue) == 0) ? 999999 : Convert.ToInt32(ucInv_Menu.cmbProducto.EditValue);
        ...
        private void XINV_Rpt034_frm_Load(object sender, EventArgs e)
        {
            try
            {
