...
{
    public partial class XINV_Rpt027_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void Set_lst_bodega(List<int> lst_bodega_int)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XINV_Rpt026_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XINV_Rpt025_Rpt) };
            }
        }

        private void XINV_Rpt027_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
