    ...
    public partial class XINV_Rpt024_SinCosto_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void XINV_Rpt024_SinCosto_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XINV_Rpt024_SinCosto_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XINV_Rpt024_SinCosto_Rpt) };
            }
        }
