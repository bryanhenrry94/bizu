...
{
    public partial class XINV_Rpt036_frm : Form
    {
        ...
        void ucInv_MenuReportes1_event_tnConsultar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                XINV_Rpt036_Rpt rpt = new XINV_Rpt036_Rpt();
                ...
                rpt.Parameters["IdCategoria"].Value = ucInv_MenuReportes1.bei_Categoria.EditValue == null || ucInv_MenuReportes1.bei_Categoria.EditValue == null ? "" : ucInv_MenuReportes1.bei_Categoria.EditValue;
                ...
                rpt.Parameters["Considerar_saldo_inicial"].Value = ucInv_MenuReportes1.chk_checked_item_1.Checked;
                
                rpt.IdLinea_List = ucInv_MenuReportes1.Get_list_Linea_Cheked();          
        ...
        private void XINV_Rpt036_frm_Load(object sender, EventArgs e)
        {
