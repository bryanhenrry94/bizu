    ...
    public partial class XCOMP_Rpt003_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void set_parametros(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdNumMovi, int IdMovi_inven_tipo)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "set_parametros", ex.Message), ex) { EntityType = typeof(XCOMP_Rpt003_Rpt) };
            }
        }
        ...
        private void XCOMP_Rpt003_Rpt_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XCOMP_Rpt003_Rpt_BeforePrint_1", ex.Message), ex) { EntityType = typeof(XCOMP_Rpt003_Rpt) };
            }
        }
