    ...
    public partial class XCAJ_Rpt004_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void Set_Parametros(decimal IdConciliacion_caja)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Set_Parametros", ex.Message), ex) { EntityType = typeof(XCAJ_Rpt004_Rpt) };
            }
        }
        ...
        private void XCAJ_Rpt004_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "XCAJ_Rpt004_BeforePrint", ex.Message), ex) { EntityType = typeof(XCAJ_Rpt004_Rpt) };
            }
        }
