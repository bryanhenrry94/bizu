...
{
    public partial class FrmFa_CotizacionCliente_consu : DevExpress.XtraEditors.XtraForm
    {
        int fila = -1;
        ...
        FrmFa_CotizacionCliente_Mant frm = new FrmFa_CotizacionCliente_Mant();
        ...
        public FrmFa_CotizacionCliente_consu()
        {
            try
            {
                InitializeComponent();
                ...
                frm.Event_frmFA_Pedido_Mant_FormClosing += new FrmFa_CotizacionCliente_Mant.delegate_frmFA_Pedido_Mant_FormClosing(frm_Event_frmFA_Pedido_Mant_FormClosing);
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnAnular_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                {
                    frm = new FrmFa_CotizacionCliente_Mant();
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnconsultar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                {
                    frm = new FrmFa_CotizacionCliente_Mant(info.IdSucursal, info.IdBodega);
                    // frm.Event_frmFA_Pedido_Mant_FormClosing += new frmFa_Pedido_Mant_GE.delegate_frmFA_Pedido_Mant_FormClosing(frm_Event_frmFA_Pedido_Mant_FormClosing);
                    frm.Event_frmFA_Pedido_Mant_FormClosing += new FrmFa_CotizacionCliente_Mant.delegate_frmFA_Pedido_Mant_FormClosing(frm_Event_frmFA_Pedido_Mant_FormClosing);
                    info.lista_detalle = pedido_det_bus.Get_List_pedido_det(param.IdEmpresa, info.IdSucursal, info.IdBodega, info.IdPedido);
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnModificar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    frm = new FrmFa_CotizacionCliente_Mant(InfoSu.IdSucursal, 1);
        ...
        private void frmFA_Pedido_General_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Facturacion.FrmFa_CotizacionCliente_consu");
