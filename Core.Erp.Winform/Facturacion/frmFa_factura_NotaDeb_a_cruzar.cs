...
{
    public partial class frmFa_factura_NotaDeb_a_cruzar : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
        ...
        public void Cargar_combos(decimal IdCliente)
        {
            try
            {
                ...
                {
                    Lst_FactNotaDeb_x_cruzar = Bus_FactNotaDeb_x_cruzar.Get_list_docs_x_cruzar_SinSaldo(param.IdEmpresa, IdCliente);
