...
{
    public partial class frmFa_Bodega : DevExpress.XtraEditors.XtraForm
    {
        ...
        public tb_Bodega_Info get_Bodega()
        {
            try
            {
                ...
                info.IdCentroCosto = ucCon_CentroCosto_ctas_Movi.get_item() == "" ? null : ucCon_CentroCosto_ctas_Movi.get_item();
