...
{
    public partial class frmFa_Factura_Consulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void frmFA_Factura_Consulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Facturacion.frmFa_Factura_Consulta");
