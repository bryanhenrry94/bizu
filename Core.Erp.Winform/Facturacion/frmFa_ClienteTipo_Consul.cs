...
{
    public partial class frmFa_ClienteTipo_Consul : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmFa_ClienteTipo_Consul_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Facturacion.frmFa_ClienteTipo_Consul");
