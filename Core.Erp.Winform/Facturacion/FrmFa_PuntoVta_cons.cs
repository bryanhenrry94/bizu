...
{
    public partial class FrmFa_PuntoVta_cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmFa_PuntoVta_cons_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Facturacion.FrmFa_PuntoVta_cons");
