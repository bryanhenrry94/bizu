...
{
    public partial class frmFa_Orden_Despacho_cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmFA_Orden_Despacho_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Facturacion.frmFa_Orden_Despacho_cons");
