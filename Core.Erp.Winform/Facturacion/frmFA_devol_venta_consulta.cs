...
{
    public partial class frmFa_devol_venta_consulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmFA_devol_venta_consulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Facturacion.frmFa_devol_venta_consulta");
