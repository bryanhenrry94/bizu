...
{
    public partial class FrmSeg_Login_x_Empresas : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void cmb_empresa_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
        ...
        private void cmb_sucursal_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Enter)
