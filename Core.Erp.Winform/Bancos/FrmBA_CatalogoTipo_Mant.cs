...
{
    public partial class FrmBA_CatalogoTipo_Mant : DevExpress.XtraEditors.XtraForm
    {
                ...
                if (validar())
                {
                    if (Bus.ValidarCodigoExiste(_Info.IdTipoCatalogo) == false)
                    {
                        ...
                        if (Bus.GuardarDB(ref _Info))
                        {
                            ...
                            string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El Tipo de Catálogo", _Info.IdTipoCatalogo);
            ...
            try
            {
                if (validar())
                {
                    if (Bus.ModificarDB(ref _Info))
                    {
                        ...
                        string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El Tipo de Catálogo ", _Info.IdTipoCatalogo);
                        MessageBox.Show(smensaje, param.Nombre_sistema);
                    }
                    else
                    {
            ...
            try
            {
                switch (_Accion)
                {
                    case Cl_Enumeradores.eTipo_action.grabar:
                        ...
                        ucGe_Menu.Visible_bntLimpiar = DevExpress.XtraBars.BarItemVisibility.Always;
                        //btnAnular.Enabled = DevExpress.XtraBars.BarItemVisibility.Never;
                        break;
                    case Cl_Enumeradores.eTipo_action.actualizar:
                        ucGe_Menu.Visible_bntGuardar_y_Salir = DevExpress.XtraBars.BarItemVisibility.Always;
                        ucGe_Menu.Visible_btnGuardar = DevExpress.XtraBars.BarItemVisibility.Always;
