...
{
    public partial class FrmBA_TipoDeFlujoMant : DevExpress.XtraEditors.XtraForm
    {
        ...
        void set() 
        {
            try
            {
                ...
                if (SetInfo.Tipo == "EGR")
                {
                    rbt_Egreso.Checked = SetInfo.Tipo == "EGR" ? true : false;
                }
                else
                {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (MessageBox.Show("¿Está seguro que desea anular Tipo de Flujo  ?", "Anulación de Tipo de Flujo  " + param.Nombre_sistema, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        ...
                        {
                            MessageBox.Show("El registro ha sido anulado con éxito", param.Nombre_sistema);
