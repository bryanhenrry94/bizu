...
{
    public partial class FrmBA_Prestamos_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmBA_Prestamos_Cons_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Bancos.FrmBA_Prestamos_Cons");
