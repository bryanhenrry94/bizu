...
{
    public partial class frmBA_DespositoBancarioConsulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmBA_ChequesConsulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Bancos.frmBA_DespositoBancarioConsulta");
