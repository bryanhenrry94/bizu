...
{
    public partial class FrmBA_DepositoBancario_Varios_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FrmBA_DepositoBancario_Varios_Cons()
        {
            InitializeComponent();
        ...
        public void load_data()
        {
            try
            {
                ...
                nc = paramBa_I.First(q => q.CodTipoCbteBan == "DEPO").IdTipoCbteCble;
        ...
        private void PrepararFrm(Cl_Enumeradores.eTipo_action Accion, ba_Cbte_Ban_Info Info)
        {
            try
            {
                FrmBA_DepositoBancario_Varios_Mant frmNC = new FrmBA_DepositoBancario_Varios_Mant();
                frmNC.event_FrmBA_DepositoBancario_Varios_Mant_FormClosing += frmNC_event_FrmBA_Credito_Mant_FormClosing;
        ...
        private void FrmBA_DepositoBancario_Varios_Cons_Load(object sender, EventArgs e)
        {
            try
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Bancos.FrmBA_DepositoBancario_Varios_Cons");
