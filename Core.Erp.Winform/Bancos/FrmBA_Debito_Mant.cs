...
{
    public partial class FrmBA_Debito_Mant : DevExpress.XtraEditors.XtraForm
    {
        # region 'delegados'
        //Delegados
        ...
        public FrmBA_Debito_Mant()
        {
            try
            {
                ...
                ucGe_Beneficiario1.event_cmb_beneficiario_EditValueChanged += ucGe_Beneficiario1_event_cmb_beneficiario_EditValueChanged;
            }
            catch (Exception ex)
            {
                string NameMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
        ...
        private void cargar_OP_Pendientes_x_Beneficiario()
        {
            try
            {
                if (_Accion == Cl_Enumeradores.eTipo_action.grabar)
                {
                    List_BingList_orden_pago_con_cancelacion = new BindingList<vwcp_orden_pago_con_cancelacion_Info>(Bus_orden_pago_con_cancelacion.Get_List_orden_pago_con_cancelacion_Mayor_a_cero_x_OrdenPago(param.IdEmpresa,
                        InfoBeneficiario.IdTipo_Persona, InfoBeneficiario.IdPersona, InfoBeneficiario.IdEntidad, "APRO"));
