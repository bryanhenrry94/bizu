...
{
    public partial class FrmBA_DepositoBancario_Varios_Mant : DevExpress.XtraEditors.XtraForm
    {
        //Bus
        int bandera = 0;
        ...
        public delegate void delegate_FrmBA_DepositoBancario_Varios_Mant_FormClosing(object sender, FormClosingEventArgs e);
        public event delegate_FrmBA_DepositoBancario_Varios_Mant_FormClosing event_FrmBA_DepositoBancario_Varios_Mant_FormClosing;
                             
        public FrmBA_DepositoBancario_Varios_Mant()
        {
            InitializeComponent();
            ...
            try
            {
                ...
                event_FrmBA_DepositoBancario_Varios_Mant_FormClosing += FrmBA_DepositoBancario_Varios_Mant_event_FrmBA_DepositoBancario_Varios_Mant_FormClosing;
        ...
        void FrmBA_DepositoBancario_Varios_Mant_event_FrmBA_DepositoBancario_Varios_Mant_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            try
            {
                ...
                if (MessageBox.Show("¿Está seguro que desea anular dicho Comprobante?" + "\n También se procederá con la liberación de los pagos de las órdenes de giro seleccionadas", "Anulación de Comprobante", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    if (Respuesta)
                    {
                        ...
                        info_ba_Cbte_Ban.FechaAnulacion = fechaAnul;
        ...
        private void FrmBA_DepositoBancario_Varios_Mant_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FrmBA_DepositoBancario_Varios_Mant_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
               event_FrmBA_DepositoBancario_Varios_Mant_FormClosing(sender, e);
            }
            catch (Exception ex)
            {
                string NameMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
        ...
        private void cmb_TipoMovCaj_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                lista = cxc_B.Get_List_Cobros_x_depositar_Agrupado_x_cobro(param.IdEmpresa, Convert.ToString(cmb_TipoMovCaj.Text));
