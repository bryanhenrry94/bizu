       ...
       public event delegate_cmb_beneficiario_EditValueChanged event_cmb_beneficiario_EditValueChanged;
        ...
        private void llamar_Formulario(Cl_Enumeradores.eTipo_action Accion)
        {
            try
            {
                ...
                {                                        
                    if (Info.General.Cl_Enumeradores.eCliente_Vzen.EDEHSA == param.IdCliente_Ven_x_Default)
                    {
                        Core.Erp.Winform.General_Edehsa.frmGe_MantPersona frmPersona = new Core.Erp.Winform.General_Edehsa.frmGe_MantPersona();
