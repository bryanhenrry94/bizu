    ...
    public partial class UCBa_Parametros : UserControl
    {
        ...
        private void UCBa_Parametros_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                chk_NotificacionCheque.Checked = Convert.ToBoolean(InfoParam_x_Banco.pa_notificacion_cheque);
                chk_NotificacionChequeAuto.Checked = Convert.ToBoolean(InfoParam_x_Banco.pa_notificacion_cheque_auto);
        ...
        public void getGrid()
        {
            try
            {
                ...
                if (cmbTipoCbteCble_x_Presta.get_TipoCbteCble() != null)
                {
                ...
                InfoBancoOtroParam.pa_notificacion_cheque = chk_NotificacionCheque.Checked;
                InfoBancoOtroParam.pa_notificacion_cheque_auto = chk_NotificacionChequeAuto.Checked;
            }
            catch (Exception ex)
            {
                string NameMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
        ...
        private void chkDiarioModi_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void chk_NotificacionCheque_CheckedChanged(object sender, EventArgs e)
        {
            chk_NotificacionChequeAuto.Visible = chk_NotificacionCheque.Checked;
        }
    }
}