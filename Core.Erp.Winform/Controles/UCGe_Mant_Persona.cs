    ...
    public partial class UCGe_Mant_Persona : UserControl
    {
        ...
        private void IniciarControles()
        {
            try
            {
                ...
                cmb_TipoDocumento_Acreditacion.Properties.DataSource = lEstado;
            }
            catch (Exception ex)
            {
                string NameMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
        ...
        public void get_Persona()
        {
            try
            {
                ...
                _PersonaInfo.IdBanco_acreditacion = UCGe_Banco.get_BancoInfo().IdBanco;
                _PersonaInfo.IdTipoDocumento_acreditacion = Convert.ToString(cmb_TipoDocumento_Acreditacion.EditValue);
                _PersonaInfo.cedulaRuc_acreditacion = Convert.ToString(txt_cedulaRuc_Acreditacion.EditValue);
                _PersonaInfo.beneficiario_acreditacion = Convert.ToString(txt_Beneficiario_Acreditacion.EditValue);
                _PersonaInfo.correo_acreditacion = Convert.ToString(txt_correo_acreditacion.EditValue);
            }
            catch (Exception ex)
            {
                string NameMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
        ...
        public void set_Persona_in_controls()
        {
            try
            {
                ...
                {
                    UCGe_Banco.cmb_Banco.EditValue = Convert.ToInt32(_PersonaInfo.IdBanco_acreditacion);
                    UCGe_Banco.Refresh();
                }
                ...
                cmb_TipoDocumento_Acreditacion.EditValue = _PersonaInfo.IdTipoDocumento_acreditacion;
                txt_cedulaRuc_Acreditacion.EditValue = _PersonaInfo.cedulaRuc_acreditacion;
                txt_Beneficiario_Acreditacion.EditValue = _PersonaInfo.beneficiario_acreditacion;
                txt_correo_acreditacion.EditValue = _PersonaInfo.correo_acreditacion;
            }
            catch (Exception ex)
            {
                string NameMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
