...
namespace Core.Erp.Winform.Controles
{
    public partial class UCIn_Categoria_Linea : UserControl
    {
        ...
        public delegate void delegate_cmb_linea_EditValueChanged(object sender, EventArgs e);
        public event delegate_cmb_linea_EditValueChanged event_delegate_cmb_linea_EditValueChanged;
        ...
        public UCIn_Categoria_Linea()
        {
            ...
            event_delegate_cmb_linea_EditValueChanged += UCIn_Categoria_Linea_event_delegate_cmb_linea_EditValueChanged;
        }
        ...
        void UCIn_Categoria_Linea_event_delegate_cmb_linea_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void cmb_linea_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                event_delegate_cmb_linea_EditValueChanged(sender, e);

                if (GrupoList.Count == 0)
                {
                    MessageBox.Show("No existen grupos asociados a esta Linea, revise antes de continuar!!", param.NombreEmpresa, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        public void set_item_Grupo_Linea_NoDisponible()
        {
            ...
            if (SubGrupoList.Count == 0)
            {
                MessageBox.Show("No existen Subgrupos asociados a este Grupo, revise antes de continuar!!", param.NombreEmpresa, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                cmb_grupo.EditValue = null;
                return;
            }
