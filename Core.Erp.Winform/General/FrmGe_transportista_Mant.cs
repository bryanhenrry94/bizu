...
{
    public partial class FrmGe_transportista_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        void GetTransportista()
        {
            try
            {
                ...
                Info_Transp.IdTipoDocumento = info_doc_personal.codigo;
        ...
        void SetTransportista()
        {
            try
            {
                ...
                UC_Doc_per.set_TipoDoc_Personales(SetInfo.IdTipoDocumento);
            }
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
        ...
        Boolean Validar()
        {
            try
            {
                if (this.UC_Doc_per.cmb_Docum_perso.Text == "")
                {
                    MessageBox.Show("Seleccione el Tipo de Identificacion", "Sistemas");
                    UC_Doc_per.cmb_Docum_perso.Focus();
                    return false;
                }
