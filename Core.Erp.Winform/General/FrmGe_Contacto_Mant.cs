...
{
    public partial class FrmGe_Contacto_Mant : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
        ...
        public void CargarDatos()
        {
            ...
            {               
                ...
                ucGe_PaisProvinciaCiudad.set_InfoCiudad(info_contacto.IdCiudad);
                ucGe_PaisProvinciaCiudad.set_InfoProvincia(info_contacto.IdProvincia);
                ucGe_PaisProvinciaCiudad.set_InfoPais(info_contacto.IdPais);
                cmbNacionalidad.SelectedValue = (info_contacto.IdNacionalidad == null) ? "0" : info_contacto.IdNacionalidad;                
