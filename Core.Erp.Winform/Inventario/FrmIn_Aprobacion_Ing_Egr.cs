...
{
    public partial class FrmIn_Aprobacion_Ing_Egr : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
        ...
        public void Buscar()
        {
            try
            {
                if (ucIn_Sucursal_Bodega1.get_bodega() == null || Convert.ToInt32(ucIn_Sucursal_Bodega1.cmb_bodega.EditValue) == 0)
                {
                    MessageBox.Show("Seleccione la bodega", "Sistemas");
                    return;
                }
                ...
                {
                    MessageBox.Show("Seleccione el Tipo de Movimiento Ingreso  /  Egreso ", "Sistemas");
                    return;
                }
