...
{
    public partial class FrmIn_Egresos_Inv_Multi_Bodega_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmIn_Egresos_Inv_Multi_Bodega_Cons_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Inventario.FrmIn_Egresos_Inv_Multi_Bodega_Cons");
