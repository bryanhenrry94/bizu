...
{
    public partial class FrmIn_Ajuste_Inven_fisico_Cons : DevExpress.XtraEditors.XtraForm
    {//Version 1.1
        ...
        private void frmIn_AjusteFisico_Consulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Inventario.FrmIn_Ajuste_Inven_fisico_Cons");
