...
{
    public partial class FrmIn_Motivo_Inven_Cons : DevExpress.XtraEditors.XtraForm
    { 
        ...
        {
            //Control de Usuario
            Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Inventario.FrmIn_Motivo_Inven_Cons");
