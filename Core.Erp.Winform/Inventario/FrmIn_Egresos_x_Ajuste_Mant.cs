...
{
    public partial class FrmIn_Egresos_x_Ajuste_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FrmIn_Egresos_x_Ajuste_Mant()
        {
            InitializeComponent();
            ...
            event_FrmIn_Egreso_varios_Mant_FormClosing += FrmIn_Egresos_x_Ajuste_Mant_event_FrmIn_Egreso_varios_Mant_FormClosing;
        ...
        void FrmIn_Egresos_x_Ajuste_Mant_event_FrmIn_Egreso_varios_Mant_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        void FrmIn_Egresos_x_Ajuste_Mant_event_FrmIn_Ingreso_varios_Mant_FormClosing(object sender, FormClosingEventArgs e)
        {           
        }
        
        private void FrmIn_Egresos_x_Ajuste_Mant_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            try
            {
                ...
                if (ValidarAnulacion_x_Estado())
                {
                    ...
                    if (bus_IngEgr.AnularDB(info_IngEgr, ref mensaje))
                    {
                        ...
                        //***** SE OMITE ESTE PASO PORQUE LA FUNCION DE ARRIBA YA REALIZA LA ANULACION DEL MOVIMIENTO DE INVENTARIO Y DE LOS COMPROBANTES DE DIARIO ******
            ...
            try
            {
                ...
                switch (Accion)
                {
                    case Cl_Enumeradores.eTipo_action.grabar:
                        ...
                        decimal IdNumMovi = 0;
                        bus_IngEgr = new in_Ing_Egr_Inven_Bus();
                        if (bus_IngEgr.GuardarDB_x_Ajuste(info_IngEgr, ref   IdNumMovi, ref mensaje))
                        {
                    ...
                    case Cl_Enumeradores.eTipo_action.actualizar:
                        ...
                        bus_IngEgr = new in_Ing_Egr_Inven_Bus();
                        if (bus_IngEgr.ModificarDB_x_Ajuste(info_IngEgr, ref mensaje))
                        {
                            MessageBox.Show(mensaje, param.Nombre_sistema);
                            LimpiarDatos();
                        }
       ...
       private void gridViewProductos_KeyDown(object sender, KeyEventArgs e)
            ...
            try
            {
                ...
                if (e.Column == coldm_cantidad_sin_conversion) 
                {
                    if (info_parametros.Maneja_Stock_Negativo == "N")
                    {
                        ...
                        {                            
                            var ItemProd_Busc = listProducto.FirstOrDefault(p => p.IdProducto == InfoDet.IdProducto);
        ...
        private void FrmIn_Egresos_x_Ajuste_Mant_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                foreach (var item in List_Bind_IngEgrDet)
                {
                   ...
                   // info_parametros.
                    ...
                    if (info_parametros.Maneja_Stock_Negativo == "N")
                    {
                        ...
                        {
                            var ItemProd_Busc = listProducto.FirstOrDefault(p => p.IdProducto == item.IdProducto);

                            if (item.dm_cantidad_sinConversion > ItemProd_Busc.pr_stock)
                            {
                                MessageBox.Show("Item: " + ItemProd_Busc.pr_descripcion + " no puede ser mayor al stock");
                                item.dm_cantidad_sinConversion = Convert.ToDouble(ItemProd_Busc.pr_stock);
                                return false;
                            }
