...
{
    public partial class FrmIn_Catalogo_Tipo_Mant : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
        ...
        Boolean Guardar()
        {
            ...
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El tipo de Catálogo ", Info.IdCatalogo_tipo);
        ...
        Boolean Actualizar()
        {
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El Catálogo", Info.IdCatalogo_tipo);
                    MessageBox.Show(smensaje, param.Nombre_sistema);
                    LimpiarDatos();
                    return true;
                }
