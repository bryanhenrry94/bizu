...
{
    public partial class FrmIn_Aprobacion_despacho : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
        ...
        private void Buscar_movi_inven_x_despachar()
        {
            try
            {
                blist_movi_inven = new BindingList<in_movi_inve_Info>(bus_movi_inven.Get_list_Movi_inven_x_despachar(param.IdEmpresa, Convert.ToInt32(ucIn_Sucursal_Bodega1.cmb_sucursal.EditValue), Convert.ToInt32(ucIn_Sucursal_Bodega1.cmb_bodega.EditValue)));
