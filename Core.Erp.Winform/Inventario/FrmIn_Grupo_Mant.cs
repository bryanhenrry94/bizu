...
{
    public partial class FrmIn_Grupo_Mant : DevExpress.XtraEditors.XtraForm
    {
        #region variables
        //Bus
        ...
        void Guardar()
        {
            try
            {
                ...
                {
                    msgRecurso = "El registro ha sido guardado con éxito";
        ...
        void Actualizar()
        {
            try
            {
                ...
                {
                    msgRecurso = "Error al Modificar:   {0}";
        ...
        void Anular()
        {
            try
            {
                ...
                {
                    msgRecurso = "El registro ha sido anulado con éxito";
                    MessageBox.Show(msgRecurso, param.Nombre_sistema,MessageBoxButtons.OK,MessageBoxIcon.Information);
                    lblAnulado.Visible = true;
                    ucGe_Menu.Visible_bntAnular = DevExpress.XtraBars.BarItemVisibility.Never;
                }
