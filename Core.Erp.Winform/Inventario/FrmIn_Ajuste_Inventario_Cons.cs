...
{
    public partial class FrmIn_Ajuste_Inventario_Cons : DevExpress.XtraEditors.XtraForm
    {
       ...
       private void frmIn_AjustesInven_Cosulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Inventario.FrmIn_Ajuste_Inventario_Cons");
