...
namespace Core.Erp.Winform.Inventario
{
    ...
    public partial class FrmIn_Producto_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void set_producto_in_controls()
        {
            try
            {
                txtIdProducto.EditValue = Info_Producto.IdProducto.ToString();
                txtDescripcion2.EditValue = Info_Producto.pr_descripcion_2;
                ...
                txtCodigo.EditValue = Info_Producto.pr_codigo;
                ...
                txtNombre.EditValue = Info_Producto.pr_descripcion;
        ...
        public in_Producto_Info Get_producto()
        {
            try
            {
                ...
                Info_Producto.pr_descripcion = Convert.ToString(txtNombre.EditValue);
                Info_Producto.IdPresentacion = null;
                Info_Producto.pr_descripcion_2 = Convert.ToString(txtDescripcion2.EditValue);
                ...
                Info_Producto.IdProducto = Convert.ToDecimal(txtIdProducto.EditValue);
                ...
                Info_Producto.pr_codigo = Convert.ToString(txtCodigo.EditValue);
                Info_Producto.pr_codigo_barra = null;
                ...
                Info_Producto.pr_partidaArancel = "";
                ...
                Info_Producto.Aparece_modu_Activo_F = true;
                Info_Producto.Aparece_modu_Compras = true;
            ...
            try
            {
                ...
                foreach (var item in LBinProxProve)
                {
                    if (item.NomProducto_en_Proveedor != "")
                    {
                        ...
                        pxp_inf.IdProducto = Convert.ToInt32(txtIdProducto.EditValue);
        ...
        public Boolean Validaciones()
        {
            try
            {
                ...
                {
                    if (!prob.ValidarNombreItem(param.IdEmpresa, Convert.ToString(txtNombre.EditValue)))
                    {
                        MessageBox.Show("El Nombre del Propducto " + Convert.ToString(txtNombre.EditValue) + " Ya se Encuentra Ingresado", "Sistemas", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        return false;
                    }
                }
        ...
        public Boolean Actualizar()
        {
            try
            {
                ...
                if (!(Info_Producto == null))
                {
                    ...
                    pxpbus.eliminarRegistro_x_producto(param.IdEmpresa, Convert.ToInt32(txtIdProducto.EditValue), ref MensajeError);
                    pxpbus.Grabar_Producto_Proveedor_lista(lm_prod_x_prove, param.IdEmpresa, Convert.ToInt32(txtIdProducto.EditValue), ref MensajeError);

                    busComposicion.eliminarRegistro_x_producto(param.IdEmpresa, Convert.ToInt32(txtIdProducto.EditValue), ref MensajeError);
                    busComposicion.GrabarDB(lsComposicionProducto, Convert.ToInt32(txtIdProducto.EditValue), ref MensajeError);
                    ...
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El producto ", Info_Producto.IdProducto);
            ...
            try
            {
                ...
                if (!(Info_Producto == null))
                {
                    ...
                    if (Bus_Producto.GrabarDB(Info_Producto, ref idProducto, ref MensajeError))
                    {
                        ...
                        txtIdProducto.EditValue = idProducto;
                        ...
                        string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El producto ", idProducto);
                        MessageBox.Show(smensaje, param.Nombre_sistema);
                        resultB = true;
                    }
                    else
        ...
        public void load_grid()
        {
            try
            {
                ...
                listaProd_x_prove = _lm_prod_x_prove.FindAll(q => q.IdProducto == Convert.ToDecimal(txtIdProducto.EditValue));
        ...
        private void carga_ultragrid_composicion()
        {
            try
            {
                ...
                _lsComposicionProducto = bus.ObtenerListProductoComposicion(param.IdEmpresa, Convert.ToInt32(txtIdProducto.EditValue));
        ...
        private void carga_cmb_ProductoHijo()
        {
            try
            {
                ...
                List<in_Producto_Info> itemComp = ls.FindAll(q => q.IdProducto != Convert.ToDecimal(txtIdProducto.EditValue));
            ...
            try
            {
                ...
                foreach (var item in LBinProComposi)
                {
                    if (item.Cantidad != 0)
                    {
                        ...
                        info.IdProductoPadre = Convert.ToDecimal(txtIdProducto.EditValue);
        ...
        private void carga_dgvProductoBodega()
        {
            try
            {
                ...
                if (Convert.ToDecimal(txtIdProducto.EditValue) == 0)
                {
                ...
                else
                {
                    ...
                    lsProdBodega = busProductoBodega.Get_list_Productos_x_Bodega(param.IdEmpresa, Convert.ToDecimal(txtIdProducto.EditValue));
            ...
            try
            {
                ...
                foreach (var item in lst_Bod_x_Suc)
                {
                    if (item.Nivel == 2)
                    {
                        ...
                        info.IdProducto = Convert.ToInt32(txtIdProducto.EditValue);
        ...
        void LimpiarDatos()
        {
            try
            {
                ...
                txtDescripcion2.EditValue = null;
                txtIdProducto.EditValue = null;
                txtCodigo.EditValue = null;
                txeCostoCIF.EditValue = null;
                txeCostoFOB.EditValue = null;
                txeCostoPromedio.EditValue = null;
                txtObservacion.Text = "";
                txePrecioMayor.EditValue = null;
                txePrecioMinimo.EditValue = null;
                txePrecioPublico.EditValue = 0;
                txeStockMaximo.EditValue = null;
                txeStockminimo.EditValue = null;
                pibx_imagenPequeña.Image = null;
            }
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
        ...
        private void txtIdProducto_EditValueChanged(object sender, EventArgs e)
        {
            codigoBarraProducto.Text = Convert.ToString(txtIdProducto.EditValue);
