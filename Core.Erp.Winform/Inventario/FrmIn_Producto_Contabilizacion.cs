...
{
    public partial class FrmIn_Producto_Contabilizacion : DevExpress.XtraEditors.XtraForm
    {
        string MensajeError = "";
        ...
        {
            InitializeComponent();
            ucGe_Menu.btnGuardar.Caption = "Guardar";
        ...
        private void Cargar_Grid()
        {
            try
            {
                ...
                IdBodega = (IdSucursal == 0) ? 0 : Convert.ToInt32(ucIn_Sucursal_Bodega.cmb_bodega.EditValue);
        ...
        private void gridControlProducto_x_Bodg_Click(object sender, EventArgs e)
        {
        ...
        {
            gridControlProducto_x_Bodg.ShowRibbonPrintPreview();
        }
