...
{
    public partial class FrmIn_Productos_Actualizacion_Precios_Masivo : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FrmIn_Productos_Actualizacion_Precios_Masivo()
        {
            InitializeComponent();
        }
        ...
        private void FrmIn_Productos_Actuazacion_Precios_Macivamente_Cons_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ListMarca = BusMarca.Get_list_Marca_Filtro(param.IdEmpresa, "GENERAL");
        ...
        public void cargagrid()
        {
            try
            {
                IdSucursalIni = Convert.ToInt32(cmb_Sucursal_Bodega.cmb_sucursal.EditValue);
                if (IdSucursalIni == 0)
                {
                    IdSucursalIni = 1;
                    IdSucursalFin = 9999;
                ...
                {
                    IdSucursalIni = Convert.ToInt32(cmb_Sucursal_Bodega.cmb_sucursal.EditValue);
                    IdSucursalFin = Convert.ToInt32(cmb_Sucursal_Bodega.cmb_sucursal.EditValue);
                    IdBodegaIni = Convert.ToInt32(cmb_Sucursal_Bodega.cmb_bodega.EditValue) == 0 ? 1 : Convert.ToInt32(cmb_Sucursal_Bodega.cmb_bodega.EditValue);
                    IdBodegaFin = Convert.ToInt32(cmb_Sucursal_Bodega.cmb_bodega.EditValue) == 0 ? 9999 : Convert.ToInt32(cmb_Sucursal_Bodega.cmb_bodega.EditValue);
                }
            ...
            try
            {
                ...
                if (rbtValor.Checked == true)
                {
                    for (int i = 0; i < gridViewProductos.RowCount; i++)
                    {
                        if (Convert.ToBoolean(gridViewProductos.GetRowCellValue(i, colChecked)) == true)
                        {
                            ...
                            {
                                case 0:
                                    precio_publico = Convert.ToDecimal(gridViewProductos.GetRowCellValue(i, col_pr_precio_publico_nuevo));
                                    precio_publico += valor;                                                       
                                    gridViewProductos.SetRowCellValue(i, col_pr_precio_publico_nuevo, precio_publico);
                                                        
                                    break;

                                case 1:
                                    precio_mayor = Convert.ToDecimal(gridViewProductos.GetRowCellValue(i, col_pr_precio_mayor_nuevo));
                                    precio_mayor += valor;
                                    gridViewProductos.SetRowCellValue(i, col_pr_precio_mayor_nuevo, precio_mayor);

                                    break;

                                case 2:
                                    precio_minimo = Convert.ToDecimal(gridViewProductos.GetRowCellValue(i, col_pr_precio_minimo_nuevo));
                                    precio_minimo += valor;
                                    gridViewProductos.SetRowCellValue(i, col_pr_precio_minimo_nuevo, precio_minimo); 
                ...
                else
                {
                    for (int i = 0; i < gridViewProductos.RowCount; i++)
                    {
                        if (Convert.ToBoolean(gridViewProductos.GetRowCellValue(i, colChecked)) == true)
                        {
                            Porcentaje = Convert.ToDecimal(txtPorcentaje.EditValue);
            ...
            try
            {
                ...
                for (int i = 0; i < gridViewProductos.RowCount; i++)
                {
                    if (Convert.ToBoolean(gridViewProductos.GetRowCellValue(i, colChecked)) == true)
                    {
                        ...
                        Info.IdSucursal = Convert.ToInt32(cmb_Sucursal_Bodega.cmb_sucursal.EditValue);
                        ...
                        Info.producto_info.pr_precio_publico = Convert.ToDouble(gridViewProductos.GetRowCellValue(i, col_pr_precio_publico_nuevo));
                        Info.producto_info.pr_precio_mayor = Convert.ToDouble(gridViewProductos.GetRowCellValue(i, col_pr_precio_mayor_nuevo));
                        Info.producto_info.pr_precio_minimo = Convert.ToDouble(gridViewProductos.GetRowCellValue(i, col_pr_precio_minimo_nuevo));
        ...
        {      
            if (e.Column == col_pr_precio_mayor_nuevo || e.Column == col_pr_precio_minimo_nuevo || e.Column == col_pr_precio_publico_nuevo) 
            {                
                gridViewProductos.SetRowCellValue(e.RowHandle, colChecked, true);
            }
        }
