...
{
    public partial class FrmIn_Ingreso_x_OrdenCompra_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmIn_Ingreso_x_OrdenCompra_Cons_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Inventario.FrmIn_Ingreso_x_OrdenCompra_Cons");
