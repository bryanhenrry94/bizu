...
{
    public partial class frmCP_NotaCredito_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        sri_impuesto_Bus BusImpuestoSRI = new sri_impuesto_Bus();
        vwba_Cbte_Ban_detallePagos_Bus _CbteBan_B;
        vwba_ordenGiroPendientes_Bus OGP_B;
        cp_orden_pago_cancelaciones_Bus bus_PagoCance;
        cp_nota_DebCre_Impuesto_Bus BusNotaDebCre_Impuesto = new cp_nota_DebCre_Impuesto_Bus();
        ...
        // LIST
        List<cp_codigo_SRI_Info> ListaCodigoSri = new List<cp_codigo_SRI_Info>();
        ...
        List<sri_impuesto_Info> ListImpuestoSRI = new List<sri_impuesto_Info>();
        BindingList<vwcp_orden_pago_con_cancelacion_Info> BindList_Cancelacion;
        BindingList<cp_nota_DebCre_Impuesto_Info> BindingList_DesgloseIVA;
            ...
            try
            {
                if (Cargar_cancelacion)
                {
                    ...
                    if (ucCp_Proveedor1.get_ProveedorInfo() != null)
                    {
                        ...
                        lista_Cancelacion = bus_cancelacion.Get_List_orden_pago_con_cancelacion_Mayor_a_cero_Lite(param.IdEmpresa, "FACT_PROVEE", ucCp_Proveedor1.get_ProveedorInfo().IdProveedor, "APRO");
        ...
        void cargar_Combos()
        {
            try
            {
                ...
                ListaCodigoSri = dat_ti.Get_List_codigo_SRI_x_codigo(CodRetencion2, param.IdEmpresa);
                ...
                List_Pais_SRI = Bus_Pais_SRI.Get_List_Pais_SRI(ref MensajeError);
                cmbPais.Properties.DataSource = List_Pais_SRI;

                ListImpuestoSRI = BusImpuestoSRI.GetList();
                cmbImpuestoSRI.DataSource = ListImpuestoSRI;
            }
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
        ...
        public void get_notaCr()
        {
            try
            {
                ...
                // Le seteamos a la lista el bindinglist
                notaCr_I.ListNotaCredImpuesto = new List<cp_nota_DebCre_Impuesto_Info>(this.BindingList_DesgloseIVA);
            }
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
            ...
            try
            {
                ...
                foreach (var item in this.BindList_Cancelacion)
                {
                    if (item.Check == true)
                    {
                        ...
                        opcsinfo.FechaCancelacion = Convert.ToDateTime(dtE_Fecha.EditValue);
                        ...
                        opcsinfo.fechaTransaccion = param.Fecha_Transac;
        ...
        public void set_notaCr()
        {
            try
            {
                // Obtiene datos del desglose del IVA
                notaCr_I.ListNotaCredImpuesto = BusNotaDebCre_Impuesto.GetList(notaCr_I.IdEmpresa, notaCr_I.IdCbteCble_Nota, notaCr_I.IdTipoCbte_Nota);
                BindingList_DesgloseIVA = new BindingList<cp_nota_DebCre_Impuesto_Info>(notaCr_I.ListNotaCredImpuesto);
                gridControlOrdenGiroImpuesto.DataSource = BindingList_DesgloseIVA;
                ...
                else
                {
                    if (_Accion == Cl_Enumeradores.eTipo_action.actualizar)
                    {
                        ...
                        lista_Cancelacion = bus_cancelacion.Get_List_orden_pago_con_cancelacion_Mayor_a_cero_Lite(param.IdEmpresa, "", ucCp_Proveedor1.get_ProveedorInfo().IdProveedor, "APRO");
        ...
        private Boolean Grabar()
        {
            ...
            try
            {
                ...
                {
                    foreach (var item in this.notaCr_I.ListNotaCredImpuesto)
                    {
                        // key
                        item.IdEmpresa = notaCr_I.IdEmpresa;
                        item.IdCbteCble_Nota = notaCr_I.IdCbteCble_Nota;
                        item.IdTipoCbte_Nota = notaCr_I.IdTipoCbte_Nota;

                        // Graba tabla impuesto
                        BusNotaDebCre_Impuesto.GrabarBD(item);
                    }
                    ...
                    string smensaje = string.Format("{0} # {1} se guardó con éxito.", "Nota de Crédito ", notaCr_I.IdCbteCble_Nota);
        ...
        private Boolean Actualizar()
        {
            try
            {
                ...
                {
                    // elimina
                    BusNotaDebCre_Impuesto.Eliminar(notaCr_I.IdEmpresa, notaCr_I.IdCbteCble_Nota, notaCr_I.IdTipoCbte_Nota);
                    ...
                    if (Respuesta)
                    {
                        string smensaje = string.Format("{0} # {1} se modificó con éxito.", "Nota de Crédito ", txE_NotaCre.EditValue);
                        MessageBox.Show(smensaje, param.Nombre_sistema);
                        Limpiar();
                    }
                }
        ...
        public Boolean validaColumna()
        {
            try
            {
                ...
                if (this.BindingList_DesgloseIVA.Count <= 0)
                {
                    MessageBox.Show("Ingrese informacion desglose de IVA", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return false;
                }
        ...
        private void frmCP_NotaCredito_Mant_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (BindingList_DesgloseIVA == null)
                {
                    BindingList_DesgloseIVA = new BindingList<cp_nota_DebCre_Impuesto_Info>();
                    gridControlOrdenGiroImpuesto.DataSource = BindingList_DesgloseIVA;
                }
        ...
        private void txeNumDocum_Validating(object sender, CancelEventArgs e)
        {
            try
            {
                ...
                if (numDocum != "" && ucCp_Proveedor1.get_ProveedorInfo() != null)
                {
            ...
            try
            {
                ...
                if (openFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    if ((myStream = openFileDialog1.OpenFile()) != null)
                    {
                        ...
                        if (InfoNotaCredito_SRI.infoNotaCredito == null)
                        {
                            MessageBox.Show("El archivo presenta problemas al momento de cargar la información en la estructura de la infoTributaria", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                            return;
                        }

                        if (InfoNotaCredito_SRI.infoTributaria.ambiente == "1")
                        {
                        ...
                        string Ruc_Proveedor = InfoNotaCredito_SRI.infoTributaria.ruc;
                        ...
                        if (ProveeInfo_ != null)
                        {
                            ...
                            {
                                MessageBox.Show("No existe un proveedor con este RUC q se encuentra en el xml Subido .. verifique \n\n" + "[" + Ruc_Proveedor + "]" + InfoNotaCredito_SRI.infoTributaria.razonSocial, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                return;
                            }
                        }
                        else
                        ...
                        // cmbTipoDocu.EditValue = InfoNotaCredito_SRI.infoNotaCredito.tipoIdentificacionComprador;

                        txE_BaseImponible.EditValue = InfoNotaCredito_SRI.infoNotaCredito.totalSinImpuestos;

                        decimal sum_base_iva = 0;
                        decimal sum_base_0 = 0;
                        decimal sum_base_2 = 0;
                        decimal sum_base = 0;
                        decimal sum_base_iva_tot = 0;
                        decimal sum_base_0_tot = 0;
                        decimal sum_valor_iva_12 = 0;

                        // Recorre xml el <totalConImpuestos>
                        this.notaCr_I.ListNotaCredImpuesto = new List<cp_nota_DebCre_Impuesto_Info>();

                        foreach (var item in InfoNotaCredito_SRI.infoNotaCredito.totalConImpuestos)
                        {
                            int tarifa = 0;

                            // Correccion de xml si el campo tarifa viene en 0 o vacio
                            if (item.codigo == "2")
                            {
                            ...
                            cp_nota_DebCre_Impuesto_Info InfoOrdenGiroImpuesto = new cp_nota_DebCre_Impuesto_Info();
                            InfoOrdenGiroImpuesto.IdEmpresa = notaCr_I.IdEmpresa;
                            InfoOrdenGiroImpuesto.IdCbteCble_Nota = notaCr_I.IdCbteCble_Nota;
                            InfoOrdenGiroImpuesto.IdTipoCbte_Nota = notaCr_I.IdTipoCbte_Nota;
                            InfoOrdenGiroImpuesto.Codigo = item.codigo;
                            InfoOrdenGiroImpuesto.CodigoPorcentaje = item.codigoPorcentaje;
                            InfoOrdenGiroImpuesto.BaseImponible = item.baseImponible;
                            InfoOrdenGiroImpuesto.Tarifa = tarifa;
                            InfoOrdenGiroImpuesto.Valor = item.valor;

                            this.notaCr_I.ListNotaCredImpuesto.Add(InfoOrdenGiroImpuesto);
                        }

                        this.BindingList_DesgloseIVA = new BindingList<cp_nota_DebCre_Impuesto_Info>(this.notaCr_I.ListNotaCredImpuesto);
                        this.gridControlOrdenGiroImpuesto.DataSource = this.BindingList_DesgloseIVA;
                        this.gridControlOrdenGiroImpuesto.RefreshDataSource();
                        ...
                        foreach (var item in InfoNotaCredito_SRI.detalles)
                        {
                            ...
                            List<string> arrCodigoIva = new List<string>();
                            arrCodigoIva.Add("2"); // IVA12
                            arrCodigoIva.Add("3"); // IVA14
                            arrCodigoIva.Add("4"); // IVA15

                            foreach (var item2 in item.impuestos)
                            {
                                if (item2.codigo == "2")
                                {
                                    if (arrCodigoIva.Contains(item2.codigoPorcentaje))
                                        sum_valor_iva_12 += item2.valor;
                                }
                                ...
                                if (cod_3 >= 1)
                                {
                                    if (item2.codigo == "2")
                                    {
                                        ...
                                        if (item2.codigoPorcentaje == "5") // IVA5
                                        {
                                            base_12 = item2.baseImponible;
                                            conta12 = 1;
                                        }
                                    ...
                                    if (item2.codigo == "3") // ICE
                                    {
                                        valor_ice = item2.valor;

                                        if (conta12 == 1)
                                        {
                                            sum_base_iva = sum_base_iva + (base_12 - valor_ice);
                                        }
                                ...
                                else
                                {
                                    ...
                                    if (item2.codigo == "2")
                                    {
                                        ...
                                        if (item2.codigoPorcentaje == "5")  // IVA15
                                        {
                                            base_12 = item2.baseImponible;
                                            sum_base_2 = sum_base_2 + base_12;
                                        }
                            ...
                            sum_base_iva_tot = sum_base_iva + sum_base_2;
                            sum_base_0_tot = sum_base_0 + sum_base;
                        }     // for detalle

                        txE_ValorIva.EditValue = sum_valor_iva_12;
                        txE_SubtotalIva.EditValue = sum_base_iva_tot;
        ...
        private void txE_SubtotalIva_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (chkCalculaIVA.Checked)
                {
                    valor_iva = ((Convert.ToDecimal(txE_IVA.EditValue) * Convert.ToDecimal(txE_SubtotalIva.EditValue)) / 100);
                }
                else
                {
                    valor_iva = BindingList_DesgloseIVA.Select(q => q.Valor).Sum();
                }
            ...
            try
            {
                ...
                if (Frm.bAcepto)
                {
                    if (Frm.Row_Selected != null)
                    {
                        ...
                        tb_Proceso_SRI_Bus bus_proSri = new tb_Proceso_SRI_Bus();
                        string mensaje = "";
                        InfoNotaCredito_SRI = bus_proSri.Deserializar_NotaCredito_SRI_xml(Frm.Row_Selected.XML, ref numAutoriza, ref fechAutoriza, ref mensaje);

                        if (InfoNotaCredito_SRI != null)
                        {
                            if (InfoNotaCredito_SRI.infoTributaria != null)
                            {
                                if (InfoNotaCredito_SRI.infoTributaria.ambiente == "1")
                                {
                                    MessageBox.Show("El documento importado esta en ambiente de Pruebas!", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
                                ...
                                //cmbTipoDocu.EditValue = InfoNotaCredito_SRI.infoTributaria.codDoc;
                                //txe_propina.EditValue = InfoNotaCredito_SRI.infoNotaCredito.propina;
                                ...
                                foreach (var item in InfoNotaCredito_SRI.detalles)
                                {
                                    ...
                                    foreach (var item2 in item.impuestos)
                                    {
                                        ...
                                        {                                          
                                            if (item2.codigo.Trim() == "2")
                                            {
                                                if (item2.codigoPorcentaje.Trim() == "2" || item2.codigoPorcentaje.Trim() == "3" || item2.codigoPorcentaje.Trim() == "4" || item2.codigoPorcentaje.Trim() == "5")
                                        ...
                                        if (cod_3 >= 1)
                                        {
                                            if (item2.codigo == "2")
                                            {
                                                ...
                                                if (item2.codigoPorcentaje == "4")
                                                {
                                                    base_12 = item2.baseImponible;
                                                    conta12 = 1;
                                                    sum_base_2 = sum_base_2 + base_12;
                                                }
                                                if (item2.codigoPorcentaje == "5")
                                                {
                                                    base_12 = item2.baseImponible;
                                                    sum_base_2 = sum_base_2 + base_12;
                                                }
                                            ...
                                            if (item2.codigo == "3")
                                            {
                                                ...
                                                info_ICE = ListaCodigoSri.FirstOrDefault(q => q.codigoSRI == item2.codigoPorcentaje);
                                                if (info_ICE != null)
                                                {
                                                    cmbCodigoIce.EditValue = info_ICE.IdCodigo_SRI;
                                ...
                                cmbTipoNota.EditValue = "T_TIP_NOTA_SRI";
                                txE_DocuModifica.EditValue = InfoNotaCredito_SRI.infoNotaCredito.numDocModificado;
                                ...
                                txE_serie2.EditValue =  InfoNotaCredito_SRI.infoTributaria.ptoEmi;
                                txeNumDocum.EditValue = InfoNotaCredito_SRI.infoTributaria.secuencial;
                                dtE_Fecha.EditValue = Convert.ToDateTime(InfoNotaCredito_SRI.infoNotaCredito.fechaEmision).Date;
                                dtE_FecVenci.EditValue = Convert.ToDateTime(InfoNotaCredito_SRI.infoNotaCredito.fechaEmision).Date;                                
                                txeIdNumAutoriza.EditValue = numAutoriza;
                                dteFecAutoriza.EditValue = fechAutoriza;

                                GeneraDiario();

                                MessageBox.Show("XML Importado Satisfactoriamente", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
                            }
                            else
                            {
                        ...
                        {
                            MessageBox.Show("Error al Importar XML : " + mensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
                        }
                    }
                }
            }
        ...
        private void gridViewOrdenGiroImpuesto_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            try
            {
                if (e.Column == colImpuestoBaseImponible || e.Column == colImpuestoTarifa)
                {

                    decimal dBaseImponible = 0;
                    decimal dTarifa = 0;
                    decimal dTotalIva = 0;

                    dBaseImponible = (decimal)gridViewOrdenGiroImpuesto.GetFocusedRowCellValue(colImpuestoBaseImponible);
                    dTarifa = (decimal)gridViewOrdenGiroImpuesto.GetFocusedRowCellValue(colImpuestoTarifa);

                    if (dTarifa > 0)
                        dTotalIva = dBaseImponible * (dTarifa / 100);

                    gridViewOrdenGiroImpuesto.SetFocusedRowCellValue(colImpuestoCodigo, "2");
                    gridViewOrdenGiroImpuesto.SetFocusedRowCellValue(colImpuestoValor, dTotalIva);

                    NewCalculoImpuesto();
                }

                if (e.Column == colImpuestoCodigoPorcentaje)
                {
                    string CodigoPorcentaje = (string)gridViewOrdenGiroImpuesto.GetFocusedRowCellValue(colImpuestoCodigoPorcentaje);
                    var Impuesto = ListImpuestoSRI.Find(q => q.Codigo == CodigoPorcentaje);

                    gridViewOrdenGiroImpuesto.SetFocusedRowCellValue(colImpuestoCodigo, "2");

                    if (Impuesto != null)
                        gridViewOrdenGiroImpuesto.SetFocusedRowCellValue(colImpuestoTarifa, Impuesto.Porcentaje);
                }
            }
            catch (Exception ex)
            {
        ...
        private void NewCalculoImpuesto()
        {
            try
            {
                decimal dSubtotalIva = 0;
                decimal dSubtotalSinIva = 0;
                decimal dSubtotalNoObjetoDeImpuesto = 0;

                foreach (var item in BindingList_DesgloseIVA)
                {
                    switch (item.CodigoPorcentaje)
                    {
                        case "0":
                            dSubtotalSinIva += item.BaseImponible;

                            break;
                        case "2":
                            dSubtotalIva += item.BaseImponible;
                        ...
                        case "5":
                            ...
                            break;
                        case "6":
                            dSubtotalNoObjetoDeImpuesto += item.BaseImponible;
                ...
                //txE_subTotalIVA_12= dSubtotalIva;
                txE_SubtotalIva.EditValue = dSubtotalIva;
                //txE_SubTotal0.EditValue = dSubtotalSinIva;
                txE_Subtotal0.EditValue = dSubtotalSinIva + dSubtotalNoObjetoDeImpuesto;
                //txENoObjetoDeIva.EditValue = dSubtotalNoObjetoDeImpuesto;
                //txte.EditValue = dSubtotalNoObjetoDeImpuesto;

                if (MessageBox.Show("Un valor ha sido modificado, ¿Desea generar el diario de la transacción nuevamente?", param.Nombre_sistema, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    UC_Diario.LimpiarGrid();
                    GeneraDiario();
                }
            ...
            {
                MessageBox.Show("Error en calculo de impuesto: " + ex.Message, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
