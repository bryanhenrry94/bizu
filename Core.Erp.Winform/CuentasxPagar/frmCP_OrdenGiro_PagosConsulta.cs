...
{
    public partial class frmCP_OrdenGiro_PagosConsulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCP_OrdenGiro_PagosConsulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxPagar.frmCP_OrdenGiro_PagosConsulta");
