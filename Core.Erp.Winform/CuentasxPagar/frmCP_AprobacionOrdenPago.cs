...
{
    public partial class frmCP_AprobacionOrdenPago : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void Insertar_OrdenPago()
        {
            ...
            try
            {
                ...
                if (Bus_AprobacionOrdenCab.Guardar_AprobacionOrdenPago(Cab, ref Id, ref mensaje))
                {
                    ...
                    string smensaje = string.Format("{0} # {1} se guardó con éxito.", "La Aprobación Orden de Pago", Id);
