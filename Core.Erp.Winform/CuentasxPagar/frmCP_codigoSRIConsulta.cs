...
{
    public partial class frmCP_codigoSRIConsulta : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
        ...
        private void frmCP_codigo_SRI_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxPagar.frmCP_codigoSRIConsulta");
