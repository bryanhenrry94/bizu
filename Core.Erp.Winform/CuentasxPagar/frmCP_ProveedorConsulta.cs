...
{
    public partial class frmCP_ProveedorConsulta : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
        ...
        private void frmCP_ProveedorConsulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxPagar.frmCP_ProveedorConsulta");
