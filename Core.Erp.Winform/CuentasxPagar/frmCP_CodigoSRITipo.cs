...
{
    public partial class frmCP_CodigoSRITipo : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCP_codigo_SRI_tipo_Load(object sender, EventArgs e)
        {
            try
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxPagar.frmCP_CodigoSRITipo");
