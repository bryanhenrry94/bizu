...
{
    public partial class frmCP_NotaCredito_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCP_NotaCredito_Cons_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxPagar.frmCP_NotaCredito_Cons");
        ...
        private void gridViewCredito_RowCellStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            try
            {
                ...
                if (Math.Round(Convert.ToDouble(data.Saldo), 2) <= 0)
