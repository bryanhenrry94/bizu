...
{
    public partial class frmCP_OrdenGiroConsulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCP_OrdenGiroConsulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxPagar.frmCP_OrdenGiroConsulta");
        ...
        private void gridControlOG_Click(object sender, EventArgs e)
        {
