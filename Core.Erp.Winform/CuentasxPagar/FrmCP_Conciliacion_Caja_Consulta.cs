...
{
    public partial class frmCP_Conciliacion_Caja_Consulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmCP_Conciliacion_Caja_Consulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxPagar.frmCP_Conciliacion_Caja_Consulta");
