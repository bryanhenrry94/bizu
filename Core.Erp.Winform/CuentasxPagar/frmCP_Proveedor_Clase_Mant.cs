...
{
    public partial class frmCP_Proveedor_Clase_Mant : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
         string MensajeError = "";
        ...
        public Boolean Guardar()
        {
            ...
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se guardó con éxito.", "La Clase de Proveedor", InfoProveedor_clase.IdClaseProveedor);
                ...
                if (InfoProveedor_clase != null)
                {
                    ...
                    if (InfoProveedor_clase.Estado == "A")
                    {
                        if (MessageBox.Show("¿Está seguro que desea anular el registro #: " + InfoProveedor_clase.IdClaseProveedor + " ?", "Anulación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
                            ...
                            {
                                string smensaje = string.Format("{0} # {1} se anuló con éxito.", "La Clase de Proveedor", InfoProveedor_clase.IdClaseProveedor);
                                MessageBox.Show(smensaje, param.Nombre_sistema);
        ...
        public Boolean Actualizar()
        {
            ...
            try
            {
                ...
                {     
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "La Clase de Proveedor", InfoProveedor_clase.IdClaseProveedor);
                    MessageBox.Show(smensaje, param.Nombre_sistema);
                    //ucGe_Menu.Visible_btnGuardar = DevExpress.XtraBars.BarItemVisibility.Never;
                    //ucGe_Menu.Visible_bntGuardar_y_Salir = DevExpress.XtraBars.BarItemVisibility.Never;
                    limpiar();
