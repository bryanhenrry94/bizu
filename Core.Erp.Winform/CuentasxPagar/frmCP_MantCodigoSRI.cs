...
{
    public partial class frmCP_MantCodigoSRI : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
                ...
                if (validar())
                {
                    ...
                    if (_Accion == Cl_Enumeradores.eTipo_action.grabar)
                    {
                        ...
                        if (codSRI_Bus.GrabarDB(codSRI_inf, ref id))
                        {
                            ...
                            if (info.IdCtaCble != null)
                            {
                                ...
                                string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El Código SRI", id);
                    ...
                    if (_Accion == Cl_Enumeradores.eTipo_action.actualizar)
                    {
                        ...
                        if (codSRI_Bus.ModificarDB(codSRI_inf))
                        {
                            ...
                            if (info.IdCtaCble != null)
                            {
                                ...
                                string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El Código SRI", codSRI_inf.IdCodigo_SRI);
                                MessageBox.Show(smensaje, param.Nombre_sistema);
                            }
                            bolResult = true;
                    ...
                    if (_Accion == Cl_Enumeradores.eTipo_action.Anular)
                    {
                        ...
                        if (MessageBox.Show("¿Está seguro que desea anular dicho Código SRI?", "Anulación de Código SRI", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
                            ...
                            {
                                string smensaje = string.Format("{0} # {1} se anuló con éxito.", "El Código SRI", codSRI_inf.IdCodigo_SRI);
                                MessageBox.Show(smensaje, param.Nombre_sistema);
                                ucGe_Menu.Visible_bntAnular = DevExpress.XtraBars.BarItemVisibility.Never;
                                bolResult = true;
                            }
