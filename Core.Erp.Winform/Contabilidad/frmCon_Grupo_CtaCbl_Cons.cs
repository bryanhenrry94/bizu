...
{
    public partial class frmCon_Grupo_CtaCbl_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCon_Grupo_CtaCbl_Cons_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Contabilidad.frmCon_Grupo_CtaCbl_Cons");
