...
{
    public partial class frmCon_GrupoEmpresarial : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void Grabar()
        {
            try
            {
                ...
                if (_Accion == Cl_Enumeradores.eTipo_action.grabar)
                {
                    ...
                    {
                        string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El Grupo Empresarial ", txt_GrupoEmpresarial.Text);
                ...
                if (_Accion == Cl_Enumeradores.eTipo_action.actualizar)
                {
                    ...
                    {
                        string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El Grupo Empresarial ", txt_GrupoEmpresarial.Text);
                        MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ...
                    {
                        MessageBox.Show("Error al Modificar:   {0}", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                ...
                if (_Accion == Cl_Enumeradores.eTipo_action.Anular)
                {
                    ...
                    {
                        string smensaje = string.Format("{0} # {1} se anuló con éxito.", "El Grupo Empresarial ", txt_GrupoEmpresarial.Text);
                        MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
                        ...
                        MessageBox.Show("Error al Anular:  {0}", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            }
            catch (Exception ex)
