...
{
    public partial class frmCon_grupo_x_Tipo_Gasto_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCon_grupo_x_Tipo_Gasto_Cons_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Contabilidad.frmCon_grupo_x_Tipo_Gasto_Cons");
