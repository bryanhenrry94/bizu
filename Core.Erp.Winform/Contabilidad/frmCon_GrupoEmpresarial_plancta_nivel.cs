...
{
    public partial class frmCon_GrupoEmpresarial_plancta_nivel : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void Grabar()
        {
            try
            {
                ...
                if (_Accion == Cl_Enumeradores.eTipo_action.grabar)
                {
                    ...
                    {
                        string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El Nivel del Plan de Cuenta del Grupo Empresarial ", "");
                ...
                if (_Accion == Cl_Enumeradores.eTipo_action.actualizar)
                {
                    ...
                    {
                        string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El Nivel del Plan de Cuenta del Grupo Empresarial ", "");
                        MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
