...
{
    public partial class frmCon_Punto_Cargo_Mant : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
        ...
        void Guardar()
        {
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El registro : ", Info.IdPunto_cargo);
        ...
        void Actualizar()
        {
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El registro ", "");
                    MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    limpiar();
                }
                else
        ...
        void Anular()
        {
            try
            {
                ...
                {
                    string smensaje = string.Format("Anular Registro", "El registro ", "");
                    MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);                    
