...
{
    public partial class frmCon_GrupoEmpresarial_plancta : DevExpress.XtraEditors.XtraForm
    {
            ...
            try
            {
                ...
                if (validacion())
                {
                    if (_Accion == Cl_Enumeradores.eTipo_action.grabar)
                    {
                        ...
                        {
                            string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El Plan de cuenta ", txt_cuenta.Text);
                    ...
                    if (_Accion == Cl_Enumeradores.eTipo_action.actualizar)
                    {
                        ...
                        string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El Plan de cuenta ", this.txt_cuenta.Text);
                        MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ...
                    if (_Accion == Cl_Enumeradores.eTipo_action.Anular)
                    {
                        ...
                        {
                            string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El Plan de cuenta", this.txt_cuenta.Text);
                            MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
