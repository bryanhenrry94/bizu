...
{
    public partial class frmCon_CentroCostos_Consulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCon_CentroCostos_Consulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Contabilidad.frmCon_CentroCostos_Consulta");
