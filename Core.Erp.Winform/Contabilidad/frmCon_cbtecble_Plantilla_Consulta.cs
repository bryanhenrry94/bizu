...
{
    public partial class frmCon_cbtecble_Plantilla_Consulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCon_cbtecble_Plantilla_Consulta_Load(object sender, EventArgs e)
        {
            try
             {
                 //Control de Usuario
                 Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Contabilidad.frmCon_cbtecble_Plantilla_Consulta");
