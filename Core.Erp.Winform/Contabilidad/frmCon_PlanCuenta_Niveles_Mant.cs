...
{
    public partial class frmCon_PlanCuenta_Niveles_Mant : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void Grabar()
        {
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se guardó con éxito.", "El Nivel ", _PlanCtaNivel_info.IdNivelCta);
        ...
        private void Modificar()
        {
            try
            {
                ...
                {
                    string smensaje = string.Format("{0} # {1} se modificó con éxito.", "El Nivel ", _PlanCtaNivel_info.IdNivelCta);
                    MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    LimpiarDatos();
                }
                else
                ...
                if (_PlanCtaNivel_info.IdNivelCta != 0)
                {
                    ...
                    else
                    {
                        if (MessageBox.Show("¿Está seguro que desea anular el Nivel #: " + _PlanCtaNivel_info.IdNivelCta + " ?", "ANULACIÓN", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
                            ...
                            {
                                string smensaje = string.Format("{0} # {1} se anuló con éxito.", "El Nivel ", _PlanCtaNivel_info.IdNivelCta);
                                MessageBox.Show(smensaje, param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Information);
