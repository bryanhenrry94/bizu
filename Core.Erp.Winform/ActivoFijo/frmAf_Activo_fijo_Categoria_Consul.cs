...
{
    public partial class frmAf_Activo_fijo_Categoria_Consul : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmAf_Activo_fijo_Categoria_Consul_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "ActivoFijo.frmAf_Activo_fijo_Categoria_Consul");
