...
{
    public partial class frmAF_RetiroActivo_Consul : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmAF_RetiroActivo_Consul_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "ActivoFijo.frmAF_RetiroActivo_Consul");
