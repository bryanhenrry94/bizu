...
{
    public partial class frmAf_Activo_Fijo_Grupo_Cons : DevExpress.XtraEditors.XtraForm
    {
        #region Variables
        ...
        private void frmAf_Activo_Fijo_Grupo_Cons_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "ActivoFijo.frmAf_Activo_Fijo_Grupo_Cons");
