...
{
    public partial class FrmCa_caj_Caja_MoviTipoConsulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmCa_caj_Caja_MoviTipoConsulta_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Caja.FrmCa_caj_Caja_MoviTipoConsulta");
