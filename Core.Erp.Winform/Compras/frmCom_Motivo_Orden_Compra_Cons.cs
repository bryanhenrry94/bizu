...
{
    public partial class frmCom_Motivo_Orden_Compra_Cons : DevExpress.XtraEditors.XtraForm
    {  
        ...
        private void frmCom_Motivo_Orden_Compra_Cons_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "Compras.frmCom_Motivo_Orden_Compra_Cons");
