...
{
    public partial class frmCxc_cobro_tipo_Mant : DevExpress.XtraEditors.XtraForm
    {
                    ...
                    switch (_Accion)
                    {
                        case Cl_Enumeradores.eTipo_action.grabar:
                            ...
                            if (bus.GuardarDB(info, ref MensajeError))
                            {
                                ...
                                MessageBox.Show("El registro ha sido guardado con éxito", param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
               ...
               // gridConsulta.DataSource = ListaBind;
                ...
                switch (_Accion)
                {
                    ...
                    case Cl_Enumeradores.eTipo_action.consultar:
                        ucGe_Menu.Visible_btnGuardar = ucGe_Menu.Visible_bntGuardar_y_Salir = DevExpress.XtraBars.BarItemVisibility.Never;
                        bloquear_Controles();
                        set();
                        break;
