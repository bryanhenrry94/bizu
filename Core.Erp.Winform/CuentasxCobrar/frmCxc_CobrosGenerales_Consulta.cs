...
{
    public partial class frmCxc_CobrosGenerales_Consulta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmcxc_CobrosGenerales_Consulta_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxCobrar.frmCxc_CobrosGenerales_Consulta");
