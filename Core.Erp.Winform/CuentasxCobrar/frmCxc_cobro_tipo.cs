...
{
    public partial class frmCxc_cobro_tipo : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCo_cxc_cobro_tipo_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxCobrar.frmCxc_cobro_tipo");
