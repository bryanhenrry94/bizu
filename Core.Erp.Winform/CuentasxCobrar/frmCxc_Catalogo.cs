...
{
    public partial class frmCxc_Catalogo : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCxc_Catalogo_Load(object sender, EventArgs e)
        {
            //Control de Usuario
            Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxCobrar.frmCxc_Catalogo");
