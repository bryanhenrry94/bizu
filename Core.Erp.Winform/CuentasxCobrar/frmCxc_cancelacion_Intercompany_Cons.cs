...
{
    public partial class frmCxc_cancelacion_Intercompany_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmCo_cxc_cancelacion_Intercompany_Cons_Load_2(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxCobrar.frmCxc_cancelacion_Intercompany_Cons");
