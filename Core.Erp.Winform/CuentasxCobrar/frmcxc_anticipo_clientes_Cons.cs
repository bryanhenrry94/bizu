...
{
    public partial class frmCxc_anticipo_clientes_Cons : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmcxc_anticipo_clientes_Cons_Load(object sender, EventArgs e)
        {
            ...
            {
                //Control de Usuario
                Infoseg = Busseg.Get_List_Menu_x_Empresa_x_Usuario_Control(param.IdEmpresa, param.IdUsuario, "CuentasxCobrar.frmCxc_anticipo_clientes_Cons");
