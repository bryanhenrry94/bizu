...
namespace Core.Erp.Info.CuentasxPagar
{
    public class cp_parametros_Info
    {
        ...
        public string pa_ctacble_x_Iva_Gastos_default { get; set; }
        public Nullable<bool> pa_notificacion_archivo_transferencia_auto { get; set; }
        public Nullable<bool> pa_valida_existe_retencion { get; set; }
        public Nullable<bool> pa_notificacion_archivo_transferencia { get; set; }
