...
namespace Core.Erp.Info.CuentasxPagar
{
    ...
    public class cp_orden_giro_Info
    {
        ...
        public bool ConsiderarATS { get; set; }
        public string Descripcion { get; set; }
        public string FactComp { get; set; }
        ...
        public cp_liquidacion_compra_Info Info_LiquidacionCompra { get; set; }
        ...
        public Nullable<bool> Tiene_ride { get; set; }
        public Nullable<bool> Tiene_xml { get; set; }
        //Campos cuota
        public Nullable<decimal> IdCuota { get; set; }
        public Nullable<int> Secuencia { get; set; }
        public Nullable<double> Valor_cuota { get; set; }
        public List<cp_liquidacion_compra_Info> cp_liquidacion_compra { get; set; }
        public List<cp_orden_giro_Impuesto_Info> ListOrdenGiroImpuesto { get; set; }
        public string TipoDocumento { get; set; }
        public List<cp_orden_giro_det_Info> ListOrdenGiroDet { get; set; }

        public cp_orden_giro_Info()
        {
            Info_CbteCble_x_OG = new ct_Cbtecble_Info();
            Info_Retencion = new cp_retencion_Info();
            Info_LiquidacionCompra = new cp_liquidacion_compra_Info();
            ...
            cp_liquidacion_compra = new List<cp_liquidacion_compra_Info>();
            ListOrdenGiroDet = new List<cp_orden_giro_det_Info>();
        }
    }
}