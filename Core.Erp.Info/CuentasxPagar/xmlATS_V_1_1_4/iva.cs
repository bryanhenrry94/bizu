...
namespace Core.Erp.Info.CuentasxPagar.xmlATS_V_1_1_4
{
    ...
    public partial class iva
    {
      ...
      //[DisplayFormat(DataFormatString = "{0:N2}")]
        ...
        [XmlElement("totalVentas")]
        public string totalVentasFormatted
        {
            get { return totalVentas.ToString("0.00"); }
            set { totalVentas = decimal.Parse(value); }
        }
