...
namespace Core.Erp.Info.General
{
    ...
    public class Cl_Enumeradores
    {
        ...
        public enum eEstadoAprobacion_OrdenTaller
        {
            EST_OT_APRO,
            EST_OT_PEND
        }

        public enum eEstadoAprobacion_Proyecto
        {
            EST_PROY_APRO,
            EST_PROY_XAPRO
        }

        public enum eEstadoAprobacion_Planilla
        {
            EST_PLAN_APRO,
            EST_PLAN_PEND
        }

        public enum eEstadoCierre_Proyecto
        {
            ABI,
            CERR
        }

        public enum eEstadoLiberacion_Etapa
        {
            LIB,
            RECH
        }
        ...
        public enum eTipo_CUADRO_COSTO
        {
            EQUIP_Y_HERRA,
            MANO_OBRA,
            MATERIALES,
        ...
        public enum eTipoComprobante_Alias
        {
            FA,
            RT,
            NC,
        ...
        public enum eTipoPantalla_Pizarra
        {
        ...
        public enum eTipoPrioridad_Tarea
        {
            BAJA,
            MEDIA,
            ALTA
