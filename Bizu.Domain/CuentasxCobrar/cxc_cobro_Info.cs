...
namespace Bizu.Domain.CuentasxCobrar
{
    public class cxc_cobro_Info : cxc_cobro_Det_Info
    {
        ...
        public string dc_Autorizacion { get; set; }
        public string DocumentoPDF { get; set; }

        //J.A EsNegativo se creó para la conciliación de ajuste de centavos 
        public string EsNegativo { get; set; }

        //J.A se crea porque cuando el cobro tiene diario contable, pero no tiene detalle de cobro el sistema no permite anular
        public string TieneDiarioCont_y_NoTieneDetalleCobro { get; set; }
        ...
        public DateTime? Fecha_Anulac { get; set; }
        ...
        //PERSONALIZACION EDEHSA
        public string CodObra { get; set; }
        public string Obra { get; set; }

        //Info para retenciones
        public cxc_retencion_Multiple_Info infoReten { get; set; }
        public List<cxc_retencion_Multiple_Documento_Info> ListaRetenDoc { get; set; }
        public List<cxc_retencion_Multiple_Documentos_ValorAplicado_Info> ListaRetenDocValorApli { get; set; }
        ...
        public cxc_cobro_Info()
        {
            ...
            infoReten = new cxc_retencion_Multiple_Info();
            ListaRetenDoc = new List<cxc_retencion_Multiple_Documento_Info>();
            ListaRetenDocValorApli = new List<cxc_retencion_Multiple_Documentos_ValorAplicado_Info>();
        }
    }
}