...
{
    public class vwcxc_NotasCreditoConFacturaXCobrar_Info
    {  
        ...
        //public string  IdCobro_tipo_RTIVA { get; set; }
        //public string IdCobro_tipo_RTFU { get; set; }
        ...
        public vwcxc_NotasCreditoConFacturaXCobrar_Info()
        {
