   ...
   public class com_solicitud_compra_Info
    {
        ...
        public bool Mostrar_Icono_Buscar_OC { get; set; }

        public Bitmap Ico { get; set; }

        public List<com_ordencompra_local_x_com_solicitud_compra_Info> list_compra_x_solicitud;

        public List<com_ordencompra_local_det_x_com_solicitud_compra_det_Info> list_compra_det_x_solicitud_det;

        public com_solicitud_compra_Info()
        {
            this.DetSolicitudCompra = new List<com_solicitud_compra_det_Info>();
            this.list_compra_x_solicitud = new List<com_ordencompra_local_x_com_solicitud_compra_Info>();
            this.list_compra_det_x_solicitud_det = new List<com_ordencompra_local_det_x_com_solicitud_compra_det_Info>();
        }
    }
}
