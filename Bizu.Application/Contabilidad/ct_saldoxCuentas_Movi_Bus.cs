    ...
    public class ct_saldoxCuentas_Movi_Bus
    {
        ...
        public Boolean GrabarDB(List<ct_saldoxCuentas_Movi_Info> ListSaldoMovi)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ct_saldoxCuentas_Movi_Bus) };
            }
        ...
        public Boolean EliminarDB_Registros_despues_del_periodo(int idempresa, int idPeriodo,ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB_Registros_despues_del_periodo", ex.Message), ex) { EntityType = typeof(ct_saldoxCuentas_Movi_Bus) };
        ...
        public Boolean EliminarDB_SaldoxCuentas_Movi(List<ct_saldoxCuentas_Movi_Info> ListaSaldoActualizados)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB_SaldoxCuentas_Movi", ex.Message), ex) { EntityType = typeof(ct_saldoxCuentas_Movi_Bus) };
            }
        }
        ...
        public Boolean ExisteRegistros_SaldoMensualxCta(int IdEmpresa,int AnioF, int IdPeriodo ,String IdCtaCble)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_ExisteRegistros_SaldoMensualxCta", ex.Message), ex) { EntityType = typeof(ct_saldoxCuentas_Movi_Bus) };
            }
        ...
        public List<ct_saldoxCuentas_Movi_Info> Get_List_saldoxCuentas_Movi_x_Periodo(int IdEmpresa, int AnioF, int IdPeriodo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_saldoxCuentas_Movi_x_Periodo", ex.Message), ex) { EntityType = typeof(ct_saldoxCuentas_Movi_Bus) };
            }
        ...
        public List<ct_saldoxCuentas_Movi_Info> Get_List_saldoxCuentas_Movi_SinCtasIngEgrex_Periodo(int IdEmpresa, int AnioF, int IdPeriodo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_saldoxCuentas_Movi_SinCtasIngEgrex_Periodo", ex.Message), ex) { EntityType = typeof(ct_saldoxCuentas_Movi_Bus) };
            }
