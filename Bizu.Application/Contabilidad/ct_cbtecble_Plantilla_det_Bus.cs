    ...
    public class ct_cbtecble_Plantilla_det_Bus
    {
        ...
        public List<ct_cbtecble_Plantilla_det_Info> Get_list_Cbtecble_det(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Planilla_det", ex.Message), ex) { EntityType = typeof(ct_cbtecble_Plantilla_det_Bus) };
            }
        ...
        public Boolean ModificarDB(ct_cbtecble_Plantilla_det_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(ct_cbtecble_Plantilla_det_Bus) };
            }
        ...
        public Boolean GrabarDB(ct_cbtecble_Plantilla_det_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ct_cbtecble_Plantilla_det_Bus) };
            }
        ...
        public Boolean EliminarDB(ct_cbtecble_Plantilla_det_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(ct_cbtecble_Plantilla_det_Bus) };
            }
