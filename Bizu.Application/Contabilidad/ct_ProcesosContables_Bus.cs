    ...
    public class ct_ProcesosContables_Bus
    {
        ...
        public ct_ProcesosContables_Bus(ct_Periodo_Info oPerid)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ct_ProcesosContables_Bus) };
            }
        ...
        public bool ProcesoCierreAnual(ct_Periodo_Info Info_Periodo,ref string MensajeError_)
        {
            ...
            try
            {
                ...
                DateTime FechaIni = Convert.ToDateTime(Info_Periodo.pe_FechaIni.Date);
                DateTime FechaFin = Convert.ToDateTime(Info_Periodo.pe_FechaFin.Date);
        ...
        //        DateTime FechaIni = Convert.ToDateTime(oPeridoi.pe_FechaIni.Date);
        //        DateTime FechaFin = Convert.ToDateTime(oPeridoi.pe_FechaFin.Date);
        ...
        //        DateTime FechaIni;
        //        DateTime FechaFin;
        //        FechaIni = Convert.ToDateTime(DateTime.Now.AddYears(-50).Date);
        //        FechaIni = Convert.ToDateTime(FechaIni.Date);

        //        FechaFin = FechaCorte.AddDays(-1);
        //        FechaFin = Convert.ToDateTime(FechaFin.Date);
        ...
        //        DateTime FechaIni = Convert.ToDateTime(InfoPerido_Actual.pe_FechaIni.Date);
        //        DateTime FechaFin = Convert.ToDateTime(InfoPerido_Actual.pe_FechaFin.Date);
