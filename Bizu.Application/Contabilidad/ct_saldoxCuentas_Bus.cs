    ...
    public class ct_saldoxCuentas_Bus
    {
        ...
        public List<ct_SaldoxCuentas_Info> Get_List_saldoxCuentas_x_Periodo(int IdEmpresa, int AnioF, int IdPeriodo)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_SaldoxCuentas_x_Periodo", ex.Message), ex) { EntityType = typeof(ct_saldoxCuentas_Bus) };
            }
        ...
        public List<ct_SaldoxCuentas_Info> Get_List_saldoxCuentas_x_Periodo_ParaEliminar(int IdEmpresa, int AnioF, int IdPeriodo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_saldoxCuentas_x_Periodo_ParaEliminar", ex.Message), ex) { EntityType = typeof(ct_saldoxCuentas_Bus) };
            }
        ...
        public Boolean GrabarDB(List<ct_SaldoxCuentas_Info> ListSaldoxCta,ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ct_saldoxCuentas_Bus) };
            }
        ...
        public Boolean EliminarDB_Registros_despues_del_periodo(int idempresa, int idPeriodo,ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB_Registros_despues_del_periodo", ex.Message), ex) { EntityType = typeof(ct_saldoxCuentas_Bus) };
        ...
        public Boolean EliminarDB(List<ct_SaldoxCuentas_Info> ListSaldoxCuenta)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB_SaldoxCuentas", ex.Message), ex) { EntityType = typeof(ct_saldoxCuentas_Bus) };
            }
        }
        ...
        public List<ct_SaldoxCuentas_Info> Get_Mayorizar_y_Optener_SaldoxCuentas(int IdEmpresa, DateTime FechaIni, DateTime FechaFin, string idusuario, Boolean Considerar_Asiento_cierre, string pc, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Mayorizar_y_Optener_SaldoxCuentas", ex.Message), ex) { EntityType = typeof(ct_saldoxCuentas_Bus) };
            }
        ...
        public List<ct_SaldoxCuentas_Info> Get_list_SaldoxCuentas_x_Periodo(int IdEmpresa, List<string> listCuentas, DateTime FechaCorte, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Saldo_Inicial_x_Cuenta", ex.Message), ex) { EntityType = typeof(ct_saldoxCuentas_Bus) };
            }
        }
