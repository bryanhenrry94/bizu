    ...
    public class ct_GrupoEmpresarial_plancta_Bus
    {
        ...
        public Boolean GrabarDB(ct_GrupoEmpresarial_plancta_Info Info)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ct_GrupoEmpresarial_plancta_Bus) };
            }
        ...
        public List<ct_GrupoEmpresarial_plancta_Info> Get_list_GrupoEmpresarial_plancta()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_GrupoEmpresarial_plancta", ex.Message), ex) { EntityType = typeof(ct_GrupoEmpresarial_plancta_Bus) };
            }
        ...
        public Boolean ModificarDB(ct_GrupoEmpresarial_plancta_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(ct_GrupoEmpresarial_plancta_Bus) };
            }
        ...
        public Boolean EliminarDB(ct_GrupoEmpresarial_plancta_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(ct_GrupoEmpresarial_plancta_Bus) };
            }
        ...
        public ct_GrupoEmpresarial_plancta_Info Get_Info_GrupoEmpresarial_plancta(string IdCuenta_gr)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_GrupoEmpresarial_plancta", ex.Message), ex) { EntityType = typeof(ct_GrupoEmpresarial_plancta_Bus) };
            }
