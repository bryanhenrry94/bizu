    ...
    public class ct_Periodo_Bus
    {
        ...
        public List<ct_Periodo_Info> Get_List_Periodo(int IdEmpresa,ref string MensajeError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Periodo", ex.Message), ex) { EntityType = typeof(ct_Periodo_Bus) };
            }
        }
        ...
        public ct_Periodo_Info Get_Info_Periodo(int IdEmpresa, int IdPeriodo, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Periodo", ex.Message), ex) { EntityType = typeof(ct_Periodo_Bus) };
        ...
        public ct_Periodo_Info Get_Info_Periodo(int IdEmpresa, int IdAnioFiscal, int IdMes, ref string MensajeError)
        {
            try
            {
                return data.Get_Info_Periodo(IdEmpresa, IdAnioFiscal, IdMes, ref MensajeError);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public Boolean ModificarDB(ct_Periodo_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(ct_Periodo_Bus) };
            }
        }
        ...
        public Boolean Modificar_Estado_CierreDB(int IdEmpresa, int IdPeriodo, string SCerrado,ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Modificar_Estado_CierreDB", ex.Message), ex) { EntityType = typeof(ct_Periodo_Bus) };
            }
        }
        ...
        public Boolean EliminarDB(ct_Periodo_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(ct_Periodo_Bus) };
            }
        }
        ...
        public Boolean GrabarDB(ct_Periodo_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ct_Periodo_Bus) };
            }
        }
        ...
        public ct_Periodo_Info Get_Info_Ultimo_periodo_mayorizado(int IdEmpresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Ultimo_periodo_mayorizado", ex.Message), ex) { EntityType = typeof(ct_Periodo_Bus) };
        ...
        public Boolean Get_Periodo_Esta_Cerrado(int idempresa, DateTime fecha, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Periodo_Esta_Cerrado", ex.Message), ex) { EntityType = typeof(ct_Periodo_Bus) };
            }
        }
        ...
        public ct_Periodo_Info Get_Info_PeriodoAnterior(int IdEmpresa, int IdPeriodo, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_PeriodoAnterior", ex.Message), ex) { EntityType = typeof(ct_Periodo_Bus) };
            }
