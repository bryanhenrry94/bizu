    ...
    public class ct_Cbtecble_Bus
    {
        ...
        public Boolean ModificarDB_CbteMayorizado(int IdEmpresa, DateTime FechaIni, DateTime FechaFin, char Mayorizado, ref string MensajeError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB_CbteMayorizado", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_Bus) };
            }
        ...
        public List<ct_Cbtecble_Info> Get_list_Cbtecble_ParaSaldoInicial(int IdEmpresa, DateTime iFechaIni, DateTime iFechaFin, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Cbtecble_ParaSaldoInicial", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_Bus) };
            }
        ...
        public DateTime Get_fecha_min_cbtes_no_Contabilizados(int IdEmpresa, DateTime fecha_Ini, DateTime fecha_fin, ref string MensajeError)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_fecha_min_cbtes_no_Mayorizado", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_Bus) };
            }
        }
        ...
        public decimal Get_Numeros_Cbtes_no_Contabilizados(int IdEmpresa, DateTime fecha_Ini, DateTime fecha_Fin, ref string MensajeError)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Numeros_Cbtes_no_Contabilizados", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_Bus) };
            }
        }
        ...
        public List<ct_Cbtecble_Info> Get_list_Cbtecble_ParaMayorizar(int IdEmpresa, DateTime iFechaIni, DateTime iFechaFin, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Cbtecble_ParaMayorizar", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_Bus) };
            }
        }
            ...
            DateTime iFechaIni, DateTime iFechaFin, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Cbtecble_Pendientes_ParaMayorizacion", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_Bus) };
            }
        ...
        public Boolean Eliminar(ct_Cbtecble_Info _CbteCbleInfo, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_Bus) };
            }
        }
        ...
        public ct_Cbtecble_Info Get_Info_CbteCble(int IdEmpresa, int IdTipoCbte, decimal IdCbteCbl, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_CbteCble", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_Bus) };
            }
