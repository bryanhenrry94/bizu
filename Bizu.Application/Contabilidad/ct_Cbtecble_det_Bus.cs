    ...
    public class ct_Cbtecble_det_Bus
    {
        ...
        public List<ct_Cbtecble_det_Info> Get_list_Cbtecble_det(int IdEmpresa,ref string MensajeError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Cbtecble_det", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_det_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(ct_Cbtecble_det_Info _CbteCble_det_Info,ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_det_Bus) };
            }

        }

        public Boolean ModificarDB(List<ct_Cbtecble_det_Info> _CbteCble_det_Info, ref string MensajeError)
        {
        ...
        public Boolean AnularDB(ct_Cbtecble_det_Info _CbteCble_det_Info,ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_det_Bus) };
            }
        }
        ...
        public Boolean GrabarDB(ct_Cbtecble_det_Info _CbteCble_det_Info,ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_det_Bus) };
            }
        }
        ...
        public void Get_SaldoContableMesAnterior(int IdEmpresa, string IdCtaCble, DateTime Fecha, ref decimal  Saldo,ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_SaldoContableMesAnterior", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_det_Bus) };
            }
        }
        ...
        public List<vwct_cbtecble_Con_Saldo_Info> Get_list_Cbtecble_Con_Saldo(int IdEmpresa, DateTime FechaIni, DateTime FechaFin, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Cbtecble_Con_Saldo", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_det_Bus) };
            }
        }
        ...
        public List<vwct_cbtecble_Con_Saldo_Info> Get_list_Cbtecble_OG_otrosPagos(int IdEmpresa, decimal IdCbteCble, int IdTipoCbte, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_ObtenerCbtecble_OG_otrosPagos", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_det_Bus) };
            }
        }
        ...
        public List<ct_Cbtecble_det_Info> Get_list_CbteCble_x_cp_Conciliacion_caja(int IdEmpresa, decimal IdConciliacion_caja)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_CbteCble_x_cp_Conciliacion_caja", ex.Message), ex) { EntityType = typeof(ct_Cbtecble_det_Bus) };
            }
        }
