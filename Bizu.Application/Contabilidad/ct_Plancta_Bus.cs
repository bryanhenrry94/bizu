    ...
    public class ct_Plancta_Bus
    {
        ...
        public List<ct_Plancta_Info> Get_List_Plancta(int IdEmpresa, ref string MensajeError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Plancta", ex.Message), ex) { EntityType = typeof(ct_Plancta_Bus) };
            }
        }
        public List<ct_Plancta_Info> ProcesarDataTableCt_Plancta_Info(DataTable ds, int idempresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ProcesarDataTableCt_Plancta_Info", ex.Message), ex) { EntityType = typeof(ct_Plancta_Bus) };
            }
        ...
        public List<ct_Plancta_Info> Get_List_Plancta_x_ctas_Movimiento(int IdEmpresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Cuentas_de_Movimiento", ex.Message), ex) { EntityType = typeof(ct_Plancta_Bus) };
            }
        }
        ...
        public List<ct_Plancta_Info> Get_List_Plan_ctaPadre(int IdEmpresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Plan_ctaPadre", ex.Message), ex) { EntityType = typeof(ct_Plancta_Bus) };
            }
        }
        public string Get_Id(int IdEmpresa,string IdCuenta_padre, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Id", ex.Message), ex) { EntityType = typeof(ct_Plancta_Bus) };
            }
        ...
        public Boolean ModificarDB(ct_Plancta_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(ct_Plancta_Bus) };
            }
        }
        public Boolean AnularDB(ct_Plancta_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(ct_Plancta_Bus) };
            }
        }
        public Boolean GrabarDB(ct_Plancta_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ct_Plancta_Bus) };
            }
        }
        public Boolean EliminarDB(int IdEmpresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(ct_Plancta_Bus) };
            }
        }
        public Boolean VerificaNivel(int idnivel, int idempresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VerificaNivel", ex.Message), ex) { EntityType = typeof(ct_Plancta_Bus) };
            }
        }
        public Boolean ValidaIdCtaCble(int idempresa, string IdCuenta, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ValidaIdCtaCble", ex.Message), ex) { EntityType = typeof(ct_Plancta_Bus) };
            }
        }
        public List<ct_Plancta_Info> Get_List_Plancta(int IdEmpresa, int IdNivel)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_info_plancta", ex.Message), ex) { EntityType = typeof(ct_Plancta_Bus) };
            }
        }
        ...
        public List<ct_Plancta_Info> Get_Plancta_x_Grupo(int IdEmpresa, string IdGrupoCble)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Plancta_x_Grupo", ex.Message), ex) { EntityType = typeof(ct_Plancta_Bus) };
            }
        }
