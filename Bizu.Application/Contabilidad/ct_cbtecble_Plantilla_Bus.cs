    ...
    public class ct_cbtecble_Plantilla_Bus
    {
        ...
        public List<ct_cbtecble_Plantilla_Info> Get_list_cbtecble_Plantilla(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Plantilla", ex.Message), ex) { EntityType = typeof(ct_cbtecble_Plantilla_Bus) };
            }
        ...
        public Boolean ModificarDB(ct_cbtecble_Plantilla_Info Pla_I)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(ct_cbtecble_Plantilla_Bus) };
            }
        ...
        public Boolean GrabarDB( ct_cbtecble_Plantilla_Info info, ref decimal IdPlantilla, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ct_cbtecble_Plantilla_Bus) };
            }
        }
        ...
        public Boolean EliminarDB(ct_cbtecble_Plantilla_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(ct_cbtecble_Plantilla_Bus) };
            }
        ...
        public ct_cbtecble_Plantilla_Info Get_Info_Plantilla(int IdEmpresa, int IdTipoCbte, decimal IdPlantilla)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Plantilla", ex.Message), ex) { EntityType = typeof(ct_cbtecble_Plantilla_Bus) };
            }
        ...
        public ct_Cbtecble_Info Get_Info_Plantilla_CbteCble(int IdEmpresa, int IdTipoCbte, decimal IdPlantilla)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Plantilla_CbteCble", ex.Message), ex) { EntityType = typeof(ct_cbtecble_Plantilla_Bus) };
            }
        }
