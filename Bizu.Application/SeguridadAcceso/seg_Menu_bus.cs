    ...
    public class seg_Menu_bus
    {
        public List<seg_Menu_info> Get_List_Menu(ref string MensajeError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Menu", ex.Message), ex) { EntityType = typeof(seg_Menu_bus) };
            }
        }
        ...
        public List<seg_Menu_info> Get_List_Menu_x_Empresa(int idEmpresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Menu_x_Empresa", ex.Message), ex) { EntityType = typeof(seg_Menu_bus) };
            }
        }
        ...
        public List<seg_Menu_info> Get_List_Menu_x_Empresa_x_Usuario(string idUsuario, int idEmpresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Menu_x_Empresa_x_Usuario", ex.Message), ex) { EntityType = typeof(seg_Menu_bus) };
            }
        }
        ...
        public List<seg_Menu_info> Get_List_Menu_x_Empresa_x_Usuario_Control(int idEmpresa, string idUsuario, string NomFor)
        {
            ...
            {
                seg_Menu_data data = new seg_Menu_data();
                return data.Get_List_Menu_x_Empresa_x_Usuario_Control(idEmpresa, idUsuario, NomFor);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public seg_Menu_info Get_Info_Menu(int idmenu, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Menu", ex.Message), ex) { EntityType = typeof(seg_Menu_bus) };
            }
        }
        ...
        public Boolean ModificarDB(seg_Menu_info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(seg_Menu_bus) };
            }
        }
        ...
        public int getIdMenu_Max(ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "getIdMenu_Max", ex.Message), ex) { EntityType = typeof(seg_Menu_bus) };
            }
        }
        ...
        public Boolean GrabarDB(seg_Menu_info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(seg_Menu_bus) };
            }
        }
        ...
        public Boolean EliminarDB(List<seg_Menu_info> Lista, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(seg_Menu_bus) };
            }
        }
        ...
        public Boolean ExisteRelacionMenu(int idMenu, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ExisteRelacionMenu", ex.Message), ex) { EntityType = typeof(seg_Menu_bus) };
            }
        }
        ...
        public Boolean Anular_Menu(int idMenu, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Anular_Menu", ex.Message), ex) { EntityType = typeof(seg_Menu_bus) };
            }
        }
    }
}
