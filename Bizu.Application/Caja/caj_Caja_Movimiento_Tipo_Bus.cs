    ...
    public class caj_Caja_Movimiento_Tipo_Bus
    {
        ...
        public List<caj_Caja_Movimiento_Tipo_Info> Get_list_Caja_Movimiento_Tipo(ref string MensajeError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Caja_Movimiento_Tipo", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_Tipo_Bus) };
            }
        ...
        public caj_Caja_Movimiento_Tipo_Info Get_Info_Movimiento_Tipo(int IdTipoMovi, int IdEmpresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Movimiento_Tipo", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_Tipo_Bus) };
            }
        ...
        public Boolean GrabarDB(caj_Caja_Movimiento_Tipo_Info info,ref int id, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_Tipo_Bus) };
            }
        ...
        public Boolean ModificarDB(caj_Caja_Movimiento_Tipo_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_Tipo_Bus) };
            }
        ...
        public Boolean AnularDB(caj_Caja_Movimiento_Tipo_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_Tipo_Bus) };
            }
