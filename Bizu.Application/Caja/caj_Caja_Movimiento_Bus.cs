    ...
    public class caj_Caja_Movimiento_Bus
    {
        ...
        public List<caj_Caja_Movimiento_Info> Get_list_Ingreso(int IdEmpresa,DateTime FechaIni,DateTime FechaFin, ref string MensajeError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Ingreso", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_Bus) };
            }
        }
        ...
        public List<caj_Caja_Movimiento_Info> Get_list_Egreso(int IdEmpresa, DateTime FechaIni, DateTime FechaFin, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Egreso", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_Bus) };
            }
        }
        ...
        public Boolean GrabarDB(ref caj_Caja_Movimiento_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(caj_Caja_Movimiento_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_Bus) };
            }
        }
        ...
        public Boolean AnularDB(caj_Caja_Movimiento_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_Bus) };
            }
        }
        ...
        public caj_Caja_Movimiento_Info Get_Info_MovimientoCaja(int IdEmpresa, decimal IdCbteCble, int IdTipoCbte, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_MovimientoCaja_Rpt", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_Bus) };
            }
        }
        ...
        public List<vwcaj_MovCaja_x_Cobro_Info> Get_list_MovimientosCaja_x_Cobro(int Idempresa, int IdTipocbte_Caja, decimal IdCbteCble_Caja, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_MovimientosCaja_x_Cobro", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_Bus) };
            }
        }
        ...
        public List<vwcaj_MovCaja_x_Cobro_Info> Get_list_MovimientosCaja_x_Cobro_Anticipo(int Idempresa, int IdTipocbte_Caja, decimal IdCbteCble_Caja, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_MovimientosCaja_x_Cobro_Anticipo", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_Bus) };
            }
        }
        ...
        private Boolean Validar_y_corregir_objeto(ref caj_Caja_Movimiento_Info Caja_Movi_Info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Validar_y_corregir_objeto", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_Bus) };
            }
        }
