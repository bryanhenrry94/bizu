    ...
    public class caj_parametro_Bus
    {
        ...
        public caj_parametro_Info Get_Info_Parametro(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener", ex.Message), ex) { EntityType = typeof(caj_parametro_Bus) };
            }
        ...
        public Boolean ModificarDB(caj_parametro_Info info, List<caj_Caja_Movimiento_Tipo_x_CtaCble_Info> LstTipoxCta)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Modificar", ex.Message), ex) { EntityType = typeof(caj_parametro_Bus) };
            }
