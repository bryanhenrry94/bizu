    ...
    public class Caj_Talonario_Recibo_Bus
    {
        ...
        public List<Caj_Talonario_Recibo_Info> Get_List_Recibo(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Recibo", ex.Message), ex) { EntityType = typeof(Caj_Talonario_Recibo_Bus) };
            }
        }
        ...
        public string Get_Num_ultimo_Recibo(int IdEmpresa, int IdSucursal, int IdPuntoVta, string IdTipo_Docu, ref string MensajeError)//opin 2017/03/23
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Num_ultimo_Recibo", ex.Message), ex) { EntityType = typeof(Caj_Talonario_Recibo_Bus) };
            }
        }
        ...
        public Boolean GuardarDB(Caj_Talonario_Recibo_Info Info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(Caj_Talonario_Recibo_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(Caj_Talonario_Recibo_Info Info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(Caj_Talonario_Recibo_Bus) };
            }
        }
        ...
        public Boolean AnularDB(Caj_Talonario_Recibo_Info Info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(Caj_Talonario_Recibo_Bus) };
            }
        }
        ...
        public Caj_Talonario_Recibo_Info Get_Ultimo_Recibo_No_Usado(int IdEmpresa, int IdSucursal, int IdPuntoVta, string IdTipo_Docu, ref string MensajeError)//opin 2017/03/23
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Ultimo_Recibo_No_Usado", ex.Message), ex) { EntityType = typeof(Caj_Talonario_Recibo_Bus) };
            }
        }
        ...
        public string Get_Num_Recibo_optenido(int IdRecibo, ref string MensajeError)//opin 2017/03/24
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Num_Recibo_optenido", ex.Message), ex) { EntityType = typeof(Caj_Talonario_Recibo_Bus) };
            }
        }
    }
}
