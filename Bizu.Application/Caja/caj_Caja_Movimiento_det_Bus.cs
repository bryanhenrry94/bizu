   ...
   public class caj_Caja_Movimiento_det_Bus
    {
       ...
       public List<vwcaj_Caja_Movimiento_det_cancelado_Info> Get_list_Caja_Movimiento_det_cancelado(int IdEmpresa, decimal IdCbteCble, int IdTipocbte, ref string MensajeError)
       {
           ...
           catch (Exception ex)
           {
               ...
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Caja_Movimiento_det_cancelado", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_det_Bus) };
           }
       ...
       public List<caj_Caja_Movimiento_det_Info> Get_listDetalle(int IdEmpresa, decimal IdCbteCble, int IdTipocbte, ref string MensajeError)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_listDetalle", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_det_Bus) };
           }
       ...
       public Boolean GrabarDBDetalle(List<caj_Caja_Movimiento_det_Info> Lista, ref string MensajeError)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDBDetalle", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_det_Bus) };
           }
       ...
       public Boolean ModificarDBDetalle(List<caj_Caja_Movimiento_det_Info> Lista, ref string MensajeError)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDBDetalle", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_det_Bus) };
           }
       ...
       public Boolean EliminarRegistroDetalle(caj_Caja_Movimiento_det_Info Info, ref string MensajeError)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarRegistroDetalle", ex.Message), ex) { EntityType = typeof(caj_Caja_Movimiento_det_Bus) };
           }
