    ...
    public class Af_Depreciacion_Det_Bus
    {
        ...
        public Boolean GuardarDB(List<Af_Depreciacion_Det_Info> lstInfo, decimal IdDepreciacion, int IdTipoDepreciacion, ref string msjError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Det_Bus) };
            }
        }
        ...
        public List<Af_Depreciacion_Det_Info> Get_List_Depreciacion_Det(int IdEmpresa, decimal IdDepreciacion, int IdTipoDepreciacion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_Depreciacion_Det", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Det_Bus) };
            }
        ...
        public List<vwAf_ActivoFijo_Info> Get_List_DepreciacionDetalle(int IdEmpresa, decimal IdDepreciacion, int IdTipoDepreciacion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_DepreciacionDetalle", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Det_Bus) };
            }
        }
        ...
        public Boolean Guardar_HistoricoDB(List<Af_Depreciacion_Det_Info> lstInfo, int IdHisDepreciacion, decimal IdDepreciacion, int IdTipoDepreciacion, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Guardar_HistoricoDB", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Det_Bus) };
            }
        }
        ...
        public Boolean EliminarDB(List<Af_Depreciacion_Det_Info> lstInfo, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Det_Bus) };
            }
        }
        ...
        public double Get_DepreAcum_x_Activo(int IdEmpresa, int IdActivoFijo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_DepreAcum_x_Activo", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Det_Bus) };
            }
        }

        public List<Af_Depreciacion_Det_Info> Get_List_Depreciacion_Det_(int IdEmpresa, int IdActivoFijo)
        {
            try
            {

                return dataAF.Get_List_Depreciacion_Det_(IdEmpresa, IdActivoFijo);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
