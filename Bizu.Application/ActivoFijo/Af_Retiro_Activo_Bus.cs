    ...
    public class Af_Retiro_Activo_Bus
    {
        ...
        public Boolean GuardarDB(Af_Retiro_Activo_Info InfoAf, ct_Cbtecble_Info CbteCbleInfo, ref decimal IdRetiroActivo, ref decimal IdCbteCble, ref string msjError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_PeriodoDepreciacion", ex.Message), ex) { EntityType = typeof(Af_Retiro_Activo_Bus) };
            }
        }
        ...
        private Af_TipoTransac_x_Cta_CbteCble_Info Get_Info_TipoTran_x_CtaCble(Af_Retiro_Activo_Info InfoAf, ct_Cbtecble_Info CbteCbleInfo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "getTipoTran_x_CtaCble", ex.Message), ex) { EntityType = typeof(Af_Retiro_Activo_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(Af_Retiro_Activo_Info InfoAf, ct_Cbtecble_Info CbteCbleInfo, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(Af_Retiro_Activo_Bus) };
            }
        }
        ...
        public Boolean AnularDB(Af_Retiro_Activo_Info InfoAf, ct_Cbtecble_Info CbteCbleInfo, ref decimal IdCbteCble_Rev, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(Af_Retiro_Activo_Bus) };
            }
        }
        ...
        public List<Af_Retiro_Activo_Info> Get_List_Retiro_Activo(int IdEmpresa, DateTime FechaIni, DateTime FechaFin)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Retiro_Activo", ex.Message), ex) { EntityType = typeof(Af_Retiro_Activo_Bus) };
            }
        }
        ...
        public Af_Retiro_Activo_Info Get_Info_Retiro_Activo(int IdEmpresa, decimal IdRetiroActivo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Retiro_Activo", ex.Message), ex) { EntityType = typeof(Af_Retiro_Activo_Bus) };
            }
        }
