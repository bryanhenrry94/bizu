    ...
    public class Af_Mej_Baj_Activo_Bus
    {
        ...
        public Boolean GuardarDB(Af_Mej_Baj_Activo_Info InfoAf, ct_Cbtecble_Info CbteCbleInfo, ref decimal IdMejoraBaja, ref decimal IdCbteCble, ref string msjError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDataDB", ex.Message), ex) { EntityType = typeof(Af_Mej_Baj_Activo_Bus) };
            }
        }
        ...
        private Af_TipoTransac_x_Cta_CbteCble_Info Get_Info_TipoTran_x_CtaCble(Af_Mej_Baj_Activo_Info InfoAf, ct_Cbtecble_Info CbteCbleInfo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "getTipoTran_x_CtaCble", ex.Message), ex) { EntityType = typeof(Af_Mej_Baj_Activo_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(Af_Mej_Baj_Activo_Info InfoAf, ct_Cbtecble_Info CbteCbleInfo, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDataDB", ex.Message), ex) { EntityType = typeof(Af_Mej_Baj_Activo_Bus) };
            }
        }
        ...
        public Boolean AnularDB(Af_Mej_Baj_Activo_Info InfoAf, ct_Cbtecble_Info CbteCbleInfo, ref decimal IdCbteCble_Rev, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDataDB", ex.Message), ex) { EntityType = typeof(Af_Mej_Baj_Activo_Bus) };
            }
        }
        ...
        public Af_Mej_Baj_Activo_Info Get_Info_Mej_Baj_Activo(int IdEmpresa, decimal Id_Mej_Baj_Activo, string Id_Tipo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Mej_Baj_Activo", ex.Message), ex) { EntityType = typeof(Af_Mej_Baj_Activo_Bus) };
            }
        }
        ...
        public List<Af_Mej_Baj_Activo_Info> Get_List_Sum_Valor_Mej_Baj_Activo(int IdEmpresa, decimal IdActivoFijo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Sum_Valor_Mej_Baj_Activo", ex.Message), ex) { EntityType = typeof(Af_Mej_Baj_Activo_Bus) };
            }
        }
        ...
        public List<Af_Mej_Baj_Activo_Info> Get_List_Mej_Baj_Activo(int IdEmpresa, string IdTipo, DateTime FechaIni, DateTime FechaFin)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Mej_Baj_Activo", ex.Message), ex) { EntityType = typeof(Af_Mej_Baj_Activo_Bus) };
            }
        }


        public List<Af_Mej_Baj_Activo_Info> Get_Info_Mej_Baj_Activo_Rango(int IdEmpresa, decimal Id_ActivoFijo, string IdTipo, DateTime FechaIni, DateTime FechaFin) 
        {
            try
            {
                return dataAf.Get_Info_Mej_Baj_Activo_Rango(IdEmpresa, Id_ActivoFijo, IdTipo, FechaIni, FechaFin);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public List<Af_Mej_Baj_Activo_Info> Get_Info_Mej_Baj_Activo_SinRango(int IdEmpresa, decimal Id_ActivoFijo)
        {
            try
            {
                return dataAf.Get_Info_Mej_Baj_Activo_SinRango(IdEmpresa, Id_ActivoFijo);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
