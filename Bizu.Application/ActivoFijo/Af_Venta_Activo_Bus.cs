    ...
    public class Af_Venta_Activo_Bus
    {
        ...
        public Boolean GuardarDB(Af_Venta_Activo_Info InfoAf ,  ct_Cbtecble_Info CbteCbleInfo, ref decimal IdVtaActivo, ref decimal IdCbteCble, ref string msjError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(Af_Venta_Activo_Bus) };
            }
        }
        ...
        private Af_TipoTransac_x_Cta_CbteCble_Info Get_Info_TipoTran_x_CtaCble(Af_Venta_Activo_Info InfoAf, ct_Cbtecble_Info CbteCbleInfo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "getTipoTran_x_CtaCble", ex.Message), ex) { EntityType = typeof(Af_Venta_Activo_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(Af_Venta_Activo_Info InfoAf, ct_Cbtecble_Info CbteCbleInfo, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(Af_Venta_Activo_Bus) };
            }
        }
        ...
        public Boolean AnularDB(Af_Venta_Activo_Info InfoAf, ct_Cbtecble_Info CbteCbleInfo, ref decimal IdCbteCble_Rev, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(Af_Venta_Activo_Bus) };
            }
        }
        ...
        public List<Af_Venta_Activo_Info> Get_List_Venta_Activo(int IdEmpresa, DateTime FechaIni, DateTime FechaFin)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Venta_Activo", ex.Message), ex) { EntityType = typeof(Af_Venta_Activo_Bus) };
            }
        }
        ...
        public Af_Venta_Activo_Info Get_Info_Venta_Activo(int IdEmpresa, decimal IdVtaActivo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Venta_Activo", ex.Message), ex) { EntityType = typeof(Af_Venta_Activo_Bus) };
            }
        }
