    ...
    public class Af_Depreciacion_Bus
    {
        ...
        public Boolean GuardarDB(Af_Depreciacion_Info  Info, ref decimal IdDepreciacion, ref string msjError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Bus) };
            }
        }
        ...
        public Boolean AnularDB(Af_Depreciacion_Info Info, ct_Cbtecble_Info CbteCbleInfo, ref decimal IdCbteCble_Rev, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(Af_Depreciacion_Info Info, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Bus) };
            }
        }
        ...
        public List<Af_Depreciacion_Info> Get_List_Depreciacion(int IdEmpresa, int IdTipoDepreciacion, DateTime FechaIni, DateTime FechaFin)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Depreciacion", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Bus) };
            }
        }
        ...
        public Af_Depreciacion_Info Get_Info_Depreciacion(int IdEmpresa, decimal IdDepreciacion, int IdTipoDepreciacion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Depreciacion", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Bus) };
            }
        }
        ...
        public Boolean VerificarUltDepre(int IdEmpresa, decimal IdDepreciacion, int IdTipoDepreciacion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VerificarUltDepre", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Bus) };
            }
        }


        public Boolean VerificarFechaUltDepre(int IdEmpresa, ref DateTime FechaUlt, decimal TipoDepreciacion)
        {
            try
            {
                return dataDepre.VerificarFechaUltDepre(IdEmpresa, ref FechaUlt, TipoDepreciacion);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public Boolean VerificarPeriodoExistente(int IdEmpresa, int IdPeriodo, string Estado)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VerificarPeriodoExistente", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Bus) };
            }
        }
        ...
        public List<ct_Periodo_Info> get_Periodos(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_Periodos_No_Depreciados", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Bus) };
            }
        }
        ...
        public Boolean ContabilizarDepreciacion(int IdEmpresa, decimal IdDepreciacion, int IdPeriodo, Cl_Enumeradores.eForma_Contabilizar sFormaContabiliza, ref  decimal IdCbteCble, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ContabilizarDepreciacion", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Bus) };
            }
        }
            ...
            (int IdEmpresa, decimal IdDepreciacion, int IdTipoDepreciacion, int IdPeriodo, Cl_Enumeradores.eForma_Contabilizar FormaContabiliza)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_ValoresDepreciacion", ex.Message), ex) { EntityType = typeof(Af_Depreciacion_Bus) };
            }
        }
