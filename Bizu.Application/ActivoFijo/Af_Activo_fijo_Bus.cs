    ...
    public class Af_Activo_fijo_Bus
    {
        ...
        public List<Af_Activo_fijo_Info> Get_List_ActivoFijo(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_ActivoFijo", ex.Message), ex) { EntityType = typeof(Af_Activo_fijo_Bus) };
            }
        }
        ...
        public List<Af_Activo_fijo_Info> Get_List_ActivoFijo_x_categoria(int IdEmpresa, int idCategoria)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_ActivoFijo_x_categoria", ex.Message), ex) { EntityType = typeof(Af_Activo_fijo_Bus) };
            }
        }
        ...
        public List<Af_Activo_fijo_Info> Get_List_Vista_Af_x_Categoria(int IdEmpresa, int idCategoria)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Vista_Af_x_Categoria", ex.Message), ex) { EntityType = typeof(Af_Activo_fijo_Bus) };
            }
        }
        ...
        public List<Af_Activo_fijo_Info> Get_List_ActivoFijo(int IdEmpresa, string EstadoProceso)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_ActivoFijo", ex.Message), ex) { EntityType = typeof(Af_Activo_fijo_Bus) };
            }
        }
        ...
        public List<Af_Activo_fijo_Info> Get_List_Vista_Af(int idEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Vista_Af", ex.Message), ex) { EntityType = typeof(Af_Activo_fijo_Bus) };
            }
        }
        ...
        public Af_Activo_fijo_Info Get_Info_ActivoFijo(int IdEmpresa, int IdActivoFijo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_Info_ActivoFijo", ex.Message), ex) { EntityType = typeof(Af_Activo_fijo_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(Af_Activo_fijo_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(Af_Activo_fijo_Bus) };
            }
        }
        ...
        public Boolean ModificarUbicacion(Af_CambioUbicacion_Activo_Info Info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarUbicacion", ex.Message), ex) { EntityType = typeof(Af_Activo_fijo_Bus) };
            }
        }
        ...
        public Boolean GrabarDB(Af_Activo_fijo_Info info, ref int id, ref string CodActivo, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(Af_Activo_fijo_Bus) };
            }
        }
        ...
        public Boolean EliminarDB(Af_Activo_fijo_Info info, ref  string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(Af_Activo_fijo_Bus) };
            }
        }
        ...
        Boolean Validar_y_corregir_objeto(ref Af_Activo_fijo_Info Info, ref string msg)
        {
            try
            {
                ...
                if (Info.IdEmpresa <= 0 && Info.IdSucursal <= 0)
                {
                    ...
                    throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Validaciones", msg)) { EntityType = typeof(Af_Activo_fijo_Bus) };
                }
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_CtasCbles_AF", ex.Message), ex) { EntityType = typeof(Af_Activo_fijo_Bus) };
        ...
        public List<Af_Activo_fijo_Info> ProcesarDataTablePc_ActivoFijo_Info(DataTable ds, int idempresa, int idsucursal, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GetId", ex.Message), ex) { EntityType = typeof(Af_Activo_fijo_Bus) };
            }
