...
namespace Bizu.Application.Compras
{
    public class com_Catalogo_Bus
    {
        ...
        public List<com_Catalogo_Info> Get_ListMotivo()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_ListMotivo", ex.Message), ex) { EntityType = typeof(com_Catalogo_Bus) };
            }
        }
        ...
        public List<com_Catalogo_Info> Get_ListEstadoRecepcion()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_ListEstadoRecepcion", ex.Message), ex) { EntityType = typeof(com_Catalogo_Bus) };
            }
        }
        ...
        public List<com_Catalogo_Info> Get_ListEstadoAprobacion()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_ListEstadoAprobacion", ex.Message), ex) { EntityType = typeof(com_Catalogo_Bus) };
            }
        }
        ...
        public List<com_Catalogo_Info> Get_ListEstadoAnulacion()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_ListEstadoAnulacion", ex.Message), ex) { EntityType = typeof(com_Catalogo_Bus) };
            }
        }
        ...
        public com_Catalogo_Info Get_EstadoAprobacion(string IdEAprob)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_EstadoAprobacion", ex.Message), ex) { EntityType = typeof(com_Catalogo_Bus) };
            }
        }
        ...
        public List<com_Catalogo_Info> Get_ListEstadoAprobacion_solicitud_compra()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_ListEstadoAprobacion_solicitud_compra", ex.Message), ex) { EntityType = typeof(com_Catalogo_Bus) };
            }
        }
        ...
        public string GetId()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GetId", ex.Message), ex) { EntityType = typeof(com_Catalogo_Bus) };
            }
        }
        ...
        public List<com_Catalogo_Info> Get_List_Catalogo()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Catalogo", ex.Message), ex) { EntityType = typeof(com_Catalogo_Bus) };
            }
        }
        ...
        public List<com_Catalogo_Info> Get_IdTipoLista(string cod)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_IdTipoLista", ex.Message), ex) { EntityType = typeof(com_Catalogo_Bus) };
            }
        }
        ...
        public Boolean GuardarDB(com_Catalogo_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(com_Catalogo_Bus) };
            }
        }
        ...
        public Boolean ValidarCodigoExiste(string cod)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ValidarCodigoExiste", ex.Message), ex) { EntityType = typeof(com_Catalogo_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(com_Catalogo_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(com_Catalogo_Bus) };
            }
        }
        ...
        public Boolean AnularDB(com_Catalogo_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(com_Catalogo_Bus) };
            }
        }
        ...
        public Boolean ValidarIdTipoCatalogoCompra_Descripcion(string idTipoCatalogoCompra, string ca_descripcion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ValidarIdTipoCatalogo_Descripcion", ex.Message), ex) { EntityType = typeof(com_Catalogo_Bus) };
            }
        }
