    ...
    public class com_ordencompra_local_det_x_com_solicitud_compra_det_Bus
    {
        ...
        public Boolean GrabarDB(List<com_ordencompra_local_det_x_com_solicitud_compra_det_Info> lista, ref string mensaje)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(com_ordencompra_local_det_x_com_solicitud_compra_det_Bus) };
            }
        }
        ...
        public List<com_ordencompra_local_det_x_com_solicitud_compra_det_Info> Get_List_ordencompra_local_det_x_com_solicitud_compra_det_x_Solicitud(int IdEmpresa, int IdSucursal, decimal IdSolicitudCompra)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_ordencompra_local_det_x_com_solicitud_compra_det_x_Solicitud", ex.Message), ex) { EntityType = typeof(com_ordencompra_local_det_x_com_solicitud_compra_det_Bus) };
        ...
        public List<com_ordencompra_local_det_x_com_solicitud_compra_det_Info> ConsultaDetalleSolicitud_x_Solicitud(int IdEmpresa, int IdSucursal, decimal IdSolicitudCompra)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(com_ordencompra_local_det_x_com_solicitud_compra_det_Bus) };
            }
        }
        ...
        public List<com_ordencompra_local_det_x_com_solicitud_compra_det_Info> Get_List_ordencompra_local_det_x_com_solicitud_compra_det(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_ordencompra_local_det_x_com_solicitud_compra_det", ex.Message), ex) { EntityType = typeof(com_ordencompra_local_det_x_com_solicitud_compra_det_Bus) };
            }
        }
        ...
        public Boolean Eliminar_Detalle_OCDxSCD(int IdEmpresa, int IdSucursal, decimal IdOrdenCompra, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Eliminar_Detalle_OCDxSCD", ex.Message), ex) { EntityType = typeof(com_ordencompra_local_det_x_com_solicitud_compra_det_Bus) };
            }
        }
