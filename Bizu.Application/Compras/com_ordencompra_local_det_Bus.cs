    ...
    public class com_ordencompra_local_det_Bus
    {
        ...
        public Boolean GuardarDB(List<com_ordencompra_local_det_Info> LstInfo, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(com_ordencompra_local_det_Bus) };
            }
        ...
        public int GetSecuencia_x_OC(int IdEmpresa, int IdSucursal, decimal IdOrdenCompra)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GetSecuencia_x_OC", ex.Message), ex) { EntityType = typeof(com_ordencompra_local_det_Bus) };
        ...
        public Boolean EliminarDetalle_OC(int IdEmpresa, int IdSucursal, decimal IdOrdenCompra, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDetalle_OC", ex.Message), ex) { EntityType = typeof(com_ordencompra_local_det_Bus) };
            }
        }
        ...
        public Boolean Eliminarregistrotabla(List<com_ordencompra_local_det_Info> lmDetalleInfo, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Eliminarregistrotabla", ex.Message), ex) { EntityType = typeof(com_ordencompra_local_det_Bus) };
            }
        }
        ...
        public com_ordencompra_local_det_Info Get_Info_ordencompra_local_det(int IdEmpresa, int IdSucursal, decimal IdOrdenCompra, int Secuencia)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_ordencompra_local_det", ex.Message), ex) { EntityType = typeof(com_ordencompra_local_det_Bus) };
            }
        }
        ...
        public List<com_ordencompra_local_det_Info> Get_List_ordencompra_local_det(int IdEmpresa, int IdSucursal, decimal IdOrdenCompra)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_ordencompra_local_det", ex.Message), ex) { EntityType = typeof(com_ordencompra_local_det_Bus) };
            }
        }
        ...
        public List<com_ordencompra_local_det_Info> Get_List_ordencompra_local_det_Agrupado(int IdEmpresa, int IdSucursal, decimal IdOrdenCompra)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_ordencompra_local_det_Agrupado", ex.Message), ex) { EntityType = typeof(com_ordencompra_local_det_Bus) };
            }
        ...
        public List<com_ordencompra_local_det_Info> Get_List_ordencompra_local_det_x_Proveedor(int IdEmpresa, int IdSucursal, decimal IdProveedor)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_ordencompra_local_det_x_Proveedor", ex.Message), ex) { EntityType = typeof(com_ordencompra_local_det_Bus) };
            }
        }
        ...
        public List<in_movi_inve_detalle_Info> Get_List_movi_inve_detalle(int IdEmpresa, decimal IdProveedor)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_movi_inve_detalle", ex.Message), ex) { EntityType = typeof(com_ordencompra_local_det_Bus) };
