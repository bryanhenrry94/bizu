    ...
    public class vwin_Ingr_Egr_Inven_det_Bus
    {
        ...
        public List<vwin_Ing_Egr_Inven_det_Info> Get_List_in_Ing_Egr_Inven_det(int IdEmpresa, int IdSucursal, int IdBodega, int IdMovi_inven_tipo, string IdEstadoAproba)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Consulta_IngEgrVariosDet", ex.Message), ex) { EntityType = typeof(vwin_Ingr_Egr_Inven_det_Bus) };
            }
        }
        ...
        public List<vwin_Ing_Egr_Inven_det_Info> Get_List_in_Ing_Egr_Inven_det_Todos(int IdEmpresa, int IdSucursal, int IdBodega, int IdMovi_inven_tipo, string IdEstadoAproba, int idOrdenCompra)
        {
            try
            {
                return odata.Get_List_in_Ing_Egr_Inven_det_Todos(IdEmpresa, IdSucursal, IdBodega, IdMovi_inven_tipo, IdEstadoAproba, idOrdenCompra);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public Boolean Modificar_Estado_IngEgr_Det(List<in_Ing_Egr_Inven_det_Info> lista, string tipo, ref string msgs)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Modificar_Estado_IngEgr_Det", ex.Message), ex) { EntityType = typeof(vwin_Ingr_Egr_Inven_det_Bus) };
            }
        }
        ...
        public Boolean Validar_objeto_IngEgr_Det(List<in_Ing_Egr_Inven_det_Info> lista, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Validar_objeto_IngEgr_Det", ex.Message), ex) { EntityType = typeof(vwin_Ingr_Egr_Inven_det_Bus) };
            }
        }
    }
}