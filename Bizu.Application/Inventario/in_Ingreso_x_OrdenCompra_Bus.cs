    ...
    public class in_Ingreso_x_OrdenCompra_Bus
    {
        ...
        Boolean Genera_Inventario(in_Ingreso_x_OrdenCompra_Info info, decimal IdIngreso_oc, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Genera_Inventario", ex.Message), ex) { EntityType = typeof(in_Ingreso_x_OrdenCompra_Bus) };
        ...
        public Boolean Validar_objeto_IngxComp(in_Ingreso_x_OrdenCompra_Info Info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Validar_objeto_IngxComp", ex.Message), ex) { EntityType = typeof(in_Ingreso_x_OrdenCompra_Bus) };
        ...
        public List<in_Ingreso_x_OrdenCompra_Info> Get_List_Ingreso_x_OrdenCompra(int IdEmpresa, int IdSucursal, int IdBodega, DateTime FechaIni, DateTime FechaFin)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Consulta_IngxComp", ex.Message), ex) { EntityType = typeof(in_Ingreso_x_OrdenCompra_Bus) };
        ...
        public in_Ingreso_x_OrdenCompra_Info Get_Info_Ingreso_x_OrdenCompra(int IdEmpresa, decimal IdIngreso_x_oc)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Consulta_Info_IngxComp", ex.Message), ex) { EntityType = typeof(in_Ingreso_x_OrdenCompra_Bus) };
