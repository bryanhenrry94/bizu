    ...
    public class in_grupo_Bus
    {
        ...
        public Boolean GrabarDB(in_grupo_info info, ref int IdGrupo, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(in_grupo_Bus) };
        ...
        public Boolean Validar_objeto_Grupo(in_grupo_info Info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Validar_objeto_Grupo", ex.Message), ex) { EntityType = typeof(in_grupo_Bus) };
        ...
        public Boolean ModificarDB(in_grupo_info info, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_grupo_Bus) };
        ...
        public Boolean AnularDB(in_grupo_info info, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(in_grupo_Bus) };
        ...
        public List<in_grupo_info> Get_List_Grupo(int IdEmpresa, string IdCategoria, int IdLinea)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerListGrupo", ex.Message), ex) { EntityType = typeof(in_grupo_Bus) };
        ...
        public List<in_grupo_info> Get_List_Grupo(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaGeneralGrupo", ex.Message), ex) { EntityType = typeof(in_grupo_Bus) };
        ...
        public List<in_grupo_info> ProcesarDataTablein_grupo_info(DataTable ds, int IdEmpresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ProcesarDataTablein_grupo_info", ex.Message), ex) { EntityType = typeof(in_grupo_info) };
            }
            return lista;
        }
