    ...
    public class in_Catalogo_Tipo_Bus
    {
        ...
        public List<in_CatalogoTipo_Info> Get_List_CatalogoTipo()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ListaTipoCatalogo", ex.Message), ex) { EntityType = typeof(in_Catalogo_Tipo_Bus) };
        ...
        public Boolean GuardarDB(in_CatalogoTipo_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(in_Catalogo_Tipo_Bus) };
        ...
        public Boolean ModificarDB(in_CatalogoTipo_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_Catalogo_Tipo_Bus) };
