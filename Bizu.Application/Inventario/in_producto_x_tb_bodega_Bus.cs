    ...
    public class in_producto_x_tb_bodega_Bus
    {
        ...
        public List<in_producto_x_tb_bodega_Info> Get_List_Producto_x_Bodega_x_CtasCbles(int IdEmpresa, int IdSucursal, int IdBodega)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Producto_x_Bodega_x_CtasCbles", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Bus) };
        ...
        public List<in_producto_x_tb_bodega_Info> Get_List_Producto_x_Bodega(int idempresa, int idbodega)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Producto_x_Bodega", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Bus) };

            }
        }

        public List<in_producto_x_tb_bodega_Info> Get_List_Producto_x_Bodega_InicioFin(int idempresa, int idbodega_Inicio, int idbodega_Fin, int IdMarca, int IdLinea, string IdCategoria, decimal IdProductoIni, decimal IdProductoFin)
        {

            try
            {
                return data.Get_List_Producto_x_Bodega_InicioFin(idempresa, idbodega_Inicio, idbodega_Fin, IdMarca, IdLinea, IdCategoria, IdProductoIni, IdProductoFin);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public List<in_producto_x_tb_bodega_Info> Get_list_Productos_x_Bodega(int idempresa, decimal IdProducto)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Productos_x_Bodega", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Bus) };
        ...
        public List<in_producto_x_tb_bodega_Info> Get_List_ProductoxBodegaxSucursal_q_no_existen_en_sucu_bod(int idempresa, int idbodega, int Idsucursal, List<decimal> listProducto)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_ProductoxBodegaxSucursal_q_no_existen_en_sucu_bod", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Bus) };
        ...
        public Boolean GrabaDB(List<in_producto_x_tb_bodega_Info> ls, int idempresa, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabaDB", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Bus) };
        ...
        public Boolean GrabaDB(in_producto_x_tb_bodega_Info item, int idempresa, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabaDB_x_item", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Bus) };
        ...
        public Boolean ModificarDB(List<in_producto_x_tb_bodega_Info> ls, int idempresa, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Bus) };
        ...
        public bool Delete_Todos_Producto_x_bodega(int IdEmpresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminaRegistros", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Bus) };
        ...
        public List<in_producto_x_tb_bodega_Info> Get_List_producto_x_tb_bodega_x_Transferencia(int idempresa, int idbodega, int idsucursa, List<in_transferencia_det_Info> listdetalle, decimal idtransferencia)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerProduPedidos", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Bus) };
        ...
        public Boolean ActualizarStock_x_Bodega_con_moviInven(List<in_movi_inve_detalle_Info> listaMovi, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ActualizarStock_x_Bodega_con_moviInven", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Bus) };
        ...
        public List<in_producto_x_tb_bodega_Info> Get_List_ProductoxBodegaxSucursal_x_Bodega(int idempresa, int idbodega, int Idsucursal)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerProductoxBodegaxSucursal", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Bus) };
        ...
        public double Get_Stock_Actual_x_Producto(int IdEmpresa, int IdSucursa, int IdBodega, Decimal IdProducto)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerObjeto", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Bus) };
        ...
        public Boolean EliminarDB(in_producto_x_tb_bodega_Info item, int idempresa, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminaUnRegistros", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Bus) };
        ...
        public Boolean EliminarDB(int IdEmpresa, decimal IdProducto)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Bus) };
