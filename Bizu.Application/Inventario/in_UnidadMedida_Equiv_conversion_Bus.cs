    ...
    public class in_UnidadMedida_Equiv_conversion_Bus
    {
        ...
        public List<in_UnidadMedida_Equiv_conversion_Info> Get_List_in_UnidadMedida_Equiv_conversion(string IdUnidadMedida)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerListUnidadMedida_Equiv_conversion", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Equiv_conversion_Bus) };
        ...
        public Boolean GrabarDB(in_UnidadMedida_Equiv_conversion_Info prI, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Equiv_conversion_Bus) };
        ...
        public Boolean ModificarDB(in_UnidadMedida_Equiv_conversion_Info prI, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Equiv_conversion_Bus) };
        ...
        public Boolean GuardarListDB(List<in_UnidadMedida_Equiv_conversion_Info> Lista,ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarListDB", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Equiv_conversion_Bus) };
        ...
        public Boolean EliminarDB(string IdUnidadMedida,ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Equiv_conversion_Bus) };
        ...
        public in_UnidadMedida_Equiv_conversion_Info Get_Info_in_UnidadMedida_Equiv_conversion(string IdUnidadMedida, string IdUnidadMedida_equiva)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_Info_ValorConversion", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Equiv_conversion_Bus) };
