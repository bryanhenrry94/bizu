    ...
    public class in_producto_x_cp_proveedor_Bus
    {
        ...
        public List<in_producto_x_cp_proveedor_Info> ObtenerProducto_Proveedor(int idempresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerProducto_Proveedor", ex.Message), ex) { EntityType = typeof(in_producto_x_cp_proveedor_Bus) };
        ...
        public Boolean ModificarDB(in_producto_x_cp_proveedor_Info pxp, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_producto_x_cp_proveedor_Bus) };
        ...
        public Boolean eliminarregistrotabla(List<in_producto_x_cp_proveedor_Info> lst, int idEmpresa, int idProducto, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "eliminarregistrotabla", ex.Message), ex) { EntityType = typeof(in_producto_x_cp_proveedor_Bus) };
        ...
        public Boolean eliminarRegistro_x_producto(int idEmpresa, int IdProductoPadre, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "eliminarRegistro_x_producto", ex.Message), ex) { EntityType = typeof(in_producto_x_cp_proveedor_Bus) };
            }
        }
        ...
        public Boolean ModificarLIsta(List<in_producto_x_cp_proveedor_Info> lst, int idEmpresa, int idProducto, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarLIsta", ex.Message), ex) { EntityType = typeof(in_producto_x_cp_proveedor_Bus) };
        ...
        public Boolean Grabar_Producto_Proveedor(in_producto_x_cp_proveedor_Info item, int idEmpresa, decimal idProducto, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Grabar_Producto_Proveedor", ex.Message), ex) { EntityType = typeof(in_producto_x_cp_proveedor_Bus) };
        ...
        public Boolean Grabar_Producto_Proveedor_lista(List<in_producto_x_cp_proveedor_Info> Lista, int idEmpresa, decimal idProducto, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Grabar_Producto_Proveedor_lista", ex.Message), ex) { EntityType = typeof(in_producto_x_cp_proveedor_Bus) };
        ...
        public Boolean eliminarregistrotablaUno(in_producto_x_cp_proveedor_Info item, int idEmpresa, decimal idProducto, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "eliminarregistrotablaUno", ex.Message), ex) { EntityType = typeof(in_producto_x_cp_proveedor_Bus) };
