    ...
    public class in_movi_inven_tipo_Bus
    {
        ...
        public List<in_movi_inven_tipo_Info> Get_List_movi_inven_tipo(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerListaMovimientoInventarioTipoXEmpresa", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_Bus) };
        ...
        public List<in_movi_inven_tipo_Info> Get_list_movi_inven_tipo(int IdEmpresa, string tipoMovi, string Interno, string todos)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_list_movi_inven_tipo", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_Bus) };
        ...
        public List<in_movi_inven_tipo_Info> Get_list_movi_inven_tipo(int IdEmpresa, string tipoMovi)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_list_movi_inven_tipoParametros", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_Bus) };
        ...
        public List<in_movi_inven_tipo_Info> Get_list_movi_inven_tipo_x_bodega(int IdEmpresa, int IdSucursal, int idBodega, string tipoMovi, string Interno)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_list_movi_inven_tipo_x_bodega", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_Bus) };
        ...
        public Boolean ModificarDB(in_movi_inven_tipo_Info moviI, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_Bus) };
        ...
        public Boolean AnularDB(in_movi_inven_tipo_Info moviI)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Anuliar_Reg_DB", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_Bus) };
        ...
        public Boolean GrabarDB(in_movi_inven_tipo_Info MoviI, ref string Mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Guardar_Reg_DB", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_Bus) };
        ...
        public int GetIdMoviInvent(int id)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerId", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_Bus) };
        ...
        public Boolean Get_Codigo(in_movi_inven_tipo_Info MoviI, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultarCodigo", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_Bus) };
        ...
        public Boolean Cons_MovimientoInventario(in_movi_inven_tipo_Info MoviI, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Cons_MovimientoInventario", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_Bus) };
        ...
        public in_movi_inven_tipo_Info Get_Info_movi_inven_tipo(int IdEmpresa, string Idtipo, int s = 0)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_Un_movi_inven_tipo", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_Bus) };
