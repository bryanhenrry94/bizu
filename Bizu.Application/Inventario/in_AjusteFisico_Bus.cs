    ...
    public class in_AjusteFisico_Bus
    {
        ...
        public Boolean GuardarDB(in_ajusteFisico_Info Info,ref decimal  idAjuste,ref decimal  idEgressoMovi,ref decimal  idIngresoMovi)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarAjusteFisico", ex.Message), ex) { EntityType = typeof(in_AjusteFisico_Bus) };
            }          
        }
        ...
        public Boolean ModificarDB(in_ajusteFisico_Info Info, ref decimal idAjuste, ref decimal idEgressoMovi, ref decimal idIngresoMovi)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_AjusteFisico_Bus) };
            }  
        }
        ...
        private bool Generar_info_ing_egr(in_ajusteFisico_Info info_ajuste, ref decimal IdNumMovi_ing,ref decimal IdNumMovi_egr)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Armar_info_ing_egr", ex.Message), ex) { EntityType = typeof(in_AjusteFisico_Bus) };
            }   
        }
        ...
        public List<in_ajusteFisico_Info> Get_List_ajusteFisico(int idEmpresa, int IdSucursal, int idBodga, DateTime FechaIni, DateTime FechaFin)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaGenera", ex.Message), ex) { EntityType = typeof(in_AjusteFisico_Bus) };
        ...
        public Boolean AnularDB(in_ajusteFisico_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Anular", ex.Message), ex) { EntityType = typeof(in_AjusteFisico_Bus) };
        ...
        public Boolean ModificarDB(int IdEmpresa, decimal IdAjusteFisico, string IdEstadoAproba, decimal IdNumMovi_Egr, decimal IdNumMovi_Ing)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Modificar", ex.Message), ex) { EntityType = typeof(in_AjusteFisico_Bus) };
        ...
        public List<in_Producto_Info> Get_List_Productos_en_ajuste_fisico_a_fecha(int IdEmpresa, List<in_Producto_Info> listadoProducto_a_buscar, DateTime FechaAjuste, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Listado_Productos_en_ajuste_fisico_a_fecha", ex.Message), ex) { EntityType = typeof(in_AjusteFisico_Bus) };
