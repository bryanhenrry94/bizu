    ...
    public class in_subgrupo_x_CentroCosto_x_SubCentroCosto_x_CtaCble_Bus
    {
        ...
        public List<in_subgrupo_x_CentroCosto_x_SubCentroCosto_x_CtaCble_Info> Get_List_Info_in_subgrupo(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Info_in_subgrupo", ex.Message), ex) { EntityType = typeof(in_subgrupo_x_CentroCosto_x_SubCentroCosto_x_CtaCble_Bus) };
            }
        }
        ...
        public List<in_subgrupo_x_CentroCosto_x_SubCentroCosto_x_CtaCble_Info> Get_List_Info_in_subgrupo_no_parametrizados(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Info_in_subgrupo_no_parametrizados", ex.Message), ex) { EntityType = typeof(in_subgrupo_x_CentroCosto_x_SubCentroCosto_x_CtaCble_Bus) };
            }
        }

        public in_subgrupo_x_CentroCosto_x_SubCentroCosto_x_CtaCble_Info Get_Info_in_subgrupo(int IdEmpresa, string IdCategoria, int IdLinea, int IdGrupo, int IdSubGrupo, string IdCentroCosto, string IdSubCentroCosto)
        {
            try
            {
