    ...
    public class in_linea_Bus
    {
        ...
        public Boolean GrabarDB(in_linea_info info, ref int IdLinea, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(in_linea_Bus) };
        ...
        public Boolean Validar_objeto_Linea(in_linea_info Info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Validar_objeto_Linea", ex.Message), ex) { EntityType = typeof(in_linea_Bus) };
        ...
        public Boolean ModificarDB(in_linea_info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_linea_Bus) };
        ...
        public Boolean AnularDB(in_linea_info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(in_linea_Bus) };

            }
        }

        public in_linea_info Get_Info_Linea(int IdEmpresa, string IdCategoria, int IdLinea)
        {
            try
            {
                return odata.Get_Info_Linea(IdEmpresa, IdCategoria, IdLinea);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerListLinea", ex.Message), ex) { EntityType = typeof(in_linea_Bus) };
            }
        }
        ...
        public List<in_linea_info> ConsultaGeneralLinea(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaGeneralLinea", ex.Message), ex) { EntityType = typeof(in_linea_Bus) };
        ...
        public List<in_linea_info> ProcesarDataTablein_linea_info(DataTable ds, int IdEmpresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ProcesarDataTablein_linea_info", ex.Message), ex) { EntityType = typeof(in_linea_info) };
            }
            return lista;
        }
        ...
        public int Get_IdLinea(int IdEmpresa, string IdCategoria, string Nom_Linea)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerObjeto", ex.Message), ex) { EntityType = typeof(in_categorias_bus) };
            }
        }
    }
}
