...
namespace Bizu.Application.Inventario
{
    public class in_movi_inve_Bus
    {
        ...
        in_Motivo_Inven_Bus motivoInvBus = new in_Motivo_Inven_Bus();
        in_Motivo_Inven_Info motivoInvInfo = new in_Motivo_Inven_Info();
        ...
        public Boolean ModificarDB_proceso_cerrado(in_movi_inve_Info info, ref string msgs)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Actualizar_estado_despacho", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
        ...
        public List<in_movi_inve_Info> Get_list_Movi_inven(int IdEmpresa, int IdSucursalIni, int IdSucursalFin, int IdBodegaIni, int IdBodegaFin, int TipoMoviIni, int TipoMoviFin, DateTime FechaIni, DateTime FechaFin, string Signo_Ing_Egre = "")
        {
            try
            {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_list_Movi_inven", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
        ...
        public List<in_movi_inve_Info> Get_list_Movi_inven_para_contabilizar(int IdEmpresa, string cm_signo, DateTime Fecha_ini, DateTime Fecha_fin, string Estado_contabilizacion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_list_Movi_inven_Recepcion", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }

        public Boolean GrabarDB(in_movi_inve_Info MoviInven_Info, ref decimal idMoviInven, ref string mensaje_cbte_cble, ref string mensaje, Boolean Esta_Transaccion_Contabiliza = true)
        {
            try
            {
                ...
                infoParam = busParam.Get_Info_Parametro(MoviInven_Info.IdEmpresa);
                ...
                if (PerBus.Get_Periodo_Esta_Cerrado(MoviInven_Info.IdEmpresa, Convert.ToDateTime(MoviInven_Info.cm_fecha), ref mensaje))
                {
                ...
                MoviInven_Info.cm_fecha = Convert.ToDateTime(MoviInven_Info.cm_fecha);
        ...
        public List<in_movi_inve_Info> Get_list_Movi_inven_x_despachar(int IdEmpresa, int IdSucursal, int IdBodega)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Movi_inven_x_despachar", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
        ...
        public void setInfo_Costo_Historico_Graba(List<in_movi_inve_detalle_Info> InfoDet, DateTime cm_fecha)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "setInfo_Costo_Historico_Graba", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
        ...
        public List<in_movi_inve_detalle_Info> Calcular_Costeo(in_movi_inve_Info InfoDet)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Calcular_Costeo", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(in_movi_inve_Info prI, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
        ...
        public Boolean AnularDB(in_movi_inve_Info MoviInvenInfo_a_anular, DateTime Fecha_Anulacion, ref  string mensaje)
        {
            try
            {
                ...
                Fecha_Anulacion = Convert.ToDateTime(Fecha_Anulacion);
                ...
                if (PerBus.Get_Periodo_Esta_Cerrado(MoviInvenInfo_a_anular.IdEmpresa, Convert.ToDateTime(Fecha_Anulacion), ref mensaje_cbte_cble))
                {
                ...
                MoviInven_x_anulacion.Estado = "I";
                ...
                MoviInve_x_ctecble_bus.Anular_reversar_Diario_x_Movi_Inven(MoviInvenInfo_a_anular.IdEmpresa, MoviInvenInfo_a_anular.IdSucursal,
                                                                           MoviInvenInfo_a_anular.IdBodega, MoviInvenInfo_a_anular.IdMovi_inven_tipo,
                                                                           MoviInvenInfo_a_anular.IdNumMovi, IdTipoCbteCble_x_anulacion,
                                                                           ref  IdCbteCble_x_anulacion, param.IdUsuario, Fecha_Anulacion);

                //guardando la relacion del diario por reverso versus el Movi inven
                if (IdCbteCble_x_anulacion != 0)
                {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }

        public in_movi_inve_Info Get_Info_Movi_inven_Report(int IdEmpresa, int IdSucursal, int IdBodega, int TipoMovi, decimal IdNumMovi)
        {
            try
            {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_list_Movi_inven_Reporte", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
        ...
        public List<vwIn_MoviemientoInvetarioXImportacion_Info> Get_List_SaldoImpoXMovimiento(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdOrdenCompraExterna)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "SaldoImpoXMovimiento", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
        ...
        public List<in_movi_inve_Info> Get_list_Movi_inven_x_ProdDiariaLagminadosTalme(int idcompany, int idSucursal, int IdBodega, int TipoMovi, decimal IdNumMo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_list_Movi_inven_x_ProdDiariaLaminadosTalme", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
        ...
        public List<in_movi_inve_Info> Get_list_Movi_inven(int IdEmpresa, int IdSucursal)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_list_Movi_inven_All", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
        ...
        public Boolean Contabilizar(in_movi_inve_Info in_movi_info, ref string mensaje_cbte_cble, ref string mensaje)
        {
            try
            {
                ...
                listMovi_Inven = BusMoviInven_det_conta.Get_List_movi_inve_detalle_x_Contabilizar_x_ctacbles(in_movi_info.IdEmpresa, in_movi_info.IdSucursal, in_movi_info.IdBodega, in_movi_info.IdMovi_inven_tipo, in_movi_info.IdNumMovi);
                ...
                if (listMovi_Inven.Count() > 0)// solo contabilizar si hay datos a contabilizar
                {
                    ...
                    if (ParamInven_info.P_Fecha_para_contabilizacion_ingr_egr == "FEC_ACTUAL")
                        cbt_Info.cb_Fecha = (in_movi_info.Fecha_Transac == null) ? in_movi_info.cm_fecha : Convert.ToDateTime(Convert.ToDateTime(in_movi_info.Fecha_Transac));
                    else
                        cbt_Info.cb_Fecha = Convert.ToDateTime(in_movi_info.cm_fecha);
                    ...
                    foreach (var item_x_Movi_Inven in listMovi_Inven)
                    {
                        ...
                        _cbteCble_det_info.secuencia = iSecuencia;
                        iSecuencia++;
                        ...
                        else
                        {
                            ...
                            {
                                InfoSubGx_Cta = BusSubGx_Cta.Get_Info_in_subgrupo(item_x_Movi_Inven.IdEmpresa, item_x_Movi_Inven.IdCategoria, item_x_Movi_Inven.IdLinea, item_x_Movi_Inven.IdGrupo, item_x_Movi_Inven.IdSubGrupo, item_x_Movi_Inven.IdCentro_Costo_x_MoviInv, item_x_Movi_Inven.IdSubCentro_Costo_x_MoviInv);
                            ...
                            if (item_x_Movi_Inven.es_Inven_o_Consumo == ein_Inventario_O_Consumo.TIC_PRODUCCION || item_x_Movi_Inven.es_Inven_o_Consumo == ein_Inventario_O_Consumo.TIC_VAR_MT)
                            {
                                if (item_x_Movi_Inven.IdMotivo_Inv_det != null && item_x_Movi_Inven.IdCtaCble_Costo_x_Motivo_det != null)//tienen motivo
                                {
                                    _cbteCble_det_info.IdCtaCble = item_x_Movi_Inven.IdCtaCble_Costo_x_Motivo_det;
                            ...
                            if (item_x_Movi_Inven.es_Inven_o_Consumo == ein_Inventario_O_Consumo.TIC_NC)
                            {
                                if (item_x_Movi_Inven.IdMotivo_Inv_det != null && item_x_Movi_Inven.IdCtaCble_Costo_x_Motivo_det != null)//tienen motivo
                                {
                                    _cbteCble_det_info.IdCtaCble = item_x_Movi_Inven.IdCtaCble_Costo_x_Motivo_det;
                            ...
                            if (item_x_Movi_Inven.es_Inven_o_Consumo == ein_Inventario_O_Consumo.TIC_TRANS)
                            {
                                if (item_x_Movi_Inven.IdMotivo_Inv_det != null && item_x_Movi_Inven.IdCtaCble_Costo_x_Motivo_det != null)//tienen motivo
                                {
                                    _cbteCble_det_info.IdCtaCble = item_x_Movi_Inven.IdCtaCble_Costo_x_Motivo_det;
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Contabilizar", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
        ...
        public Boolean ReversoContable_MoviInven_sin_moviinven(int IdEmpresa, int IdSucursal, int IdBodega, int IdTipoMovi_Inven, decimal IdNumMovi_Inven, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ReversoContable_MoviInven_sin_moviinven", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
        ...
        public List<in_movi_inve_Info> BusquedasIngCompraBodega(int idempresa, int idsucursal, int idbodega, DateTime FechaIni, DateTime FechaFin)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "BusquedasIngCompraBodega", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
        ...
        public int GetMovimientIngresoEmpresa(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GetMovimientIngresoEmpresa", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
        ...
        public DateTime Get_fecha_costeo_recomendada(int IdEmpresa, int IdSucursal)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_fecha_costeo_recomendada", ex.Message), ex) { EntityType = typeof(in_movi_inve_Bus) };
            }
        }
