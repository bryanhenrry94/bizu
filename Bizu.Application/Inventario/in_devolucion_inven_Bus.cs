    ...
    public class in_devolucion_inven_Bus
    {
        ...
        public decimal GetId(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GetId", ex.Message), ex) { EntityType = typeof(in_devolucion_inven_Bus) };
        ...
        public Boolean GuardarDB(in_devolucion_inven_Info info, ref decimal IdDev_Inven, ref string mensaje)
        {
            ...
            try
            {
                ...
                if (Respuesta)
                {
                    ...
                    Info_Ing_Egr.IdEmpresa = param.IdEmpresa;
                    Info_Ing_Egr.IdSucursal = param.IdSucursal;
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(in_devolucion_inven_Bus) };
        ...
        public Boolean ModificarDB(in_devolucion_inven_Info info, ref string msgs)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_devolucion_inven_Bus) };
        ...
        public Boolean AnularDB(in_devolucion_inven_Info info, ref string msgs)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(in_devolucion_inven_Bus) };

            }
        }

        public List<in_devolucion_inven_Info> Get_List_in_devolucion_inven(int IdEmpresa, int IdSucursalIni, int IdSucursalFin, DateTime FechaIni, DateTime FechaFin)
        {
            try
            {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_in_devolucion_inven", ex.Message), ex) { EntityType = typeof(in_devolucion_inven_Bus) };
            }
        }
        ...
        public in_devolucion_inven_Info Get_Info_in_devolucion_inven(int IdEmpresa, decimal IdDev_Inven)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_in_devolucion_inven", ex.Message), ex) { EntityType = typeof(in_devolucion_inven_Bus) };
