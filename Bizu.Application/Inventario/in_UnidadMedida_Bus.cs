       ...
       public List<in_UnidadMedida_Info> Get_list_UnidadMedida_equivalencia(string IdUnidadMedida)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_UnidadMedida_equivalencia", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Bus) };
        ...
        public List<in_UnidadMedida_Info> Get_list_UnidadMedida()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_list_UnidadMedida", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Bus) };

            }
        }

        public in_UnidadMedida_Info Get_Info_UnidadMedida(string IdUnidadMedida)
        {
            try
            {
                return OData.Get_Info_UnidadMedida(IdUnidadMedida);                
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_UnidadMedida", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Bus) };                
            }
        }
        ...
        public Boolean ValidarObjeto(in_UnidadMedida_Info Info, ref string mensaje)
        {
            try
            {
                ...
                {
                    Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                    throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ValidarObjeto", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Bus) };
        ...
        private void corregirObjeto(ref in_UnidadMedida_Info Info,ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "corregirObjeto", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Bus) };
        ...
        public Boolean GrabarDB(in_UnidadMedida_Info prI, ref string IdUnidadMedida, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Bus) };
        ...
        public Boolean ModificarDB(in_UnidadMedida_Info prI, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Bus) };
        ...
        public Boolean AnularDB(in_UnidadMedida_Info UniInfo, ref  string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Bus) };
        ...
        public Boolean Existe_IdUnidadMedida(string IdUnidaMedida)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Existe_IdUnidadMedida", ex.Message), ex) { EntityType = typeof(in_UnidadMedida_Bus) };
