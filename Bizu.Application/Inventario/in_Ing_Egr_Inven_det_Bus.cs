    ...
    public class in_Ing_Egr_Inven_det_Bus
    {
        ...
        public Boolean GuardarDB(List<in_Ing_Egr_Inven_det_Info> LstInfo)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(in_Ing_Egr_Inven_det_Bus) };
        ...
        public Boolean EliminarDB(List<in_Ing_Egr_Inven_det_Info> lstInfo, ref string msgs)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(in_Ing_Egr_Inven_det_Bus) };
        ...
        public Boolean ModificarDetalle_IdMovi_Inven_x_IngEgr(List<in_Ing_Egr_Inven_det_Info> lista, ref string msgs)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDetalle_IdMovi_Inven_x_IngEgr", ex.Message), ex) { EntityType = typeof(in_Ing_Egr_Inven_det_Bus) };
        ...
        public in_Ing_Egr_Inven_det_Info Get_Info_Ing_Egr_Inven_det_x_Movi_Inven(int IdEmpresa_inv, int IdSucursal_inv, int IdBodega_Inv, int IdMovi_inven_tipo_inv, decimal IdNumMovi)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Ing_Egr_Inven_det_x_Num_Movimiento", ex.Message), ex) { EntityType = typeof(in_Ing_Egr_Inven_det_Bus) };
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_Inven_det(int IdEmpresa, int IdSucursal, int IdMovi_inven_tipo, decimal IdNumMovi)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Ing_Egr_Inven_det", ex.Message), ex) { EntityType = typeof(in_Ing_Egr_Inven_det_Bus) };
            }
        }

        public in_Ing_Egr_Inven_det_Info Get_List_Ing_Egr_Inven_det(int IdEmpresa, int IdSucursal, int IdMovi_inven_tipo, decimal IdNumMovi, int Secuencia)
        {
            try
            {
                return odata.Get_List_Ing_Egr_Inven_det(IdEmpresa, IdSucursal, IdMovi_inven_tipo, IdNumMovi, Secuencia);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_Inven_det_x_transferencia(int IdEmpresa, int IdSucursalOrigen, int IdBodegaOrigen, decimal IdTransferencia)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Consulta_IngEgrDet_x_Transfe", ex.Message), ex) { EntityType = typeof(in_Ing_Egr_Inven_det_Bus) };
            }
        }
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_Inven_det_agrupada(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdNumMovi)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Ing_Egr_Inven_det_agrupada", ex.Message), ex) { EntityType = typeof(in_Ing_Egr_Inven_det_Bus) };
            }
        }
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_det_x_OC_Agrupado(int IdEmpresa, int IdSucursal, decimal IdOrdenCompra)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Consulta_IngEgrDet_x_OC_Agrupado", ex.Message), ex) { EntityType = typeof(in_Ing_Egr_Inven_det_Bus) };
            }
        }

        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_det_x_GR_Agrupado(int IdEmpresa, int IdSucursal, decimal IdGuiaRemision)
        {
            try
            {
                return odata.Get_List_Ing_Egr_det_x_GR_Agrupado(IdEmpresa, IdSucursal, IdGuiaRemision);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_det_x_OT_Agrupado(int IdEmpresa, int IdSucursal, decimal IdOrdenTrabajo)
        {
            List<in_Ing_Egr_Inven_det_Info> list;
            try
            {
                list = this.odata.Get_List_Ing_Egr_det_x_OT_Agrupado(IdEmpresa, IdSucursal, IdOrdenTrabajo);
            }
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_Inven_det_x_OrdenCompra(int IdEmpresa, int IdSucursal, decimal IdOrdenCompra)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Consulta_IngEgrDet_x_OC", ex.Message), ex) { EntityType = typeof(in_Ing_Egr_Inven_det_Bus) };
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_Inven_det_x_OrdenCompraDet(int IdEmpresa, int IdSucursal, int IdMovi_inven_tipo, decimal IdNumMovi)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Consulta_IngEgrDet_x_OrdenCompraDet", ex.Message), ex) { EntityType = typeof(in_Ing_Egr_Inven_det_Bus) };
        ...
        public Boolean ModificarDB(in_Ing_Egr_Inven_det_Info Info, ref  string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_Ing_Egr_Inven_det_Bus) };
        ...
        public List<vwIn_Ing_Egr_Inven_det_x_Cbte_Cble_Info> Get_List_Ing_Egr_x_Cbte_Cble(int IdEmpresa, int IdSucursal, int IdBodega, int IdMovi_inven_tipo, decimal IdNumMovi)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_Ing_Egr_x_Cbte_Cble", ex.Message), ex) { EntityType = typeof(in_Ing_Egr_Inven_det_Bus) };
            }
        }
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_det_x_Cat_lin_gru_sub_Centro_subcentro(int IdEmpresa, string IdCategoria, int IdLinea, int IdGrupo, int IdSubgrupo, string IdCentroCosto, string IdCentroCosto_sub_centro_costo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Ing_Egr_det_x_Cat_lin_gru_sub_Centro_subcentro", ex.Message), ex) { EntityType = typeof(in_Ing_Egr_Inven_det_Bus) };
            }
        }
        ...
        public List<in_Ing_Egr_Inven_det_Info> Get_List_Ing_Egr_Inven_x_Lote(int IdEmpresa, int IdSucursal, int IdMovi_inven_tipo, decimal IdProducto, string numero_lote)
        {
            try
            {
                return odata.Get_List_Ing_Egr_Inven_x_Lote(IdEmpresa, IdSucursal, IdMovi_inven_tipo, IdProducto, numero_lote);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Ing_Egr_Inven_x_Lote", ex.Message), ex) { EntityType = typeof(in_Ing_Egr_Inven_Bus) };
            }
        }
    }
}