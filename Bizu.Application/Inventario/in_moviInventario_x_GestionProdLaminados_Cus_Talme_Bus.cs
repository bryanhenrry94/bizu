    ...
    public class in_moviInventario_x_GestionProdLaminados_Cus_Talme_Bus
    {
        ...
        public Boolean GuardarDB(in_moviInventario_x_GestionProdLaminados_Cus_Talme_Info Info)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(in_moviInventario_x_GestionProdLaminados_Cus_Talme_Bus) };
        ...
        public in_moviInventario_x_GestionProdLaminados_Cus_Talme_Info Get_Info_moviInventario_x_GestionProdLaminados_Cus_Talme(int IdEmpresa, Decimal IdGestion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultarObjeto", ex.Message), ex) { EntityType = typeof(in_moviInventario_x_GestionProdLaminados_Cus_Talme_Bus) };
        ...
        public Boolean Eliminar(in_moviInventario_x_GestionProdLaminados_Cus_Talme_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Eliminar", ex.Message), ex) { EntityType = typeof(in_moviInventario_x_GestionProdLaminados_Cus_Talme_Bus) };
