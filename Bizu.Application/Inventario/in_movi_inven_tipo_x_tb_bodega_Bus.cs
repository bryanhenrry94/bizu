  ...
  public   class in_movi_inven_tipo_x_tb_bodega_Bus
    {
        ...
        public in_movi_inven_tipo_x_tb_bodega_Info Get_Info_movi_inven_tipo_x_tb_bodega(int IdEmpresa, int IdSucursal, int IdBodega, int IdMovi_inven_tipo)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_list_inventario_tipobodega", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_x_tb_bodega_Bus) };
        ...
        public Boolean GrabarDB(List<in_movi_inven_tipo_x_tb_bodega_Info> lst, int IdEmpresa, in_movi_inven_tipo_Info moviI, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarLista", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_x_tb_bodega_Bus) };
        ...
        public List<in_movi_inven_tipo_x_tb_bodega_Info> Get_List_movi_inven_tipo_x_tb_bodega(int IdEmpresa, in_movi_inven_tipo_Info moviI, int IdSucursal)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "consulta_movimiento_tipo_x_bodega", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_x_tb_bodega_Bus) };
        ...
        public Boolean ModificarDB(List<in_movi_inven_tipo_x_tb_bodega_Info> lst, int idEmpresa, in_movi_inven_tipo_Info moviI, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarLIsta", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_x_tb_bodega_Bus) };
        ...
        public List<in_movi_inven_tipo_x_tb_bodega_Info> Get_List_movi_inven_tipo_x_tb_bodega(int IdEmpresa, int IdMoviInvenTipo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Consultar_BodegayCuentaContable_X_TipodeMovimiento", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_x_tb_bodega_Bus) };
        ...
        public Boolean GrabarDB(List<in_movi_inven_tipo_x_tb_bodega_Info> lst, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarSucursalBodegaxCtaContable", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_x_tb_bodega_Bus) };
        ...
        public Boolean ModificarDB(List<in_movi_inven_tipo_x_tb_bodega_Info> lst, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarSucursalBodegaXCtaContable", ex.Message), ex) { EntityType = typeof(in_movi_inven_tipo_x_tb_bodega_Bus) };
