    ...
    public class in_movi_inve_detalle_Bus
    {
        ...
        public List<in_movi_inve_detalle_Info> Get_list_Movi_inven_det(int IdEmpresa, int Idsucursal, int IdBodega, int idTipoMovi, decimal IdNumMovimiento)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_list_Movi_inven_det", ex.Message), ex) { EntityType = typeof(in_movi_inve_detalle_Bus) };
            }
        }

        public in_movi_inve_detalle_Info Get_info_Movi_inven_det(int IdEmpresa, int Idsucursal, int idbodega, int idTipoMovi, decimal IdNumMovimiento, int Secuencia)
        {
            try
            {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Consulta_list_Movi_inven_det", ex.Message), ex) { EntityType = typeof(in_movi_inve_detalle_Bus) };
            }
        }

        public List<in_movi_inve_detalle_Info> Get_list_Movi_inven_det_x_Ing_OrdenCompra_local(int IdEmpresa, int Idsucursal, int IdBodega, int idTipoMovi, decimal IdNumMovimiento)
        {
            try
            {
        ...
        public Boolean GrabarDB(List<in_movi_inve_detalle_Info> list, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(in_movi_inve_detalle_Bus) };
            }
        }
        ...
        public Boolean AnularDB(List<in_movi_inve_detalle_Info> ListMoviInfo, ref  string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(in_movi_inve_detalle_Bus) };
            }
        }
        ...
        public in_movi_inve_detalle_Info Get_Saldo_x_Prod_x_Fecha(int IdEmpresa, DateTime Fecha, int IdSucursal, int IdBodega, decimal IdProducto, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_Saldo_x_Prod_x_Fecha", ex.Message), ex) { EntityType = typeof(in_movi_inve_detalle_Bus) };
            }
        }
        ...
        public List<in_movi_inve_detalle_Info> Get_Kardex_x_Prod_x_Fecha(int IdEmpresa, DateTime FechaIni, DateTime FechaFin, int IdSucursal, int IdBodega, decimal IdProducto, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_Kardex_x_Prod_x_Fecha", ex.Message), ex) { EntityType = typeof(in_movi_inve_detalle_Bus) };
            }
        }
        ...
        public List<in_movi_inve_detalle_Info> Get_List_StockAFecha(int IdEmpresa, int IdSucursal, int IdBodega, DateTime Fecha)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObjtenerStockAFecha", ex.Message), ex) { EntityType = typeof(in_movi_inve_detalle_Bus) };
            }
        }

        public List<in_movi_inve_detalle_Info> Get_list_Movi_inven_det_x_ing_egr(int IdEmpresa, int Idsucursal, int idTipoMovi, decimal IdNumMovimiento)
        {
            try
            {
        ...
        public List<in_movi_inve_detalle_Info> Get_List_CuerpoKardex(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdProducto, DateTime FechaIncial, DateTime FechaFinal)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerCuerpoKardex", ex.Message), ex) { EntityType = typeof(in_movi_inve_detalle_Bus) };
            }
        }
        ...
        public in_movi_inve_detalle_Info Get_Info_StockAFechaPorProduct(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdProducto, DateTime Fecha)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerStockAFechaPorProduct", ex.Message), ex) { EntityType = typeof(in_movi_inve_detalle_Bus) };
            }
        }
    }
}