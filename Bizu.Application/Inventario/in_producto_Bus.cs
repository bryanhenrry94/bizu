...
namespace Bizu.Application.Inventario
{
    public class in_producto_Bus
    {
        ...
        string CodProducto_x_Linea = "";
        int SecuencialCodProducto_x_Categoria = 0;
        int SecuencialCodProducto_x_Linea = 0;
        ...
        public List<in_Producto_Info> Get_list_Producto(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_listProducto", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> Get_list_Producto_cmb(int IdEmpresa)
        {
            try
            {
                return proD.Get_list_Producto_cmb(IdEmpresa);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public List<in_Producto_Info> Get_list_Producto_modulo_x_compra(int IdEmpresa, int IdSucursal)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_Productos_x_Sucursal", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> Get_list_Producto_modulo_x_compra_lite(int IdEmpresa, int IdSucursal)
        {
            try
            {
                return proD.Get_list_Producto_modulo_x_compra_lite(IdEmpresa, IdSucursal);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public List<in_Producto_Info> Get_list_Producto_modulo_x_compra_sin_Stock(int IdEmpresa, int IdSucursal)
        {
            try
            {
                return proD.Get_list_Producto_modulo_x_compra_sin_Stock(IdEmpresa, IdSucursal);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public List<in_Producto_Info> Get_list_Producto_modulo_x_inventario(int IdEmpresa, int IdSucursal, int IdBodega)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Producto_modulo_x_inventario", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> Get_list_Producto_modulo_x_inventario_Lote(int IdEmpresa, int IdSucursal, int IdBodega)
        {
            try
            {
                return proD.Get_list_Producto_modulo_x_inventario_Lote(IdEmpresa, IdSucursal, IdBodega);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public List<in_Producto_Info> Get_list_Producto_modulo_x_inventario_lite(int IdEmpresa, int IdSucursal, int IdBodega)
        {
            try
            {
                return proD.Get_list_Producto_modulo_x_inventario_lite(IdEmpresa, IdSucursal, IdBodega);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public in_Producto_Info Get_Producto_modulo_x_inventario(int IdEmpresa, int IdSucursal, int IdBodega, string codigo_barra)
        {
            try
            {
                return proD.Get_Producto_modulo_x_inventario(IdEmpresa, IdSucursal, IdBodega, codigo_barra);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public in_Producto_Info Get_Producto_modulo_x_inventario_sin_Stock(int IdEmpresa, int IdSucursal, int IdBodega, string codigo_barra)
        {
            try
            {
                return proD.Get_Producto_modulo_x_inventario_sin_Stock(IdEmpresa, IdSucursal, IdBodega, codigo_barra);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public List<in_Producto_Info> Get_ListaProducto_x_Bodega(int IdEmpresa, int IdSucursal, int IdBodega)
        {
            try
            {
                return proD.get_listaProducto_X_Bodega(IdEmpresa, IdSucursal, IdBodega);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public List<in_Producto_Info> Get_list_Producto(int IdEmpresa, int IdSucursal, int IdBodega)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Producto", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> Get_list_Productos_x_Empresa(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Todos_Productos_x_Empresa", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public in_Producto_Info Get_Info_Producto(int IdEmpresa, string CodBarra)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GetProducto", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public in_Producto_Info Get_Info_BuscarProducto(decimal IdProducto, int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "BuscarProducto", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public bool Producto_maneja_inventario(int IdEmpresa, decimal IdProducto)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_lst_producto_maneja_inventario", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public bool Producto_maneja_lote(int IdEmpresa, decimal IdProducto)
        {
            try
            {
                return proD.Producto_maneja_lote(IdEmpresa, IdProducto);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public in_Producto_Info Get_info_Product(int IdEmpresa, decimal IdProducto)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_lProd", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public in_Producto_Info Get_Info_Producto_x_Bodega(int IdEmpresa, int IdBodega, decimal IdProducto)
        {
            try
            {
                return proD.Get_Info_Producto_x_Bodega(IdEmpresa, IdBodega, IdProducto);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public in_Producto_Info Get_Info_Producto_x_Bodega(int IdEmpresa, int IdBodega, string codigo_barra)
        {
            try
            {
                return proD.Get_Info_Producto_x_Bodega(IdEmpresa, IdBodega, codigo_barra);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public Boolean GrabarDB(in_Producto_Info prI, ref decimal IdProducto, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public Boolean ValidarNombreItem(int IdEmpresa, string NombreItem)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ValidarNombreItem", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(in_Producto_Info prI, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public decimal GetIdProducto(int idempresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GetIdProducto", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public Boolean AnularDB(in_Producto_Info ProductoInfo, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public string Get_Descripcion_Producto(int IdEmpresa, decimal IdProducto)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Des_Producto", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public string Get_Codigo_Producto(int IdEmpresa, decimal IdProducto)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Codigo_Producto", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public string Get_Sec_Codigo_Producto_x_Categoria(int IdEmpresa, string IdCategoria)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Cod_Producto", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> Get_list_MateriaPrima(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_MateriaPrima", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> Get_list_ProductosTerminados(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_ProductosTerminados", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public string Get_DescripcionTot_Producto(int p, decimal p_2)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "DescripcionTot_Producto", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> Get_list_MateriaPrima_X_ModeloDeProduccion(int IdEmpresa, int IdTipoModelo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerMateriaPrima_X_ModeloDeProduccion", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public Boolean ValidarProductExiste(string Nombre)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ValidarProductExiste", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public in_Producto_Info Get_Info_ProductoXNombre(int IdEmpresa, string Descripcion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerProductoXNombre", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> Get_list_ProductosXModeloProduccio(int IdEmpresa, int IdModeloProduccion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerProductosXModeloProduccion", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> Get_list_MateriaPrimaModulosdeProduccion(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerMateriaPrimaModulosdeProduccion", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> Get_list_MateriaPrimaPorModeloProduccion(int IdEmpresa, int IdModeloProduccion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_MateriaPrimaPorModeloProduccion", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> Get_list_ProductosSucursalXBodegaXModulodeProduccion(int IdEmpresa, int IdModeloProduccion, int IdBodega, int IdSucursa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultarProductosSucursalXBodegaXModulodeProduccion", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> Get_Productos_X_Proveedor(int IdEmpresa, decimal IdProveedor, int IdEmpresa_x_Proveedor, string Esta = "")
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Productos_X_Proveedor", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> Get_ProductoTerminado_X_ModeloDeProduccion(int IdEmpresa, int IdTipoModelo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerProductoTerminado_X_ModeloDeProduccion", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> ProcesarDataTablein_Producto_Info(DataTable ds, int IdEmpresa, ref string MensajeError)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ProcesarDataTablein_Producto_Info", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        ...
        public bool Delete_Todos_Producto(int IdEmpresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Delete_Todos_Producto", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public Boolean ValidarObjeto(in_Producto_Info _Info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ValidarObjeto", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public List<in_Producto_Info> Get_list_Productos_not_exist_in_producto_x_bodega(int IdEmpresa, int Idsucursal, int idbodega)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Productos_not_exist_in_producto_x_bodega", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public Boolean Modificar_codigo_barra(in_Producto_Info prI, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Modificar_codigo_barra", ex.Message), ex) { EntityType = typeof(in_producto_Bus) };
            }
        }
        ...
        public in_Producto_Info Get_Producto_X_Bodega(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdProducto)
        {
            try
            {
                return proD.Get_Producto_X_Bodega(IdEmpresa, IdSucursal, IdBodega, IdProducto);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public in_Producto_Info Get_Info_x_Descripcion(int IdEmpresa, string pr_descripcion)
        {
            try
            {
                return proD.Get_Info_x_Descripcion(IdEmpresa, pr_descripcion);
            }
            catch (Exception ex)
            {
