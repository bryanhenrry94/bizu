    ...
    public class in_parametro_Impuesto_Iva_Ice_Bus
    {
        ...
        public List<in_parametro_Impuesto_Iva_Ice_Info> Get_List_Impuesto_Iva_Ice(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Impuesto_Iva_Ice", ex.Message), ex) { EntityType = typeof(in_Catalogo_Bus) };
        ...
        public in_parametro_Impuesto_Iva_Ice_Info Get_Info_Impuesto_Iva_Ice(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Impuesto_Iva_Ice", ex.Message), ex) { EntityType = typeof(in_Catalogo_Bus) };
        ...
        public Boolean GuardarDB(in_parametro_Impuesto_Iva_Ice_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(in_parametro_Impuesto_Iva_Ice_Bus) };
