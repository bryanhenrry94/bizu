  ...
  public  class in_Ingreso_x_OrdenCompra_det_Bus
    {
      ...
      public List<in_Ingreso_x_OrdenCompra_det_Info> Get_List_Ingreso_x_OrdenCompra_det(int Idempresa, decimal IdIngreso_x_oc)
      {
          ...
          catch (Exception ex)
          {
              ...
              throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Consulta_IngxOrdCompDet", ex.Message), ex) { EntityType = typeof(in_Ingreso_x_OrdenCompra_det_Bus) };
          }
      }
      ...
      public List<in_Ingreso_x_OrdenCompra_det_Info> Get_List_Ingreso_x_OrdenCompra_det_x_proveedor(int IdEmpresa, decimal IdProveedor)
      {
          ...
          {
              Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
              throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Consulta_IngxOrdComDet_x_Prov", ex.Message), ex) { EntityType = typeof(in_Ingreso_x_OrdenCompra_det_Bus) };
      ...
      public List<in_Ingreso_x_OrdenCompra_det_Info> Get_List_Ingreso_x_OrdenCompra_det_x_proveedor_x_OrdenCompra(int IdEmpresa, decimal IdProveedor, int ordenCompra)
      {
          try
          {
              return odata.Get_List_Ingreso_x_OrdenCompra_det_x_proveedor_x_OrdenCompra(IdEmpresa, IdProveedor, ordenCompra);
          }
          catch (Exception ex)
          {
              Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
