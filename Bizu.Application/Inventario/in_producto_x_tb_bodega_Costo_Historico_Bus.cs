    ...
    public class in_producto_x_tb_bodega_Costo_Historico_Bus
    {
        ...
        public Boolean GuardarDB(in_producto_x_tb_bodega_Costo_Historico_Info Info ,  ref string msjError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Costo_Historico_Bus) };
        ...
        public in_producto_x_tb_bodega_Costo_Historico_Info get_UltimoCosto_x_Producto_Bodega(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdProducto, DateTime Fecha)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_UltimoCosto_x_Producto_Bodega", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Costo_Historico_Bus) };
            }
        }
        ...
        public bool Proceso_recosteo_y_correccion_contable_inv(int IdEmpresa, int IdSucursal, int IdBodega, DateTime Fecha_ini, DateTime Fecha_fin, int Decimales)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Proceso_recosteo_y_correccion_contable_inv", ex.Message), ex) { EntityType = typeof(in_producto_x_tb_bodega_Costo_Historico_Bus) };
            }
        }
        ...
        public List<in_producto_x_tb_bodega_Costo_Historico_Info> Proceso_recosteo_y_correccion_contable_inv(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdProducto, DateTime Fecha_ini, int Decimales)
        {
            try
            {
                return dataProd.Proceso_recosteo_y_correccion_contable_inv(IdEmpresa, IdSucursal, IdBodega, IdProducto, Fecha_ini, Decimales);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
