    ...
    public class in_marca_bus
    {
        ...
        public in_Marca_Info Get_Info_Marca(int IdMarca, int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "BuscarMarca", ex.Message), ex) { EntityType = typeof(in_marca_bus) };
            }
        }
        ...
        public List<in_Marca_Info> Get_list_Marca(int idEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_listMarca", ex.Message), ex) { EntityType = typeof(in_marca_bus) };
                ;
            }
        }

        public List<in_Marca_Info> Get_list_Marca_Filtro(int idEmpresa, string Codigo)
        {
            try
            {
                in_marca_data mb = new in_marca_data();

                return mb.Get_list_Marca_Filtro(idEmpresa, Codigo);
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Marca_Costos", ex.Message), ex) { EntityType = typeof(in_marca_bus) };
            }
        }      
        ...
        public Boolean GrabarDB(in_Marca_Info prI, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(in_marca_bus) };
        ...
        public Boolean ModificarDB(in_Marca_Info prI, ref string mensaje)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_marca_bus) };
        ...
        public Boolean AnularDB(in_Marca_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Anular", ex.Message), ex) { EntityType = typeof(in_marca_bus) };
            }
        }
        ...
        public List<in_Marca_Info> ProcesarDataTablein_Marca_Info(DataTable ds, int IdEmpresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ProcesarDataTablein_Marca_Info", ex.Message), ex) { EntityType = typeof(in_marca_bus) };
            }
            return lista;
        }
    }
