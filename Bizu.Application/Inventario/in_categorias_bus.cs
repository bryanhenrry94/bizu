    ...
    public class in_categorias_bus
    {
        ...
        public List<in_categorias_Info> Get_List_categorias(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_listCategoria", ex.Message), ex) { EntityType = typeof(in_categorias_bus) };
            }
        }
        ...
        public Boolean GrabarDB(int IdEmpresa, in_categorias_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(in_categorias_bus) };
        ...
        public Boolean ModificarDB(int IdEmpresa, in_categorias_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_categorias_bus) };
        ...
        public Boolean AnularDB(in_categorias_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(in_categorias_bus) };
        ...
        public List<in_categorias_Info> ProcesarDataTablein_categorias_Info(DataTable ds, int IdEmpresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ProcesarDataTablein_categorias_Info", ex.Message), ex) { EntityType = typeof(in_categorias_Info) };
            }
            return lista;
        }
    }
