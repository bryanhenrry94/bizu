...
namespace Bizu.Application.Inventario
{
    public class in_responsable_Bus
    {
        ...
        //        throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VericarCedulaExiste", ex.Message), ex) { EntityType = typeof(com_comprador_Bus) };
        //    }
        ...
        public Boolean VerificarNombre(int IdEmpresa, string nombre, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VerificarNombre", ex.Message), ex) { EntityType = typeof(in_responsable_Bus) };
            }
        ...
        public Boolean GuardarDB(in_responsable_Info info, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(in_responsable_Bus) };
        ...
        public Boolean ModificarDB(in_responsable_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_responsable_Bus) };
            }
        }
        ...
        public Boolean AnularDB(in_responsable_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(in_responsable_Bus) };
            }
        ...
        public List<in_responsable_Info> Get_List_Responsable(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_comprador", ex.Message), ex) { EntityType = typeof(in_responsable_Bus) };
            }
        }     
    }
}
