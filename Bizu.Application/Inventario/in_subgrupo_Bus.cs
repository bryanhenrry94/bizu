    ...
    public class in_subgrupo_Bus
    {
        ...
        public Boolean GrabarDB(in_subgrupo_info info, ref int IdSubGrupo, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(in_subgrupo_Bus) };
        ...
        public Boolean ModificarDB(in_subgrupo_info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_subgrupo_Bus) };
        ...
        public Boolean AnularDB(in_subgrupo_info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(in_subgrupo_Bus) };
        ...
        public Boolean Validar_objeto_SubGrupo(in_subgrupo_info Info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Validar_objeto_SubGrupo", ex.Message), ex) { EntityType = typeof(in_subgrupo_Bus) };
        ...
        public List<in_subgrupo_info> ObtenerListSubGrupo(int IdEmpresa, string IdCategoria, int IdLinea, int IdGrupo)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerListSubGrupo", ex.Message), ex) { EntityType = typeof(in_subgrupo_Bus) };
        ...
        public in_subgrupo_info ObtenerInfoSubGrupo(int IdEmpresa, string IdCategoria, int IdLinea, int IdGrupo, int IdSubGrupo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerInfoSubGrupo", ex.Message), ex) { EntityType = typeof(in_subgrupo_Bus) };
        ...
        public List<in_subgrupo_info> ConsultaGeneralSubGrupo(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaGeneralSubGrupo", ex.Message), ex) { EntityType = typeof(in_subgrupo_Bus) };
        ...
        public List<in_subgrupo_info> ProcesarDataTablein_subgrupo_info(DataTable ds, int IdEmpresa, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ProcesarDataTablein_subgrupo_info", ex.Message), ex) { EntityType = typeof(in_subgrupo_info) };
            }
            return lista;
        }
    }
