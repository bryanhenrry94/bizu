    ...
    public class in_Motivo_Inven_Bus
    {
        ...
        public Boolean validarobjeto(in_Motivo_Inven_Info Info, ref string msj)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "validarobjeto", ex.Message), ex) { EntityType = typeof(in_Motivo_Inven_Bus) };
            }
        }
        ...
        public in_Motivo_Inven_Info Get_Info_Motivo_Inven(int IdEmpresa, int IdMotivo_Inv)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "in_Motivo_Inven_Info", ex.Message), ex) { EntityType = typeof(in_Motivo_Inven_Bus) };
        ...
        public Boolean GuardarDB(in_Motivo_Inven_Info Imfo, ref int Id, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(in_Motivo_Inven_Bus) };
        ...
        public Boolean ModificarDB(in_Motivo_Inven_Info Imfo, ref int Id, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_Motivo_Inven_Bus) };
            }
        }
        ...
        public Boolean AnularDB(in_Motivo_Inven_Info Imfo, ref int Id, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(in_Motivo_Inven_Bus) };
        ...
        public List<in_Motivo_Inven_Info> Get_List_Motivo_Inven(int IdEmpresa, string Tipo_Ing_Egr = "")
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaGeneral", ex.Message), ex) { EntityType = typeof(in_Motivo_Inven_Bus) };
            }
        }
