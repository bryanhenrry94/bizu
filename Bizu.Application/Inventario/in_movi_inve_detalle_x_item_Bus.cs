  ...
  public  class in_movi_inve_detalle_x_item_Bus
    {
      ...
      public Boolean GrabarDB(List<in_movi_inve_detalle_Info> List_Movi_Inven_det)
      {
          ...
          catch (Exception ex)
          {
              ...
              throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(in_movi_inve_detalle_x_item_Bus) };
          }
      }
      ...
      public in_movi_inve_detalle_x_item_Info Get_info_disponible(in_movi_inve_detalle_x_item_Info Movi)
      {
          ...
          {
              Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
              throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_info_disponible", ex.Message), ex) { EntityType = typeof(in_movi_inve_detalle_x_item_Bus) };
          }
      }
    }
}
