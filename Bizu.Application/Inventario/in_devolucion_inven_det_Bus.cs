   ...
   public class in_devolucion_inven_det_Bus
    {
        ...
        public Boolean GuardarDB(in_devolucion_inven_det_Info info, ref string mensaje)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(in_devolucion_inven_det_Bus) };
             ...
             , int Secuencia_movi_inv)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_cantidad_devuelta", ex.Message), ex) { EntityType = typeof(in_devolucion_inven_det_Bus) };
        ...
        public Boolean EliminarDB(int IdEmpresa, decimal IdDev_Inven, ref string msgs)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(in_devolucion_inven_det_Bus) };
        ...
        public List<in_devolucion_inven_det_Info> Get_List_in_devolucion_inven_det(int IdEmpresa, decimal IdDev_Inven)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_in_devolucion_inven_det", ex.Message), ex) { EntityType = typeof(in_devolucion_inven_det_Bus) };
        ...
        public in_devolucion_inven_det_Info Get_Info_in_devolucion_inven(int IdEmpresa, decimal IdDev_Inven)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_in_devolucion_inven", ex.Message), ex) { EntityType = typeof(in_devolucion_inven_det_Bus) };
