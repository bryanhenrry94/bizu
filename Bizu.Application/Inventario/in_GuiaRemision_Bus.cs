    ...
    public class in_GuiaRemision_Bus
    {
        ...
        public Boolean Generar_Guardar_Xml_Guia(int IdEmpresa, int IdSucursal, decimal IdGuia, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Generar_Guardar_Xml_Guia", ex.Message), ex) { EntityType = typeof(in_GuiaRemision_Bus) };
            }
        }
        ...
        private List<guiaRemision> Get_Xml_Guia(int IdEmpresa, int IdSucursal, decimal IdGuia)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Xml_Guia", ex.Message), ex) { EntityType = typeof(in_Guia_x_traspaso_bodega_Bus) };
            }
