   ...
   public class in_Guia_x_traspaso_bodega_Bus
    {
       ...
       public Boolean GuardarDB(in_Guia_x_traspaso_bodega_Info info,ref decimal IdGuia, ref string mensaje)
       {
           ...
           catch (Exception ex)
           {
               ...
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(in_Guia_x_traspaso_bodega_Bus) };
           }
       }
       ...
       public Boolean ModificarDB(in_Guia_x_traspaso_bodega_Info info, ref string mensaje)
       {
           ...
           catch (Exception ex)
           {
               ...
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(in_Guia_x_traspaso_bodega_Bus) };
       ...
       public Boolean AnularDB(in_Guia_x_traspaso_bodega_Info info, ref string mensaje)
       {
           ...
           catch (Exception ex)
           {
               ...
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(in_Guia_x_traspaso_bodega_Bus) };
       ...
       public List<in_Guia_x_traspaso_bodega_Info> Get_List_Guia_x_traspaso_bodega(int IdEmpresa, DateTime FechaIni, DateTime FechaFin)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerListGuixTrasBod", ex.Message), ex) { EntityType = typeof(in_Guia_x_traspaso_bodega_Bus) };
       ...
       Boolean Validar_y_corregir_objeto(ref in_Guia_x_traspaso_bodega_Info Info_Guia, ref string msg)
       {
           try
           {
               ...
               if (Info_Guia.IdEmpresa <= 0 && Info_Guia.IdSucursal_Partida <= 0 && Info_Guia.IdSucursal_Llegada <= 0)
               {
                   ...
                   throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Validaciones", msg)) { EntityType = typeof(in_Guia_x_traspaso_bodega_Bus) };
               }
               ...
               Info_Guia.Fecha = Convert.ToDateTime(Info_Guia.Fecha);
                   ...
                   || Info_Guia.NumDocumento_Guia == "" || Info_Guia.NumDocumento_Guia == null)
               {
                   ...
                   if (infoTalonario.NumDocumento == null)
                   {
                       ...
                       throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "no hay talonario activos", msg)) { EntityType = typeof(in_Guia_x_traspaso_bodega_Bus) };
                   }
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Validar_y_corregir_objeto", ex.Message), ex) { EntityType = typeof(in_Guia_x_traspaso_bodega_Bus) };
       ...
       private List<guiaRemision> Get_Xml_Guia_x_Traspaso(int IdEmpresa, decimal IdGuia )
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerParaGuiaRemision", ex.Message), ex) { EntityType = typeof(in_Guia_x_traspaso_bodega_Bus) };
           }
