    ...
    public class fa_pedido_det_Bus
    {
        ...
        public List<fa_pedido_det_Info> Get_List_pedido_det(int idempresa, int idsucursal, int idbodega, decimal idpedido)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerPedido_Detalle", ex.Message), ex) { EntityType = typeof(fa_pedido_det_Bus) };
        ...
        public int GetIdPedido(int idempresa, int idsucursal, int idbodega, decimal idpedido)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "getIdPedido_Secuencial", ex.Message), ex) { EntityType = typeof(fa_pedido_det_Bus) };
            }
        ...
        public List<fa_pedido_det_Info> Get_List_pedido_det_x_Producto(int idempresa, int idsucursal, int idbodega, decimal idpedido, decimal IdProducto)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerPedido_Detalle_x_Producto", ex.Message), ex) { EntityType = typeof(fa_pedido_det_Bus) };
            }
        }
        ...
        public Boolean GrabarListaDetalle(List<fa_pedido_det_Info> ListaDetalleNuevo, List<fa_pedido_det_Info> ListaDetalleAnterior, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarListaDetalle", ex.Message), ex) { EntityType = typeof(fa_pedido_det_Bus) };
            }
        }
        ...
        public Boolean EliminarDB(fa_pedido_det_Info info, ref  string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarItems", ex.Message), ex) { EntityType = typeof(fa_pedido_det_Bus) };
            }
        ...
        public Boolean VerificarOrdenDespacho(fa_pedido_Info info)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VerificarOrdenDespacho", ex.Message), ex) { EntityType = typeof(fa_pedido_det_Bus) };
            }
