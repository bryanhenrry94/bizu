    ...
    public class fa_cotizacion_Bus
    {
        ...
        public List<fa_cotizacion_info> Get_List_cotizacion_para_facturacion(int IdEmpresa, int IdSucursal, int IdBodega, DateTime fechaIni, DateTime fechaFin)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerParaFactura", ex.Message), ex) { EntityType = typeof(fa_cotizacion_Bus) };
            }
        }
            ...
            , DateTime FechaIni, DateTime FechaFin)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaCotizacion", ex.Message), ex) { EntityType = typeof(fa_cotizacion_Bus) };
            }           
        }
        ...
        public Boolean ActualizarEstado(int idempresa, fa_cotizacion_info oInfo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ActualizarEstado", ex.Message), ex) { EntityType = typeof(fa_cotizacion_Bus) };
            }
        ...
        public Boolean ValidarObjeto(fa_cotizacion_info inf,ref string  mensajeE)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ValidarObjeto", ex.Message), ex) { EntityType = typeof(fa_cotizacion_Bus) };             
            }        
        }
        ...
        private void ArreglandoObjeto(ref fa_cotizacion_info inf)
        {
            try
            {
                ...
                inf.cc_fecha = Convert.ToDateTime(inf.cc_fecha);
                inf.cc_fechaVencimiento = Convert.ToDateTime(inf.cc_fechaVencimiento);
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ArreglandoObjeto", ex.Message), ex) { EntityType = typeof(fa_cotizacion_Bus) };
        ...
        public Boolean GrabarDB(fa_cotizacion_info inf, ref decimal IdNumCotizacion, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(fa_cotizacion_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(fa_cotizacion_info inf, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(fa_cotizacion_Bus) };
            }
        }
        ...
        public fa_cotizacion_info Get_Info_cotizacio(int IdEmpresa, int idSucursal, int IdBodega, decimal idCotizacion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerCabecera", ex.Message), ex) { EntityType = typeof(fa_cotizacion_Bus) };
            }
        }
        ...
        public Boolean AnularDB(fa_cotizacion_info inf, ref string mensajeE) 
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularCotizacionDB", ex.Message), ex) { EntityType = typeof(fa_cotizacion_Bus) };
            }   
        }
    }
}
