    ...
    public class fa_cliente_pto_emision_cliente_Bus
    {
        ...
        public List<fa_cliente_pto_emision_cliente_Info> Get_List(int IdEmpresa, decimal IdCliente)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List", ex.Message), ex) { EntityType = typeof(fa_cliente_pto_emision_cliente_Bus) };
            }  
        }
        ...
        public Boolean GuardarDB(fa_cliente_pto_emision_cliente_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(fa_cliente_pto_emision_cliente_Bus) };
            }  
        }
        ...
        public Boolean ModificarDB(fa_cliente_pto_emision_cliente_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(fa_cliente_pto_emision_cliente_Bus) };
            }  
        }
        ...
        public Boolean AnularDB(int idEmpresa, decimal idCliente)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(fa_cliente_pto_emision_cliente_Bus) };
            }  
        }
        ...
        public Boolean MergeDB(fa_Cliente_Info info_Cliente)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "MergeDB", ex.Message), ex) { EntityType = typeof(fa_cliente_pto_emision_cliente_Bus) };
            }
        }
