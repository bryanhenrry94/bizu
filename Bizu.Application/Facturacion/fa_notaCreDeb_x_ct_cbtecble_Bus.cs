    ...
    public class fa_notaCreDeb_x_ct_cbtecble_Bus
    {
        ...
        public Boolean GuardarDB(fa_notaCreDeb_x_ct_cbtecble_Info info)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(fa_notaCreDeb_x_ct_cbtecble_Bus) };
            }
        }
        ...
        public fa_notaCreDeb_x_ct_cbtecble_Info Get_Info_fa_notaCreDeb_x_ct_cbtecble(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdNota)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_fa_notaCreDeb_x_ct_cbtecble", ex.Message), ex) { EntityType = typeof(fa_notaCreDeb_x_ct_cbtecble_Bus) };
