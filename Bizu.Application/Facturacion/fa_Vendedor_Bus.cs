    ...
    public class fa_Vendedor_Bus
    {
        ...
        public List<fa_Vendedor_Info> Get_List_Vendedores(int idempresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_Vendedores", ex.Message), ex) { EntityType = typeof(fa_TipoNota_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(fa_Vendedor_Info info, List<fa_VendedorxSucursal_Info> lstVendeSucu, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(fa_TipoNota_Bus) };
            }
        }
        ...
        public Boolean VerificaSiExisteVendedor(fa_Vendedor_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VerificaSiExisteVendedor", ex.Message), ex) { EntityType = typeof(fa_TipoNota_Bus) };
        ...
        public Boolean GrabarDB(fa_Vendedor_Info info, List<fa_VendedorxSucursal_Info> lstVendeSucu, ref int id, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(fa_TipoNota_Bus) };
        ...
        public Boolean AnularDB(fa_Vendedor_Info info, ref  string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(fa_TipoNota_Bus) };
        ...
        public fa_Vendedor_Info ConsultarVendedorPorCedula(int Idempresa, String Cedula)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultarVendedorPorCedula", ex.Message), ex) { EntityType = typeof(fa_TipoNota_Bus) };
