  ...
  public  class fa_devol_venta_det_Bus
    {
      ...
      public Boolean GuardarDB(List<fa_devol_venta_det_Info> Lista, ref string msg)
      {
          ...
          catch (Exception ex)
          {
              ...
              throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDetalle", ex.Message), ex) { EntityType = typeof(fa_devol_venta_det_Bus) };
          }
      ...
      public List<fa_devol_venta_det_Info> Get_List_devol_venta_det(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdDevolucion)
      {
          ...
          {
              Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
              throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerDetalle", ex.Message), ex) { EntityType = typeof(fa_devol_venta_det_Bus) };
          }
      }
      ...
      public Boolean ModificarDB(List<fa_devol_venta_det_Info> Lista, fa_devol_venta_Info info)
      {
          ...
          {
              Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
              throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDetalle", ex.Message), ex) { EntityType = typeof(fa_devol_venta_det_Bus) };
          }
      }
    }
}
