    ...
    public class fa_TipoNota_Bus
    {
        ...
        public List<fa_TipoNota_Info> Get_List_TipoNota(int idempresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerTipoNota", ex.Message), ex) { EntityType = typeof(fa_TipoNota_Bus) };
        ...
        public List<fa_TipoNota_Info> Get_List_TipoNota_Todos()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerTipoNotaTodos", ex.Message), ex) { EntityType = typeof(fa_TipoNota_Bus) };
        ...
        public fa_TipoNota_Info Get_List_TipoNota(int idempresa, int idsucursal, int idtipoNota)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerTipoNota_x_sucursal", ex.Message), ex) { EntityType = typeof(fa_TipoNota_Bus) };
        ...
        public Boolean EliminarDB(fa_TipoNota_Info info, ref  string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(fa_TipoNota_Bus) };
