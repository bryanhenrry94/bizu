    ...
    public class fa_orden_Desp_Bus
    {
            ...
            , DateTime FechaIni, DateTime FechaFin)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "getlist_OrdenDespachi", ex.Message), ex) { EntityType = typeof(fa_orden_Desp_Bus) };
        ...
        public Boolean ActualizarEstado(int idempresa, fa_orden_Desp_Info oDes)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ActualizarEstado", ex.Message), ex) { EntityType = typeof(fa_orden_Desp_Bus) };
            }
            ...
            , DateTime FechaIni, DateTime FechaFin)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "rpt_orde_Despacho", ex.Message), ex) { EntityType = typeof(fa_orden_Desp_Bus) };
            }
        ...
        public Boolean GuardarDB(fa_orden_Desp_Info info, ref decimal IdOrdenDespacho)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(fa_orden_Desp_Bus) };
            }
        ...
        public Boolean VerificarCodigo(string Codigo, int idempresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VerificarCodigo", ex.Message), ex) { EntityType = typeof(fa_orden_Desp_Bus) };
            }
        ...
        public List<fa_orden_Desp_Info> CargarOrdenDespachoPorCliente(int idEmpresa, int idSucursal, int idBodega, decimal Idcliente)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "CargarOrdenDespachoPorCliente", ex.Message), ex) { EntityType = typeof(fa_orden_Desp_Bus) };
            }
        ...
        public Boolean ModificarDB(int idempresa, fa_orden_Desp_Info info,ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(fa_orden_Desp_Bus) };
            }
        ...
        private Boolean Validar_Cantidad_Detalle_Despacho_en_Guia(ref fa_orden_Desp_Info Despacho_info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Validar_Cantidad_Detalle_Despacho_en_Guia", ex.Message), ex) { EntityType = typeof(fa_orden_Desp_Bus) };
