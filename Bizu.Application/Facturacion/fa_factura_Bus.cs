    ...
    public class fa_factura_Bus
    {
        ...
        public Boolean GuardarDB(fa_factura_Info Factura_info, ref decimal IdCbt_vta, ref string numDocFactura, ref string msg, ref string mensajeDocumentoDupli) 
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(fa_factura_Bus) };
            }
        }
        ...
        public Boolean ValidarNumFact(fa_factura_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ValidarNumFact", ex.Message), ex) { EntityType = typeof(fa_factura_Bus) };
        ...
        public Boolean AnularDB(fa_factura_Info info,DateTime fecha_Anulacion ,ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Anular", ex.Message), ex) { EntityType = typeof(fa_factura_Bus) };
        ...
        public Boolean ModificarDB(fa_factura_Info info, ref string msg) 
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(fa_factura_Bus) };
        ...
        public fa_factura_Info Get_Info_factura(int idEmpresa, int idSucursal, int idBodega, decimal IdCbteVta) 
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerCabecera", ex.Message), ex) { EntityType = typeof(fa_factura_Bus) };
        ...
        public fa_factura_Info Get_Info_factura_x_Numero_Factura(int idEmpresa, int idSucursal, int idBodega, String NumFac)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerCabeceraNumDoc", ex.Message), ex) { EntityType = typeof(fa_factura_Bus) };
           

            }
        }

        public List<fa_factura_Info> Get_List_factura(int IdEmpresa, int IdSucursal, decimal IdCliente)
        {
            try
            {
                return data.Get_List_factura(IdEmpresa, IdSucursal, IdCliente);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public List<fa_factura_Info> Get_Lits_FacturaDEV(int IdEmpresa, int IdSucursal, int IdBodega, DateTime FechaIni, DateTime FechaFin)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaFacturaDEV", ex.Message), ex) { EntityType = typeof(fa_factura_Bus) };
        ...
        public fa_factura_Info Get_Info_FactuXGuia(fa_guia_remision_Info info)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsFactuXGuia", ex.Message), ex) { EntityType = typeof(fa_factura_Bus) };
        ...
        public Boolean ContabilizarFactura(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdCbteVta)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ContabilizarFactura", ex.Message), ex) { EntityType = typeof(fa_factura_Bus) };
        ...
        Boolean Generar_Cbte_Ctbl_x_Factura(fa_factura_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GeneraCbteCtbl", ex.Message), ex) { EntityType = typeof(fa_factura_Bus) };
            }
        }
        ...
        void set_factura_x_ct_cbtecble(fa_factura_Info Info, ct_Cbtecble_Info Info_Cbte_Cble, Cl_Enumeradores.eMotivo_Diario_x_Vta motivo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "set_factura_x_ct_cbtecble", ex.Message), ex) { EntityType = typeof(fa_factura_Bus) };
       ...
       public Boolean ContabilizarFacturaREVERSO(int idEmpresa, int idSucursal, int idBodega, decimal IdCbteVta)
        ...
        public List<Bizu.Domain.CuentasxPagar.xmlATS_V_1_1_4.detalleVentas> Get_List_VentasParaATS(int IdEmpresa, int anio, int mes)
        {
            try
            {
        ...
        public List<Bizu.Domain.CuentasxPagar.xmlATS_V_1_1_4.ventaEst> Get_List_VentasXEstablecimientoParaATS(int IdEmpresa, int anio, int mes)
        {
            try
            {
        ...
        Boolean Validar_y_corregir_objeto(ref fa_factura_Info Factura_info ,ref string  msg) 
        {
            try
            {
                ...
                if (Factura_info.IdEmpresa <= 0 && Factura_info.IdSucursal <= 0 && Factura_info.IdBodega <= 0)
                {
                    ...
                    throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Validaciones", msg)) { EntityType = typeof(fa_factura_Bus) };
                }
                ...
                Factura_info.vt_fecha = Convert.ToDateTime(Factura_info.vt_fecha);
                Factura_info.vt_fech_venc = Convert.ToDateTime(Factura_info.vt_fech_venc);
                ...
                foreach (var item in Factura_info.DetformaPago_list)
                {
                    item.Fecha =Convert.ToDateTime(item.Fecha);
                    item.Fecha_vct =Convert.ToDateTime(item.Fecha_vct);
                    ...
                    || Factura_info.vt_NumFactura == "" || Factura_info.vt_NumFactura == null)
                {
                    ...
                    if (infoTalonario.NumDocumento == null)
                    {
                        ...
                        throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "no hay talonario activos", msg)) { EntityType = typeof(fa_factura_Bus) };
                    }
                ...
                if (consulta.ToList().Count != 0)
                {
                    ...
                    if (infoDetFact.Count != 0)
                    {
                        ...
                        foreach (var item in consulta)
                        {
                            ...
                            if (!String.IsNullOrEmpty(item.pe_correo_secundario1)) //poniendo el pe_correo_secundario1 como campo adicional
                            {
                                campoAdicional = item.pe_correo_secundario1;
                            ...
                            if (!String.IsNullOrEmpty(item.pe_correo_secundario2)) //poniendo el pe_correo_secundario2 como campo adicional
                            {
                                campoAdicional = item.pe_correo_secundario2;
        ...
        public fa_notaCreDeb_Info GetInfo_NotaCredito_X_Anulacion_Factura(fa_factura_Info infoFactura)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GetInfo_NotaCredito", ex.Message), ex) { EntityType = typeof(fa_factura_Bus) };
            }
        }
        ...
        public cxc_cobro_Info Get_Info_Cobro(fa_notaCreDeb_Info _Info, fa_factura_Info InfoFactura)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Cobro", ex.Message), ex) { EntityType = typeof(fa_factura_Bus) };

            }
        }

        public byte[] Get_Comprobante_Efirm_PDF(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdCbteVta, ref string IdComprobante, ref string mensaje_error)
        {    
            try
            {
                ...
                Info_Factura = Get_Info_factura(IdEmpresa, IdSucursal, IdBodega, IdCbteVta);

                if (Info_Factura != null)
                {
                    Info_Cliente = Bus_Cliente.Get_Info_Cliente(Info_Factura.IdEmpresa, Info_Factura.IdCliente);

                    IdComprobante = Cl_Enumeradores.eTipoComprobante_Alias.FA + "-" + Info_Factura.vt_serie1 + "-" + Info_Factura.vt_serie2 + "-" + Info_Factura.vt_NumFactura;
                ...
                {
                    mensaje = "No se encontraron registros para el comprobante de Vta #" + IdCbteVta;
                }
        ...
        public string Get_Comprobante_Efirm_XML(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdCbteVta, ref string IdComprobante, ref string mensaje_error)
        {
            try
            {
                tb_Comprobantes_Efirm_Bus Bus_Comprobante = new tb_Comprobantes_Efirm_Bus();
