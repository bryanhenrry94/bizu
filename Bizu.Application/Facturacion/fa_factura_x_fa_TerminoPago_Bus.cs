       ...
       fa_factura_x_fa_TerminoPago_Data oData = new fa_factura_x_fa_TerminoPago_Data();
        ...
        public Boolean validar_objeto_lista(List<fa_factura_x_fa_TerminoPago_Info> Lista, ref string mensajeE)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "validar_objeto_lista", ex.Message), ex) { EntityType = typeof(fa_factura_x_fa_TerminoPago_Bus) };
        ...
        public Boolean GuardarDB(List<fa_factura_x_fa_TerminoPago_Info> Lista, ref string mensajeE)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(fa_factura_x_fa_TerminoPago_Bus) };
            }
        }
        ...
        public List<fa_factura_x_fa_TerminoPago_Info> Get_List_fa_factura_x_formaPago(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdCbteVta)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaLista_FormaPago", ex.Message), ex) { EntityType = typeof(fa_factura_x_fa_TerminoPago_Bus) };
            }
        }
