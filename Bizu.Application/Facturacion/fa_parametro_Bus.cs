    ...
    public class fa_parametro_Bus
    {
        ...
        public fa_parametro_info Get_Info_parametro(int idEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener", ex.Message), ex) { EntityType = typeof(fa_parametro_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(fa_parametro_info Info, ref string mensaje)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Modificar", ex.Message), ex) { EntityType = typeof(fa_parametro_Bus) };
