    ...
    public class fa_devol_venta_Bus
    {
            ...
            , DateTime FechaIni, DateTime FechaFin)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaDevVenta", ex.Message), ex) { EntityType = typeof(fa_devol_venta_Bus) };
            }
        ...
        public Boolean GuardarDB(fa_devol_venta_Info Info, ref string msg)         
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(fa_devol_venta_Bus) };
            }
        ...
        public in_movi_inve_Info setInventarioMovi(fa_devol_venta_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "setInventarioMovi", ex.Message), ex) { EntityType = typeof(fa_devol_venta_Bus) };
            }
        ...
        public fa_devol_venta_Info Get_Info_devol_vent(int idEmpresa, int idSucursal, int idBodega, decimal idCbtevta, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaCabecera", ex.Message), ex) { EntityType = typeof(fa_devol_venta_Bus) };
            }        
        }
        ...
        public Boolean ModificarDB(fa_devol_venta_Info info, ref string msgs)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarCabecera", ex.Message), ex) { EntityType = typeof(fa_devol_venta_Bus) };
            }
        ...
        public Boolean AnularDevolucion(int idEmpresa, int idSucursal, int idBodega, decimal idDevolucion,DateTime Fecha_Anulacion, string motivo ,ref  string mensageError) 
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDevolucion", ex.Message), ex) { EntityType = typeof(fa_devol_venta_Bus) };
        ...
        public Boolean consultaDevolucionFactura(int IdEmpresa, int IdSucursal, int IdBodega, Decimal IdCteVta)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "consultaDevolucionFactura", ex.Message), ex) { EntityType = typeof(fa_devol_venta_Bus) };
            }
        ...
        public List<vwFa_FacturasConDevolucionxItemSaldos_Info> Get_List_Fa_FacturasConDevolucionxItemSaldos(int IdEmpresa, int IdSucursal, int IdBodega, Decimal IdCteVta)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaFacConDev", ex.Message), ex) { EntityType = typeof(fa_devol_venta_Bus) };
            }
        ...
        public List<vwFa_FacturasConDevolucionxItemSaldos_Info> Get_List_Fa_FacturasConDevolucionxItemSaldos(int IdEmpresa, int IdSucursal, int IdBodega, Decimal IdCteVta, decimal IdDevolucion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaFacConsultaIdDevolucion", ex.Message), ex) { EntityType = typeof(fa_devol_venta_Bus) };
            }
