    ...
    public class fa_TerminoPago_Bus
    {
        ...
        public List<fa_TerminoPago_Info> Get_List_TerminoPago(string IdTipoCredito)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerPedido_Detalle", ex.Message), ex) { EntityType = typeof(fa_TerminoPago_Bus) };
            }
        }
        ...
        public Boolean GuardarDB(fa_TerminoPago_Info _Info, List<fa_TerminoPago_Distribucion_Info> lstTerminoDis, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Guardar", ex.Message), ex) { EntityType = typeof(fa_TerminoPago_Bus) };
        ...
        public Boolean ModificarDB(fa_TerminoPago_Info _Info, List<fa_TerminoPago_Distribucion_Info> lstTerminoDis, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Modificacion", ex.Message), ex) { EntityType = typeof(fa_TerminoPago_Bus) };
