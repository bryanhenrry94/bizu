    ...
    public class fa_notaCreDeb_x_fa_factura_NotaDeb_Bus
    {
        ...
        public List<fa_notaCreDeb_x_fa_factura_NotaDeb_Info> Get_list_docs_x_NC(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdNota)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_docs_x_NC", ex.Message), ex) { EntityType = typeof(fa_notaCreDeb_x_fa_factura_NotaDeb_Bus) };
            }
        }
        ...
        public List<fa_notaCreDeb_x_fa_factura_NotaDeb_Info> Get_list_docs_x_NC_x_cobro(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdNota)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_docs_x_NC_x_cobro", ex.Message), ex) { EntityType = typeof(fa_notaCreDeb_x_fa_factura_NotaDeb_Bus) };
            }
        }
        ...
        public List<fa_notaCreDeb_x_fa_factura_NotaDeb_Info> Get_list_docs_x_cruzar(int IdEmpresa, decimal IdCliente)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_docs_x_cruzar", ex.Message), ex) { EntityType = typeof(fa_notaCreDeb_x_fa_factura_NotaDeb_Bus) };
            }
        }

        public List<fa_notaCreDeb_x_fa_factura_NotaDeb_Info> Get_list_docs_x_cruzar_SinSaldo(int IdEmpresa, decimal IdCliente)
        {
            try
            {
                return oData.Get_list_docs_x_cruzar_SinSaldo(IdEmpresa, IdCliente);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public Boolean ModificarDB(List<fa_notaCreDeb_x_fa_factura_NotaDeb_Info> Lista)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(fa_notaCreDeb_x_fa_factura_NotaDeb_Bus) };
            }
        }
        ...
        public Boolean GuardarDB(List<fa_notaCreDeb_x_fa_factura_NotaDeb_Info> Lista)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(fa_notaCreDeb_x_fa_factura_NotaDeb_Bus) };
            }
        }
