    ...
    public class fa_Cliente_Bus
    {
        ...
        public List<fa_Cliente_Info> Get_List_Clientes(int idempresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Clientes", ex.Message), ex) { EntityType = typeof(fa_Cliente_Bus) };
            }
        }
        ...
        public List<fa_Cliente_Info> Get_List_Cliente(int idempresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Clientes_Todos", ex.Message), ex) { EntityType = typeof(fa_catalogo_tipo_Bus) };
            }
        }
        ...
        public List<fa_Cliente_Info> ProcesarDataTableFa_Cliente_Info(DataTable ds, int idempresa, int idsucursal, ref string MensajeError)
        {
            ...
            try
            {
                //VALIDAR QUE TENGA MAS DE 16 COLUMNAS
                if (ds.Columns.Count == 16)
                {
                                ...
                                for (int col = 0; col < ds.Columns.Count + 1; col++)
                                {
                                    ...
                                    switch (col)
                                    {
                                        ...
                                        case 5://CEDULA
                                            ...
                                            if (info.Persona_Info.pe_cedulaRuc == "1891710182001")
                                            {
                                                info.Persona_Info.pe_cedulaRuc = info.Persona_Info.pe_cedulaRuc;
                                            }
                ...
                {
                    MensajeError = "Por favor verifique que el archivo tenga el formato correcto.\r Son 16 columnas.";
                    lista = new List<fa_Cliente_Info>();
                }
                return lista;
            }
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GetId", ex.Message), ex) { EntityType = typeof(fa_Cliente_Bus) };
            }
        ...
        public bool Eliminar_Clientes(int idempresa, ref string message)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Eliminar_Clientes", ex.Message), ex) { EntityType = typeof(fa_catalogo_tipo_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(fa_Cliente_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(fa_catalogo_tipo_Bus) };
            }
        }
        ...
        public Boolean EliminarDB(fa_Cliente_Info info, ref  string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(fa_catalogo_tipo_Bus) };
            }
        }
        ...
        public Boolean ConsultarClienteVendedor(int IdEmpresa, ref fa_Cliente_Info Cliente, ref fa_Vendedor_Info Vendedor)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultarClienteVendedor", ex.Message), ex) { EntityType = typeof(fa_catalogo_tipo_Bus) };
            }
        }
        ...
        public fa_Cliente_Info Get_info_Cliente_x_IdPersona(int Idempresa, decimal IdPersona)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_info_Cliente_x_IdPersona", ex.Message), ex) { EntityType = typeof(fa_catalogo_tipo_Bus) };
            }
        }
        ...
        public fa_Cliente_Info Get_Info_Cliente(int Idempresa, decimal IdCliente)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Cliente", ex.Message), ex) { EntityType = typeof(fa_catalogo_tipo_Bus) };
            }
        }
