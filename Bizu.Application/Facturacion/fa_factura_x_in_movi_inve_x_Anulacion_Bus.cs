    ...
    public class fa_factura_x_in_movi_inve_x_Anulacion_Bus
    {
           ...
           int idempresa, int idsucursal, int idbodega, decimal idCbteVta)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDetalle", ex.Message), ex) { EntityType = typeof(fa_factura_x_in_movi_inve_x_Anulacion_Bus) };
        ...
        public Boolean GuardarDB(fa_factura_x_in_movi_inve_x_Anulacion_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(fa_factura_x_in_movi_inve_x_Anulacion_Bus) };
