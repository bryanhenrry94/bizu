    ...
    public class cxc_anticipo_facturado_Bus
    {
        ...
        public List<cxc_anticipo_facturado_Info> Get_List(int IdEmpresa, int IdSucursal, ref string mensaje)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_cobro_x_Anticipo", ex.Message), ex) { EntityType = typeof(cxc_cobro_x_Anticipo_Bus) };
            }
        }
        ...
        public Boolean validar_objeto(cxc_anticipo_facturado_Info info, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "validar_objeto", ex.Message), ex) { EntityType = typeof(cxc_cobro_x_Anticipo_Bus) };
            }
        }
        ...
        public Boolean GuardarDB(cxc_anticipo_facturado_Info infoAnticipo, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(cxc_cobro_x_Anticipo_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(cxc_anticipo_facturado_Info infoAnticipo, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cxc_cobro_x_Anticipo_Bus) };
            }
        }
        ...
        public decimal Existe(int IdCliente, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Existe", ex.Message), ex) { EntityType = typeof(cxc_cobro_x_Anticipo_Bus) };
            }
        }
        ...
        public bool Anular(cxc_anticipo_facturado_Info Info, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Anular", ex.Message), ex) { EntityType = typeof(cxc_cobro_x_Anticipo_Bus) };
            }
        }
    }
}