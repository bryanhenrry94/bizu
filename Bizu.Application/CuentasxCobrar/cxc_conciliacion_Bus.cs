   ...
   public class cxc_conciliacion_Bus
    {
       ...
       public void ModificarDB(cxc_conciliacion_Info Item,cxc_cobro_Info CobrosInfo,  decimal Id, ref string mensaje) 
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GetModificarConciliacion", ex.Message), ex) { EntityType = typeof(cxc_cobro_x_EstadoCobro_Bus) };
       ...
       public cxc_cobro_Info Get_Cobro(cxc_conciliacion_Info cab,  ref decimal Id)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Cobro", ex.Message), ex) { EntityType = typeof(cxc_cobro_x_EstadoCobro_Bus) };
           }
       ...
       public List<cxc_cobro_Det_Info> GetDetalleCobro(cxc_conciliacion_Info cab, ref decimal IdCobro)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "getDetalleCobro", ex.Message), ex) { EntityType = typeof(cxc_cobro_x_EstadoCobro_Bus) };
           }
       ...
       public fa_notaCreDeb_x_cxc_cobro_Info Get_faNotaCreDeb_x_Cobro(cxc_cobro_Info info, cxc_conciliacion_Info Item)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_faNotaCreDeb_x_Cobro", ex.Message), ex) { EntityType = typeof(cxc_cobro_x_EstadoCobro_Bus) };
            }
       ...
       public Boolean Anular_Conciliacion(cxc_conciliacion_Info SETINFO_, ref string mensaje)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Anular_Conciliacion", ex.Message), ex) { EntityType = typeof(cxc_cobro_x_EstadoCobro_Bus) };
           }
       }
