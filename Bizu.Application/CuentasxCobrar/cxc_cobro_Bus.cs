    ...
    public class cxc_cobro_Bus
    {
        ...
        public bool Valida_cobro_x_deposito(cxc_cobro_Info info, ref ba_Cbte_Ban_Info InfoCbteBan_del_deposito)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Valida_cobro_x_deposito", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public List<cxc_cobro_Info> Get_List_Cobros_x_depositar_Agrupado_x_cobro(int IdEmpresa, string TipoMovCaj)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Cobros_x_depositar", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        ...
        public List<cxc_cobro_Info> Get_List_Cobros_x_depositar_Agrupado_detallado(int IdEmpresa, int mcj_IdTipocbte, decimal mcj_IdCbteCble)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Cobros_x_depositar_Agrupado_detallado", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        ...
        public cxc_cobro_Info Get_Info_cobro_x_cliente(int IdEmpresa, int IdSucursal, decimal IdCobro, int IdCliente)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_cobro_x_cliente", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public List<vwcxc_cartera_x_cobrar_Info> NotasCreditoConFacturaXCodigoCLi(String CodCliente)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "NotasCreditoConFacturaXCodigoCLi", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public List<cxc_EstadoCobro_Info> Get_List_CobroEstado()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_CobroEstado", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        ...
        public List<cxc_cobro_Info> Get_List_cobro(int IdEmpresa, string tipoCheque, string EstadoCheque, DateTime desde, DateTime hasta, int porfecha)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_cobro", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        ...
        public List<cxc_cobro_Info> Get_List_cobro_x_Tarjeta(int IdEmpresa, string tipoCheque, string EstadoCheque, DateTime desde, DateTime hasta)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_cobro_x_Tarjeta", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        ...
        public List<cxc_cobro_Info> Get_List_cobros_x_depositados(int IdEmpresa, int IdSucursal, decimal IdCobro)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_cobros_x_depositados", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        ...
        public List<cxc_cobro_Info> Get_List_cobro_x_Factura_x_DocxCobrar(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdCbteCble, string TipoDoc, decimal IdCobro_doc_x_cobrar)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_cobro_x_Factura_x_DocxCobrar", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public Boolean Contabilizar(int IdEmpresa, int IdSucursal, decimal IdCobro, decimal Idvta = 0)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Contabilizar", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public Boolean Contabilizar_Anulacion(int IdEmpresa, int IdSucursal, decimal IdCobro, DateTime FechaAnul)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Contabilizar_Anulacion", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public void GuardarCxCxCajaMovimiento(cxc_cobro_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarCxCxCajaMovimiento", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public void GeneraMoviCajaANULACION(cxc_cobro_Info Info, int IdTipocbte_Anu, decimal IdCbteCble_Anu)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GeneraMoviCajaANULACION", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public void GeneraMoviBancoANULACION(cxc_cobro_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GeneraMoviBancoANULACION", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public void GeneraMoviCaja(cxc_cobro_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GeneraMoviCaja", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public void get_Cbtecble_Movi_Caja(cxc_cobro_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_Cbtecble_Movi_Caja", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public caj_Caja_Movimiento_Info get_cajaMovi(cxc_cobro_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_cajaMovi", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public List<caj_Caja_Movimiento_det_Info> get_cajaMoviD(cxc_cobro_Info Info, decimal IdCbteCble, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_cajaMoviD", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public void GeneraCbteCtbl(cxc_cobro_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GeneraCbteCtbl", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public void GeneraCbteCtblSoloDiario(cxc_cobro_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GeneraCbteCtblSoloDiario", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public ct_Cbtecble_Info get_CbteCbleInfo(cxc_cobro_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_CbteCbleInfo", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public ct_Cbtecble_Info get_CbteCbleInfoSOLODIARIO(cxc_cobro_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_CbteCbleInfoSOLODIARIO", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public List<ct_Cbtecble_det_Info> get_CbteCble_det(cxc_cobro_Info Info)
        {
            ...
            try
            {
                ...
                if (Info.cr_es_anticipo == "N" || Info.cr_es_anticipo == "" || Info.cr_es_anticipo == null)
                {
                    ...
                    {
                        throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "El Cliente no tiene cta cble cxc")) { EntityType = typeof(cxc_cobro_Bus) };
                    }
                }
                else //por anticipo 
                {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "get_CbteCble_det", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public Boolean Registra_Contabiliza_Deposito_x_Cobro(int IdEmpresa, int IdTipocbte_Caja, decimal IdCbteCble_Caja, string IdCobro_tipo, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Registra_Contabiliza_Deposito_x_Cobro", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
        ...
        public Boolean Registra_Contabiliza_Debito_Bancario_x_Cobro(int IdEmpresa, int IdTipocbte_Caja, decimal IdCbteCble_Caja, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Registra_Contabiliza_Debito_Bancario_x_Cobro", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            } return res;
        ...
        public Boolean Registra_Contabiliza_MovCaja_x_Cobro_enDeposito(List<caj_Caja_Movimiento_Info> LstMovCaja, int idBanco, DateTime FechaDep, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Registra_Contabiliza_MovCaja_x_Cobro_enDeposito", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            } return res;
        }
        ...
        public void GeneraCbteCtblANULACION(cxc_cobro_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GeneraCbteCtblANULACION", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public void GeneraCbteCtblANULACIONSOLODIARIO(cxc_cobro_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GeneraCbteCtblANULACIONSOLODIARIO", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(cxc_cobro_Info Info, Cl_Enumeradores.PantallaEjecucion Accion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        ...
        public Boolean AnularDB(cxc_cobro_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public List<vwcxc_cartera_x_cobrar_Info> NotasCreditoConFacturaXCobrar(int IdEmpresa, int IdSucursal, decimal IdCliente)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "NotasCreditoConFacturaXCobrar", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        ...
        public List<cxc_cobro_Info> Get_List_cobros_x_Factura(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdCbteCble, string TipoDoc)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_cobros_x_Factura", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        ...
        public Boolean ExisteCobro(int IdEmpresa, int IdSucursal, int IdBodega, decimal IdCbteCble, string TipoDoc)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ExisteCobro", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public List<cxc_cobro_Info> Get_List_cobro_x_Cliente(int IdEmpresa, int IdCliente, DateTime Fecha)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_cobro_x_Cliente", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        public List<vwcxc_cobros_x_vta_nota_x_Ret_Info> Get_List_cobro_x_RteFte(int IdEmpresa, int IdSucursal, int IdBodega_Cbte, decimal IdCbte_vta_nota, string TipoDoc)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_cobro_x_RteFte", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        ...
        public List<vwcxc_cobros_x_vta_nota_x_Ret_Info> Get_List_cobro_x_RteIVA(int IdEmpresa, int IdSucursal, int IdBodega_Cbte, decimal IdCbte_vta_nota, string TipoDoc)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_cobro_x_RteIVA", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        ...
        public cxc_cobro_Info Get_Info_Cobro(int IdEmpresa, int IdSucursal, decimal IdCobro)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Cobro", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
        ...
        private Boolean validar_objeto(cxc_cobro_Info Info, ref string mensaje1)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "validar_objeto", ex.Message), ex) { EntityType = typeof(cxc_cobro_Bus) };
            }
        }
