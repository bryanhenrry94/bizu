...
namespace Bizu.Application.CuentasxCobrar
{
    public class cxc_cobro_x_Anticipo_Bus
    {
        ...
        public List<cxc_cobro_x_Anticipo_Info> Get_List_cobro_x_Anticipo(int IdEmpresa, DateTime FechaIni, DateTime FechaFin, ref string mensaje)
        {
            try
            {
                return data.Get_List_cobro_x_Anticipo(IdEmpresa, FechaIni, FechaFin, ref mensaje);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public  Boolean validar_objeto(cxc_cobro_x_Anticipo_Info info,ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Cobro_Tipo", ex.Message), ex) { EntityType = typeof(cxc_cobro_x_Anticipo_Bus) };
            }
        }
