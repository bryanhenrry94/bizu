...
namespace Bizu.Application.CuentasxCobrar
{
    public class cxc_cobro_tipo_Bus
    {
        ...
        public List<cxc_cobro_tipo_Info> Get_List_Cobro_Tipo_FUEIVA()
        {
            try
            {
                return data.Get_List_Cobro_Tipo_FUEIVA();
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public List<cxc_cobro_tipo_Info> Get_List_Cobro_Tipo_Anticipo(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Cobro_Tipo_Anticipo", ex.Message), ex) { EntityType = typeof(cxc_cobro_tipo_Bus) };
            }
        ...
        public Boolean GuardarDB(cxc_cobro_tipo_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(cxc_cobro_tipo_Bus) };
            }
        ...
        public Boolean ModificarDB(cxc_cobro_tipo_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cxc_cobro_tipo_Bus) };
            }
        ...
        public List<cxc_cobro_tipo_Info> Get_List_Cobro_Tipo_ParaMantCheque()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Cobro_Tipo_ParaMantCheque", ex.Message), ex) { EntityType = typeof(cxc_cobro_tipo_Bus) };
            }
        ...
        public List<cxc_cobro_tipo_Info> Get_List_Cobro_Tipo_RetIva()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Cobro_Tipo_RetIva", ex.Message), ex) { EntityType = typeof(cxc_cobro_tipo_Bus) };
            }
        ...
        public List<cxc_cobro_tipo_Info> Get_List_Cobro_Tipo_x_RetFte()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Cobro_Tipo_x_RetFte", ex.Message), ex) { EntityType = typeof(cxc_cobro_tipo_Bus) };
            }
        ...
        public List<cxc_cobro_tipo_Info> Get_List_Cobro_Tipo_x_Anticipo(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Cobro_Tipo_x_Anticipo", ex.Message), ex) { EntityType = typeof(cxc_cobro_tipo_Bus) };
            }
        ...
        public List<cxc_cobro_tipo_Info> Get_List_Cobro_Tipo_Documento()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Cobro_Tipo_Documento", ex.Message), ex) { EntityType = typeof(cxc_cobro_tipo_Bus) };
            }
        ...
        public List<cxc_cobro_tipo_Info> Get_List_Cobro_Tipo_Todos()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Cobro_Tipo_Todos", ex.Message), ex) { EntityType = typeof(cxc_cobro_tipo_Bus) };
        ...
        public cxc_cobro_tipo_Info Get_Info_Cobro_Tipo(string IdCobro_tipo)
        {
            try
            {
                return data.Get_Info_Cobro_Tipo(IdCobro_tipo);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Cobro_Tipo", ex.Message), ex) { EntityType = typeof(cxc_cobro_tipo_Bus) };
            }
        }
    }
}
