    ...
    public class vwcxc_cobro_x_documentos_x_cobrar_Bus
    {
            ...
            , DateTime FechaFin, Cl_Enumeradores.eTipo_Fecha_buscar_cobro tipo, string IdCobro_tipo)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_cobro_x_documentos_x_cobrar", ex.Message), ex) { EntityType = typeof(vwcxc_cobro_x_documentos_x_cobrar_Bus) };
            }
        }
    }
}
