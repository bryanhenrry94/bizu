       ...
       public Boolean ActualizarDetallePrestamosCancelados(ba_prestamo_detalle_Info Info, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ActualizarDetallePrestamosCancelados", ex.Message), ex) { EntityType = typeof(ba_prestamo_detalle_cancelacion_Bus) };
            }
        ...
        public Boolean AnularDetallePrestamosCancelados(ba_prestamo_detalle_Info Info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDetallePrestamosCancelados", ex.Message), ex) { EntityType = typeof(ba_prestamo_detalle_cancelacion_Bus) };
            }
        ...
        public Boolean GuardarDetallePrestamosCancelados(List<ba_prestamo_detalle_Info> Listado, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDetallePrestamosCancelados", ex.Message), ex) { EntityType = typeof(ba_prestamo_detalle_cancelacion_Bus) };
            }
