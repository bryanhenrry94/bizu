    ...
    public class ba_Cbte_Ban_tipo_x_ct_CbteCble_tipo_Bus
    {
        ...
        public ba_Cbte_Ban_tipo_x_ct_CbteCble_tipo_Info Get_info_Cbte_Ban_tipo_x_ct_CbteCble_tipo(int Idempresa, string CodCbte)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_info_Cbte_Ban_tipo_x_ct_CbteCble_tipo", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_tipo_x_ct_CbteCble_tipo_Bus) };
            }
        }
        ...
        public List<ba_Cbte_Ban_tipo_x_ct_CbteCble_tipo_Info> Get_List_Cbte_Ban_tipo_x_ct_CbteCble_tipo(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Cbte_Ban_tipo_x_ct_CbteCble_tipo", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_tipo_x_ct_CbteCble_tipo_Bus) };
            }
