    ...
    public class ba_Cbte_Ban_Bus
    {
        ...
        private Boolean validar_objeto(ba_Cbte_Ban_Info Info, ref string mensaje1)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "validar_objeto", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
            }
        }
        ...
        public List<ba_Cbte_Ban_Info> Get_List_Cbte_Ban(int IdEmpresa, int IdTipocbteIni, int IdTipocbteFin, DateTime F_inicio, DateTime F_fin, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Cbte_Ban", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
            }
        ...
        //    {
        //        Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        //        throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_CbtBancoReport", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
        //    }
        ...
        public Boolean GrabarDB(ba_Cbte_Ban_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
            }
        ...
        public Boolean AnularDB(ba_Cbte_Ban_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ActualizarEstado", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
            }
        ...
        public Boolean ActualizarUltimocheque(ba_Cbte_Ban_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ActualizarUltimocheque", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
            }
        ...
        public Boolean ModificarDB(ba_Cbte_Ban_Info info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
            }
        ...
        public Boolean VericarChequeExiste(string cheque, int IdEmpresa, decimal IdCbteCble, int IdTipoCbte, int IdBanco, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VericarChequeExiste", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
            }
        }
        ...
        //    {
        //        Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        //        throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_ChequeComprobante_Rpt", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
        //    }
        ...
        public List<cxc_cobro_Info> Get_List_CobrosDepositados(int IdEmpresa, decimal IdCbteCble, int IdTipoCbte, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_CobrosDepositados", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
            }
        }

        public List<cxc_cobro_Info> Get_List_CobrosDepositados(int IdEmpresa, int IdSucursal, decimal IdCobro)
        {
            try
            {
                return data.Get_List_CobrosDepositados(IdEmpresa, IdSucursal, IdCobro);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public List<ba_Cbte_Ban_Info> Get_List_X_NotasMasivas(List<ba_notasDebCre_masivo_Info> ListCbtMasivo, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_X_NotasMasivas", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
            }
        ...
        public Boolean VerificarExisteRegistroImportacion(string IdHash, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VerificarExisteRegistroImportacion", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
            }
        ...
        public List<vwba_Banco_Movimiento_det_cancelado_Info> Get_List_Cancelada(int IdEmpresa, decimal IdCbteCble, int IdTipocbte, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Cancelada", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
            }
        ...
        public List<vwcp_orden_pago_con_cancelacion_x_CbteBan_Debi_Info> Get_List_CanceladaNotaDebCred(int IdEmpresa, decimal IdCbteCble, int IdTipocbte, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_CanceladaNotaDebCred", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
            }
        ...
        public Boolean Modificar_Estado_Preaviso_ch(List<ba_Cbte_Ban_Info> Lista, eEstado_Preaviso_Cheque IdEstado_Preaviso, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Modificar_Estado_cbte_ban", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
            }
        ...
        public Boolean Modificar_tipo_flujo(int IdEmpresa, int IdTipoCbte, decimal IdCbteCble, Nullable<decimal> IdTipoFlujo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Modificar_tipo_flujo", ex.Message), ex) { EntityType = typeof(ba_Cbte_Ban_Bus) };
            }
        }
        ...
        public bool ActualizarEstadoCheque(int IdEmpresa, int IdTipoCbte, decimal IdCbteCble, eEstado_Cheque Estado)
        {
            try
            {
                return data.ActualizarEstadoCheque(IdEmpresa, IdTipoCbte, IdCbteCble, Estado);
            }catch(Exception e)
            {
                throw e;
            }
