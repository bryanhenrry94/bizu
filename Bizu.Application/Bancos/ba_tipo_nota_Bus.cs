    ...
    public class ba_tipo_nota_Bus
    {
        ...
        public List<ba_tipo_nota_Info> Get_List_tipo_nota(int IdEmpresa, string tipo)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_tipo_nota", ex.Message), ex) { EntityType = typeof(ba_tipo_nota_Bus) };
            }
        ...
        public Boolean ActualizarDB(ba_tipo_nota_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ActualizarDB", ex.Message), ex) { EntityType = typeof(ba_tipo_nota_Bus) };
            }
        }
        ...
        public Boolean Eliminar(ba_tipo_nota_Info Info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_tipo_nota", ex.Message), ex) { EntityType = typeof(ba_tipo_nota_Bus) };
            }
        }
        ...
        public Boolean GuardarDB(ba_tipo_nota_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(ba_tipo_nota_Bus) };
            }
        }
        ...
        public Boolean ValidarObjeto(ba_tipo_nota_Info Info, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ValidarObjeto", ex.Message), ex) { EntityType = typeof(ba_tipo_nota_Bus) };
            }
