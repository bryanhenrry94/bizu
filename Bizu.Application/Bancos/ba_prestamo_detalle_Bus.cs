    ...
    public class ba_prestamo_detalle_Bus
    {
        ...
        public Boolean GuardarPrestamoDetalle(List<ba_prestamo_detalle_Info> Lst)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarPrestamoDetalle", ex.Message), ex) { EntityType = typeof(ba_prestamo_detalle_Bus) };
            }
        }
        ...
        public List<ba_prestamo_detalle_Info> Get_List_prestamo_detalle(int IdEmpresa, decimal IdPrestamo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_prestamo_detalle", ex.Message), ex) { EntityType = typeof(ba_prestamo_detalle_Bus) };
            }
        ...
        public Boolean CancelarEstadoDetallePrestamo(ba_prestamo_detalle_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "CancelarEstadoDetallePrestamo", ex.Message), ex) { EntityType = typeof(ba_prestamo_detalle_Bus) };
            }
        ...
        public Boolean ModificarDetallePrestamo(ba_prestamo_detalle_Info prI, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDetallePrestamo", ex.Message), ex) { EntityType = typeof(ba_prestamo_detalle_Bus) };
            }
        }
        ...
        public Boolean AnularDetallePrestamo(List<ba_prestamo_detalle_Info> prI, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDetallePrestamo", ex.Message), ex) { EntityType = typeof(ba_prestamo_detalle_Bus) };
            }
        }
        ...
        public Boolean ReversaEstadoCanc(ba_prestamo_detalle_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ReversaEstadoCanc", ex.Message), ex) { EntityType = typeof(ba_prestamo_detalle_Bus) };
            }
        ...
        public List<ba_prestamo_detalle_Info> Get_List_EstadoCuenta(ba_prestamo_Info Item, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_EstadoCuenta", ex.Message), ex) { EntityType = typeof(ba_prestamo_detalle_Bus) };
            }
        ...
        public List<ba_prestamo_detalle_Info> Get_List_DetallePrestamosxCancelar(ba_prestamo_Info Item, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_DetallePrestamosxCancelar", ex.Message), ex) { EntityType = typeof(ba_prestamo_detalle_Bus) };
            }
        ...
        public bool Eliminar(int idempresa, int idprestamo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Eliminar", ex.Message), ex) { EntityType = typeof(ba_prestamo_detalle_Bus) };
            }
        }
