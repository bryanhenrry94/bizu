    ...
    public class ba_parametros_Bus
    {
        ...
        public ba_parametros_Info Get_List_parametros(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_parametros", ex.Message), ex) { EntityType = typeof(ba_parametros_Bus) };
            }
        ...
        public Boolean ModificarDB(ba_parametros_Info inf, int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Modificar", ex.Message), ex) { EntityType = typeof(ba_parametros_Bus) };
            }
        }
        ...
        public List<ba_parametros_Info> Get_List_Banco_otros_Parametro(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Banco_otros_Parametro", ex.Message), ex) { EntityType = typeof(ba_parametros_Bus) };
            }
        ...
        public Boolean ModificarDiarioModif(ba_parametros_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDiarioModif", ex.Message), ex) { EntityType = typeof(ba_parametros_Bus) };
            }
        ...
        public ba_parametros_Info Get_Info_Banco_Otros_Parametros(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Banco_Otros_Parametros", ex.Message), ex) { EntityType = typeof(ba_parametros_Bus) };
            }
