    ...
    public class ba_Conciliacion_Bus
    {
        ...
        public List<vwba_TransaccionesAConciliar_Info> Get_List_Transacciones_x_Conciliar(int IdEmpresa, string IdCtaCble, DateTime F_inicio, DateTime F_fin)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ba_Conciliacion_Bus", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_Bus) };
            }
        }
        ...
        public List<ba_Conciliacion_Info> Get_List_Conciliacion(int IdEmpresa, DateTime Fecha_ini, DateTime Fecha_fin)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Conciliacion", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_Bus) };
            }
        }
        ...
        public Boolean GrabarDB(ba_Conciliacion_Info info, ref decimal IdConciliacion, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(ba_Conciliacion_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_Bus) };
            }
        }
        ...
        public Boolean EliminarDB(ba_Conciliacion_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_Bus) };
            }
        }
        ...
        public Boolean AnularDB(ba_Conciliacion_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_Bus) };
            }
        }
        ...
        public ba_Conciliacion_Info Get_Info_Conciliacion_x_Rpt(int IdEmpresa, int IdConciliacion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Conciliacion_x_Rpt", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_Bus) };
            }
        }
        ...
        public Boolean VerificarPeriodoConciliado(int IdEmpresa, int IdPeriodo, int IdBanco)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VerificarPeriodoConciliado", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_Bus) };
            }
        ...
        public Boolean VerificarConciliacionPrimeraVez(int IdEmpresa, int Idbanco)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VerificarConciliacionPrimeraVez", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_Bus) };
            }
