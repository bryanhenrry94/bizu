    ...
    public class ba_Talonario_cheques_x_banco_Bus
    {
        ...
        public decimal GetSecuencia(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GetSecuencia", ex.Message), ex) { EntityType = typeof(ba_Talonario_cheques_x_banco_Bus) };
            }
        }
        ...
        public List<ba_Talonario_cheques_x_banco_Info> Get_List_Talonario_cheques_x_banco(int IdEmpresa, ref string mensajeErrorOut)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Talonario_cheques_x_banco", ex.Message), ex) { EntityType = typeof(ba_Talonario_cheques_x_banco_Bus) };
        ...
        public ba_Talonario_cheques_x_banco_Info Get_Info_Ultimo_cheq_no_usuado(int IdEmpresa, int idbanco, ref string MensajeErrorOut)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Ultimo_cheq_no_usuado", ex.Message), ex) { EntityType = typeof(ba_Talonario_cheques_x_banco_Bus) };
            }
        }
        ...
        public ba_Talonario_cheques_x_banco_Info Get_Info_Ultimo_cheq_banco(int IdEmpresa, int idbanco, ref string MensajeErrorOut)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Ultimo_cheq_banco", ex.Message), ex) { EntityType = typeof(ba_Talonario_cheques_x_banco_Bus) };
            }
        }
        ...
        public Boolean GrabarDB(ba_Talonario_cheques_x_banco_Info Info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ba_Talonario_cheques_x_banco_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(ba_Talonario_cheques_x_banco_Info Info, string numcheq, ref string msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(ba_Talonario_cheques_x_banco_Bus) };
            }
        }
        ...
        public Boolean AnularDB(ba_Talonario_cheques_x_banco_Info Info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(ba_Talonario_cheques_x_banco_Bus) };
            }
        ...
        public Boolean Usar(ba_Cbte_Ban_Info CbteBan_I,  string  Num_cheque, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Usar", ex.Message), ex) { EntityType = typeof(ba_Talonario_cheques_x_banco_Bus) };
            }
