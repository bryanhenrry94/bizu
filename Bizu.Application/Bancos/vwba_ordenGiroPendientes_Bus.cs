   ...
   public class vwba_ordenGiroPendientes_Bus
    {
       ...
       public List<vwba_ordenGiroPendientes_Info> Get_List_ordenGiroPendientes(int IdEmpresa)
       {
           ...
           catch (Exception ex)
           {
               ...
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_ordenGiroPendientes", ex.Message), ex) { EntityType = typeof(vwba_ordenGiroPendientes_Bus) };
           }
