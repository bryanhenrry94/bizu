    ...
    {/*
        ...
        public List<ba_Conciliacion_det_no_conciliado_Info> Get_List_Conciliacion_det_no_conciliado(int IdEmpresa, int IdConciliacion, int Secuencia)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Conciliacion_det_no_conciliado", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_det_no_conciliado_Bus) };
            }
        }
        ...
        public List<vwba_TransaccionesAConciliar_Info> Get_List_TransaccionesAConciliar(int IdEmpresa, decimal IdConciliacion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_TransaccionesAConciliar", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_det_no_conciliado_Bus) };
            }
        }
        ...
        public Boolean GrabarDB(ba_Conciliacion_det_no_conciliado_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_det_no_conciliado_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(ba_Conciliacion_det_no_conciliado_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_det_no_conciliado_Bus) };
            }
        }
        ...
        public Boolean AnularDB(ba_Conciliacion_det_no_conciliado_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_det_no_conciliado_Bus) };
            }
        }
        ...
        public Boolean EliminarDB(int IdEmpresa, int IdConciliacion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(ba_Conciliacion_det_no_conciliado_Bus) };
            }
        }
