...
namespace Bizu.Application.Bancos
{
    public class ba_Archivo_Transferencia_Det_Bus
    {
        ...
        public List<ba_Archivo_Transferencia_Det_Info> Get_List_Vista_Archivo_transferencia_Det(int idEmpresa, int idBancoIni, int idBancoFin, string idProceso, DateTime fechaIni, DateTime fechaFin)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Vista_Archivo_transferencia_Det", ex.Message), ex) { EntityType = typeof(ba_Archivo_Transferencia_Det_Bus) };
            }
        }
        ...
        public Boolean Actualizar_registro(ba_Archivo_Transferencia_Det_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Actualizar_registro", ex.Message), ex) { EntityType = typeof(ba_Archivo_Transferencia_Det_Bus) };
        ...
        public decimal Get_Secuencial_registro(int IdEmpresa, string IdProceso_bancario)
        {
            try
            {
                return oData.Get_Secuencial_registro(IdEmpresa, IdProceso_bancario);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Secuencial_registro", ex.Message), ex) { EntityType = typeof(ba_Archivo_Transferencia_Det_Bus) };
            }
        }
        ...
        public decimal Get_secuencial_registro_modificar(int IdEmpresa, string IdProceso_bancario, decimal IdArchivo)
        {
            try
            {
                return oData.Get_secuencial_registro_modificar(IdEmpresa, IdProceso_bancario, IdArchivo);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_secuencial_registro_modificar", ex.Message), ex) { EntityType = typeof(ba_Archivo_Transferencia_Det_Bus) };
        ...
        public decimal Get_Secuencial_registro_BB(int IdEmpresa, string IdProceso_bancario)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Secuencial_registro_BB", ex.Message), ex) { EntityType = typeof(ba_Archivo_Transferencia_Det_Bus) };
        ...
        public decimal Get_secuencial_registro_BB_modificar(int IdEmpresa, string IdProceso_bancario, decimal IdArchivo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_secuencial_registro_BB_modificar", ex.Message), ex) { EntityType = typeof(ba_Archivo_Transferencia_Det_Bus) };
        ...
        public Boolean ModificarDB(ba_Archivo_Transferencia_Det_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(ba_Archivo_Transferencia_Det_Bus) };
        ...
        //    {
        //        Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        //        throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Archivo_transferencia_para_deposito", ex.Message), ex) { EntityType = typeof(ba_Archivo_Transferencia_Det_Bus) };
        //    }
        //}
    }
}