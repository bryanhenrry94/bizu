    ...
    public class ba_Banco_Cuenta_Bus
    {
        ...
        private Boolean Validar_Objeto(ba_Banco_Cuenta_Info info, ref string MensajeError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Validar_Objeto", ex.Message), ex) { EntityType = typeof(ba_Banco_Cuenta_Bus) };
        ...
        public List<ba_Banco_Cuenta_Info> Get_list_Banco_Cuenta(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Banco_Cuenta", ex.Message), ex) { EntityType = typeof(ba_Banco_Cuenta_Bus) };
            }
        }
        ...
        public List<ba_Banco_Cuenta_Info> Get_list_Banco_Cuenta_Todos(int IdEmpres)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_Banco_Cuenta_Todos", ex.Message), ex) { EntityType = typeof(ba_Banco_Cuenta_Bus) };
            }
        }
        ...
        public Boolean Verificar_Si_Existe_Cuenta_x_CtaCble(int IdEmpresa, string IdCtaCble)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ba_Banco_Cuenta_Bus) };
            }
        }
        ...
        public Boolean ActualizarEstado(ba_Banco_Cuenta_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ActualizarEstado", ex.Message), ex) { EntityType = typeof(ba_Banco_Cuenta_Bus) };
            }
        ...
        public Boolean ModificarDB(ba_Banco_Cuenta_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(ba_Banco_Cuenta_Bus) };
            }
        ...
        public ba_Banco_Cuenta_Info Get_Info_Banco_Cuenta(int IdEmpresa, int Idbanco)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Banco_Cuenta", ex.Message), ex) { EntityType = typeof(ba_Banco_Cuenta_Bus) };
            }
