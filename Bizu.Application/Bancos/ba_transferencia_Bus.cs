    ...
    public class ba_transferencia_Bus
    {
        ...
        public Boolean GrabarDB(ba_transferencia_Info info, ref decimal IdTranf)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(ba_transferencia_Bus) };
            }
        ...
        public Boolean ModificarDB(ba_transferencia_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(ba_transferencia_Bus) };
            }
        ...
        public Boolean AnularDB(ba_transferencia_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(ba_transferencia_Bus) };
            }
        ...
        public List<ba_transferencia_Info> Get_List_transferencia(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_transferencia", ex.Message), ex) { EntityType = typeof(ba_transferencia_Bus) };
            }
        ...
        public ba_rpt_transferencia_Info Get_Info_rpt_transferencia(int IdEmpresa, int idtransferencia)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ProcesarDataTable_a_Info", ex.Message), ex) { EntityType = typeof(ba_transferencia_Bus) };
            }
