    ...
    public sealed class cl_parametrosGenerales_Bus
    {
        ...
        cl_parametrosGenerales_Bus()
        {
            ...
            catch (Exception ex)
            {
                ...
                //throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "no se puede acceder a la base o ", ex.Message), ex) { EntityType = typeof(cl_parametrosGenerales_Bus) };
        ...
        public DateTime GetDateServer()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_Bodegas", ex.Message), ex) { EntityType = typeof(cl_parametrosGenerales_Bus) };
