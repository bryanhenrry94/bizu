            ...
            try
            {
                ...
                using (var response = (HttpWebResponse)HttpWReq.GetResponse())
                {
                    using (var reader = new StreamReader(response.GetResponseStream()))
                    {
                        ...
                        var data = JsonConvert.DeserializeObject<Bizu.Domain.Efirm.tb_Comprobante_Info>(jsonContent);
        ...
        public int Get_IdEmpresa_x_Ruc(string Ruc, ref string mensaje_error)
        {
            ...
            try
            {
                ...
                using (var response = (HttpWebResponse)HttpWReq.GetResponse())
                {
                    ...
                    {
                        var jsonContent = reader.ReadToEnd();
                        var data = JsonConvert.DeserializeObject<Bizu.Domain.Efirm.tb_Empresa_Info>(jsonContent);
