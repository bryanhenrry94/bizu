    ...
    public class tb_persona_bus
    {
        ...
        public List<tb_persona_Info> Get_List_Persona_x_Tipo(int IdTipoPersona)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerPersonasXtipo", ex.Message), ex) { EntityType = typeof(tb_persona_bus) };
        ...
        public Boolean Verifica_Ruc(string cedula, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "tb_persona_bus", ex.Message), ex) { EntityType = typeof(tb_persona_bus) };
            }
        }
        ...
        public List<tb_persona_Info> Get_List_Persona()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Persona", ex.Message), ex) { EntityType = typeof(tb_persona_bus) };
            }
        }
        ...
        public tb_persona_Info Get_Info_Persona(decimal idPersona)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerPersona", ex.Message), ex) { EntityType = typeof(tb_persona_bus) };
        ...
        public tb_persona_Info Get_Info_Persona(string cedula)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerDatoPersona", ex.Message), ex) { EntityType = typeof(tb_persona_bus) };
        ...
        public tb_persona_Info Get_Info_Persona(string IdTipoDocumento, string CedulaRuc)
        {
            try
            {
                return EmpD.Get_Info_Persona(IdTipoDocumento, CedulaRuc);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public decimal getIdPersona()
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "getIdPersona", ex.Message), ex) { EntityType = typeof(tb_persona_bus) };
        ...
        public Boolean ModificarDB(tb_persona_Info info, ref string msgError)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(tb_persona_bus) };
        ...
        public Boolean ModificaPersEmpl(tb_persona_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificaPersEmpl", ex.Message), ex) { EntityType = typeof(tb_persona_bus) };
        ...
        public Boolean GrabarDB(tb_persona_Info info, ref decimal idPersonaOut, ref string msgError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(tb_persona_bus) };
        ...
        public Boolean AnularDB(tb_persona_Info info, ref string msgError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(tb_persona_bus) };
        ...
        public Boolean VericarCedulaExiste(string cedula, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VericarCedulaExiste", ex.Message), ex) { EntityType = typeof(tb_persona_bus) };
        ...
        private Boolean validar_y_corregir_objeto(ref tb_persona_Info Info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "validar_y_corregir_objeto", ex.Message), ex) { EntityType = typeof(tb_persona_bus) };
