    ...
    public class tb_banco_procesos_bancarios_x_empresa_Bus
    {
        ...
        public List<tb_banco_procesos_bancarios_x_empresa_Info> Get_list_procesos_bancarios_x_empresa(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_procesos_bancarios_x_empresa", ex.Message), ex) { EntityType = typeof(tb_banco_procesos_bancarios_x_empresa_Bus) };
            }
        }
        ...
        public tb_banco_procesos_bancarios_x_empresa_Info Get_info_proceso_bancario_x_empresa(int IdEmpresa, string IdProceso_bancario)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_info_proceso_bancario_x_empresa", ex.Message), ex) { EntityType = typeof(tb_banco_procesos_bancarios_x_empresa_Bus) };
            }
        }
        ...
        public bool GuardarDB(tb_banco_procesos_bancarios_x_empresa_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(tb_banco_procesos_bancarios_x_empresa_Bus) };
            }
        }
        ...
        public bool EliminarDB(int IdEmpresa, int IdBanco)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(tb_banco_procesos_bancarios_x_empresa_Bus) };
            }
        }
    }
}
