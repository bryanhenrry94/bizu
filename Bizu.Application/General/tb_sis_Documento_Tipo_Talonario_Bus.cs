    ...
    public  class tb_sis_Documento_Tipo_Talonario_Bus
    {
        ...
        public List<tb_sis_Documento_Tipo_Talonario_Info> Get_List_DocTipoxSecTalonario(int idEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerListaDocTipoxSecTalonario", ex.Message), ex) { EntityType = typeof(tb_sis_Documento_Tipo_Talonario_Bus) };
            ...
            (int IdEmpresa, string TipoDocu,bool Es_Documento_Electronico)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerLista_Docu_Tipo_Talonario_x_TipoDocu", ex.Message), ex) { EntityType = typeof(tb_sis_Documento_Tipo_Talonario_Bus) };
        ...
        public tb_sis_Documento_Tipo_Talonario_Info Get_Info_Ult_Documento(int idEmpresa, string puntoemision, string establecimiento, string tipodoc)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_Ult_Documento", ex.Message), ex) { EntityType = typeof(tb_sis_Documento_Tipo_Talonario_Bus) };
            ...
            (int idEmpresa, string puntoemision, string establecimiento, string tipodoc,bool Es_Documento_Electronico)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_Ult_Documento_no_usado", ex.Message), ex) { EntityType = typeof(tb_sis_Documento_Tipo_Talonario_Bus) };
           ...
           (int IdEmpresa, string tipodoc, string establecimiento, string puntoemision, string NumDocumento)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_Primer_Documento_no_usado", ex.Message), ex) { EntityType = typeof(tb_sis_Documento_Tipo_Talonario_Bus) };
        ...
        public Boolean Verificar_NumTalonario(int IdEmpresa, string codDocuTipo, string establecimiento, string puntoEmision, string numDocumento, ref string mensaje)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Verificar_NumTalonario", ex.Message), ex) { EntityType = typeof(tb_sis_Documento_Tipo_Talonario_Bus) };
           
            }
        
        }

        public Boolean Modificar_Estado_Usado(Domain.General.tb_sis_Documento_Tipo_Talonario_Info Info, ref string  mensajeError)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Modificar_Estado_Usado", ex.Message), ex) { EntityType = typeof(tb_sis_Documento_Tipo_Talonario_Bus) };
        ...
        public Boolean Documento_talonario_esta_Usado(tb_sis_Documento_Tipo_Talonario_Info Info, ref string mensajeError, ref string mensajeDocumentoDupli)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "validarEstadoDocumento", ex.Message), ex) { EntityType = typeof(tb_sis_Documento_Tipo_Talonario_Bus) };
        ...
        public  tb_sis_Documento_Tipo_Talonario_Info Verificar_DocumentoElectronico(int IdEmpresa,string codDocuTipo, string establecimiento, string puntoEmision, string numDocumento, tb_sis_Documento_Tipo_Talonario_Info Info, ref string mensaje)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Verificar_EsDocumentoElectronico", ex.Message), ex) { EntityType = typeof(tb_sis_Documento_Tipo_Talonario_Bus) };
