    ...
    public class tb_Bodega_Bus
    {
        ...
        public List<tb_Bodega_Info> Get_List_Bodega(int IdEmpresa, int IdSucursal)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_Bodegas", ex.Message), ex) { EntityType = typeof(tb_Bodega_Bus) };
        ...
        public string Get_cod_pto_emision_x_Bodega(int IdEmpresa, int IdSucursal, int IdBodega)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_Objeto", ex.Message), ex) { EntityType = typeof(tb_Bodega_Bus) };
        ...
        public Boolean ModificarDB(tb_Bodega_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(tb_Bodega_Bus) };
        ...
        public int getId(int IdEmpresa,int IdSucursal)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "getId", ex.Message), ex) { EntityType = typeof(tb_Bodega_Bus) };
        ...
        public Boolean GrabarDB(tb_Bodega_Info info, ref int id, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(tb_Bodega_Bus) };
        ...
        public Boolean EliminarDB(tb_Bodega_Info info, ref  string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(tb_Bodega_Bus) };
        ...
        public List<tb_Bodega_Info> Get_List_Bodegas_x_CentroCosto(int IdEmpresa, string IdCentroCosto)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Obtener_Bodegas_x_CentroCosto", ex.Message), ex) { EntityType = typeof(tb_Bodega_Bus) };
