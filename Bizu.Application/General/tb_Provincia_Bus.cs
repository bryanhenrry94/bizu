  ...
  public  class tb_Provincia_Bus
    {
        ...
        public Boolean Guardar_DB(tb_provincia_Info Info_Pro, ref string IdProvincia, ref string msjError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Guardar_DB", ex.Message), ex) { EntityType = typeof(tb_Provincia_Bus) };
        ...
        public Boolean Modificar_DB(tb_provincia_Info Info_Pro, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Modificar_DB", ex.Message), ex) { EntityType = typeof(tb_Provincia_Bus) };
        ...
        public Boolean Anular_DB(tb_provincia_Info Info_Pro, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Anular_DB", ex.Message), ex) { EntityType = typeof(tb_Provincia_Bus) };
          ...
          public List<tb_provincia_Info> Get_List_Provincia(string IdPais) 
          {
              ...
              {
                  Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                  throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Provincia", ex.Message), ex) { EntityType = typeof(tb_Provincia_Bus) };
          ...
          public string GetIdProvincia(string IdCiudad) {
              ...
              catch (Exception ex)
              {
                  ...
                  Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                  throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_IdProvincia", ex.Message), ex) { EntityType = typeof(tb_Provincia_Bus) };
