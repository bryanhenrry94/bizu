    ...
    public class tb_contacto_Bus
    {
        ...
        public List<tb_contacto_Info> Get_Contanto_x_cedula(int IdEmpresa, string Cedula)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get__Contacto_x Cedula", ex.Message), ex) { EntityType = typeof(tb_contacto_Bus) };
            }
        }
        ...
        public bool ExisteContacto(int idEmpresa, decimal idContacto, decimal idPersona,ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ExisteCedula", ex.Message), ex) { EntityType = typeof(tb_contacto_Bus) };
            }
        }
        ...
        public List<tb_contacto_Info> Get_List_Contacto(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Contacto", ex.Message), ex) { EntityType = typeof(tb_contacto_Bus) };
            }
        }
        public int getId(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GetId", ex.Message), ex) { EntityType = typeof(tb_contacto_Bus) };
            }
        }
        ...
        public bool GuardarContacto(tb_contacto_Info Info, decimal idContacto, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarContacto", ex.Message), ex) { EntityType = typeof(tb_contacto_Bus) };
            }
        }
        ...
        public Boolean ActualizarContacto(tb_contacto_Info Info, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ActualizarContacto", ex.Message), ex) { EntityType = typeof(tb_contacto_Bus) };
            }
        }
        ...
        public Boolean AnularContacto(tb_contacto_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularContacto", ex.Message), ex) { EntityType = typeof(tb_contacto_Bus) };
            }
        ...
        {            
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Información Contacto", ex.Message), ex) { EntityType = typeof(tb_contacto_Bus) };
            }
        }
