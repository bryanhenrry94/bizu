    ...
    public class tb_sis_reporte_Bus
    {
        ...
        public List<tb_sis_reporte_Info> Get_List_reporte(string CodModulo, string Tipo)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(tb_sis_reporte_Bus) };
            }
        ...
        public Boolean VericarExisteIdString(string codigo, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VericarExisteIdString", ex.Message), ex) { EntityType = typeof(tb_sis_reporte_Bus) };
        ...
        public List<tb_sis_reporte_Info> Get_List_reporte(Boolean _se_Muestra_Admin_Reporte)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaGeneral", ex.Message), ex) { EntityType = typeof(tb_sis_reporte_Bus) };
        ...
        public List<tb_sis_reporte_Info> Get_list_sis_reporte(List<tb_modulo_Info> lstModulo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaRptXModulo", ex.Message), ex) { EntityType = typeof(tb_sis_reporte_Bus) };
        ...
        public tb_sis_reporte_Info Get_Info_sis_reporte(string CodReporte)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerObjeto", ex.Message), ex) { EntityType = typeof(tb_sis_reporte_Bus) };
        ...
        public Boolean ModificarDB_Disenio(tb_sis_reporte_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(tb_sis_reporte_Bus) };
        ...
        public string Get_Numero(string CodModulo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ObtenerNumero", ex.Message), ex) { EntityType = typeof(tb_sis_reporte_Bus) };
