    ...
    public class tb_sis_Documento_Tipo_x_Empresa_Anulados_Bus
    {
        ...
        public Boolean GuardarDB(tb_sis_Documento_Tipo_x_Empresa_Anulados_Info Info,ref string msj)
        {
            ...
            catch(Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "validarEstadoDocumento", ex.Message), ex) { EntityType = typeof(tb_sis_Documento_Tipo_x_Empresa_Anulados_Bus) };
