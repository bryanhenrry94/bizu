    ...
    public class cp_Conciliacion_Ing_Bodega_x_Orden_Giro_Bus
    {
        ...
        public Boolean GuardarDB(cp_Conciliacion_Ing_Bodega_x_Orden_Giro_Info Info, ref decimal IdConciliacion, ref decimal IdIdAprobacion, ref string msjError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(cp_Conciliacion_Ing_Bodega_x_Orden_Giro_Bus) };
            }
        }
        ...
        public Boolean AnularDB(cp_Conciliacion_Ing_Bodega_x_Orden_Giro_Info Info, ref string msjError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(cp_Conciliacion_Ing_Bodega_x_Orden_Giro_Bus) };
            }
        }
        ...
        public cp_Conciliacion_Ing_Bodega_x_Orden_Giro_Info Get_Info_Conciliacion_Ing(int IdEmpresa, decimal IdConciliacion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Conciliacion_Ing", ex.Message), ex) { EntityType = typeof(cp_Conciliacion_Ing_Bodega_x_Orden_Giro_Bus) };
            }
        }
        ...
        public List<vwcp_Conciliacion_Ing_Bodega_x_Orden_Giro_Info> Get_List_Conciliacion(int IdEmpresa, DateTime FechaIni, DateTime FechaFin)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Conciliacion", ex.Message), ex) { EntityType = typeof(cp_Conciliacion_Ing_Bodega_x_Orden_Giro_Bus) };
            }
        }
        ...
        public List<vwcp_Orden_Giro_Pendiente_Conciliar_Info> Get_List_OG_Pendiente_Conciliar(int IdEmpresa, decimal IdProveedor)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_OG_Pendiente_Conciliar", ex.Message), ex) { EntityType = typeof(cp_Conciliacion_Ing_Bodega_x_Orden_Giro_Bus) };
            }
        }
        ...
        public List<vwcp_Orden_Giro_Pendiente_Conciliar_Info> Get_List_OG_Facturas_Conciliadas(int IdEmpresa, decimal IdConciliacion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_OG_Facturas_Conciliadas", ex.Message), ex) { EntityType = typeof(cp_Conciliacion_Ing_Bodega_x_Orden_Giro_Bus) };
            }
        }
        ...
        public List<cp_Aprobacion_Ing_Bod_x_OC_det_Info> Get_List_Ing_Bod_x_OC_Conciliadas(int IdEmpresa, decimal IdConcilacion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Ing_Bod_x_OC_Conciliadas", ex.Message), ex) { EntityType = typeof(cp_Conciliacion_Ing_Bodega_x_Orden_Giro_Bus) };
            }
