    ...
    public class cp_proveedor_codigo_SRI_Bus
    {
        ...
        public List<cp_proveedor_codigo_SRI_Info> Get_List_proveedor_codigo_SRI(int empresa, decimal proveedor)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_proveedor_codigo_SRI", ex.Message), ex) { EntityType = typeof(cp_proveedor_codigo_SRI_Bus) };
            }
        ...
        public Boolean GrabarDB(cp_proveedor_codigo_SRI_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(cp_proveedor_codigo_SRI_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(cp_proveedor_codigo_SRI_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cp_proveedor_codigo_SRI_Bus) };
            }
        }
        ...
        public Boolean ModificarLista(cp_proveedor_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarLista", ex.Message), ex) { EntityType = typeof(cp_proveedor_codigo_SRI_Bus) };
            }
        }
        ...
        public Boolean EliminarDB(int IdEmpresa, decimal IdProveedor)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(cp_proveedor_codigo_SRI_Bus) };
            }
