   ...
   public class cp_reembolso_Bus
    {
       ...
       public Boolean GuardarDB(cp_reembolso_Info Info)
       {
           ...
           catch (Exception ex)
           {
               ...
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(cp_reembolso_Bus) };
           }
       ...
       public List<cp_reembolso_Info> Get_List_reembolso(int IdEmpresa)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_reembolso", ex.Message), ex) { EntityType = typeof(cp_reembolso_Bus) };
           }
       ...
       public List<cp_reembolso_Info> Get_List_reembolso(int IdEmpresa, int IdTipoCbte_Ogiro, decimal IdCbteCble_Ogiro)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_proveedor_codigo_SRI", ex.Message), ex) { EntityType = typeof(cp_reembolso_Bus) };
           }
       ...
       public Boolean GuardarDBLst(List<cp_reembolso_Info> lst, int IdEmpresa,int IdTipoCbte_Ogiro, decimal IdCbteCble_Ogiro, ref string mensaje)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDBLst", ex.Message), ex) { EntityType = typeof(cp_reembolso_Bus) };
           }
       }
       ...
       public bool Eliminar(int IdEmpresa, Decimal IdCbteCble_Ogiro, int IdTipoCbte_Ogiro)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(cp_reembolso_Bus) };
           }
       ...
       public bool ModificarLst(List<cp_reembolso_Info> lst,int IdEmpresa, Decimal IdCbteCble_Ogiro, int IdTipoCbte_Ogiro)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarLst", ex.Message), ex) { EntityType = typeof(cp_reembolso_Bus) };
           }
       }
