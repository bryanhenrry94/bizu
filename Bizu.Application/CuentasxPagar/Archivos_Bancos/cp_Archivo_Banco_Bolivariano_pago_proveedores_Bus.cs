    ...
    public class cp_Archivo_Banco_Bolivariano_pago_proveedores_Bus
    {
        public Boolean Generar_archivo_pago_proveedores_BB(Archivo_Banco_Bolivariano_pago_proveedores_Info info, string patch, string nombre_File)
        {
            try
            {
                ...
                linea += info.PagTer_campoUsoInterno.PadLeft(2, ' ');
                ...
                linea += info.PagTer_numeroAutorizacionSRI.PadRight(10, ' ');
                linea += info.PagTer_fechaValidez.PadRight(10, ' ');
                linea += info.PagTer_referencia.PadRight(10, ' ');
                ...
                linea += info.PagTer_fechaAutorizacionImpresion.PadRight(10, ' ');
                linea += info.PagTer_codigoBanco.PadRight(5, ' ');
