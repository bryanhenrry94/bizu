...
namespace Bizu.Application.CuentasxPagar.Archivos_Bancos
{
    public class cp_Archivo_Banco_Internacional_pago_proveedores_Bus
    {
        ...
        public Boolean Generar_archivo_pago_proveedores_BI(Archivo_Banco_Internacional_pago_proveedores_Info info, string patch, string carSeparador, string nombre_File)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Generar_archivo_pago_proveedores_BI", ex.Message), ex) { EntityType = typeof(cp_Archivo_Banco_Bolivariano_pago_proveedores_Bus) };
            }
        }
    }
}