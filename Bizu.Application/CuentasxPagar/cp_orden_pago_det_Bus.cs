  ...
  public  class cp_orden_pago_det_Bus
    {
      ...
      public List<cp_orden_pago_det_Info> Get_List_OrdenPagoDetalle(int IdEmpresa, decimal IdOrdenPago, ref string mensaje)
      {
          ...
          {
              Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
              throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_OrdenPagoDetalle", ex.Message), ex) { EntityType = typeof(cp_orden_pago_det_Bus) };
          }
      ...
      public List<cp_orden_pago_det_Info> Get_list_orden_pago_con_cta_acreedora(int IdEmpresa, List<decimal> list_op)
      {
          ...
          {
              Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
              throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_list_orden_pago_con_cta_acreedora", ex.Message), ex) { EntityType = typeof(cp_orden_pago_det_Bus) };
          }
      }
      ...
      public Boolean ModificarDB(cp_orden_pago_det_Info Info)
      {
          ...
          {
              Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
              throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cp_orden_pago_det_Bus) };
          }
      }
      ...
      public Boolean ModificarDB(List<cp_orden_pago_det_Info> lista)
      {
          ...
          {
              Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
              throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Guardar_OrdenPagoCancelacion", ex.Message), ex) { EntityType = typeof(cp_orden_pago_det_Bus) };
          }
      }
