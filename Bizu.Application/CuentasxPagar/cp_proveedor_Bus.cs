    ...
    public class cp_proveedor_Bus
    {
        ...
        public List<cp_proveedor_Info> Get_List_proveedor(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_proveedor", ex.Message), ex) { EntityType = typeof(cp_proveedor_Bus) };
            }
        ...
        public Boolean GrabarDB(cp_proveedor_Info info, ref decimal idPro, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(cp_proveedor_Bus) };
            }
        }
        ...
        public Boolean AnularDB(cp_proveedor_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(cp_proveedor_Bus) };
            }
        }

        public bool ActualizarDatosBancarios(cp_proveedor_Info Info)
        {
            return data.ActualizarDatosBancarios(Info);
        }
        ...
        public Boolean ModificarDB(cp_proveedor_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cp_proveedor_Bus) };
            }
        }
        ...
        public cp_proveedor_Info Get_Info_Proveedor_Solo_CtasCbles(int IdEmpresa, decimal IdProveedor)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Proveedor", ex.Message), ex) { EntityType = typeof(cp_proveedor_Bus) };
            }
        }
        ...
        public List<cp_proveedor_Info> Get_List_ProveedoresXPresupuestoCusTalme(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ProveedoresXPresupuestoCusTalme", ex.Message), ex) { EntityType = typeof(cp_proveedor_Bus) };
            }
        }
        ...
        public cp_proveedor_Info Get_Info_Proveedor_x_Persona(int IdEmpresa, decimal IdPersona, ref string msj)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Proveedor_x_Persona", ex.Message), ex) { EntityType = typeof(cp_proveedor_Bus) };
            }
        }
        ...
        public bool EliminarDB_Todos(int IdEmpresa, ref string message)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(cp_proveedor_Bus) };
            }
        ...
        public cp_proveedor_Info Get_info_proveedor_x_codigo_para_saldo_inicial(int IdEmpresa, string cod_prov, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_info_proveedor_x_codigo_para_saldo_inicial", ex.Message), ex) { EntityType = typeof(cp_proveedor_Bus) };
            }
        }
        ...
        public cp_proveedor_Info Get_Info_ProveedorVistaPrevia(int IdEmpresa, decimal IdProveedor)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_ProveedorVistaPrevia", ex.Message), ex) { EntityType = typeof(cp_proveedor_Bus) };
            }
        }
    }
}