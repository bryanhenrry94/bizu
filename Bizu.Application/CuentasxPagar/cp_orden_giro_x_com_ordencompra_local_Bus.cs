    ...
    public class cp_orden_giro_x_com_ordencompra_local_Bus
    {
        ...
        public List<cp_orden_giro_x_com_ordencompra_local_Info> Get_List_orden_giro_x_com_ordencompra_local(int IdEmpresa_Ogiro, decimal IdCbteCble_Ogiro, int IdTipoCbte_Ogiro)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_orden_giro_x_com_ordencompra_local", ex.Message), ex) { EntityType = typeof(cp_orden_giro_x_com_ordencompra_local_Bus) };
            }
        ...
        public Boolean GrabarDB(cp_orden_giro_x_com_ordencompra_local_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(cp_orden_giro_x_com_ordencompra_local_Bus) };
            }
        ...
        public Boolean ActualizarDB(List<cp_orden_giro_x_com_ordencompra_local_Info> listaNueva, List<cp_orden_giro_x_com_ordencompra_local_Info> listaAntigua)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ActualizarDB", ex.Message), ex) { EntityType = typeof(cp_orden_giro_x_com_ordencompra_local_Bus) };
            }
        ...
        public Boolean EliminarLista(List<cp_orden_giro_x_com_ordencompra_local_Info> lista)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(cp_orden_giro_x_com_ordencompra_local_Bus) };
            }
        ...
        public Boolean ModificarDB(List<cp_orden_giro_x_com_ordencompra_local_Info> Lst, int IdEmpresa, decimal IdCbteCble, int IdTipoCbte)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cp_orden_giro_x_com_ordencompra_local_Bus) };
            }
        ...
        public List<com_ordencompra_local_Info> Get_List_ordencompra_local(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_ordencompra_local", ex.Message), ex) { EntityType = typeof(cp_orden_giro_x_com_ordencompra_local_Bus) };
            }
