    ...
    public class cp_nota_DebCre_Bus
    {
        ...
        public List<cp_nota_DebCre_Info> Get_List_nota_DebCre(int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_nota_DebCre", ex.Message), ex) { EntityType = typeof(cp_nota_DebCre_Bus) };
            }
        ...
        public List<cp_nota_DebCre_Info> Get_List_nota_DebCre(int IdEmpresa, string DebCre, string IdTipoNota)
        {
            try
            {
                return data.Get_List_nota_DebCre(IdEmpresa, DebCre, IdTipoNota);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public Boolean Existe_NumNotaCredito_Proveedor(int IdEmpresa, decimal IdProveedor, String ptoEmision, String Establecimiento, String secuencial, String Tipo, String IdTipoNota)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Existe_NumNotaCredito_Proveedor", ex.Message), ex) { EntityType = typeof(cp_nota_DebCre_Bus) };
            }
        }
        ...
        public Boolean GrabarDB(cp_nota_DebCre_Info info, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(cp_nota_DebCre_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(cp_nota_DebCre_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cp_nota_DebCre_Bus) };
        ...
        public Boolean AnularDB(cp_nota_DebCre_Info Info_notaCredDeb)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "EliminarDB", ex.Message), ex) { EntityType = typeof(cp_nota_DebCre_Bus) };
            }
        }
        ...
        public Boolean VericarNumDocumento(int IdEmpresa, decimal IdProveedor, string Serie1, string Serie2, string cn_NotaC, decimal IdCbteCble_NotaC, int IdTipoCbte_NotaC, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "VericarNumDocumento", ex.Message), ex) { EntityType = typeof(cp_nota_DebCre_Bus) };
            }
        }
        ...
        public cp_nota_DebCre_Info Get_Info_nota_DebCre(int IdEmpresa, decimal IdCbteCble_NotaC, int IdTipoCbte_NotaC)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_nota_DebCre", ex.Message), ex) { EntityType = typeof(cp_nota_DebCre_Bus) };
        ...
        public cp_nota_DebCre_Info Get_Info_nota_DebCre(int IdEmpresa, decimal IdProveedor, string Serie1, string Serie2, string Secuencia)
        {
            try
            {
                return data.Get_Info_nota_DebCre(IdEmpresa, IdProveedor, Serie1, Serie2, Secuencia);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public cp_rpt_nota_credito_Info Get_Info_rpt_nota_credito(int IdEmpresa, decimal IdProveedor, decimal IdCbteCble_NotaC, int IdTipoCbte_NotaC)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_rpt_nota_credito", ex.Message), ex) { EntityType = typeof(cp_nota_DebCre_Bus) };
            }
        }
        ...
        public bool Modificar_tipo_flujo(cp_nota_DebCre_Info info_nota)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Modificar_tipo_flujo", ex.Message), ex) { EntityType = typeof(cp_nota_DebCre_Bus) };
            }
        }
        ...
        public List<cp_nota_DebCre_Info> ProcesarDataTable_ND_x_Saldo_inicial(DataTable ds, ref string MensajeError)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GetId", ex.Message), ex) { EntityType = typeof(cp_proveedor_Bus) };
            }
