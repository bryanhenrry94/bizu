    ...
    public class cp_orden_pago_cancelaciones_Bus
    {
        ...
        public Boolean GuardarDB(List<cp_orden_pago_cancelaciones_Info> Lst, int Id, ref string mensaje)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Guardar_OrdenPagoCancelacion", ex.Message), ex) { EntityType = typeof(cp_orden_pago_cancelaciones_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(List<cp_orden_pago_cancelaciones_Info> info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cp_orden_pago_cancelaciones_Bus) };
            }
        }
        ...
        public List<cp_orden_pago_cancelaciones_Info> ConsultaGeneralOPCxIdCancelaciones(int IdEmpresa, decimal IdCancelacion, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaGeneralOPCxIdCancelaciones", ex.Message), ex) { EntityType = typeof(cp_orden_pago_cancelaciones_Bus) };
            }
        ...
        public List<cp_orden_pago_cancelaciones_Info> ConsultaGeneralOPCxOP(int IdEmpresa, decimal IdOrdenPago,  ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaGeneralOPCxOP", ex.Message), ex) { EntityType = typeof(cp_orden_pago_cancelaciones_Bus) };
            }
        ...
        public List<cp_orden_pago_cancelaciones_Info> ConsultaGeneral_Cancelacion_x_Pagos(int IdEmpresa_pago, int IdTipoCbte_pago, decimal IdCbteCble_pago, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaGeneral_Cancelacion_x_Pagos", ex.Message), ex) { EntityType = typeof(cp_orden_pago_cancelaciones_Bus) };
            }
        ...
        public List<cp_orden_pago_cancelaciones_Info> ConsultaGeneral_Cancelacion_x_Pagos_Anticipos(int IdEmpresa_pago, int IdTipoCbte_pago, decimal IdCbteCble_pago, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ConsultaGeneral_Cancelacion_x_Pagos_Anticipos", ex.Message), ex) { EntityType = typeof(cp_orden_pago_cancelaciones_Bus) };
            }
        ...
        public Boolean Eliminar_OrdenPagoCancelaciones(cp_orden_pago_cancelaciones_Info Info, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Eliminar_OrdenPagoCancelaciones", ex.Message), ex) { EntityType = typeof(cp_orden_pago_cancelaciones_Bus) };
            }
        }
        ...
        public Boolean Eliminar_OrdenPagoCancelaciones_List(List<cp_orden_pago_cancelaciones_Info> Lst, int Id, ref string mensaje)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Eliminar_OrdenPagoCancelaciones_List", ex.Message), ex) { EntityType = typeof(cp_orden_pago_cancelaciones_Bus) };
            }
        }
