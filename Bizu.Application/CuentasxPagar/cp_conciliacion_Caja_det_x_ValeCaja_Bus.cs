       ...
       cp_conciliacion_Caja_det_x_ValeCaja_Data odata = new cp_conciliacion_Caja_det_x_ValeCaja_Data();
        ...
        public Boolean GrabarDB(List<cp_conciliacion_Caja_det_x_ValeCaja_Info> lista, ref string mensaje)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(cp_conciliacion_Caja_det_x_ValeCaja_Bus) };
            }
        ...
        public List<caj_Caja_Movimiento_Info> Get_List_Conciliacion_Caja_Det_ValeCaja(int IdEmpresa, decimal IdConciliacion_caja)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Conciliacion_Caja_Det_ValeCaja", ex.Message), ex) { EntityType = typeof(cp_conciliacion_Caja_det_x_ValeCaja_Bus) };
            }
        ...
        public Boolean ModificarDB(cp_conciliacion_Caja_det_x_ValeCaja_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cp_conciliacion_Caja_det_x_ValeCaja_Bus) };
            }
        }
