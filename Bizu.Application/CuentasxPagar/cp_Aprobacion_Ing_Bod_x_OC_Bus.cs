    ...
    public class cp_Aprobacion_Ing_Bod_x_OC_Bus
    {
        ...
        public Boolean GuardarDB(cp_Aprobacion_Ing_Bod_x_OC_Info Info, ref decimal id, ref string msg)
        {
            try
            {
                ...
                //cabecera
                if (Info.cpAproIngBodxOceliminadoDup != "1")
                ...
                Info_Ogiro = Bus_Ogiro.Get_Info_orden_giro(Convert.ToInt32(Info.IdEmpresa_Ogiro), Convert.ToInt32(Info.IdTipoCbte_Ogiro), Convert.ToDecimal(Info.IdCbteCble_Ogiro));

                if (Info_Ogiro == null)
                {
                    if (!Generar_Orden_Giro(Info, ref msg))
                        return false;
                }
                else
                {
                    if (Info_Ogiro.IdCbteCble_Ogiro == 0)
                    {
                        if (!Generar_Orden_Giro(Info, ref msg))
                            return false;
                    }
        ...
        public Boolean GuardarBD_AprobacionIngxOC(cp_Aprobacion_Ing_Bod_x_OC_Info Info, ref decimal id, ref string msg)
        {
            try
            {
                Boolean res = true;

                if (!Validar_objeto_AprobIngEgrxOC_SinDiarioContable(Info, ref msg))
                    return false;
        ...
        public Boolean ModificarDB(cp_Aprobacion_Ing_Bod_x_OC_Info info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cp_Aprobacion_Ing_Bod_x_OC_Bus) };
            }
        }
        ...
        public Boolean ModificarDB_AprobacionIngxOC(cp_Aprobacion_Ing_Bod_x_OC_Info info, ref string msg)
        {
            try
            {
                return odata.ModificarDB_AprobacionIngxOC(info, ref msg);
            }
            catch (Exception ex)
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
        ...
        public Boolean VerificarNumDocumento(int IdEmpresa, string serie, string serie2, string numDocu, decimal IdProveedor, ref string mensaj)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_cancelacion_Intercompany", ex.Message), ex) { EntityType = typeof(cp_Aprobacion_Ing_Bod_x_OC_Bus) };
            }
        ...
        public Boolean Generar_Orden_Giro(cp_Aprobacion_Ing_Bod_x_OC_Info Info, ref string msg)
        {
            try
            {
                ...
                List<cp_orden_giro_pagos_sri_Info> lst_formasPagoSRI2 = new List<cp_orden_giro_pagos_sri_Info>();
                lst_formasPagoSRI2 = Info.Info_orden_giro.lst_formasPagoSRI;
                ...
                Info_Ogiro.Archivo_PDF = Info.Archivo_PDF;
                ...
                cp_codigo_SRI_Info InfoCodigoSRI_101 = new cp_codigo_SRI_Info();
                cp_codigo_SRI_Info InfoCodigoSRI_ice = new cp_codigo_SRI_Info();

                InfoCodigoSRI_101 = dat_ti.Get_List_codigo_SRI_(Info_Ogiro.IdEmpresa).First(c => c.co_estado == "A" && c.IdTipoSRI == "COD_101");
                InfoCodigoSRI_ice = dat_ti.Get_List_codigo_SRI_(Info_Ogiro.IdEmpresa).First(c => c.co_estado == "A" && c.IdTipoSRI == "COD_ICE");



                // codigo quemado esta MALLLLLLLLLLLLLLLLLLLLLL
                //Info_Ogiro.IdCod_ICE = 41;
                // Info_Ogiro.IdCod_101 = 42;

                Info_Ogiro.IdCod_ICE = InfoCodigoSRI_ice.IdCodigo_SRI;
                Info_Ogiro.IdCod_101 = InfoCodigoSRI_101.IdCodigo_SRI;
                ...
                if (lstDet_OG.Count() > 0)
                {
                    foreach (var item in lstDet_OG)
                    {
                        Info_Ogiro.IdCentroCosto = item.IdCentro_Costo;
                    }
                }
                else
                {
                ...
                //rth sunchodesa
                Info_Ogiro.PagoLocExt = (Info.PagoLocExt == null) ? "LOC" : Info.PagoLocExt;
                Info_Ogiro.ConvenioTributacion = (Info.ConvenioTributacion == "NA") ? "NO" : Info.ConvenioTributacion;
                Info_Ogiro.PagoSujetoRetencion = (Info.PagoSujetoRetencion == "NA") ? "NO" : Info.PagoSujetoRetencion;
                ...
                if (lst_formasPagoSRI == null)
                {
                    if (lst_formasPagoSRI2 != null)
                    {
                        Info_Ogiro.lst_formasPagoSRI = lst_formasPagoSRI2;
                    }
                ...
                if (BusOrdenGiro_B.ExisteFacturaPorProveedor(Info_Ogiro.IdEmpresa, Info_Ogiro.IdProveedor, Info_Ogiro.IdOrden_giro_Tipo, Info_Ogiro.co_serie, Info_Ogiro.co_factura))
                {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Generar_Orden_Giro", ex.Message), ex) { EntityType = typeof(cp_Aprobacion_Ing_Bod_x_OC_Bus) };
            }
        }
        ...
        public Boolean Validar_objeto_AprobIngEgrxOC(cp_Aprobacion_Ing_Bod_x_OC_Info Info, ref string msg)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Validar_objeto_AprobIngEgrxOC", ex.Message), ex) { EntityType = typeof(cp_Aprobacion_Ing_Bod_x_OC_Bus) };
            }

        }

        public Boolean Validar_objeto_AprobIngEgrxOC_SinDiarioContable(cp_Aprobacion_Ing_Bod_x_OC_Info Info, ref string msg)
        {
        ...
        public List<cp_Aprobacion_Ing_Bod_x_OC_Info> Get_List_Aprobacion_Ing_Bod_x_OC(int IdEmpresa, DateTime FechaIni, DateTime FechaFin)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Aprobacion_Ing_Bod_x_OC", ex.Message), ex) { EntityType = typeof(cp_Aprobacion_Ing_Bod_x_OC_Bus) };
            }
        }
        ...
        public cp_Aprobacion_Ing_Bod_x_OC_Info Get_Info_Aprobacion_Ing_Bod_x_OC(int IdEmpresa, decimal IdAprobacion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_Aprobacion_Ing_Bod_x_OC", ex.Message), ex) { EntityType = typeof(cp_Aprobacion_Ing_Bod_x_OC_Bus) };
            }
        }
