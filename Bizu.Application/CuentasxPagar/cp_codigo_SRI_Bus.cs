    ...
    public class cp_codigo_SRI_Bus
    {
        ...
        public List<cp_codigo_SRI_Info> Get_List_codigo_SRI_x_codigo(string[] CodRetencion, int IdEmpresa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_codigo_SRI_x_codigo", ex.Message), ex) { EntityType = typeof(cp_codigo_SRI_Bus) };
            }
        ...
        public List<cp_codigo_SRI_Info> Get_List_codigo_SRI(string cod_tipo)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_codigo_SRI", ex.Message), ex) { EntityType = typeof(cp_codigo_SRI_Bus) };
            }
        ...
        public Boolean GrabarDB(cp_codigo_SRI_Info info, ref int id)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(cp_codigo_SRI_Bus) };
            }
        }
        ...
        public Boolean ModificarDB(cp_codigo_SRI_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cp_codigo_SRI_Bus) };
            }
        }
        ...
        public Boolean AnularDB(cp_codigo_SRI_Info info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "AnularDB", ex.Message), ex) { EntityType = typeof(cp_codigo_SRI_Bus) };
            }
        }
        ...
        public List<cp_codigo_SRI_Info> Get_List_codigo_SRI_(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_codigo_SRI_", ex.Message), ex) { EntityType = typeof(cp_codigo_SRI_Bus) };
            }
        ...
        public List<cp_codigo_SRI_Info> Get_List_codigo_SRI_IvaRet(int IdEmpresa)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_codigo_SRI_IvaRet", ex.Message), ex) { EntityType = typeof(cp_codigo_SRI_Bus) };
            }
        }
