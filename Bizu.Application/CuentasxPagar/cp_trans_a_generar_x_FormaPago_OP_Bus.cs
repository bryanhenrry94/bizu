    ...
    public class cp_trans_a_generar_x_FormaPago_OP_Bus
    {
        ...
        public List<cp_trans_a_generar_x_FormaPago_OP_Info> Get_List_trans_a_generar_x_FormaPago_OP()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_trans_a_generar_x_FormaPago_OP", ex.Message), ex) { EntityType = typeof(cp_trans_a_generar_x_FormaPago_OP_Bus) };
            }
        }
        ...
        public Boolean ValidarCodigoExiste(string Cod)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ValidarCodigoExiste", ex.Message), ex) { EntityType = typeof(cp_trans_a_generar_x_FormaPago_OP_Bus) };
            }
        ...
        public Boolean ModificarDB(List<cp_trans_a_generar_x_FormaPago_OP_Info> lst)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cp_trans_a_generar_x_FormaPago_OP_Bus) };
            }
        }
        public cp_trans_a_generar_x_FormaPago_OP_Info Get_Info_trans_a_generar_x_FormaPago_OP(string IdTipoTransaccion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_Info_trans_a_generar_x_FormaPago_OP", ex.Message), ex) { EntityType = typeof(cp_trans_a_generar_x_FormaPago_OP_Bus) };
            }
        }
        public Boolean Guardar(cp_trans_a_generar_x_FormaPago_OP_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(cp_trans_a_generar_x_FormaPago_OP_Bus) };
            }
        }
