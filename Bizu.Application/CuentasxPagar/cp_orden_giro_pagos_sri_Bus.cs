   ...
   public class cp_orden_giro_pagos_sri_Bus
    {
       ...
       public Boolean GuardarDB(cp_orden_giro_pagos_sri_Info Info)
       {
           ...
           catch (Exception ex)
           {
               ...
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(cp_orden_giro_pagos_sri_Bus) };
           }
       ...
       public List<cp_orden_giro_pagos_sri_Info> Get_List_orden_giro_pagos_sri()
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_orden_giro_pagos_sri", ex.Message), ex) { EntityType = typeof(cp_orden_giro_pagos_sri_Bus) };
           }
       ...
       public bool ModificarDB(List<cp_orden_giro_pagos_sri_Info> lst, int IdEmpresa, Decimal IdCbteCble_Ogiro, int IdTipoCbte_Ogiro, ref string mensaje)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cp_orden_giro_pagos_sri_Bus) };
           }
       }
