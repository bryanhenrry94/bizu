    ...
    public class cp_conciliacion_det_Bus
    {
        ...
        public List<cp_conciliacion_det_Info> Get_List_conciliacion_det(int IdEmpresa, decimal IdConciliacion)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_conciliacion_det", ex.Message), ex) { EntityType = typeof(cp_conciliacion_det_Bus) };
            }
        }
        ...
        public Boolean GrabarDB(List<cp_conciliacion_det_Info> Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(cp_conciliacion_det_Bus) };
            }
        }
        ...
        public List<cp_conciliacion_det_Info> Get_List_Conciliacion_x_cbte_cble(int IdEmpresa, decimal IdConciliacion)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Conciliacion_x_cbte_cble", ex.Message), ex) { EntityType = typeof(cp_conciliacion_det_Bus) };
            }
        }
    }
}
