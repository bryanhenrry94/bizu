    ...
    public class cp_orden_pago_estado_aprob_Bus
    {
        ...
        public List<cp_orden_pago_estado_aprob_Info> Get_List_orden_pago_estado_aprob()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_orden_pago_estado_aprob", ex.Message), ex) { EntityType = typeof(cp_orden_pago_estado_aprob_Bus) };
            }
        }
        ...
        public Boolean ValidarCodigoExiste(string Cod)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ValidarCodigoExiste", ex.Message), ex) { EntityType = typeof(cp_orden_pago_estado_aprob_Bus) };
            }
        ...
        public Boolean ModificarDB(List<cp_orden_pago_estado_aprob_Info> lst)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cp_orden_pago_estado_aprob_Bus) };
            }
        }
        ...
        public Boolean GuardarDB(cp_orden_pago_estado_aprob_Info Info)
        {
            ...
            {
                Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_OrdenPagoDetalle", ex.Message), ex) { EntityType = typeof(cp_orden_pago_estado_aprob_Bus) };
            }
        }
