...
namespace Bizu.Application.CuentasxPagar
{
   public class cp_conciliacion_caja_Bus
   {
       ...
       caj_parametro_Info info_parametro_caja = new Domain.Caja.caj_parametro_Info();
       ...
       public Boolean GrabarDB(cp_conciliacion_caja_Info Info_Conciliacion, ref string mensaje)
       {
           try
           {
                   ...
                   foreach (var item in Info_Conciliacion.Detalle_x_FP)//Inicio Foreach
                   {
                       ...
                       if (Info_Conciliacion.IdEstadoCierre == "EST_CIE_CER")
                       {
                           if (item.IdOrdenPago_OP==null)//Si no tiene una op este registro, la creo
                           {
                               ...
                               {
                                   Get_Orden_Pago_x_ND(item.IdEmpresa_OGiro, item.IdTipoCbte_Ogiro, item.IdCbteCble_Ogiro, ref MensajeError, Info_Conciliacion, item.Valor_a_aplicar);
                               }
                               else
                               {
               ...
               if (Info_Conciliacion.Detalle_x_ValeCaja.Count() > 0)
               {
                   ...
                   foreach (var item in Info_Conciliacion.Detalle_x_ValeCaja)
                   {
                       ...
                       {
                           caj_Caja_Movimiento_Info movimiento_caja_info = new Domain.Caja.caj_Caja_Movimiento_Info();
                           ...
                           // llenar el objeto de movimiento Domain
                           caj_Caja_Movimiento_det_Info info_movimiento_Detalle = new Domain.Caja.caj_Caja_Movimiento_det_Info();
           ...
           catch (Exception ex)
           {
               ...
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GrabarDB", ex.Message), ex) { EntityType = typeof(cp_conciliacion_caja_Bus) };
           }
       }
       ...
       public Boolean ModificarDB(cp_conciliacion_caja_Info Info, ref string msg)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB", ex.Message), ex) { EntityType = typeof(cp_conciliacion_caja_Bus) };
           }          
       }
       ...
       public Boolean ModificarDB_valores(cp_conciliacion_caja_Info Info, ref string msg)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "ModificarDB_valores", ex.Message), ex) { EntityType = typeof(cp_conciliacion_caja_Bus) };
           }
       }
       ...
       private bool Get_Orden_Pago_x_ND(int IdEmpresa, int IdTipoCbte, decimal IdCbteCble, ref string mensaje, cp_conciliacion_caja_Info info_conci, decimal Valor_a_pagar)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GenerarOrdenPago", ex.Message), ex) { EntityType = typeof(cp_conciliacion_caja_Bus) };
           }
       }
...
;
       ...
       private caj_Caja_Movimiento_Info Get_Caja_Movi_x_Item_conciliacion(cp_conciliacion_Caja_det_x_ValeCaja_Info Info_conciliacion_caja_det_x_Val, ref string mensaje, ref decimal NumConciliacion_Caja )
        {
           try
           {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GenerarEgresos", ex.Message), ex) { EntityType = typeof(cp_conciliacion_caja_Bus) };
           }
       }
       ...
       public void GenerarRpt(int IdEmpresa, decimal IdConciliacion_Caja, string IdUsuario, string nom_pc)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "GenerarRpt", ex.Message), ex) { EntityType = typeof(cp_conciliacion_caja_Bus) };
           }
       }
       ...
       public List<cp_conciliacion_caja_Info> Get_List_Conciliacion_Caja(int IdEmpresa, DateTime FDesde, DateTime FHasta)
       {
           ...
           {
               Bizu.Domain.Log_Exception.LoggingManager.Logger.Log(Bizu.Domain.Log_Exception.LoggingCategory.Error, ex.Message);
               throw new Bizu.Domain.Log_Exception.DalException(string.Format("", "Get_List_Conciliacion_Caja", ex.Message), ex) { EntityType = typeof(cp_conciliacion_caja_Bus) };
           }
       }
