    ...
    public class Af_CambioUbicacion_Activo_Bus
    {
        ...
        public Boolean GuardarDB(Af_CambioUbicacion_Activo_Info Info, ref int IdCambioUbicacion, ref string msjError)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "GuardarDB", ex.Message), ex) { EntityType = typeof(Af_CambioUbicacion_Activo_Bus) };
            }
        }
        ...
        public Af_CambioUbicacion_Activo_Info Get_Info_CambioUbicacion(int IdEmpresa, int IdCambioUbicacion)
        {
            ...
            {
                Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "Get_Info_CambioUbicacion", ex.Message), ex) { EntityType = typeof(Af_CambioUbicacion_Activo_Bus) };
            }
        }
