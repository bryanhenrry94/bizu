...
namespace Core.Erp.Business.Bancos
{
    public class ba_Archivo_Transferencia_Det_Bus
    {
        ...
        public decimal Get_Secuencial_registro(int IdEmpresa, string IdProceso_bancario)
        {
            ...
            {
                Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "Get_Secuencial_registro", ex.Message), ex) { EntityType = typeof(ba_Archivo_Transferencia_Det_Bus) };
            }
        }
        ...
        public decimal Get_secuencial_registro_modificar(int IdEmpresa, string IdProceso_bancario, decimal IdArchivo)
        {
            ...
            {
                Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "Get_secuencial_registro_modificar", ex.Message), ex) { EntityType = typeof(ba_Archivo_Transferencia_Det_Bus) };
