  ...
  public  class vwcxc_anticipos_x_cruzar_Bus
    {
      ...
      public List<vwcxc_anticipos_x_cruzar_Info> Get_List_anticipos_x_cruzar_Pendientes_de_Diario(vwcxc_anticipos_x_cruzar_Info info)
      {
          ...
          //{
          //    //Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
          //    //throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "Get_List_anticipos_x_cruzar_Pendientes_de_Diario", ex.Message), ex) { EntityType = typeof(vwcxc_anticipos_x_cruzar_Bus) };
          //}
      }
    }
}
