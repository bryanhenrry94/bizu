    ...
    public class com_solicitud_compra_Bus
    {
        ...
        public List<com_solicitud_compra_Info> Get_List_solicitud_compra_Aprobadas(int idempresa, int idsucursal)
        {
            ...
            catch (Exception ex)
            {
                ...
                Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "Get_List_solicitud_compra_Aprobadas", ex.Message), ex) { EntityType = typeof(com_solicitud_compra_Bus) };
            }
        }
