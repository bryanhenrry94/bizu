...
using Core.Erp.Info.CuentasxPagar.xmlLiquidacionCompra;
    ...
    public class cp_liquidacion_compra_Bus
    {
        ...
        public Boolean Modificar_Num_Documento(cp_liquidacion_compra_Info Info_Liquidacion, ref string mensajeError)
        {
            try
            {
                    ...
                    || Info_Liquidacion.NumDocumento == "" || Info_Liquidacion.NumDocumento == null)
                {
                    ...
                    if (infoTalonario.NumDocumento == null)
                    {
                        ...
                        throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "no hay talonario activos", mensajeError)) { EntityType = typeof(cp_liquidacion_compra_Bus) };
                    }
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "ModificarNRetencion", ex.Message), ex) { EntityType = typeof(cp_liquidacion_compra_Bus) };
            }
        ...
        public List<liquidacionCompra> Get_List_Xml_LiquidacionCompra(int IdEmpresa, decimal IdLiquidacionCompra, ref string msg)
        {
            ...
            {
                Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "Get_List_Xml_LiquidacionCompra", ex.Message), ex) { EntityType = typeof(cp_liquidacion_compra_Bus) };
            }
        }
        ...
        public byte[] Get_Comprobante_Efirm_PDF(int IdEmpresa, decimal IdLiquidacionCompra, ref string IdComprobante, ref string mensaje_error)
        {
            ...
            catch (Exception ex)
            {
                ...
                Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "Get_Comprobante_Efirm_PDF", ex.Message), ex) { EntityType = typeof(cp_retencion_Bus) };
            }
        }
        ...
        public string Get_Comprobante_Efirm_XML(int IdEmpresa, decimal IdLiquidacionCompra, ref string IdComprobante, ref string mensaje_error)
        {
            ...
            {
                Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "Get_Comprobante_Efirm_XML", ex.Message), ex) { EntityType = typeof(cp_retencion_Bus) };
            }
        }
    }
}