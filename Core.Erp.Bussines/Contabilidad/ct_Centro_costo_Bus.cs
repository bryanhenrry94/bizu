...
namespace Core.Erp.Business.Contabilidad
{
    public class ct_Centro_costo_Bus
    {
        ...
        public List<ct_Centro_costo_Info> Get_list_Centro_Costo_cuentas_de_movimiento_x_EstadoObra(int IdEmpresa, ref string MensajeError)
        {
            ...
            {
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "Get_list_Centro_Costo_cuentas_de_movimiento_x_EstadoObra", ex.Message), ex) { EntityType = typeof(ct_Centro_costo_Bus) };
            }
        }
        ...
        public Boolean Validar_CentroCosto_EstadoObra(int IdEmpresa, string IdCentroCosto, ref string mensaje)
        {
            ...
            {
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "Validar_CentroCosto_EstadoObra", ex.Message), ex) { EntityType = typeof(ct_Centro_costo_Bus) };
            }
        }
