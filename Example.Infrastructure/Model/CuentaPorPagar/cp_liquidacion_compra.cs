...
namespace Dazzsoft.ERP.Infrastructure.Model.CuentaPorPagar
{
    ...
    public partial class cp_liquidacion_compra
    {
        public cp_liquidacion_compra()
        {
            this.cp_liquidacion_compra_det = new HashSet<cp_liquidacion_compra_det>();
        }
        ...
        public virtual ICollection<cp_liquidacion_compra_det> cp_liquidacion_compra_det { get; set; }
    }
}
