...
namespace Dazzsoft.ERP.Infrastructure.Model.CuentaPorPagar
{
    ...
    {
        public cp_nota_DebCre()
        {
            this.cp_nota_DebCre_Impuesto = new HashSet<cp_nota_DebCre_Impuesto>();
            this.cp_nota_DebCre_x_com_ordencompra_local = new HashSet<cp_nota_DebCre_x_com_ordencompra_local>();
        }
        ...
        public virtual ICollection<cp_nota_DebCre_Impuesto> cp_nota_DebCre_Impuesto { get; set; }
        public virtual cp_proveedor cp_proveedor { get; set; }
        public virtual ICollection<cp_nota_DebCre_x_com_ordencompra_local> cp_nota_DebCre_x_com_ordencompra_local { get; set; }
    }
}
