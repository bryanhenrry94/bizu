...
namespace Dazzsoft.ERP.Infrastructure.Model.Inventario
{
    ...
    public partial class in_Ing_Egr_Inven_det
    {
        ...
        public Nullable<int> IdEmpresa_gr { get; set; }
        public Nullable<int> IdSucursal_gr { get; set; }
        public Nullable<decimal> IdGuiaRemision { get; set; }
        public Nullable<int> Secuencia_gr { get; set; }
        ...
        public virtual in_GuiaRemision_Det in_GuiaRemision_Det { get; set; }
