...
using Dazzsoft.ERP.Infrastructure.Model.ActivoFijo;

namespace Dazzsoft.ERP.Infrastructure.Persistence
{
    public class ActivoFijoContext : DbContext
    {
        public ActivoFijoContext() : base("name=DefaultConnection") { }
        ...
        public DbSet<Af_proceso_depreciacion> Af_proceso_depreciacion { get; set; }
        public DbSet<Af_Retiro_Activo> Af_Retiro_Activo { get; set; }
        public DbSet<Af_spACTF_Rpt012> Af_spACTF_Rpt012 { get; set; }
        public DbSet<Af_spACTF_Rpt014> Af_spACTF_Rpt014 { get; set; }
        ...
        public DbSet<Af_spACTF_activos_a_depreciar> Af_spACTF_activos_a_depreciar { get; set; }
        ...
        public virtual ObjectResult<spACTF_activos_a_depreciar_mes_contable_Result> spACTF_activos_a_depreciar_mes_contable(Nullable<int> idEmpresa, Nullable<System.DateTime> fecha_ini, Nullable<System.DateTime> fecha_fin, string idUsuario)
        {
            var idEmpresaParameter = idEmpresa.HasValue ?
                new ObjectParameter("IdEmpresa", idEmpresa) :
                new ObjectParameter("IdEmpresa", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spACTF_activos_a_depreciar_mes_contable_Result>("spACTF_activos_a_depreciar_mes_contable", idEmpresaParameter, fecha_iniParameter, fecha_finParameter, idUsuarioParameter);
        }
    }
}
