...
using Dazzsoft.ERP.Infrastructure.Model.Facturacion;

namespace Dazzsoft.ERP.Infrastructure.Persistence
{
    public class FacturacionContext : DbContext
    {
        public FacturacionContext() : base("name=DefaultConnection") { }
        ...
        public DbSet<vwfa_ContabilizacionNotaCredito_x_descuento_x_item> vwfa_ContabilizacionNotaCredito_x_descuento_x_item { get; set; }
        public DbSet<vwfa_cliente> vwfa_cliente { get; set; }
        public DbSet<fa_motivo_aprobacion_Pedido_Venta> fa_motivo_aprobacion_Pedido_Venta { get; set; }
        public DbSet<vwfa_motivo_aprobacion_Pedido_Venta> vwfa_motivo_aprobacion_Pedido_Venta { get; set; }
        public DbSet<fa_notaCreDeb_det_x_in_Ing_Egr_Inven_det> fa_notaCreDeb_det_x_in_Ing_Egr_Inven_det { get; set; }
        public DbSet<vwfa_Nota_Credito_x_Devolver> vwfa_Nota_Credito_x_Devolver { get; set; }
        public DbSet<fa_notaCreDeb_x_in_Ing_Egr_Inven> fa_notaCreDeb_x_in_Ing_Egr_Inven { get; set; }
        public DbSet<vwfa_factura_sri> vwfa_factura_sri { get; set; }
        public DbSet<fa_cliente_obra> fa_cliente_obra { get; set; }
