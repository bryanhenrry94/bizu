...
using Dazzsoft.ERP.Infrastructure.Model.Banco;

namespace Dazzsoft.ERP.Infrastructure.Persistence
{
    public class BancoContext : DbContext
    {
        public BancoContext() : base("name=DefaultConnection") { }
        ...
        public DbSet<ba_Cbte_Ban_Datos_Transferencia> ba_Cbte_Ban_Datos_Transferencia { get; set; }
        public DbSet<ba_Cbte_Ban_Edehsa> ba_Cbte_Ban_Edehsa { get; set; }
        ...
        public DbSet<vwba_Banco_Movimiento_det_cancelado_lite> vwba_Banco_Movimiento_det_cancelado_lite { get; set; }
        ...
        public DbSet<vwba_Cbte_Ban_varios> vwba_Cbte_Ban_varios { get; set; }
